...
final class Temperature_Fahrenheit_fTests0: XCTestCase {
    ...
    func testdouble_to_fahrenheit_f() {
        ...
        let result2 = d_to_degF_f(Double(-Double.greatestFiniteMagnitude))
        ...
        let result3 = d_to_degF_f(Double(Double.greatestFiniteMagnitude))
    ...
    func testfahrenheit_f_to_celsius_d() {
        ...
        let result1 = degF_f_to_degC_d(2500.0)
        ...
        let result2 = degF_f_to_degC_d(25000.0)
        ...
        let result3 = degF_f_to_degC_d(250000.0)
        ...
        let result4 = degF_f_to_degC_d(2500000.0)
        ...
        let result5 = degF_f_to_degC_d(32.0)
        ...
        let result6 = degF_f_to_degC_d(523.67)
        ...
        let result7 = degF_f_to_degC_d(100.0)
        ...
        let result8 = degF_f_to_degC_d(0.0)
        ...
        let result9 = degF_f_to_degC_d(20.0)
    ...
    func testfahrenheit_f_to_celsius_d1() {
        ...
        let result1 = degF_f_to_degC_d(15.0)
        ...
        let result2 = degF_f_to_degC_d(12.0)
        ...
        let result3 = degF_f_to_degC_d(25.0)
        ...
        let result4 = degF_f_to_degC_d(-250.0)
        ...
        let result5 = degF_f_to_degC_d(-2500.0)
        ...
        let result6 = degF_f_to_degC_d(-25000.0)
        ...
        let result7 = degF_f_to_degC_d(-250000.0)
        ...
        let result8 = degF_f_to_degC_d(-2500000.0)
        ...
        let result9 = degF_f_to_degC_d(-40.0)
    ...
    func testfahrenheit_f_to_celsius_d2() {
        ...
        let result1 = degF_f_to_degC_d(Float.greatestFiniteMagnitude)
        let expected1: celsius_d = celsius_d(Double(Float.greatestFiniteMagnitude) * (5.0 / 9.0) - 32.0 * (5.0 / 9.0))
        let tolerance1: celsius_d = 0.99
        if result1 > expected1 {
            XCTAssertLessThanOrEqual(result1 - expected1, tolerance1)
        } else {
    ...
    func testfahrenheit_f_to_celsius_f() {
        ...
        let result1 = degF_f_to_degC_f(2500.0)
        ...
        let result2 = degF_f_to_degC_f(25000.0)
        ...
        let result3 = degF_f_to_degC_f(250000.0)
        ...
        let result4 = degF_f_to_degC_f(2500000.0)
        ...
        let result5 = degF_f_to_degC_f(32.0)
        ...
        let result6 = degF_f_to_degC_f(523.67)
        ...
        let result7 = degF_f_to_degC_f(100.0)
        ...
        let result8 = degF_f_to_degC_f(0.0)
        ...
        let result9 = degF_f_to_degC_f(20.0)
    ...
    func testfahrenheit_f_to_celsius_f1() {
        ...
        let result1 = degF_f_to_degC_f(15.0)
        ...
        let result2 = degF_f_to_degC_f(12.0)
        ...
        let result3 = degF_f_to_degC_f(25.0)
        ...
        let result4 = degF_f_to_degC_f(-250.0)
        ...
        let result5 = degF_f_to_degC_f(-2500.0)
        ...
        let result6 = degF_f_to_degC_f(-25000.0)
        ...
        let result7 = degF_f_to_degC_f(-250000.0)
        ...
        let result8 = degF_f_to_degC_f(-2500000.0)
        ...
        let result9 = degF_f_to_degC_f(-40.0)
    ...
    func testfahrenheit_f_to_celsius_f2() {
        ...
        let result1 = degF_f_to_degC_f(Float.greatestFiniteMagnitude)
        let expected1: celsius_f = celsius_f(Double(Float.greatestFiniteMagnitude) * (5.0 / 9.0) - 32.0 * (5.0 / 9.0))
        let tolerance1: celsius_f = 0.99
        if result1 > expected1 {
            XCTAssertLessThanOrEqual(result1 - expected1, tolerance1)
        } else {
    ...
    func testfahrenheit_f_to_celsius_t() {
    ...
    func testfahrenheit_f_to_celsius_t1() {
    ...
    func testfahrenheit_f_to_celsius_t2() {
    ...
    func testfahrenheit_f_to_celsius_u() {
    ...
    func testfahrenheit_f_to_celsius_u1() {
    ...
    func testfahrenheit_f_to_double() {
        ...
        let result2 = degF_f_to_d(fahrenheit_f(-Float.greatestFiniteMagnitude))
        ...
        let result3 = degF_f_to_d(fahrenheit_f(Float.greatestFiniteMagnitude))
    ...
    func testfahrenheit_f_to_fahrenheit_d() {
        ...
        let result1 = degF_f_to_degF_d(fahrenheit_f(-Float.greatestFiniteMagnitude))
        let expected1: fahrenheit_d = fahrenheit_d(-Float.greatestFiniteMagnitude)
        ...
        let result2 = degF_f_to_degF_d(fahrenheit_f(Float.greatestFiniteMagnitude))
        ...
        let result3 = degF_f_to_degF_d(5.0)
    ...
    func testfahrenheit_f_to_fahrenheit_t() {
    ...
    func testfahrenheit_f_to_fahrenheit_u() {
    ...
    func testfahrenheit_f_to_float() {
        ...
        let result2 = degF_f_to_f(fahrenheit_f(-Float.greatestFiniteMagnitude))
        ...
        let result3 = degF_f_to_f(fahrenheit_f(Float.greatestFiniteMagnitude))
    ...
    func testfahrenheit_f_to_int16_t() {
    ...
    func testfahrenheit_f_to_int32_t() {
    ...
    func testfahrenheit_f_to_int64_t() {
    ...
    func testfahrenheit_f_to_int8_t() {
    ...
    func testfahrenheit_f_to_kelvin_d() {
        ...
        let result1 = degF_f_to_K_d(2500.0)
        ...
        let result2 = degF_f_to_K_d(25000.0)
        ...
        let result3 = degF_f_to_K_d(250000.0)
        ...
        let result4 = degF_f_to_K_d(2500000.0)
        ...
        let result5 = degF_f_to_K_d(32.0)
        ...
        let result6 = degF_f_to_K_d(523.67)
        ...
        let result7 = degF_f_to_K_d(100.0)
        ...
        let result9 = degF_f_to_K_d(20.0)
    ...
    func testfahrenheit_f_to_kelvin_d1() {
        ...
        let result1 = degF_f_to_K_d(15.0)
        ...
        let result2 = degF_f_to_K_d(12.0)
        ...
        let result3 = degF_f_to_K_d(25.0)
        ...
        let result4 = degF_f_to_K_d(-250.0)
        ...
        let result5 = degF_f_to_K_d(-2500.0)
        ...
        let result6 = degF_f_to_K_d(-25000.0)
        ...
        let result7 = degF_f_to_K_d(-250000.0)
        ...
        let result8 = degF_f_to_K_d(-2500000.0)
        ...
        let result9 = degF_f_to_K_d(-40.0)
    ...
    func testfahrenheit_f_to_kelvin_d2() {
        ...
        let result1 = degF_f_to_K_d(Float.greatestFiniteMagnitude)
        let expected1: kelvin_d = kelvin_d((Double(Float.greatestFiniteMagnitude) * (5.0 / 9.0)) - (32.0 * (5.0 / 9.0)) + 273.15)
        let tolerance1: kelvin_d = 0.99
        if result1 > expected1 {
            XCTAssertLessThanOrEqual(result1 - expected1, tolerance1)
        } else {
    ...
    func testfahrenheit_f_to_kelvin_f() {
        ...
        let result1 = degF_f_to_K_f(2500.0)
        ...
        let result2 = degF_f_to_K_f(25000.0)
        ...
        let result3 = degF_f_to_K_f(250000.0)
        ...
        let result4 = degF_f_to_K_f(2500000.0)
        ...
        let result5 = degF_f_to_K_f(32.0)
        ...
        let result6 = degF_f_to_K_f(523.67)
        ...
        let result7 = degF_f_to_K_f(100.0)
        ...
        let result9 = degF_f_to_K_f(20.0)
    ...
    func testfahrenheit_f_to_kelvin_f1() {
        ...
        let result1 = degF_f_to_K_f(15.0)
        ...
        let result2 = degF_f_to_K_f(12.0)
        ...
        let result3 = degF_f_to_K_f(25.0)
        ...
        let result4 = degF_f_to_K_f(-250.0)
        ...
        let result5 = degF_f_to_K_f(-2500.0)
        ...
        let result6 = degF_f_to_K_f(-25000.0)
        ...
        let result7 = degF_f_to_K_f(-250000.0)
        ...
        let result8 = degF_f_to_K_f(-2500000.0)
        ...
        let result9 = degF_f_to_K_f(-40.0)
    ...
    func testfahrenheit_f_to_kelvin_f2() {
        ...
        let result1 = degF_f_to_K_f(Float.greatestFiniteMagnitude)
        let expected1: kelvin_f = kelvin_f((Double(Float.greatestFiniteMagnitude) * (5.0 / 9.0)) - (32.0 * (5.0 / 9.0)) + 273.15)
        let tolerance1: kelvin_f = 0.99
        if result1 > expected1 {
            XCTAssertLessThanOrEqual(result1 - expected1, tolerance1)
        } else {
    ...
    func testfahrenheit_f_to_kelvin_t() {
    ...
    func testfahrenheit_f_to_kelvin_t1() {
    ...
    func testfahrenheit_f_to_kelvin_t2() {
