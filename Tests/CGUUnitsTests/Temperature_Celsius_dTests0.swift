...
final class Temperature_Celsius_dTests0: XCTestCase {
    ...
    func testcelsius_d_to_celsius_f() {
        ...
        let result1 = degC_d_to_degC_f(celsius_d(-Double.greatestFiniteMagnitude))
        let expected1: celsius_f = celsius_f(-Float.greatestFiniteMagnitude)
        ...
        let result2 = degC_d_to_degC_f(celsius_d(Double.greatestFiniteMagnitude))
        ...
        let result3 = degC_d_to_degC_f(5.0)
    ...
    func testcelsius_d_to_celsius_t() {
    ...
    func testcelsius_d_to_celsius_u() {
    ...
    func testcelsius_d_to_double() {
        ...
        let result2 = degC_d_to_d(celsius_d(-Double.greatestFiniteMagnitude))
        ...
        let result3 = degC_d_to_d(celsius_d(Double.greatestFiniteMagnitude))
    ...
    func testcelsius_d_to_fahrenheit_d() {
        ...
        let result1 = degC_d_to_degF_d(0.85)
        ...
        let result2 = degC_d_to_degF_d(25.0)
        ...
        let result3 = degC_d_to_degF_d(2.0)
        ...
        let result4 = degC_d_to_degF_d(-573.01)
        ...
        let result5 = degC_d_to_degF_d(-272.15)
        ...
        let result6 = degC_d_to_degF_d(-268.0)
        ...
        let result7 = degC_d_to_degF_d(-273.03)
        ...
        let result8 = degC_d_to_degF_d(-20.0)
        ...
        let result9 = degC_d_to_degF_d(-Double.greatestFiniteMagnitude)
        let expected9: fahrenheit_d = fahrenheit_d(-Double.greatestFiniteMagnitude)
    ...
    func testcelsius_d_to_fahrenheit_d1() {
    ...
    func testcelsius_d_to_fahrenheit_f() {
        ...
        let result1 = degC_d_to_degF_f(0.85)
        ...
        let result2 = degC_d_to_degF_f(25.0)
        ...
        let result3 = degC_d_to_degF_f(2.0)
        ...
        let result4 = degC_d_to_degF_f(-573.01)
        ...
        let result5 = degC_d_to_degF_f(-272.15)
        ...
        let result6 = degC_d_to_degF_f(-268.0)
        ...
        let result7 = degC_d_to_degF_f(-273.03)
        ...
        let result8 = degC_d_to_degF_f(-20.0)
        ...
        let result9 = degC_d_to_degF_f(-Double.greatestFiniteMagnitude)
    ...
    func testcelsius_d_to_fahrenheit_f1() {
    ...
    func testcelsius_d_to_fahrenheit_t() {
    ...
    func testcelsius_d_to_float() {
        ...
        let result2 = degC_d_to_f(celsius_d(-Double.greatestFiniteMagnitude))
        ...
        let result3 = degC_d_to_f(celsius_d(Double.greatestFiniteMagnitude))
    ...
    func testcelsius_d_to_kelvin_d() {
        ...
        let result3 = degC_d_to_K_d(-272.0)
        ...
        let result4 = degC_d_to_K_d(-273.0)
        ...
        let result5 = degC_d_to_K_d(-Double.greatestFiniteMagnitude)
        let expected5: kelvin_d = kelvin_d(-Double.greatestFiniteMagnitude) + 273.15
        ...
        let result6 = degC_d_to_K_d(Double.greatestFiniteMagnitude)
        let expected6: kelvin_d = kelvin_d(Double.greatestFiniteMagnitude)
        ...
        let result7 = degC_d_to_K_d(-300.0)
    ...
    func testcelsius_d_to_kelvin_f() {
        ...
        let result3 = degC_d_to_K_f(-272.0)
        ...
        let result4 = degC_d_to_K_f(-273.0)
        ...
        let result5 = degC_d_to_K_f(-Double.greatestFiniteMagnitude)
        let expected5: kelvin_f = kelvin_f(-Float.greatestFiniteMagnitude)
        ...
        let result6 = degC_d_to_K_f(Double.greatestFiniteMagnitude)
        ...
        let result7 = degC_d_to_K_f(-300.0)
    ...
    func testcelsius_d_to_kelvin_t() {
    ...
    func testcelsius_d_to_kelvin_u() {
    ...
    func testcelsius_d_to_uint16_t() {
    ...
    func testcelsius_d_to_uint32_t() {
    ...
    func testcelsius_d_to_uint64_t() {
    ...
    func testdouble_to_celsius_d() {
        ...
        let result2 = d_to_degC_d(Double(-Double.greatestFiniteMagnitude))
        let expected2: celsius_d = celsius_d(-Double.greatestFiniteMagnitude)
        ...
        let result3 = d_to_degC_d(Double(Double.greatestFiniteMagnitude))
        let expected3: celsius_d = celsius_d(Double.greatestFiniteMagnitude)
    ...
    func testfloat_to_celsius_d() {
        ...
        let result2 = f_to_degC_d(Float(-Float.greatestFiniteMagnitude))
        ...
        let result3 = f_to_degC_d(Float(Float.greatestFiniteMagnitude))
        let expected3: celsius_d = celsius_d(Float.greatestFiniteMagnitude)
        let tolerance3: celsius_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint16_t_to_celsius_d() {
        ...
        let result2 = i16_to_degC_d(Int16(Int16.min))
        let expected2: celsius_d = celsius_d(Int16.min)
        let tolerance2: celsius_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i16_to_degC_d(Int16(Int16.max))
        let expected3: celsius_d = celsius_d(Int16.max)
        let tolerance3: celsius_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint32_t_to_celsius_d() {
        ...
        let result2 = i32_to_degC_d(Int32(Int32.min))
        let expected2: celsius_d = celsius_d(Int32.min)
        let tolerance2: celsius_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i32_to_degC_d(Int32(Int32.max))
        let expected3: celsius_d = celsius_d(Int32.max)
        let tolerance3: celsius_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint64_t_to_celsius_d() {
        ...
        let result2 = i64_to_degC_d(Int64(Int64.min))
        let expected2: celsius_d = celsius_d(Int64.min)
        let tolerance2: celsius_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i64_to_degC_d(Int64(Int64.max))
        let expected3: celsius_d = celsius_d(Int64.max)
        let tolerance3: celsius_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint8_t_to_celsius_d() {
        ...
        let result2 = i8_to_degC_d(Int8(Int8.min))
        let expected2: celsius_d = celsius_d(Int8.min)
        let tolerance2: celsius_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i8_to_degC_d(Int8(Int8.max))
        let expected3: celsius_d = celsius_d(Int8.max)
        let tolerance3: celsius_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
