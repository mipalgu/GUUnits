...
final class Distance_Millimetres_dTests0: XCTestCase {
    ...
    func testdouble_to_millimetres_d() {
        ...
        let result2 = d_to_mm_d(Double(-Double.greatestFiniteMagnitude))
        ...
        let result3 = d_to_mm_d(Double(Double.greatestFiniteMagnitude))
    ...
    func testfloat_to_millimetres_d() {
        ...
        let result2 = f_to_mm_d(Float(-Float.greatestFiniteMagnitude))
        ...
        let result3 = f_to_mm_d(Float(Float.greatestFiniteMagnitude))
        let expected3: millimetres_d = millimetres_d(Float.greatestFiniteMagnitude)
        let tolerance3: millimetres_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint16_t_to_millimetres_d() {
        ...
        let result2 = i16_to_mm_d(Int16(Int16.min))
        let expected2: millimetres_d = millimetres_d(Int16.min)
        let tolerance2: millimetres_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i16_to_mm_d(Int16(Int16.max))
        let expected3: millimetres_d = millimetres_d(Int16.max)
        let tolerance3: millimetres_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint32_t_to_millimetres_d() {
        ...
        let result2 = i32_to_mm_d(Int32(Int32.min))
        let expected2: millimetres_d = millimetres_d(Int32.min)
        let tolerance2: millimetres_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i32_to_mm_d(Int32(Int32.max))
        let expected3: millimetres_d = millimetres_d(Int32.max)
        let tolerance3: millimetres_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint64_t_to_millimetres_d() {
        ...
        let result2 = i64_to_mm_d(Int64(Int64.min))
        let expected2: millimetres_d = millimetres_d(Int64.min)
        let tolerance2: millimetres_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i64_to_mm_d(Int64(Int64.max))
        let expected3: millimetres_d = millimetres_d(Int64.max)
        let tolerance3: millimetres_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint8_t_to_millimetres_d() {
        ...
        let result2 = i8_to_mm_d(Int8(Int8.min))
        let expected2: millimetres_d = millimetres_d(Int8.min)
        let tolerance2: millimetres_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i8_to_mm_d(Int8(Int8.max))
        let expected3: millimetres_d = millimetres_d(Int8.max)
        let tolerance3: millimetres_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmillimetres_d_to_centimetres_d() {
        ...
        let result2 = mm_d_to_cm_d(250.0)
        ...
        let result4 = mm_d_to_cm_d(2500.0)
        ...
        let result5 = mm_d_to_cm_d(25000.0)
        ...
        let result6 = mm_d_to_cm_d(250000.0)
        ...
        let result7 = mm_d_to_cm_d(2500000.0)
        ...
        let result8 = mm_d_to_cm_d(-323.0)
    ...
    func testmillimetres_d_to_centimetres_d1() {
        ...
        let result2 = mm_d_to_cm_d(-Double.greatestFiniteMagnitude)
        let expected2: centimetres_d = centimetres_d(-Double.greatestFiniteMagnitude) / 10.0
        let tolerance2: centimetres_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = mm_d_to_cm_d(Double.greatestFiniteMagnitude)
        let expected3: centimetres_d = centimetres_d(Double.greatestFiniteMagnitude) / 10.0
        let tolerance3: centimetres_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmillimetres_d_to_centimetres_f() {
        ...
        let result2 = mm_d_to_cm_f(250.0)
        ...
        let result4 = mm_d_to_cm_f(2500.0)
        ...
        let result5 = mm_d_to_cm_f(25000.0)
        ...
        let result6 = mm_d_to_cm_f(250000.0)
        ...
        let result7 = mm_d_to_cm_f(2500000.0)
        ...
        let result8 = mm_d_to_cm_f(-323.0)
    ...
    func testmillimetres_d_to_centimetres_f1() {
        ...
        let result2 = mm_d_to_cm_f(-Double.greatestFiniteMagnitude)
        ...
        let result3 = mm_d_to_cm_f(Double.greatestFiniteMagnitude)
    ...
    func testmillimetres_d_to_centimetres_t() {
    ...
    func testmillimetres_d_to_centimetres_t1() {
    ...
    func testmillimetres_d_to_centimetres_u() {
    ...
    func testmillimetres_d_to_centimetres_u1() {
    ...
    func testmillimetres_d_to_double() {
        ...
        let result2 = mm_d_to_d(millimetres_d(-Double.greatestFiniteMagnitude))
        ...
        let result3 = mm_d_to_d(millimetres_d(Double.greatestFiniteMagnitude))
    ...
    func testmillimetres_d_to_float() {
        ...
        let result2 = mm_d_to_f(millimetres_d(-Double.greatestFiniteMagnitude))
        ...
        let result3 = mm_d_to_f(millimetres_d(Double.greatestFiniteMagnitude))
    ...
    func testmillimetres_d_to_int16_t() {
    ...
    func testmillimetres_d_to_int32_t() {
    ...
    func testmillimetres_d_to_int64_t() {
    ...
    func testmillimetres_d_to_int8_t() {
    ...
    func testmillimetres_d_to_metres_d() {
        ...
        let result4 = mm_d_to_m_d(2500.0)
        ...
        let result5 = mm_d_to_m_d(25000.0)
        ...
        let result6 = mm_d_to_m_d(250000.0)
        ...
        let result7 = mm_d_to_m_d(2500000.0)
    ...
    func testmillimetres_d_to_metres_d1() {
        ...
        let result2 = mm_d_to_m_d(-Double.greatestFiniteMagnitude)
        let expected2: metres_d = metres_d(-Double.greatestFiniteMagnitude) / 1000.0
        let tolerance2: metres_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = mm_d_to_m_d(Double.greatestFiniteMagnitude)
        let expected3: metres_d = metres_d(Double.greatestFiniteMagnitude) / 1000.0
        let tolerance3: metres_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmillimetres_d_to_metres_f() {
        ...
        let result4 = mm_d_to_m_f(2500.0)
        ...
        let result5 = mm_d_to_m_f(25000.0)
        ...
        let result6 = mm_d_to_m_f(250000.0)
        ...
        let result7 = mm_d_to_m_f(2500000.0)
    ...
    func testmillimetres_d_to_metres_f1() {
        ...
        let result2 = mm_d_to_m_f(-Double.greatestFiniteMagnitude)
        ...
        let result3 = mm_d_to_m_f(Double.greatestFiniteMagnitude)
    ...
    func testmillimetres_d_to_metres_t() {
    ...
    func testmillimetres_d_to_metres_t1() {
    ...
    func testmillimetres_d_to_metres_u() {
    ...
    func testmillimetres_d_to_metres_u1() {
    ...
    func testmillimetres_d_to_millimetres_f() {
        ...
        let result1 = mm_d_to_mm_f(millimetres_d(-Double.greatestFiniteMagnitude))
        let expected1: millimetres_f = millimetres_f(-Float.greatestFiniteMagnitude)
        ...
        let result2 = mm_d_to_mm_f(millimetres_d(Double.greatestFiniteMagnitude))
    ...
    func testmillimetres_d_to_millimetres_t() {
