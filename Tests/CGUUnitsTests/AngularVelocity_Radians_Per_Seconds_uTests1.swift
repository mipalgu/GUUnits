...
final class AngularVelocity_Radians_Per_Seconds_uTests1: XCTestCase {
    ...
    func testradians_per_seconds_u_to_radians_per_nanoseconds_d() {
        let result = rad_per_s_u_to_rad_per_ns_d(0)
        let expected: radians_per_nanoseconds_d = radians_per_nanoseconds_d((Double(0)) / (Double(1000000000)))
        ...
        let result1 = rad_per_s_u_to_rad_per_ns_d(5000000)
        let expected1: radians_per_nanoseconds_d = radians_per_nanoseconds_d((Double(5000000)) / (Double(1000000000)))
        ...
        let result2 = rad_per_s_u_to_rad_per_ns_d(UInt64.min)
        let expected2: radians_per_nanoseconds_d = radians_per_nanoseconds_d(((Double(UInt64.min)) / (Double(1000000000))).rounded())
        ...
        let result3 = rad_per_s_u_to_rad_per_ns_d(UInt64.max)
    ...
    func testradians_per_seconds_u_to_radians_per_nanoseconds_f() {
        let result = rad_per_s_u_to_rad_per_ns_f(0)
        let expected: radians_per_nanoseconds_f = radians_per_nanoseconds_f((Double(0)) / (Double(1000000000)))
        ...
        let result1 = rad_per_s_u_to_rad_per_ns_f(5000000)
        let expected1: radians_per_nanoseconds_f = radians_per_nanoseconds_f((Double(5000000)) / (Double(1000000000)))
        ...
        let result2 = rad_per_s_u_to_rad_per_ns_f(UInt64.min)
        let expected2: radians_per_nanoseconds_f = radians_per_nanoseconds_f(((Double(UInt64.min)) / (Double(1000000000))).rounded())
        ...
        let result3 = rad_per_s_u_to_rad_per_ns_f(UInt64.max)
    ...
    func testradians_per_seconds_u_to_radians_per_nanoseconds_t() {
        XCTAssertEqual(rad_per_s_u_to_rad_per_ns_t(0), radians_per_nanoseconds_t(Int64(clamping: (UInt64(0)) / (UInt64(1000000000)))))
        XCTAssertEqual(rad_per_s_u_to_rad_per_ns_t(5000000), radians_per_nanoseconds_t(Int64(clamping: (UInt64(5000000)) / (UInt64(1000000000)))))
        XCTAssertEqual(rad_per_s_u_to_rad_per_ns_t(UInt64.min), radians_per_nanoseconds_t((UInt64(UInt64.min)) / (UInt64(1000000000))))
        XCTAssertEqual(rad_per_s_u_to_rad_per_ns_t(UInt64.max), radians_per_nanoseconds_t(Int64.max))
    }

    func testradians_per_seconds_u_to_radians_per_nanoseconds_u() {
        XCTAssertEqual(rad_per_s_u_to_rad_per_ns_u(0), radians_per_nanoseconds_u(UInt64(clamping: (UInt64(0)) / (UInt64(1000000000)))))
        XCTAssertEqual(rad_per_s_u_to_rad_per_ns_u(5000000), radians_per_nanoseconds_u(UInt64(clamping: (UInt64(5000000)) / (UInt64(1000000000)))))
        XCTAssertEqual(rad_per_s_u_to_rad_per_ns_u(UInt64.min), radians_per_nanoseconds_u((UInt64(UInt64.min)) / (UInt64(1000000000))))
        XCTAssertEqual(rad_per_s_u_to_rad_per_ns_u(UInt64.max), radians_per_nanoseconds_u(UInt64.max))
    }

    func testradians_per_seconds_u_to_radians_per_picoseconds_d() {
        let result = rad_per_s_u_to_rad_per_ps_d(0)
        let expected: radians_per_picoseconds_d = radians_per_picoseconds_d((Double(0)) / (Double(1000000000000)))
        ...
        let result1 = rad_per_s_u_to_rad_per_ps_d(5000000)
        let expected1: radians_per_picoseconds_d = radians_per_picoseconds_d((Double(5000000)) / (Double(1000000000000)))
        ...
        let result2 = rad_per_s_u_to_rad_per_ps_d(UInt64.min)
        let expected2: radians_per_picoseconds_d = radians_per_picoseconds_d(((Double(UInt64.min)) / (Double(1000000000000))).rounded())
        ...
        let result3 = rad_per_s_u_to_rad_per_ps_d(UInt64.max)
    ...
    func testradians_per_seconds_u_to_radians_per_picoseconds_f() {
        let result = rad_per_s_u_to_rad_per_ps_f(0)
        let expected: radians_per_picoseconds_f = radians_per_picoseconds_f((Double(0)) / (Double(1000000000000)))
        ...
        let result1 = rad_per_s_u_to_rad_per_ps_f(5000000)
        let expected1: radians_per_picoseconds_f = radians_per_picoseconds_f((Double(5000000)) / (Double(1000000000000)))
        ...
        let result2 = rad_per_s_u_to_rad_per_ps_f(UInt64.min)
        let expected2: radians_per_picoseconds_f = radians_per_picoseconds_f(((Double(UInt64.min)) / (Double(1000000000000))).rounded())
        ...
        let result3 = rad_per_s_u_to_rad_per_ps_f(UInt64.max)
    ...
    func testradians_per_seconds_u_to_radians_per_picoseconds_t() {
        XCTAssertEqual(rad_per_s_u_to_rad_per_ps_t(0), radians_per_picoseconds_t(Int64(clamping: (UInt64(0)) / (UInt64(1000000000000)))))
        XCTAssertEqual(rad_per_s_u_to_rad_per_ps_t(5000000), radians_per_picoseconds_t(Int64(clamping: (UInt64(5000000)) / (UInt64(1000000000000)))))
        XCTAssertEqual(rad_per_s_u_to_rad_per_ps_t(UInt64.min), radians_per_picoseconds_t((UInt64(UInt64.min)) / (UInt64(1000000000000))))
        XCTAssertEqual(rad_per_s_u_to_rad_per_ps_t(UInt64.max), radians_per_picoseconds_t(Int64.max))
    }

    func testradians_per_seconds_u_to_radians_per_picoseconds_u() {
        XCTAssertEqual(rad_per_s_u_to_rad_per_ps_u(0), radians_per_picoseconds_u(UInt64(clamping: (UInt64(0)) / (UInt64(1000000000000)))))
        XCTAssertEqual(rad_per_s_u_to_rad_per_ps_u(5000000), radians_per_picoseconds_u(UInt64(clamping: (UInt64(5000000)) / (UInt64(1000000000000)))))
        XCTAssertEqual(rad_per_s_u_to_rad_per_ps_u(UInt64.min), radians_per_picoseconds_u((UInt64(UInt64.min)) / (UInt64(1000000000000))))
        XCTAssertEqual(rad_per_s_u_to_rad_per_ps_u(UInt64.max), radians_per_picoseconds_u(UInt64.max))
    }
