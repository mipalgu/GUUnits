...
final class Distance_Metres_fTests0: XCTestCase {
    ...
    func testdouble_to_metres_f() {
        ...
        let result2 = d_to_m_f(Double(-Double.greatestFiniteMagnitude))
        ...
        let result3 = d_to_m_f(Double(Double.greatestFiniteMagnitude))
    ...
    func testfloat_to_metres_f() {
        ...
        let result2 = f_to_m_f(Float(-Float.greatestFiniteMagnitude))
        let expected2: metres_f = metres_f(-Float.greatestFiniteMagnitude)
        let tolerance2: metres_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        ...
        let result3 = f_to_m_f(Float(Float.greatestFiniteMagnitude))
        let expected3: metres_f = metres_f(Float.greatestFiniteMagnitude)
        let tolerance3: metres_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
    ...
    func testint16_t_to_metres_f() {
        ...
        let result2 = i16_to_m_f(Int16(Int16.min))
        let expected2: metres_f = metres_f(Int16.min)
        let tolerance2: metres_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i16_to_m_f(Int16(Int16.max))
        let expected3: metres_f = metres_f(Int16.max)
        let tolerance3: metres_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint32_t_to_metres_f() {
        ...
        let result2 = i32_to_m_f(Int32(Int32.min))
        let expected2: metres_f = metres_f(Int32.min)
        let tolerance2: metres_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i32_to_m_f(Int32(Int32.max))
        let expected3: metres_f = metres_f(Int32.max)
        let tolerance3: metres_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint64_t_to_metres_f() {
        ...
        let result2 = i64_to_m_f(Int64(Int64.min))
        let expected2: metres_f = metres_f(Int64.min)
        let tolerance2: metres_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i64_to_m_f(Int64(Int64.max))
        let expected3: metres_f = metres_f(Int64.max)
        let tolerance3: metres_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint8_t_to_metres_f() {
        ...
        let result2 = i8_to_m_f(Int8(Int8.min))
        let expected2: metres_f = metres_f(Int8.min)
        let tolerance2: metres_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i8_to_m_f(Int8(Int8.max))
        let expected3: metres_f = metres_f(Int8.max)
        let tolerance3: metres_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmetres_f_to_centimetres_d() {
        ...
        let result4 = m_f_to_cm_d(2500.0)
        ...
        let result5 = m_f_to_cm_d(25000.0)
        ...
        let result6 = m_f_to_cm_d(250000.0)
        ...
        let result7 = m_f_to_cm_d(2500000.0)
    ...
    func testmetres_f_to_centimetres_d1() {
        ...
        let result2 = m_f_to_cm_d(-Float.greatestFiniteMagnitude)
        let expected2: centimetres_d = centimetres_d(-Float.greatestFiniteMagnitude) * 100.0
        let tolerance2: centimetres_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = m_f_to_cm_d(Float.greatestFiniteMagnitude)
        let expected3: centimetres_d = centimetres_d(Float.greatestFiniteMagnitude) * 100.0
        let tolerance3: centimetres_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmetres_f_to_centimetres_f() {
        ...
        let result4 = m_f_to_cm_f(2500.0)
        ...
        let result5 = m_f_to_cm_f(25000.0)
        ...
        let result6 = m_f_to_cm_f(250000.0)
        ...
        let result7 = m_f_to_cm_f(2500000.0)
    ...
    func testmetres_f_to_centimetres_f1() {
        ...
        let result2 = m_f_to_cm_f(-Float.greatestFiniteMagnitude)
        ...
        let result3 = m_f_to_cm_f(Float.greatestFiniteMagnitude)
    ...
    func testmetres_f_to_centimetres_t() {
    ...
    func testmetres_f_to_centimetres_t1() {
    ...
    func testmetres_f_to_centimetres_u() {
    ...
    func testmetres_f_to_centimetres_u1() {
    ...
    func testmetres_f_to_double() {
        ...
        let result2 = m_f_to_d(metres_f(-Float.greatestFiniteMagnitude))
        ...
        let result3 = m_f_to_d(metres_f(Float.greatestFiniteMagnitude))
    ...
    func testmetres_f_to_float() {
        ...
        let result2 = m_f_to_f(metres_f(-Float.greatestFiniteMagnitude))
        ...
        let result3 = m_f_to_f(metres_f(Float.greatestFiniteMagnitude))
    ...
    func testmetres_f_to_metres_d() {
        ...
        let result1 = m_f_to_m_d(metres_f(-Float.greatestFiniteMagnitude))
        let expected1: metres_d = metres_d(-Float.greatestFiniteMagnitude)
        ...
        let result2 = m_f_to_m_d(metres_f(Float.greatestFiniteMagnitude))
    ...
    func testmetres_f_to_millimetres_d() {
        ...
        let result4 = m_f_to_mm_d(2500.0)
        ...
        let result5 = m_f_to_mm_d(25000.0)
        ...
        let result6 = m_f_to_mm_d(250000.0)
        ...
        let result7 = m_f_to_mm_d(2500000.0)
    ...
    func testmetres_f_to_millimetres_d1() {
        ...
        let result2 = m_f_to_mm_d(-Float.greatestFiniteMagnitude)
        let expected2: millimetres_d = millimetres_d(-Float.greatestFiniteMagnitude) * 1000.0
        let tolerance2: millimetres_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = m_f_to_mm_d(Float.greatestFiniteMagnitude)
        let expected3: millimetres_d = millimetres_d(Float.greatestFiniteMagnitude) * 1000.0
        let tolerance3: millimetres_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmetres_f_to_millimetres_f() {
        ...
        let result4 = m_f_to_mm_f(2500.0)
        ...
        let result5 = m_f_to_mm_f(25000.0)
        ...
        let result6 = m_f_to_mm_f(250000.0)
        ...
        let result7 = m_f_to_mm_f(2500000.0)
    ...
    func testmetres_f_to_millimetres_f1() {
        ...
        let result2 = m_f_to_mm_f(-Float.greatestFiniteMagnitude)
        ...
        let result3 = m_f_to_mm_f(Float.greatestFiniteMagnitude)
    ...
    func testmetres_f_to_millimetres_t() {
    ...
    func testmetres_f_to_millimetres_t1() {
    ...
    func testmetres_f_to_millimetres_u() {
