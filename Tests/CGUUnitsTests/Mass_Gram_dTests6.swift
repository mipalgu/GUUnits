...
final class Mass_Gram_dTests6: XCTestCase {
    ...
    func testgram_dTomicrogram_tUsing0_0Expectingmicrogram_tDouble0_01000000_0_rounded() {
        XCTAssertEqual(g_d_to_ug_t(0.0), microgram_t((Double(0.0) * 1000000.0).rounded()))
    }

    func testgram_dTomicrogram_tUsing15_0Expectingmicrogram_tDouble15_01000000_0_rounded() {
        XCTAssertEqual(g_d_to_ug_t(15.0), microgram_t((Double(15.0) * 1000000.0).rounded()))
    }

    func testgram_dTomicrogram_tUsing2500000_0Expectingmicrogram_tDouble2500000_01000000_0_rounded() {
        XCTAssertEqual(g_d_to_ug_t(2500000.0), microgram_t((Double(2500000.0) * 1000000.0).rounded()))
    }

    func testgram_dTomicrogram_tUsing250000_0Expectingmicrogram_tDouble250000_01000000_0_rounded() {
        XCTAssertEqual(g_d_to_ug_t(250000.0), microgram_t((Double(250000.0) * 1000000.0).rounded()))
    }

    func testgram_dTomicrogram_tUsing25000_0Expectingmicrogram_tDouble25000_01000000_0_rounded() {
        XCTAssertEqual(g_d_to_ug_t(25000.0), microgram_t((Double(25000.0) * 1000000.0).rounded()))
    }

    func testgram_dTomicrogram_tUsing2500_0Expectingmicrogram_tDouble2500_01000000_0_rounded() {
        XCTAssertEqual(g_d_to_ug_t(2500.0), microgram_t((Double(2500.0) * 1000000.0).rounded()))
    }

    func testgram_dTomicrogram_tUsing250_0Expectingmicrogram_tDouble250_01000000_0_rounded() {
        XCTAssertEqual(g_d_to_ug_t(250.0), microgram_t((Double(250.0) * 1000000.0).rounded()))
    }

    func testgram_dTomicrogram_tUsing25_0Expectingmicrogram_tDouble25_01000000_0_rounded() {
        XCTAssertEqual(g_d_to_ug_t(25.0), microgram_t((Double(25.0) * 1000000.0).rounded()))
    }

    func testgram_dTomicrogram_tUsingDouble_greatestFiniteMagnitudeExpectingmicrogram_tInt64_max() {
        XCTAssertEqual(g_d_to_ug_t(Double.greatestFiniteMagnitude), microgram_t(Int64.max))
    }

    func testgram_dTomicrogram_tUsingNeg1000_0Expectingmicrogram_tDoubleNeg1000_01000000_0_rounded() {
        XCTAssertEqual(g_d_to_ug_t(-1000.0), microgram_t((Double(-1000.0) * 1000000.0).rounded()))
    }

    func testgram_dTomicrogram_tUsingNeg10_0Expectingmicrogram_tDoubleNeg10_01000000_0_rounded() {
        XCTAssertEqual(g_d_to_ug_t(-10.0), microgram_t((Double(-10.0) * 1000000.0).rounded()))
    }

    func testgram_dTomicrogram_tUsingNeg323_0Expectingmicrogram_tDoubleNeg323_01000000_0_rounded() {
        XCTAssertEqual(g_d_to_ug_t(-323.0), microgram_t((Double(-323.0) * 1000000.0).rounded()))
    }

    func testgram_dTomicrogram_tUsingNeg5_0Expectingmicrogram_tDoubleNeg5_01000000_0_rounded() {
        XCTAssertEqual(g_d_to_ug_t(-5.0), microgram_t((Double(-5.0) * 1000000.0).rounded()))
    }

    func testgram_dTomicrogram_tUsingNegDouble_greatestFiniteMagnitudeExpectingmicrogram_tInt64_min() {
