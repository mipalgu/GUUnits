...
final class Mass_Kilogram_tTests6: XCTestCase {

    func testkilogram_tTomicrogram_dUsingInt64_maxExpectingmicrogram_dInt64_max1000000000_0() {
        let result = kg_t_to_ug_d(Int64.max)
        let expected: microgram_d = microgram_d(Int64.max) * 1000000000.0
    ...
    func testkilogram_tTomicrogram_dUsingInt64_minExpectingmicrogram_dInt64_min1000000000_0() {
        let result = kg_t_to_ug_d(Int64.min)
        let expected: microgram_d = microgram_d(Int64.min) * 1000000000.0
        let tolerance: microgram_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testkilogram_tTomicrogram_fUsing2500000Expectingmicrogram_f2500000_01000000000_0() {
        let result = kg_t_to_ug_f(2500000)
    ...
    func testkilogram_tTomicrogram_fUsing250000Expectingmicrogram_f250000_01000000000_0() {
        let result = kg_t_to_ug_f(250000)
    ...
    func testkilogram_tTomicrogram_fUsingInt64_maxExpectingmicrogram_fInt64_max1000000000_0() {
        let result = kg_t_to_ug_f(Int64.max)
        let expected: microgram_f = microgram_f(Int64.max) * 1000000000.0
        let tolerance: microgram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testkilogram_tTomicrogram_fUsingInt64_minExpectingmicrogram_fInt64_min1000000000_0() {
        let result = kg_t_to_ug_f(Int64.min)
        let expected: microgram_f = microgram_f(Int64.min) * 1000000000.0
        let tolerance: microgram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
