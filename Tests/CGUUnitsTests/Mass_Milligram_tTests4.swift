...
final class Mass_Milligram_tTests4: XCTestCase {
    ...
    func testmilligram_tTokilogram_fUsingInt64_maxExpectingkilogram_fInt64_max1000000_0() {
        ...
        let expected: kilogram_f = kilogram_f(Int64.max) / 1000000.0
        let tolerance: kilogram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmilligram_tTokilogram_fUsingInt64_minExpectingkilogram_fInt64_min1000000_0() {
        ...
        let expected: kilogram_f = kilogram_f(Int64.min) / 1000000.0
        let tolerance: kilogram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
