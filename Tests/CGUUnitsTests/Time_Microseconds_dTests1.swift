...
final class Time_Microseconds_dTests1: XCTestCase {
    ...
    func testmicroseconds_d_to_nanoseconds_u1() {
        XCTAssertEqual(us_d_to_ns_u(-1000.0), 0)
        XCTAssertEqual(us_d_to_ns_u(-6.0), 0)
        XCTAssertEqual(us_d_to_ns_u(-Double.greatestFiniteMagnitude), nanoseconds_u(UInt64.min))
        XCTAssertEqual(us_d_to_ns_u(Double.greatestFiniteMagnitude), nanoseconds_u(UInt64.max))
    }

    func testmicroseconds_d_to_picoseconds_d() {
        let result = us_d_to_ps_d(15.0)
        ...
        let result2 = us_d_to_ps_d(250.0)
        ...
        let result4 = us_d_to_ps_d(2500.0)
        ...
        let result5 = us_d_to_ps_d(25000.0)
        ...
        let result6 = us_d_to_ps_d(250000.0)
        ...
        let result7 = us_d_to_ps_d(2500000.0)
        ...
        let result8 = us_d_to_ps_d(-323.0)
    ...
    func testmicroseconds_d_to_picoseconds_d1() {
        let result = us_d_to_ps_d(-1000.0)
        ...
        let result2 = us_d_to_ps_d(-Double.greatestFiniteMagnitude)
        ...
        let result3 = us_d_to_ps_d(Double.greatestFiniteMagnitude)
    ...
    func testmicroseconds_d_to_picoseconds_f() {
        let result = us_d_to_ps_f(15.0)
        ...
        let result2 = us_d_to_ps_f(250.0)
        ...
        let result4 = us_d_to_ps_f(2500.0)
        ...
        let result5 = us_d_to_ps_f(25000.0)
        ...
        let result6 = us_d_to_ps_f(250000.0)
        ...
        let result7 = us_d_to_ps_f(2500000.0)
        ...
        let result8 = us_d_to_ps_f(-323.0)
    ...
    func testmicroseconds_d_to_picoseconds_f1() {
        let result = us_d_to_ps_f(-1000.0)
        ...
        let result2 = us_d_to_ps_f(-Double.greatestFiniteMagnitude)
        ...
        let result3 = us_d_to_ps_f(Double.greatestFiniteMagnitude)
    ...
    func testmicroseconds_d_to_picoseconds_t() {
        XCTAssertEqual(us_d_to_ps_t(15.0), picoseconds_t((Double(15.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_t(25.0), picoseconds_t((Double(25.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_t(250.0), picoseconds_t((Double(250.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_t(0.0), picoseconds_t((Double(0.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_t(2500.0), picoseconds_t((Double(2500.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_t(25000.0), picoseconds_t((Double(25000.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_t(250000.0), picoseconds_t((Double(250000.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_t(2500000.0), picoseconds_t((Double(2500000.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_t(-323.0), picoseconds_t((Double(-323.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_t(-10.0), picoseconds_t((Double(-10.0) * 1000000.0).rounded()))
    }

    func testmicroseconds_d_to_picoseconds_t1() {
        XCTAssertEqual(us_d_to_ps_t(-1000.0), picoseconds_t((Double(-1000.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_t(-5.0), picoseconds_t((Double(-5.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_t(-Double.greatestFiniteMagnitude), picoseconds_t(Int64.min))
        XCTAssertEqual(us_d_to_ps_t(Double.greatestFiniteMagnitude), picoseconds_t(Int64.max))
    }

    func testmicroseconds_d_to_picoseconds_u() {
        XCTAssertEqual(us_d_to_ps_u(15.0), picoseconds_u((Double(15.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_u(25.0), picoseconds_u((Double(25.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_u(250.0), picoseconds_u((Double(250.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_u(0.0), picoseconds_u((Double(0.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_u(2500.0), picoseconds_u((Double(2500.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_u(25000.0), picoseconds_u((Double(25000.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_u(250000.0), picoseconds_u((Double(250000.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_u(2500000.0), picoseconds_u((Double(2500000.0) * 1000000.0).rounded()))
        XCTAssertEqual(us_d_to_ps_u(-323.0), 0)
        XCTAssertEqual(us_d_to_ps_u(-10.0), 0)
    }

    func testmicroseconds_d_to_picoseconds_u1() {
        XCTAssertEqual(us_d_to_ps_u(-1000.0), 0)
        XCTAssertEqual(us_d_to_ps_u(-6.0), 0)
        XCTAssertEqual(us_d_to_ps_u(-Double.greatestFiniteMagnitude), picoseconds_u(UInt64.min))
        XCTAssertEqual(us_d_to_ps_u(Double.greatestFiniteMagnitude), picoseconds_u(UInt64.max))
    }

    func testmicroseconds_d_to_seconds_d() {
        ...
        let result4 = us_d_to_s_d(2500.0)
        ...
        let result5 = us_d_to_s_d(25000.0)
        ...
        let result6 = us_d_to_s_d(250000.0)
        ...
        let result7 = us_d_to_s_d(2500000.0)
    ...
    func testmicroseconds_d_to_seconds_d1() {
        ...
        let result2 = us_d_to_s_d(-Double.greatestFiniteMagnitude)
        let expected2: seconds_d = seconds_d(-Double.greatestFiniteMagnitude) / 1000000.0
        let tolerance2: seconds_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = us_d_to_s_d(Double.greatestFiniteMagnitude)
        let expected3: seconds_d = seconds_d(Double.greatestFiniteMagnitude) / 1000000.0
        let tolerance3: seconds_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmicroseconds_d_to_seconds_f() {
        ...
        let result4 = us_d_to_s_f(2500.0)
        ...
        let result5 = us_d_to_s_f(25000.0)
        ...
        let result6 = us_d_to_s_f(250000.0)
        ...
        let result7 = us_d_to_s_f(2500000.0)
    ...
    func testmicroseconds_d_to_seconds_f1() {
        ...
        let result2 = us_d_to_s_f(-Double.greatestFiniteMagnitude)
        ...
        let result3 = us_d_to_s_f(Double.greatestFiniteMagnitude)
    ...
    func testmicroseconds_d_to_seconds_t() {
    ...
    func testmicroseconds_d_to_seconds_t1() {
    ...
    func testmicroseconds_d_to_seconds_u() {
    ...
    func testmicroseconds_d_to_seconds_u1() {
    ...
    func testmicroseconds_d_to_uint16_t() {
    ...
    func testmicroseconds_d_to_uint32_t() {
    ...
    func testmicroseconds_d_to_uint64_t() {
    ...
    func testmicroseconds_d_to_uint8_t() {
    ...
    func testuint16_t_to_microseconds_d() {
        ...
        let result2 = u16_to_us_d(UInt16(UInt16.min))
        let expected2: microseconds_d = microseconds_d(UInt16.min)
        ...
        let result3 = u16_to_us_d(UInt16(UInt16.max))
        let expected3: microseconds_d = microseconds_d(UInt16.max)
    ...
    func testuint32_t_to_microseconds_d() {
        ...
        let result2 = u32_to_us_d(UInt32(UInt32.min))
        let expected2: microseconds_d = microseconds_d(UInt32.min)
        let tolerance2: microseconds_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u32_to_us_d(UInt32(UInt32.max))
        let expected3: microseconds_d = microseconds_d(UInt32.max)
        let tolerance3: microseconds_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint64_t_to_microseconds_d() {
        ...
        let result2 = u64_to_us_d(UInt64(UInt64.min))
        let expected2: microseconds_d = microseconds_d(UInt64.min)
        let tolerance2: microseconds_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u64_to_us_d(UInt64(UInt64.max))
        let expected3: microseconds_d = microseconds_d(UInt64.max)
        let tolerance3: microseconds_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint8_t_to_microseconds_d() {
        ...
        let result2 = u8_to_us_d(UInt8(UInt8.min))
        let expected2: microseconds_d = microseconds_d(UInt8.min)
        let tolerance2: microseconds_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u8_to_us_d(UInt8(UInt8.max))
        let expected3: microseconds_d = microseconds_d(UInt8.max)
        let tolerance3: microseconds_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
