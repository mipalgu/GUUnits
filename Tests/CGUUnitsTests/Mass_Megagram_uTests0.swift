...
final class Mass_Megagram_uTests0: XCTestCase {
    ...
    func testint16_t_to_megagram_u() {
    ...
    func testint32_t_to_megagram_u() {
    ...
    func testint64_t_to_megagram_u() {
    ...
    func testmegagram_u_to_double() {
        ...
        let result2 = Mg_u_to_d(megagram_u(UInt64.min))
        ...
        let result3 = Mg_u_to_d(megagram_u(UInt64.max))
    ...
    func testmegagram_u_to_float() {
        ...
        let result2 = Mg_u_to_f(megagram_u(UInt64.min))
        ...
        let result3 = Mg_u_to_f(megagram_u(UInt64.max))
    ...
    func testmegagram_u_to_int16_t() {
    ...
    func testmegagram_u_to_int32_t() {
    ...
    func testmegagram_u_to_int64_t() {
    ...
    func testmegagram_u_to_kilogram_d() {
    ...
    func testmegagram_u_to_kilogram_f() {
    ...
    func testmegagram_u_to_kilogram_t() {
    ...
    func testmegagram_u_to_kilogram_u() {
    ...
    func testmegagram_u_to_megagram_d() {
        ...
        let result1 = Mg_u_to_Mg_d(megagram_u(UInt64.min))
        let expected1: megagram_d = megagram_d(UInt64.min)
        ...
        let result2 = Mg_u_to_Mg_d(megagram_u(UInt64.max))
        let expected2: megagram_d = megagram_d(UInt64.max)
    ...
    func testmegagram_u_to_megagram_f() {
        ...
        let result1 = Mg_u_to_Mg_f(megagram_u(UInt64.min))
        let expected1: megagram_f = megagram_f(UInt64.min)
        ...
        let result2 = Mg_u_to_Mg_f(megagram_u(UInt64.max))
        let expected2: megagram_f = megagram_f(UInt64.max)
    ...
    func testmegagram_u_to_megagram_t() {
    ...
    func testmegagram_u_to_microgram_d() {
        ...
        let expected8: microgram_d = microgram_d(UInt64.min) * 1000000000000.0
        ...
        let expected9: microgram_d = microgram_d(UInt64.max) * 1000000000000.0
    ...
    func testmegagram_u_to_microgram_f() {
        ...
        let expected8: microgram_f = microgram_f(UInt64.min) * 1000000000000.0
        ...
        let expected9: microgram_f = microgram_f(UInt64.max) * 1000000000000.0
    ...
    func testmegagram_u_to_microgram_t() {
    ...
    func testmegagram_u_to_microgram_u() {
    ...
    func testmegagram_u_to_milligram_d() {
        ...
        let expected8: milligram_d = milligram_d(UInt64.min) * 1000000000.0
        ...
        let expected9: milligram_d = milligram_d(UInt64.max) * 1000000000.0
    ...
    func testmegagram_u_to_milligram_f() {
        ...
        let expected8: milligram_f = milligram_f(UInt64.min) * 1000000000.0
        ...
        let expected9: milligram_f = milligram_f(UInt64.max) * 1000000000.0
    ...
    func testmegagram_u_to_milligram_t() {
        XCTAssertEqual(Mg_u_to_mg_t(15), milligram_t(15) * 1000000000)
        XCTAssertEqual(Mg_u_to_mg_t(25), milligram_t(25) * 1000000000)
        XCTAssertEqual(Mg_u_to_mg_t(250), milligram_t(250) * 1000000000)
        XCTAssertEqual(Mg_u_to_mg_t(0), milligram_t(0) * 1000000000)
        XCTAssertEqual(Mg_u_to_mg_t(2500), milligram_t(2500) * 1000000000)
        XCTAssertEqual(Mg_u_to_mg_t(25000), milligram_t(25000) * 1000000000)
        XCTAssertEqual(Mg_u_to_mg_t(250000), milligram_t(250000) * 1000000000)
        XCTAssertEqual(Mg_u_to_mg_t(2500000), milligram_t(2500000) * 1000000000)
        XCTAssertEqual(Mg_u_to_mg_t(UInt64.min), milligram_t(UInt64.min) * 1000000000)
        XCTAssertEqual(Mg_u_to_mg_t(UInt64.max), milligram_t(Int64.max))
    }
