...
final class Acceleration_Centimetres_Per_Seconds_Sq_uTests1: XCTestCase {
    ...
    func testcentimetres_per_seconds_sq_u_to_millimetres_per_seconds_sq_d() {
        ...
        let result1 = cm_per_s_sq_u_to_mm_per_s_sq_d(5000000)
        let expected1: millimetres_per_seconds_sq_d = millimetres_per_seconds_sq_d((Double(5000000)) * (Double(10)))
        ...
        let result2 = cm_per_s_sq_u_to_mm_per_s_sq_d(UInt64.min)
        let expected2: millimetres_per_seconds_sq_d = millimetres_per_seconds_sq_d(((Double(UInt64.min)) * ((Double(10)) / ((Double(1)) * (Double(1))))).rounded())
        ...
        let result3 = cm_per_s_sq_u_to_mm_per_s_sq_d(UInt64.max)
    ...
    func testcentimetres_per_seconds_sq_u_to_millimetres_per_seconds_sq_f() {
        ...
        let result1 = cm_per_s_sq_u_to_mm_per_s_sq_f(5000000)
        let expected1: millimetres_per_seconds_sq_f = millimetres_per_seconds_sq_f((Double(5000000)) * (Double(10)))
        ...
        let result2 = cm_per_s_sq_u_to_mm_per_s_sq_f(UInt64.min)
        let expected2: millimetres_per_seconds_sq_f = millimetres_per_seconds_sq_f(((Double(UInt64.min)) * ((Double(10)) / ((Double(1)) * (Double(1))))).rounded())
        ...
        let result3 = cm_per_s_sq_u_to_mm_per_s_sq_f(UInt64.max)
    ...
    func testcentimetres_per_seconds_sq_u_to_millimetres_per_seconds_sq_t() {
    ...
    func testcentimetres_per_seconds_sq_u_to_millimetres_per_seconds_sq_u() {
    ...
    func testcentimetres_per_seconds_sq_u_to_uint16_t() {
    ...
    func testcentimetres_per_seconds_sq_u_to_uint32_t() {
    ...
    func testcentimetres_per_seconds_sq_u_to_uint64_t() {
    ...
    func testcentimetres_per_seconds_sq_u_to_uint8_t() {
    ...
    func testdouble_to_centimetres_per_seconds_sq_u() {
        XCTAssertEqual(d_to_cm_per_s_sq_u(0.0), 0)
        XCTAssertEqual(d_to_cm_per_s_sq_u(5.0), 5)
        XCTAssertEqual(d_to_cm_per_s_sq_u(Double(-Double.greatestFiniteMagnitude)), centimetres_per_seconds_sq_u(UInt64.min))
        XCTAssertEqual(d_to_cm_per_s_sq_u(Double(Double.greatestFiniteMagnitude)), centimetres_per_seconds_sq_u(UInt64.max))
    }

    func testfloat_to_centimetres_per_seconds_sq_u() {
        XCTAssertEqual(f_to_cm_per_s_sq_u(0.0), 0)
        XCTAssertEqual(f_to_cm_per_s_sq_u(5.0), 5)
        XCTAssertEqual(f_to_cm_per_s_sq_u(Float(-Float.greatestFiniteMagnitude)), centimetres_per_seconds_sq_u(UInt64.min))
        XCTAssertEqual(f_to_cm_per_s_sq_u(Float(Float.greatestFiniteMagnitude)), centimetres_per_seconds_sq_u(UInt64.max))
    }

    func testint16_t_to_centimetres_per_seconds_sq_u() {
        XCTAssertEqual(i16_to_cm_per_s_sq_u(0), 0)
        XCTAssertEqual(i16_to_cm_per_s_sq_u(5), 5)
        XCTAssertEqual(i16_to_cm_per_s_sq_u(Int16(Int16.min)), centimetres_per_seconds_sq_u(UInt64.min))
        XCTAssertEqual(i16_to_cm_per_s_sq_u(Int16(Int16.max)), centimetres_per_seconds_sq_u(Int16.max))
    }

    func testint32_t_to_centimetres_per_seconds_sq_u() {
        XCTAssertEqual(i32_to_cm_per_s_sq_u(0), 0)
        XCTAssertEqual(i32_to_cm_per_s_sq_u(5), 5)
        XCTAssertEqual(i32_to_cm_per_s_sq_u(Int32(Int32.min)), centimetres_per_seconds_sq_u(UInt64.min))
        XCTAssertEqual(i32_to_cm_per_s_sq_u(Int32(Int32.max)), centimetres_per_seconds_sq_u(Int32.max))
    }

    func testint64_t_to_centimetres_per_seconds_sq_u() {
        XCTAssertEqual(i64_to_cm_per_s_sq_u(0), 0)
        XCTAssertEqual(i64_to_cm_per_s_sq_u(5), 5)
        XCTAssertEqual(i64_to_cm_per_s_sq_u(Int64(Int64.min)), centimetres_per_seconds_sq_u(UInt64.min))
        XCTAssertEqual(i64_to_cm_per_s_sq_u(Int64(Int64.max)), centimetres_per_seconds_sq_u(Int64.max))
    }

    func testint8_t_to_centimetres_per_seconds_sq_u() {
        XCTAssertEqual(i8_to_cm_per_s_sq_u(0), 0)
        XCTAssertEqual(i8_to_cm_per_s_sq_u(5), 5)
        XCTAssertEqual(i8_to_cm_per_s_sq_u(Int8(Int8.min)), centimetres_per_seconds_sq_u(UInt64.min))
        XCTAssertEqual(i8_to_cm_per_s_sq_u(Int8(Int8.max)), centimetres_per_seconds_sq_u(Int8.max))
    }

    func testuint16_t_to_centimetres_per_seconds_sq_u() {
        XCTAssertEqual(u16_to_cm_per_s_sq_u(0), 0)
        XCTAssertEqual(u16_to_cm_per_s_sq_u(5), 5)
        XCTAssertEqual(u16_to_cm_per_s_sq_u(UInt16(UInt16.min)), centimetres_per_seconds_sq_u(UInt64.min))
        XCTAssertEqual(u16_to_cm_per_s_sq_u(UInt16(UInt16.max)), centimetres_per_seconds_sq_u(UInt16.max))
    }

    func testuint32_t_to_centimetres_per_seconds_sq_u() {
        XCTAssertEqual(u32_to_cm_per_s_sq_u(0), 0)
        XCTAssertEqual(u32_to_cm_per_s_sq_u(5), 5)
        XCTAssertEqual(u32_to_cm_per_s_sq_u(UInt32(UInt32.min)), centimetres_per_seconds_sq_u(UInt64.min))
        XCTAssertEqual(u32_to_cm_per_s_sq_u(UInt32(UInt32.max)), centimetres_per_seconds_sq_u(UInt32.max))
    }

    func testuint64_t_to_centimetres_per_seconds_sq_u() {
        XCTAssertEqual(u64_to_cm_per_s_sq_u(0), 0)
        XCTAssertEqual(u64_to_cm_per_s_sq_u(5), 5)
        XCTAssertEqual(u64_to_cm_per_s_sq_u(UInt64(UInt64.min)), centimetres_per_seconds_sq_u(UInt64.min))
        XCTAssertEqual(u64_to_cm_per_s_sq_u(UInt64(UInt64.max)), centimetres_per_seconds_sq_u(UInt64.max))
    }

    func testuint8_t_to_centimetres_per_seconds_sq_u() {
        XCTAssertEqual(u8_to_cm_per_s_sq_u(0), 0)
        XCTAssertEqual(u8_to_cm_per_s_sq_u(5), 5)
        XCTAssertEqual(u8_to_cm_per_s_sq_u(UInt8(UInt8.min)), centimetres_per_seconds_sq_u(UInt64.min))
        XCTAssertEqual(u8_to_cm_per_s_sq_u(UInt8(UInt8.max)), centimetres_per_seconds_sq_u(UInt8.max))
    }
