...
final class AngularVelocity_Radians_Per_Milliseconds_tTests0: XCTestCase {
    ...
    func testint8_tToradians_per_milliseconds_tUsing0Expecting0() {
    ...
    func testradians_per_milliseconds_tTodegrees_per_microseconds_dUsing0Expectingdegrees_per_microseconds_dDouble0Double180Double3_141592653589793Double1000() {
        let result = rad_per_ms_t_to_deg_per_us_d(0)
    ...
    func testradians_per_milliseconds_tTodegrees_per_microseconds_dUsingInt64_maxExpectingdegrees_per_microseconds_dDouble_greatestFiniteMagnitude() {
        let result = rad_per_ms_t_to_deg_per_us_d(Int64.max)
    ...
    func testradians_per_milliseconds_tTodegrees_per_microseconds_dUsingInt64_minExpectingdegrees_per_microseconds_dNegDouble_greatestFiniteMagnitude() {
        let result = rad_per_ms_t_to_deg_per_us_d(Int64.min)
        let expected: degrees_per_microseconds_d = degrees_per_microseconds_d(-Double.greatestFiniteMagnitude)
        let tolerance: degrees_per_microseconds_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
    ...
    func testradians_per_milliseconds_tTodegrees_per_microseconds_fUsing0Expectingdegrees_per_microseconds_fDouble0Double180Double3_141592653589793Double1000() {
        let result = rad_per_ms_t_to_deg_per_us_f(0)
