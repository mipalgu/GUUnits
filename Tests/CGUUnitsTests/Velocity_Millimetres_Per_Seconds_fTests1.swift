...
final class Velocity_Millimetres_Per_Seconds_fTests1: XCTestCase {
    ...
    func testmillimetres_per_seconds_f_to_millimetres_per_seconds_d() {
        ...
        let result1 = mm_per_s_f_to_mm_per_s_d(0)
        ...
        let result2 = mm_per_s_f_to_mm_per_s_d(5000000)
        ...
        let result3 = mm_per_s_f_to_mm_per_s_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_f_to_mm_per_s_d(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_f_to_millimetres_per_seconds_t() {
    ...
    func testmillimetres_per_seconds_f_to_millimetres_per_seconds_u() {
    ...
    func testmillimetres_per_seconds_f_to_uint16_t() {
    ...
    func testmillimetres_per_seconds_f_to_uint32_t() {
    ...
    func testmillimetres_per_seconds_f_to_uint64_t() {
    ...
    func testmillimetres_per_seconds_f_to_uint8_t() {
    ...
    func testuint16_t_to_millimetres_per_seconds_f() {
        ...
        let result1 = u16_to_mm_per_s_f(5)
        ...
        let result2 = u16_to_mm_per_s_f(UInt16(UInt16.min))
        let expected2: millimetres_per_seconds_f = millimetres_per_seconds_f(UInt16.min)
        ...
        let result3 = u16_to_mm_per_s_f(UInt16(UInt16.max))
        let expected3: millimetres_per_seconds_f = millimetres_per_seconds_f(UInt16.max)
    ...
    func testuint32_t_to_millimetres_per_seconds_f() {
        ...
        let result1 = u32_to_mm_per_s_f(5)
        let expected1: millimetres_per_seconds_f = 5.0
        let tolerance1: millimetres_per_seconds_f = 0.99
        if result1 > expected1 {
            XCTAssertLessThanOrEqual(result1 - expected1, tolerance1)
        ...
        let result2 = u32_to_mm_per_s_f(UInt32(UInt32.min))
        let expected2: millimetres_per_seconds_f = millimetres_per_seconds_f(UInt32.min)
        let tolerance2: millimetres_per_seconds_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u32_to_mm_per_s_f(UInt32(UInt32.max))
        let expected3: millimetres_per_seconds_f = millimetres_per_seconds_f(UInt32.max)
        let tolerance3: millimetres_per_seconds_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint64_t_to_millimetres_per_seconds_f() {
        ...
        let result1 = u64_to_mm_per_s_f(5)
        let expected1: millimetres_per_seconds_f = 5.0
        let tolerance1: millimetres_per_seconds_f = 0.99
        if result1 > expected1 {
            XCTAssertLessThanOrEqual(result1 - expected1, tolerance1)
        ...
        let result2 = u64_to_mm_per_s_f(UInt64(UInt64.min))
        let expected2: millimetres_per_seconds_f = millimetres_per_seconds_f(UInt64.min)
        let tolerance2: millimetres_per_seconds_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u64_to_mm_per_s_f(UInt64(UInt64.max))
        let expected3: millimetres_per_seconds_f = millimetres_per_seconds_f(UInt64.max)
        let tolerance3: millimetres_per_seconds_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint8_t_to_millimetres_per_seconds_f() {
        ...
        let result1 = u8_to_mm_per_s_f(5)
        let expected1: millimetres_per_seconds_f = 5.0
        let tolerance1: millimetres_per_seconds_f = 0.99
        if result1 > expected1 {
            XCTAssertLessThanOrEqual(result1 - expected1, tolerance1)
        ...
        let result2 = u8_to_mm_per_s_f(UInt8(UInt8.min))
        let expected2: millimetres_per_seconds_f = millimetres_per_seconds_f(UInt8.min)
        let tolerance2: millimetres_per_seconds_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u8_to_mm_per_s_f(UInt8(UInt8.max))
        let expected3: millimetres_per_seconds_f = millimetres_per_seconds_f(UInt8.max)
        let tolerance3: millimetres_per_seconds_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
