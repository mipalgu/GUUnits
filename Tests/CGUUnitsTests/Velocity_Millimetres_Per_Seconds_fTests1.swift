...
final class Velocity_Millimetres_Per_Seconds_fTests1: XCTestCase {

    func testmillimetres_per_seconds_f_to_int64_t() {
    ...
    func testmillimetres_per_seconds_f_to_int8_t() {
    ...
    func testmillimetres_per_seconds_f_to_metres_per_microseconds_d() {
        ...
        let result1 = mm_per_s_f_to_m_per_us_d(0)
        ...
        let result2 = mm_per_s_f_to_m_per_us_d(5000000)
        ...
        let result3 = mm_per_s_f_to_m_per_us_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_f_to_m_per_us_d(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_f_to_metres_per_microseconds_f() {
        ...
        let result1 = mm_per_s_f_to_m_per_us_f(0)
        ...
        let result2 = mm_per_s_f_to_m_per_us_f(5000000)
        ...
        let result3 = mm_per_s_f_to_m_per_us_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_f_to_m_per_us_f(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_f_to_metres_per_microseconds_t() {
        ...
        XCTAssertEqual(mm_per_s_f_to_m_per_us_t(5000000), metres_per_microseconds_t((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_us_t(-Float.greatestFiniteMagnitude), metres_per_microseconds_t(Int64.min))
        XCTAssertEqual(mm_per_s_f_to_m_per_us_t(Float.greatestFiniteMagnitude), metres_per_microseconds_t(Int64.max))
    }

    func testmillimetres_per_seconds_f_to_metres_per_microseconds_u() {
        XCTAssertEqual(mm_per_s_f_to_m_per_us_u(-5000000), metres_per_microseconds_u((((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_us_u(0), metres_per_microseconds_u((((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_us_u(5000000), metres_per_microseconds_u((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_us_u(-Float.greatestFiniteMagnitude), metres_per_microseconds_u(UInt64.min))
        XCTAssertEqual(mm_per_s_f_to_m_per_us_u(Float.greatestFiniteMagnitude), metres_per_microseconds_u(UInt64.max))
    }

    func testmillimetres_per_seconds_f_to_metres_per_milliseconds_d() {
        let result = mm_per_s_f_to_m_per_ms_d(-5000000)
        ...
        let result1 = mm_per_s_f_to_m_per_ms_d(0)
        ...
        let result2 = mm_per_s_f_to_m_per_ms_d(5000000)
        ...
        let result3 = mm_per_s_f_to_m_per_ms_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_f_to_m_per_ms_d(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_f_to_metres_per_milliseconds_f() {
        let result = mm_per_s_f_to_m_per_ms_f(-5000000)
        ...
        let result1 = mm_per_s_f_to_m_per_ms_f(0)
        ...
        let result2 = mm_per_s_f_to_m_per_ms_f(5000000)
        ...
        let result3 = mm_per_s_f_to_m_per_ms_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_f_to_m_per_ms_f(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_f_to_metres_per_milliseconds_t() {
        XCTAssertEqual(mm_per_s_f_to_m_per_ms_t(-5000000), metres_per_milliseconds_t((((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ms_t(0), metres_per_milliseconds_t((((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ms_t(5000000), metres_per_milliseconds_t((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ms_t(-Float.greatestFiniteMagnitude), metres_per_milliseconds_t(Int64.min))
        XCTAssertEqual(mm_per_s_f_to_m_per_ms_t(Float.greatestFiniteMagnitude), metres_per_milliseconds_t(Int64.max))
    }

    func testmillimetres_per_seconds_f_to_metres_per_milliseconds_u() {
        XCTAssertEqual(mm_per_s_f_to_m_per_ms_u(-5000000), metres_per_milliseconds_u((((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ms_u(0), metres_per_milliseconds_u((((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ms_u(5000000), metres_per_milliseconds_u((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ms_u(-Float.greatestFiniteMagnitude), metres_per_milliseconds_u(UInt64.min))
        XCTAssertEqual(mm_per_s_f_to_m_per_ms_u(Float.greatestFiniteMagnitude), metres_per_milliseconds_u(UInt64.max))
    }

    func testmillimetres_per_seconds_f_to_metres_per_nanoseconds_d() {
        let result = mm_per_s_f_to_m_per_ns_d(-5000000)
        ...
        let result1 = mm_per_s_f_to_m_per_ns_d(0)
        ...
        let result2 = mm_per_s_f_to_m_per_ns_d(5000000)
        ...
        let result3 = mm_per_s_f_to_m_per_ns_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_f_to_m_per_ns_d(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_f_to_metres_per_nanoseconds_f() {
        let result = mm_per_s_f_to_m_per_ns_f(-5000000)
        ...
        let result1 = mm_per_s_f_to_m_per_ns_f(0)
        ...
        let result2 = mm_per_s_f_to_m_per_ns_f(5000000)
        ...
        let result3 = mm_per_s_f_to_m_per_ns_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_f_to_m_per_ns_f(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_f_to_metres_per_nanoseconds_t() {
        XCTAssertEqual(mm_per_s_f_to_m_per_ns_t(-5000000), metres_per_nanoseconds_t((((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ns_t(0), metres_per_nanoseconds_t((((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ns_t(5000000), metres_per_nanoseconds_t((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ns_t(-Float.greatestFiniteMagnitude), metres_per_nanoseconds_t(Int64.min))
        XCTAssertEqual(mm_per_s_f_to_m_per_ns_t(Float.greatestFiniteMagnitude), metres_per_nanoseconds_t(Int64.max))
    }

    func testmillimetres_per_seconds_f_to_metres_per_nanoseconds_u() {
        XCTAssertEqual(mm_per_s_f_to_m_per_ns_u(-5000000), metres_per_nanoseconds_u((((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ns_u(0), metres_per_nanoseconds_u((((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ns_u(5000000), metres_per_nanoseconds_u((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ns_u(-Float.greatestFiniteMagnitude), metres_per_nanoseconds_u(UInt64.min))
        XCTAssertEqual(mm_per_s_f_to_m_per_ns_u(Float.greatestFiniteMagnitude), metres_per_nanoseconds_u(UInt64.max))
    }

    func testmillimetres_per_seconds_f_to_metres_per_picoseconds_d() {
        let result = mm_per_s_f_to_m_per_ps_d(-5000000)
        ...
        let result1 = mm_per_s_f_to_m_per_ps_d(0)
        ...
        let result2 = mm_per_s_f_to_m_per_ps_d(5000000)
        ...
        let result3 = mm_per_s_f_to_m_per_ps_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_f_to_m_per_ps_d(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_f_to_metres_per_picoseconds_f() {
        let result = mm_per_s_f_to_m_per_ps_f(-5000000)
        ...
        let result1 = mm_per_s_f_to_m_per_ps_f(0)
        ...
        let result2 = mm_per_s_f_to_m_per_ps_f(5000000)
        ...
        let result3 = mm_per_s_f_to_m_per_ps_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_f_to_m_per_ps_f(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_f_to_metres_per_picoseconds_t() {
        XCTAssertEqual(mm_per_s_f_to_m_per_ps_t(-5000000), metres_per_picoseconds_t((((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ps_t(0), metres_per_picoseconds_t((((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ps_t(5000000), metres_per_picoseconds_t((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ps_t(-Float.greatestFiniteMagnitude), metres_per_picoseconds_t(Int64.min))
        XCTAssertEqual(mm_per_s_f_to_m_per_ps_t(Float.greatestFiniteMagnitude), metres_per_picoseconds_t(Int64.max))
    }

    func testmillimetres_per_seconds_f_to_metres_per_picoseconds_u() {
        XCTAssertEqual(mm_per_s_f_to_m_per_ps_u(-5000000), metres_per_picoseconds_u((((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ps_u(0), metres_per_picoseconds_u((((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ps_u(5000000), metres_per_picoseconds_u((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(1)) / (Double(1000))) / (Double(1000000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_m_per_ps_u(-Float.greatestFiniteMagnitude), metres_per_picoseconds_u(UInt64.min))
        XCTAssertEqual(mm_per_s_f_to_m_per_ps_u(Float.greatestFiniteMagnitude), metres_per_picoseconds_u(UInt64.max))
    }

    func testmillimetres_per_seconds_f_to_metres_per_seconds_d() {
        ...
        let result1 = mm_per_s_f_to_m_per_s_d(0)
        ...
        let result2 = mm_per_s_f_to_m_per_s_d(5000000)
        ...
        let result3 = mm_per_s_f_to_m_per_s_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_f_to_m_per_s_d(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_f_to_metres_per_seconds_f() {
        ...
        let result1 = mm_per_s_f_to_m_per_s_f(0)
        ...
        let result2 = mm_per_s_f_to_m_per_s_f(5000000)
        ...
        let result3 = mm_per_s_f_to_m_per_s_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_f_to_m_per_s_f(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_f_to_metres_per_seconds_t() {
    ...
    func testmillimetres_per_seconds_f_to_metres_per_seconds_u() {
    ...
    func testmillimetres_per_seconds_f_to_millimetres_per_microseconds_d() {
        ...
        let result1 = mm_per_s_f_to_mm_per_us_d(0)
        ...
        let result2 = mm_per_s_f_to_mm_per_us_d(5000000)
        ...
        let result3 = mm_per_s_f_to_mm_per_us_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_f_to_mm_per_us_d(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_f_to_millimetres_per_microseconds_f() {
        ...
        let result1 = mm_per_s_f_to_mm_per_us_f(0)
        ...
        let result2 = mm_per_s_f_to_mm_per_us_f(5000000)
        ...
        let result3 = mm_per_s_f_to_mm_per_us_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_f_to_mm_per_us_f(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_f_to_millimetres_per_microseconds_t() {
        ...
        XCTAssertEqual(mm_per_s_f_to_mm_per_us_t(5000000), millimetres_per_microseconds_t((((Double(5000000)) / (Double(1000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) / (Double(1000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) / (Double(1000000))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_mm_per_us_t(-Float.greatestFiniteMagnitude), millimetres_per_microseconds_t(Int64.min))
        XCTAssertEqual(mm_per_s_f_to_mm_per_us_t(Float.greatestFiniteMagnitude), millimetres_per_microseconds_t(Int64.max))
    }

    func testmillimetres_per_seconds_f_to_millimetres_per_microseconds_u() {
        XCTAssertEqual(mm_per_s_f_to_mm_per_us_u(-5000000), millimetres_per_microseconds_u((((Double(-5000000)) / (Double(1000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) / (Double(1000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) / (Double(1000000))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_mm_per_us_u(0), millimetres_per_microseconds_u((((Double(0)) / (Double(1000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) / (Double(1000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) / (Double(1000000))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_mm_per_us_u(5000000), millimetres_per_microseconds_u((((Double(5000000)) / (Double(1000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) / (Double(1000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) / (Double(1000000))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_mm_per_us_u(-Float.greatestFiniteMagnitude), millimetres_per_microseconds_u(UInt64.min))
        XCTAssertEqual(mm_per_s_f_to_mm_per_us_u(Float.greatestFiniteMagnitude), millimetres_per_microseconds_u(UInt64.max))
    }

    func testmillimetres_per_seconds_f_to_millimetres_per_milliseconds_d() {
        let result = mm_per_s_f_to_mm_per_ms_d(-5000000)
        ...
        let result1 = mm_per_s_f_to_mm_per_ms_d(0)
        ...
        let result2 = mm_per_s_f_to_mm_per_ms_d(5000000)
        ...
        let result3 = mm_per_s_f_to_mm_per_ms_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_f_to_mm_per_ms_d(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_f_to_millimetres_per_milliseconds_f() {
        let result = mm_per_s_f_to_mm_per_ms_f(-5000000)
        ...
        let result1 = mm_per_s_f_to_mm_per_ms_f(0)
        ...
        let result2 = mm_per_s_f_to_mm_per_ms_f(5000000)
        ...
        let result3 = mm_per_s_f_to_mm_per_ms_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_f_to_mm_per_ms_f(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_f_to_millimetres_per_milliseconds_t() {
        XCTAssertEqual(mm_per_s_f_to_mm_per_ms_t(-5000000), millimetres_per_milliseconds_t((((Double(-5000000)) / (Double(1000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) / (Double(1000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) / (Double(1000))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_mm_per_ms_t(0), millimetres_per_milliseconds_t((((Double(0)) / (Double(1000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) / (Double(1000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) / (Double(1000))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_mm_per_ms_t(5000000), millimetres_per_milliseconds_t((((Double(5000000)) / (Double(1000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) / (Double(1000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) / (Double(1000))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_mm_per_ms_t(-Float.greatestFiniteMagnitude), millimetres_per_milliseconds_t(Int64.min))
        XCTAssertEqual(mm_per_s_f_to_mm_per_ms_t(Float.greatestFiniteMagnitude), millimetres_per_milliseconds_t(Int64.max))
    }

    func testmillimetres_per_seconds_f_to_millimetres_per_milliseconds_u() {
        XCTAssertEqual(mm_per_s_f_to_mm_per_ms_u(-5000000), millimetres_per_milliseconds_u((((Double(-5000000)) / (Double(1000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) / (Double(1000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) / (Double(1000))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_mm_per_ms_u(0), millimetres_per_milliseconds_u((((Double(0)) / (Double(1000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) / (Double(1000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) / (Double(1000))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_mm_per_ms_u(5000000), millimetres_per_milliseconds_u((((Double(5000000)) / (Double(1000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) / (Double(1000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) / (Double(1000))).rounded()))))
        XCTAssertEqual(mm_per_s_f_to_mm_per_ms_u(-Float.greatestFiniteMagnitude), millimetres_per_milliseconds_u(UInt64.min))
        XCTAssertEqual(mm_per_s_f_to_mm_per_ms_u(Float.greatestFiniteMagnitude), millimetres_per_milliseconds_u(UInt64.max))
    }
