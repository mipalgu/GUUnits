...
final class Mass_Kilogram_dTests7: XCTestCase {
    ...
    func testkilogram_dTomicrogram_uUsing0_0Expectingmicrogram_uDouble0_01000000000_0_rounded() {
        XCTAssertEqual(kg_d_to_ug_u(0.0), microgram_u((Double(0.0) * 1000000000.0).rounded()))
    }

    func testkilogram_dTomicrogram_uUsing15_0Expectingmicrogram_uDouble15_01000000000_0_rounded() {
        XCTAssertEqual(kg_d_to_ug_u(15.0), microgram_u((Double(15.0) * 1000000000.0).rounded()))
    }

    func testkilogram_dTomicrogram_uUsing2500000_0Expectingmicrogram_uDouble2500000_01000000000_0_rounded() {
        XCTAssertEqual(kg_d_to_ug_u(2500000.0), microgram_u((Double(2500000.0) * 1000000000.0).rounded()))
    }

    func testkilogram_dTomicrogram_uUsing250000_0Expectingmicrogram_uDouble250000_01000000000_0_rounded() {
        XCTAssertEqual(kg_d_to_ug_u(250000.0), microgram_u((Double(250000.0) * 1000000000.0).rounded()))
    }

    func testkilogram_dTomicrogram_uUsing25000_0Expectingmicrogram_uDouble25000_01000000000_0_rounded() {
        XCTAssertEqual(kg_d_to_ug_u(25000.0), microgram_u((Double(25000.0) * 1000000000.0).rounded()))
    }

    func testkilogram_dTomicrogram_uUsing2500_0Expectingmicrogram_uDouble2500_01000000000_0_rounded() {
        XCTAssertEqual(kg_d_to_ug_u(2500.0), microgram_u((Double(2500.0) * 1000000000.0).rounded()))
    }

    func testkilogram_dTomicrogram_uUsing250_0Expectingmicrogram_uDouble250_01000000000_0_rounded() {
        XCTAssertEqual(kg_d_to_ug_u(250.0), microgram_u((Double(250.0) * 1000000000.0).rounded()))
    }

    func testkilogram_dTomicrogram_uUsing25_0Expectingmicrogram_uDouble25_01000000000_0_rounded() {
        XCTAssertEqual(kg_d_to_ug_u(25.0), microgram_u((Double(25.0) * 1000000000.0).rounded()))
    }

    func testkilogram_dTomicrogram_uUsingDouble_greatestFiniteMagnitudeExpectingmicrogram_uUInt64_max() {
        XCTAssertEqual(kg_d_to_ug_u(Double.greatestFiniteMagnitude), microgram_u(UInt64.max))
    }

    func testkilogram_dTomicrogram_uUsingNeg1000_0Expecting0() {
        XCTAssertEqual(kg_d_to_ug_u(-1000.0), 0)
    }

    func testkilogram_dTomicrogram_uUsingNeg10_0Expecting0() {
        XCTAssertEqual(kg_d_to_ug_u(-10.0), 0)
    }

    func testkilogram_dTomicrogram_uUsingNeg323_0Expecting0() {
        XCTAssertEqual(kg_d_to_ug_u(-323.0), 0)
    }

    func testkilogram_dTomicrogram_uUsingNeg6_0Expecting0() {
        XCTAssertEqual(kg_d_to_ug_u(-6.0), 0)
    }

    func testkilogram_dTomicrogram_uUsingNegDouble_greatestFiniteMagnitudeExpectingmicrogram_uUInt64_min() {
