...
final class Velocity_Centimetres_Per_Seconds_fTests1: XCTestCase {
    ...
    func testcentimetres_per_seconds_fTocentimetres_per_seconds_dUsing0Expectingcentimetres_per_seconds_dDouble0() {
        let result = cm_per_s_f_to_cm_per_s_d(0)
    ...
    func testcentimetres_per_seconds_fTocentimetres_per_seconds_dUsing5000000Expectingcentimetres_per_seconds_dDouble5000000() {
    ...
    func testcentimetres_per_seconds_fTocentimetres_per_seconds_dUsingFloat_greatestFiniteMagnitudeExpectingcentimetres_per_seconds_dDouble_greatestFiniteMagnitude() {
        let result = cm_per_s_f_to_cm_per_s_d(Float.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_seconds_fTocentimetres_per_seconds_dUsingNeg5000000Expectingcentimetres_per_seconds_dDoubleNeg5000000() {
        let result = cm_per_s_f_to_cm_per_s_d(-5000000)
        let expected: centimetres_per_seconds_d = centimetres_per_seconds_d(Double(-5000000))
        let tolerance: centimetres_per_seconds_d = 0.99
        if result > expected {
    ...
    func testcentimetres_per_seconds_fTocentimetres_per_seconds_dUsingNegFloat_greatestFiniteMagnitudeExpectingcentimetres_per_seconds_dNegDouble_greatestFiniteMagnitude() {
        let result = cm_per_s_f_to_cm_per_s_d(-Float.greatestFiniteMagnitude)
        let expected: centimetres_per_seconds_d = centimetres_per_seconds_d(-Double.greatestFiniteMagnitude)
        let tolerance: centimetres_per_seconds_d = 0.99
        if result > expected {
    ...
    func testcentimetres_per_seconds_fTodoubleUsing0_0Expecting0_0() {
    ...
    func testcentimetres_per_seconds_fTodoubleUsing5_0Expecting5_0() {
        let result = cm_per_s_f_to_d(5.0)
    ...
    func testcentimetres_per_seconds_fTodoubleUsingcentimetres_per_seconds_fFloat_greatestFiniteMagnitudeExpectingDoubleFloat_greatestFiniteMagnitude() {
        let result = cm_per_s_f_to_d(centimetres_per_seconds_f(Float.greatestFiniteMagnitude))
    ...
    func testcentimetres_per_seconds_fTodoubleUsingcentimetres_per_seconds_fNegFloat_greatestFiniteMagnitudeExpectingDoubleNegFloat_greatestFiniteMagnitude() {
        let result = cm_per_s_f_to_d(centimetres_per_seconds_f(-Float.greatestFiniteMagnitude))
        let expected: Double = Double(-Float.greatestFiniteMagnitude)
        let tolerance: Double = 0.99
        if result > expected {
