...
final class AngularVelocity_Radians_Per_Milliseconds_tTests5: XCTestCase {
    ...
    func testradians_per_milliseconds_tToradians_per_seconds_fUsingInt64_maxExpectingradians_per_seconds_fFloat_greatestFiniteMagnitude() {
        let result = rad_per_ms_t_to_rad_per_s_f(Int64.max)
    ...
    func testradians_per_milliseconds_tToradians_per_seconds_fUsingInt64_minExpectingradians_per_seconds_fNegFloat_greatestFiniteMagnitude() {
        let result = rad_per_ms_t_to_rad_per_s_f(Int64.min)
        let expected: radians_per_seconds_f = radians_per_seconds_f(-Float.greatestFiniteMagnitude)
        let tolerance: radians_per_seconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
