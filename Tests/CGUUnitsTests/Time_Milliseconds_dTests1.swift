...
final class Time_Milliseconds_dTests1: XCTestCase {
    ...
    func testmilliseconds_d_to_nanoseconds_u1() {
        XCTAssertEqual(ms_d_to_ns_u(-1000.0), 0)
        XCTAssertEqual(ms_d_to_ns_u(-6.0), 0)
        XCTAssertEqual(ms_d_to_ns_u(-Double.greatestFiniteMagnitude), nanoseconds_u(UInt64.min))
        XCTAssertEqual(ms_d_to_ns_u(Double.greatestFiniteMagnitude), nanoseconds_u(UInt64.max))
    }

    func testmilliseconds_d_to_picoseconds_d() {
        let result = ms_d_to_ps_d(15.0)
        ...
        let result2 = ms_d_to_ps_d(250.0)
        ...
        let result4 = ms_d_to_ps_d(2500.0)
        ...
        let result5 = ms_d_to_ps_d(25000.0)
        ...
        let result6 = ms_d_to_ps_d(250000.0)
        ...
        let result7 = ms_d_to_ps_d(2500000.0)
        ...
        let result8 = ms_d_to_ps_d(-323.0)
    ...
    func testmilliseconds_d_to_picoseconds_d1() {
        let result = ms_d_to_ps_d(-1000.0)
        ...
        let result2 = ms_d_to_ps_d(-Double.greatestFiniteMagnitude)
        ...
        let result3 = ms_d_to_ps_d(Double.greatestFiniteMagnitude)
    ...
    func testmilliseconds_d_to_picoseconds_f() {
        let result = ms_d_to_ps_f(15.0)
        ...
        let result2 = ms_d_to_ps_f(250.0)
        ...
        let result4 = ms_d_to_ps_f(2500.0)
        ...
        let result5 = ms_d_to_ps_f(25000.0)
        ...
        let result6 = ms_d_to_ps_f(250000.0)
        ...
        let result7 = ms_d_to_ps_f(2500000.0)
        ...
        let result8 = ms_d_to_ps_f(-323.0)
    ...
    func testmilliseconds_d_to_picoseconds_f1() {
        let result = ms_d_to_ps_f(-1000.0)
        ...
        let result2 = ms_d_to_ps_f(-Double.greatestFiniteMagnitude)
        ...
        let result3 = ms_d_to_ps_f(Double.greatestFiniteMagnitude)
    ...
    func testmilliseconds_d_to_picoseconds_t() {
        XCTAssertEqual(ms_d_to_ps_t(15.0), picoseconds_t((Double(15.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_t(25.0), picoseconds_t((Double(25.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_t(250.0), picoseconds_t((Double(250.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_t(0.0), picoseconds_t((Double(0.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_t(2500.0), picoseconds_t((Double(2500.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_t(25000.0), picoseconds_t((Double(25000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_t(250000.0), picoseconds_t((Double(250000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_t(2500000.0), picoseconds_t((Double(2500000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_t(-323.0), picoseconds_t((Double(-323.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_t(-10.0), picoseconds_t((Double(-10.0) * 1000000000.0).rounded()))
    }

    func testmilliseconds_d_to_picoseconds_t1() {
        XCTAssertEqual(ms_d_to_ps_t(-1000.0), picoseconds_t((Double(-1000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_t(-5.0), picoseconds_t((Double(-5.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_t(-Double.greatestFiniteMagnitude), picoseconds_t(Int64.min))
        XCTAssertEqual(ms_d_to_ps_t(Double.greatestFiniteMagnitude), picoseconds_t(Int64.max))
    }

    func testmilliseconds_d_to_picoseconds_u() {
        XCTAssertEqual(ms_d_to_ps_u(15.0), picoseconds_u((Double(15.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_u(25.0), picoseconds_u((Double(25.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_u(250.0), picoseconds_u((Double(250.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_u(0.0), picoseconds_u((Double(0.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_u(2500.0), picoseconds_u((Double(2500.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_u(25000.0), picoseconds_u((Double(25000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_u(250000.0), picoseconds_u((Double(250000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_u(2500000.0), picoseconds_u((Double(2500000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ps_u(-323.0), 0)
        XCTAssertEqual(ms_d_to_ps_u(-10.0), 0)
    }

    func testmilliseconds_d_to_picoseconds_u1() {
        XCTAssertEqual(ms_d_to_ps_u(-1000.0), 0)
        XCTAssertEqual(ms_d_to_ps_u(-6.0), 0)
        XCTAssertEqual(ms_d_to_ps_u(-Double.greatestFiniteMagnitude), picoseconds_u(UInt64.min))
        XCTAssertEqual(ms_d_to_ps_u(Double.greatestFiniteMagnitude), picoseconds_u(UInt64.max))
    }
