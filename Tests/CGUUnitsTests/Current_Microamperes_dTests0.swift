...
final class Current_Microamperes_dTests0: XCTestCase {
    ...
    func testdouble_to_microamperes_d() {
        ...
        let result2 = d_to_uA_d(Double(-Double.greatestFiniteMagnitude))
        ...
        let result3 = d_to_uA_d(Double(Double.greatestFiniteMagnitude))
    ...
    func testfloat_to_microamperes_d() {
        ...
        let result2 = f_to_uA_d(Float(-Float.greatestFiniteMagnitude))
        ...
        let result3 = f_to_uA_d(Float(Float.greatestFiniteMagnitude))
        let expected3: microamperes_d = microamperes_d(Float.greatestFiniteMagnitude)
        let tolerance3: microamperes_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint16_t_to_microamperes_d() {
        ...
        let result2 = i16_to_uA_d(Int16(Int16.min))
        let expected2: microamperes_d = microamperes_d(Int16.min)
        let tolerance2: microamperes_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i16_to_uA_d(Int16(Int16.max))
        let expected3: microamperes_d = microamperes_d(Int16.max)
        let tolerance3: microamperes_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint32_t_to_microamperes_d() {
        ...
        let result2 = i32_to_uA_d(Int32(Int32.min))
        let expected2: microamperes_d = microamperes_d(Int32.min)
        let tolerance2: microamperes_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i32_to_uA_d(Int32(Int32.max))
        let expected3: microamperes_d = microamperes_d(Int32.max)
        let tolerance3: microamperes_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint64_t_to_microamperes_d() {
        ...
        let result2 = i64_to_uA_d(Int64(Int64.min))
        let expected2: microamperes_d = microamperes_d(Int64.min)
        let tolerance2: microamperes_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i64_to_uA_d(Int64(Int64.max))
        let expected3: microamperes_d = microamperes_d(Int64.max)
        let tolerance3: microamperes_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint8_t_to_microamperes_d() {
        ...
        let result2 = i8_to_uA_d(Int8(Int8.min))
        let expected2: microamperes_d = microamperes_d(Int8.min)
        let tolerance2: microamperes_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i8_to_uA_d(Int8(Int8.max))
        let expected3: microamperes_d = microamperes_d(Int8.max)
        let tolerance3: microamperes_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmicroamperes_d_to_amperes_d() {
        ...
        let result4 = uA_d_to_A_d(2500.0)
        ...
        let result5 = uA_d_to_A_d(25000.0)
        ...
        let result6 = uA_d_to_A_d(250000.0)
        ...
        let result7 = uA_d_to_A_d(2500000.0)
    ...
    func testmicroamperes_d_to_amperes_d1() {
        ...
        let result2 = uA_d_to_A_d(-Double.greatestFiniteMagnitude)
        let expected2: amperes_d = amperes_d(-Double.greatestFiniteMagnitude) / 1000000.0
        let tolerance2: amperes_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = uA_d_to_A_d(Double.greatestFiniteMagnitude)
        let expected3: amperes_d = amperes_d(Double.greatestFiniteMagnitude) / 1000000.0
        let tolerance3: amperes_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmicroamperes_d_to_amperes_f() {
        ...
        let result4 = uA_d_to_A_f(2500.0)
        ...
        let result5 = uA_d_to_A_f(25000.0)
        ...
        let result6 = uA_d_to_A_f(250000.0)
        ...
        let result7 = uA_d_to_A_f(2500000.0)
    ...
    func testmicroamperes_d_to_amperes_f1() {
        ...
        let result2 = uA_d_to_A_f(-Double.greatestFiniteMagnitude)
        ...
        let result3 = uA_d_to_A_f(Double.greatestFiniteMagnitude)
    ...
    func testmicroamperes_d_to_amperes_t() {
        ...
        XCTAssertEqual(uA_d_to_A_t(-323.0), amperes_t((Double(-323.0) / 1000000.0).rounded()))
        XCTAssertEqual(uA_d_to_A_t(-10.0), amperes_t((Double(-10.0) / 1000000.0).rounded()))
    }

    func testmicroamperes_d_to_amperes_t1() {
        XCTAssertEqual(uA_d_to_A_t(-1000.0), amperes_t((Double(-1000.0) / 1000000.0).rounded()))
        XCTAssertEqual(uA_d_to_A_t(-5.0), amperes_t((Double(-5.0) / 1000000.0).rounded()))
        XCTAssertEqual(uA_d_to_A_t(-Double.greatestFiniteMagnitude), amperes_t(Int64.min))
        XCTAssertEqual(uA_d_to_A_t(Double.greatestFiniteMagnitude), amperes_t(Int64.max))
    }

    func testmicroamperes_d_to_amperes_u() {
        XCTAssertEqual(uA_d_to_A_u(15.0), amperes_u((Double(15.0) / 1000000.0).rounded()))
        XCTAssertEqual(uA_d_to_A_u(25.0), amperes_u((Double(25.0) / 1000000.0).rounded()))
        XCTAssertEqual(uA_d_to_A_u(250.0), amperes_u((Double(250.0) / 1000000.0).rounded()))
        XCTAssertEqual(uA_d_to_A_u(0.0), amperes_u((Double(0.0) / 1000000.0).rounded()))
        XCTAssertEqual(uA_d_to_A_u(2500.0), amperes_u((Double(2500.0) / 1000000.0).rounded()))
        XCTAssertEqual(uA_d_to_A_u(25000.0), amperes_u((Double(25000.0) / 1000000.0).rounded()))
        XCTAssertEqual(uA_d_to_A_u(250000.0), amperes_u((Double(250000.0) / 1000000.0).rounded()))
        XCTAssertEqual(uA_d_to_A_u(2500000.0), amperes_u((Double(2500000.0) / 1000000.0).rounded()))
        XCTAssertEqual(uA_d_to_A_u(-323.0), 0)
        XCTAssertEqual(uA_d_to_A_u(-10.0), 0)
    }

    func testmicroamperes_d_to_amperes_u1() {
        XCTAssertEqual(uA_d_to_A_u(-1000.0), 0)
        XCTAssertEqual(uA_d_to_A_u(-6.0), 0)
        XCTAssertEqual(uA_d_to_A_u(-Double.greatestFiniteMagnitude), amperes_u(UInt64.min))
        XCTAssertEqual(uA_d_to_A_u(Double.greatestFiniteMagnitude), amperes_u(UInt64.max))
    }

    func testmicroamperes_d_to_double() {
        ...
        let result2 = uA_d_to_d(microamperes_d(-Double.greatestFiniteMagnitude))
        ...
        let result3 = uA_d_to_d(microamperes_d(Double.greatestFiniteMagnitude))
    ...
    func testmicroamperes_d_to_float() {
        ...
        let result2 = uA_d_to_f(microamperes_d(-Double.greatestFiniteMagnitude))
        ...
        let result3 = uA_d_to_f(microamperes_d(Double.greatestFiniteMagnitude))
    ...
    func testmicroamperes_d_to_int16_t() {
    ...
    func testmicroamperes_d_to_int32_t() {
    ...
    func testmicroamperes_d_to_int64_t() {
    ...
    func testmicroamperes_d_to_int8_t() {
    ...
    func testmicroamperes_d_to_microamperes_f() {
        ...
        let result1 = uA_d_to_uA_f(microamperes_d(-Double.greatestFiniteMagnitude))
        let expected1: microamperes_f = microamperes_f(-Float.greatestFiniteMagnitude)
        ...
        let result2 = uA_d_to_uA_f(microamperes_d(Double.greatestFiniteMagnitude))
        ...
        let result3 = uA_d_to_uA_f(5.0)
        let expected3: microamperes_f = 5.0
    ...
    func testmicroamperes_d_to_microamperes_t() {
    ...
    func testmicroamperes_d_to_microamperes_u() {
    ...
    func testmicroamperes_d_to_milliamperes_d() {
        ...
        let result2 = uA_d_to_mA_d(250.0)
        ...
        let result4 = uA_d_to_mA_d(2500.0)
        ...
        let result5 = uA_d_to_mA_d(25000.0)
        ...
        let result6 = uA_d_to_mA_d(250000.0)
        ...
        let result7 = uA_d_to_mA_d(2500000.0)
        ...
        let result8 = uA_d_to_mA_d(-323.0)
    ...
    func testmicroamperes_d_to_milliamperes_d1() {
        ...
        let result2 = uA_d_to_mA_d(-Double.greatestFiniteMagnitude)
        let expected2: milliamperes_d = milliamperes_d(-Double.greatestFiniteMagnitude) / 1000.0
        let tolerance2: milliamperes_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = uA_d_to_mA_d(Double.greatestFiniteMagnitude)
        let expected3: milliamperes_d = milliamperes_d(Double.greatestFiniteMagnitude) / 1000.0
        let tolerance3: milliamperes_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmicroamperes_d_to_milliamperes_f() {
        ...
        let result2 = uA_d_to_mA_f(250.0)
        ...
        let result4 = uA_d_to_mA_f(2500.0)
        ...
        let result5 = uA_d_to_mA_f(25000.0)
        ...
        let result6 = uA_d_to_mA_f(250000.0)
        ...
        let result7 = uA_d_to_mA_f(2500000.0)
        ...
        let result8 = uA_d_to_mA_f(-323.0)
    ...
    func testmicroamperes_d_to_milliamperes_f1() {
        ...
        let result2 = uA_d_to_mA_f(-Double.greatestFiniteMagnitude)
        ...
        let result3 = uA_d_to_mA_f(Double.greatestFiniteMagnitude)
    ...
    func testmicroamperes_d_to_milliamperes_t() {
    ...
    func testmicroamperes_d_to_milliamperes_t1() {
    ...
    func testmicroamperes_d_to_milliamperes_u() {
