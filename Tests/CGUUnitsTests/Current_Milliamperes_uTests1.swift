...
final class Current_Milliamperes_uTests1: XCTestCase {
    ...
    func testmilliamperes_uToamperes_dUsingUInt64_maxExpectingamperes_dUInt64_max1000_0() {
        let result = mA_u_to_A_d(UInt64.max)
        let expected: amperes_d = amperes_d(UInt64.max) / 1000.0
        let tolerance: amperes_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmilliamperes_uToamperes_dUsingUInt64_minExpectingamperes_dUInt64_min1000_0() {
        let result = mA_u_to_A_d(UInt64.min)
        let expected: amperes_d = amperes_d(UInt64.min) / 1000.0
        let tolerance: amperes_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmilliamperes_uToamperes_fUsingUInt64_maxExpectingamperes_fUInt64_max1000_0() {
        let result = mA_u_to_A_f(UInt64.max)
        let expected: amperes_f = amperes_f(UInt64.max) / 1000.0
        let tolerance: amperes_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmilliamperes_uToamperes_fUsingUInt64_minExpectingamperes_fUInt64_min1000_0() {
        let result = mA_u_to_A_f(UInt64.min)
        let expected: amperes_f = amperes_f(UInt64.min) / 1000.0
        let tolerance: amperes_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
