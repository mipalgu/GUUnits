...
final class Mass_Megagram_dTests1: XCTestCase {

    func testmegagram_d_to_megagram_u() {
    ...
    func testmegagram_d_to_microgram_d() {
    ...
    func testmegagram_d_to_microgram_d1() {
    ...
    func testmegagram_d_to_microgram_f() {
    ...
    func testmegagram_d_to_microgram_f1() {
    ...
    func testmegagram_d_to_microgram_t() {
        XCTAssertEqual(Mg_d_to_ug_t(15.0), microgram_t((Double(15.0) * 1000000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_ug_t(25.0), microgram_t((Double(25.0) * 1000000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_ug_t(250.0), microgram_t((Double(250.0) * 1000000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_ug_t(0.0), microgram_t((Double(0.0) * 1000000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_ug_t(2500.0), microgram_t((Double(2500.0) * 1000000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_ug_t(25000.0), microgram_t((Double(25000.0) * 1000000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_ug_t(250000.0), microgram_t((Double(250000.0) * 1000000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_ug_t(2500000.0), microgram_t((Double(2500000.0) * 1000000000000.0).rounded()))
    ...
    func testmegagram_d_to_microgram_t1() {
        XCTAssertEqual(Mg_d_to_ug_t(-1000.0), microgram_t((Double(-1000.0) * 1000000000000.0).rounded()))
    ...
    func testmegagram_d_to_microgram_u() {
    ...
    func testmegagram_d_to_microgram_u1() {
    ...
    func testmegagram_d_to_milligram_d() {
    ...
    func testmegagram_d_to_milligram_d1() {
    ...
    func testmegagram_d_to_milligram_f() {
    ...
    func testmegagram_d_to_milligram_f1() {
    ...
    func testmegagram_d_to_milligram_t() {
        XCTAssertEqual(Mg_d_to_mg_t(15.0), milligram_t((Double(15.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_mg_t(25.0), milligram_t((Double(25.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_mg_t(250.0), milligram_t((Double(250.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_mg_t(0.0), milligram_t((Double(0.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_mg_t(2500.0), milligram_t((Double(2500.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_mg_t(25000.0), milligram_t((Double(25000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_mg_t(250000.0), milligram_t((Double(250000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_mg_t(2500000.0), milligram_t((Double(2500000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_mg_t(-323.0), milligram_t((Double(-323.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_mg_t(-10.0), milligram_t((Double(-10.0) * 1000000000.0).rounded()))
    }

    func testmegagram_d_to_milligram_t1() {
        XCTAssertEqual(Mg_d_to_mg_t(-1000.0), milligram_t((Double(-1000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_mg_t(-5.0), milligram_t((Double(-5.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_d_to_mg_t(-Double.greatestFiniteMagnitude), milligram_t(Int64.min))
        XCTAssertEqual(Mg_d_to_mg_t(Double.greatestFiniteMagnitude), milligram_t(Int64.max))
    }

    func testmegagram_d_to_milligram_u() {
    ...
    func testmegagram_d_to_milligram_u1() {
    ...
    func testmegagram_d_to_uint16_t() {
    ...
    func testmegagram_d_to_uint32_t() {
    ...
    func testmegagram_d_to_uint64_t() {
    ...
    func testmegagram_d_to_uint8_t() {
    ...
    func testuint16_t_to_megagram_d() {
        ...
        let expected2: megagram_d = megagram_d(UInt16.min)
        ...
        let expected3: megagram_d = megagram_d(UInt16.max)
    ...
    func testuint32_t_to_megagram_d() {
        ...
        let expected2: megagram_d = megagram_d(UInt32.min)
        let tolerance2: megagram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: megagram_d = megagram_d(UInt32.max)
        let tolerance3: megagram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint64_t_to_megagram_d() {
        ...
        let expected2: megagram_d = megagram_d(UInt64.min)
        let tolerance2: megagram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: megagram_d = megagram_d(UInt64.max)
        let tolerance3: megagram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint8_t_to_megagram_d() {
        ...
        let expected2: megagram_d = megagram_d(UInt8.min)
        let tolerance2: megagram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: megagram_d = megagram_d(UInt8.max)
        let tolerance3: megagram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
