...
final class AngularVelocity_Radians_Per_Seconds_fTests1: XCTestCase {
    ...
    func testradians_per_seconds_f_to_radians_per_milliseconds_t() {
        XCTAssertEqual(rad_per_s_f_to_rad_per_ms_t(-5000000), radians_per_milliseconds_t((((Double(-5000000)) / (Double(1000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) / (Double(1000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) / (Double(1000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ms_t(0), radians_per_milliseconds_t((((Double(0)) / (Double(1000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) / (Double(1000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) / (Double(1000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ms_t(5000000), radians_per_milliseconds_t((((Double(5000000)) / (Double(1000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) / (Double(1000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) / (Double(1000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ms_t(-Float.greatestFiniteMagnitude), radians_per_milliseconds_t(Int64.min))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ms_t(Float.greatestFiniteMagnitude), radians_per_milliseconds_t(Int64.max))
    }

    func testradians_per_seconds_f_to_radians_per_milliseconds_u() {
        XCTAssertEqual(rad_per_s_f_to_rad_per_ms_u(-5000000), radians_per_milliseconds_u((((Double(-5000000)) / (Double(1000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) / (Double(1000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) / (Double(1000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ms_u(0), radians_per_milliseconds_u((((Double(0)) / (Double(1000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) / (Double(1000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) / (Double(1000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ms_u(5000000), radians_per_milliseconds_u((((Double(5000000)) / (Double(1000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) / (Double(1000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) / (Double(1000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ms_u(-Float.greatestFiniteMagnitude), radians_per_milliseconds_u(UInt64.min))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ms_u(Float.greatestFiniteMagnitude), radians_per_milliseconds_u(UInt64.max))
    }

    func testradians_per_seconds_f_to_radians_per_nanoseconds_d() {
        let result = rad_per_s_f_to_rad_per_ns_d(-5000000)
        ...
        let result1 = rad_per_s_f_to_rad_per_ns_d(0)
        ...
        let result2 = rad_per_s_f_to_rad_per_ns_d(5000000)
        ...
        let result3 = rad_per_s_f_to_rad_per_ns_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = rad_per_s_f_to_rad_per_ns_d(Float.greatestFiniteMagnitude)
    ...
    func testradians_per_seconds_f_to_radians_per_nanoseconds_f() {
        let result = rad_per_s_f_to_rad_per_ns_f(-5000000)
        ...
        let result1 = rad_per_s_f_to_rad_per_ns_f(0)
        ...
        let result2 = rad_per_s_f_to_rad_per_ns_f(5000000)
        ...
        let result3 = rad_per_s_f_to_rad_per_ns_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = rad_per_s_f_to_rad_per_ns_f(Float.greatestFiniteMagnitude)
    ...
    func testradians_per_seconds_f_to_radians_per_nanoseconds_t() {
        XCTAssertEqual(rad_per_s_f_to_rad_per_ns_t(-5000000), radians_per_nanoseconds_t((((Double(-5000000)) / (Double(1000000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) / (Double(1000000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ns_t(0), radians_per_nanoseconds_t((((Double(0)) / (Double(1000000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) / (Double(1000000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ns_t(5000000), radians_per_nanoseconds_t((((Double(5000000)) / (Double(1000000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) / (Double(1000000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ns_t(-Float.greatestFiniteMagnitude), radians_per_nanoseconds_t(Int64.min))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ns_t(Float.greatestFiniteMagnitude), radians_per_nanoseconds_t(Int64.max))
    }

    func testradians_per_seconds_f_to_radians_per_nanoseconds_u() {
        XCTAssertEqual(rad_per_s_f_to_rad_per_ns_u(-5000000), radians_per_nanoseconds_u((((Double(-5000000)) / (Double(1000000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) / (Double(1000000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ns_u(0), radians_per_nanoseconds_u((((Double(0)) / (Double(1000000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) / (Double(1000000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ns_u(5000000), radians_per_nanoseconds_u((((Double(5000000)) / (Double(1000000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) / (Double(1000000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ns_u(-Float.greatestFiniteMagnitude), radians_per_nanoseconds_u(UInt64.min))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ns_u(Float.greatestFiniteMagnitude), radians_per_nanoseconds_u(UInt64.max))
    }

    func testradians_per_seconds_f_to_radians_per_picoseconds_d() {
        let result = rad_per_s_f_to_rad_per_ps_d(-5000000)
        ...
        let result1 = rad_per_s_f_to_rad_per_ps_d(0)
        ...
        let result2 = rad_per_s_f_to_rad_per_ps_d(5000000)
        ...
        let result3 = rad_per_s_f_to_rad_per_ps_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = rad_per_s_f_to_rad_per_ps_d(Float.greatestFiniteMagnitude)
    ...
    func testradians_per_seconds_f_to_radians_per_picoseconds_f() {
        let result = rad_per_s_f_to_rad_per_ps_f(-5000000)
        ...
        let result1 = rad_per_s_f_to_rad_per_ps_f(0)
        ...
        let result2 = rad_per_s_f_to_rad_per_ps_f(5000000)
        ...
        let result3 = rad_per_s_f_to_rad_per_ps_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = rad_per_s_f_to_rad_per_ps_f(Float.greatestFiniteMagnitude)
    ...
    func testradians_per_seconds_f_to_radians_per_picoseconds_t() {
        XCTAssertEqual(rad_per_s_f_to_rad_per_ps_t(-5000000), radians_per_picoseconds_t((((Double(-5000000)) / (Double(1000000000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) / (Double(1000000000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) / (Double(1000000000000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ps_t(0), radians_per_picoseconds_t((((Double(0)) / (Double(1000000000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) / (Double(1000000000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) / (Double(1000000000000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ps_t(5000000), radians_per_picoseconds_t((((Double(5000000)) / (Double(1000000000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) / (Double(1000000000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) / (Double(1000000000000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ps_t(-Float.greatestFiniteMagnitude), radians_per_picoseconds_t(Int64.min))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ps_t(Float.greatestFiniteMagnitude), radians_per_picoseconds_t(Int64.max))
    }

    func testradians_per_seconds_f_to_radians_per_picoseconds_u() {
        XCTAssertEqual(rad_per_s_f_to_rad_per_ps_u(-5000000), radians_per_picoseconds_u((((Double(-5000000)) / (Double(1000000000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) / (Double(1000000000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) / (Double(1000000000000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ps_u(0), radians_per_picoseconds_u((((Double(0)) / (Double(1000000000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) / (Double(1000000000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) / (Double(1000000000000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ps_u(5000000), radians_per_picoseconds_u((((Double(5000000)) / (Double(1000000000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) / (Double(1000000000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) / (Double(1000000000000))).rounded()))))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ps_u(-Float.greatestFiniteMagnitude), radians_per_picoseconds_u(UInt64.min))
        XCTAssertEqual(rad_per_s_f_to_rad_per_ps_u(Float.greatestFiniteMagnitude), radians_per_picoseconds_u(UInt64.max))
    }

    func testradians_per_seconds_f_to_radians_per_seconds_d() {
        ...
        let result1 = rad_per_s_f_to_rad_per_s_d(0)
        let expected1: radians_per_seconds_d = radians_per_seconds_d(Double(0))
        ...
        let result2 = rad_per_s_f_to_rad_per_s_d(5000000)
        let expected2: radians_per_seconds_d = radians_per_seconds_d(Double(5000000))
        ...
        let result3 = rad_per_s_f_to_rad_per_s_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = rad_per_s_f_to_rad_per_s_d(Float.greatestFiniteMagnitude)
    ...
    func testradians_per_seconds_f_to_radians_per_seconds_t() {
    ...
    func testradians_per_seconds_f_to_radians_per_seconds_u() {
    ...
    func testradians_per_seconds_f_to_uint16_t() {
    ...
    func testradians_per_seconds_f_to_uint32_t() {
    ...
    func testradians_per_seconds_f_to_uint64_t() {
    ...
    func testradians_per_seconds_f_to_uint8_t() {
    ...
    func testuint16_t_to_radians_per_seconds_f() {
        ...
        let result1 = u16_to_rad_per_s_f(5)
        ...
        let result2 = u16_to_rad_per_s_f(UInt16(UInt16.min))
        let expected2: radians_per_seconds_f = radians_per_seconds_f(UInt16.min)
        ...
        let result3 = u16_to_rad_per_s_f(UInt16(UInt16.max))
        let expected3: radians_per_seconds_f = radians_per_seconds_f(UInt16.max)
    ...
    func testuint32_t_to_radians_per_seconds_f() {
        ...
        let result1 = u32_to_rad_per_s_f(5)
        let expected1: radians_per_seconds_f = 5.0
        let tolerance1: radians_per_seconds_f = 0.99
        if result1 > expected1 {
            XCTAssertLessThanOrEqual(result1 - expected1, tolerance1)
        ...
        let result2 = u32_to_rad_per_s_f(UInt32(UInt32.min))
        let expected2: radians_per_seconds_f = radians_per_seconds_f(UInt32.min)
        let tolerance2: radians_per_seconds_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u32_to_rad_per_s_f(UInt32(UInt32.max))
        let expected3: radians_per_seconds_f = radians_per_seconds_f(UInt32.max)
        let tolerance3: radians_per_seconds_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint64_t_to_radians_per_seconds_f() {
        ...
        let result1 = u64_to_rad_per_s_f(5)
        let expected1: radians_per_seconds_f = 5.0
        let tolerance1: radians_per_seconds_f = 0.99
        if result1 > expected1 {
            XCTAssertLessThanOrEqual(result1 - expected1, tolerance1)
        ...
        let result2 = u64_to_rad_per_s_f(UInt64(UInt64.min))
        let expected2: radians_per_seconds_f = radians_per_seconds_f(UInt64.min)
        let tolerance2: radians_per_seconds_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u64_to_rad_per_s_f(UInt64(UInt64.max))
        let expected3: radians_per_seconds_f = radians_per_seconds_f(UInt64.max)
        let tolerance3: radians_per_seconds_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint8_t_to_radians_per_seconds_f() {
        ...
        let result1 = u8_to_rad_per_s_f(5)
        let expected1: radians_per_seconds_f = 5.0
        let tolerance1: radians_per_seconds_f = 0.99
        if result1 > expected1 {
            XCTAssertLessThanOrEqual(result1 - expected1, tolerance1)
        ...
        let result2 = u8_to_rad_per_s_f(UInt8(UInt8.min))
        let expected2: radians_per_seconds_f = radians_per_seconds_f(UInt8.min)
        let tolerance2: radians_per_seconds_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u8_to_rad_per_s_f(UInt8(UInt8.max))
        let expected3: radians_per_seconds_f = radians_per_seconds_f(UInt8.max)
        let tolerance3: radians_per_seconds_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
