...
final class Mass_Megagram_uTests6: XCTestCase {
    ...
    func testmegagram_uTomilligram_dUsingUInt64_maxExpectingmilligram_dUInt64_max1000000000_0() {
        ...
        let expected: milligram_d = milligram_d(UInt64.max) * 1000000000.0
        let tolerance: milligram_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmegagram_uTomilligram_dUsingUInt64_minExpectingmilligram_dUInt64_min1000000000_0() {
        ...
        let expected: milligram_d = milligram_d(UInt64.min) * 1000000000.0
        let tolerance: milligram_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmegagram_uTomilligram_fUsingUInt64_maxExpectingmilligram_fUInt64_max1000000000_0() {
        ...
        let expected: milligram_f = milligram_f(UInt64.max) * 1000000000.0
        let tolerance: milligram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmegagram_uTomilligram_fUsingUInt64_minExpectingmilligram_fUInt64_min1000000000_0() {
        ...
        let expected: milligram_f = milligram_f(UInt64.min) * 1000000000.0
        let tolerance: milligram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
