...
final class Mass_Milligram_fTests7: XCTestCase {
    ...
    func testmilligram_fTomicrogram_dUsingFloat_greatestFiniteMagnitudeExpectingmicrogram_dFloat_greatestFiniteMagnitude1000_0() {
        ...
        let expected: microgram_d = microgram_d(Float.greatestFiniteMagnitude) * 1000.0
        let tolerance: microgram_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmilligram_fTomicrogram_fUsing0_0Expectingmicrogram_f0_01000_0() {
    ...
    func testmilligram_fTomicrogram_fUsing15_0Expectingmicrogram_f15_01000_0() {
    ...
    func testmilligram_fTomicrogram_fUsing2500000_0Expectingmicrogram_f2500000_01000_0() {
    ...
    func testmilligram_fTomicrogram_fUsing250000_0Expectingmicrogram_f250000_01000_0() {
    ...
    func testmilligram_fTomicrogram_fUsing25000_0Expectingmicrogram_f25000_01000_0() {
    ...
    func testmilligram_fTomicrogram_fUsing2500_0Expectingmicrogram_f2500_01000_0() {
    ...
    func testmilligram_fTomicrogram_fUsing250_0Expectingmicrogram_f250_01000_0() {
    ...
    func testmilligram_fTomicrogram_fUsing25_0Expectingmicrogram_f25_01000_0() {
    ...
    func testmilligram_fTomicrogram_fUsingFloat_greatestFiniteMagnitudeExpectingmicrogram_fFloat_greatestFiniteMagnitude() {
    ...
    func testmilligram_fTomicrogram_fUsingNeg1000_0Expectingmicrogram_fNeg1000_01000_0() {
