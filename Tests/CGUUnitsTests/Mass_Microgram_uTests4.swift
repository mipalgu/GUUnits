...
final class Mass_Microgram_uTests4: XCTestCase {
    ...
    func testmicrogram_uTomegagram_dUsingUInt64_maxExpectingmegagram_dUInt64_max1000000000000_0() {
        ...
        let expected: megagram_d = megagram_d(UInt64.max) / 1000000000000.0
        let tolerance: megagram_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmicrogram_uTomegagram_dUsingUInt64_minExpectingmegagram_dUInt64_min1000000000000_0() {
        ...
        let expected: megagram_d = megagram_d(UInt64.min) / 1000000000000.0
        let tolerance: megagram_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmicrogram_uTomegagram_fUsing15Expectingmegagram_f15_01000000000000_0() {
    ...
    func testmicrogram_uTomegagram_fUsing25Expectingmegagram_f25_01000000000000_0() {
    ...
    func testmicrogram_uTomegagram_fUsingUInt64_maxExpectingmegagram_fUInt64_max1000000000000_0() {
        ...
        let expected: megagram_f = megagram_f(UInt64.max) / 1000000000000.0
        let tolerance: megagram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmicrogram_uTomegagram_fUsingUInt64_minExpectingmegagram_fUInt64_min1000000000000_0() {
        ...
        let expected: megagram_f = megagram_f(UInt64.min) / 1000000000000.0
        let tolerance: megagram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
