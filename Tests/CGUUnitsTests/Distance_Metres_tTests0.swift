...
final class Distance_Metres_tTests0: XCTestCase {
    ...
    func testmetres_t_to_centimetres_d() {
        ...
        let result6 = m_t_to_cm_d(250000)
        ...
        let result7 = m_t_to_cm_d(2500000)
    ...
    func testmetres_t_to_centimetres_d1() {
        ...
        let result2 = m_t_to_cm_d(Int64.min)
        let expected2: centimetres_d = centimetres_d(Int64.min) * 100.0
        let tolerance2: centimetres_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = m_t_to_cm_d(Int64.max)
        let expected3: centimetres_d = centimetres_d(Int64.max) * 100.0
        let tolerance3: centimetres_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmetres_t_to_centimetres_f() {
        ...
        let result6 = m_t_to_cm_f(250000)
        ...
        let result7 = m_t_to_cm_f(2500000)
    ...
    func testmetres_t_to_centimetres_f1() {
        ...
        let result2 = m_t_to_cm_f(Int64.min)
        let expected2: centimetres_f = centimetres_f(Int64.min) * 100.0
        let tolerance2: centimetres_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = m_t_to_cm_f(Int64.max)
        let expected3: centimetres_f = centimetres_f(Int64.max) * 100.0
        let tolerance3: centimetres_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmetres_t_to_centimetres_t() {
    ...
    func testmetres_t_to_centimetres_t1() {
    ...
    func testmetres_t_to_centimetres_u() {
    ...
    func testmetres_t_to_centimetres_u1() {
    ...
    func testmetres_t_to_double() {
        ...
        let result2 = m_t_to_d(metres_t(Int64.min))
        ...
        let result3 = m_t_to_d(metres_t(Int64.max))
    ...
    func testmetres_t_to_float() {
        ...
        let result2 = m_t_to_f(metres_t(Int64.min))
        ...
        let result3 = m_t_to_f(metres_t(Int64.max))
    ...
    func testmetres_t_to_metres_d() {
        ...
        let result1 = m_t_to_m_d(metres_t(Int64.min))
        let expected1: metres_d = metres_d(Int64.min)
        ...
        let result2 = m_t_to_m_d(metres_t(Int64.max))
        let expected2: metres_d = metres_d(Int64.max)
    ...
    func testmetres_t_to_metres_f() {
        ...
        let result1 = m_t_to_m_f(metres_t(Int64.min))
        let expected1: metres_f = metres_f(Int64.min)
        ...
        let result2 = m_t_to_m_f(metres_t(Int64.max))
        let expected2: metres_f = metres_f(Int64.max)
    ...
    func testmetres_t_to_millimetres_d() {
        ...
        let result6 = m_t_to_mm_d(250000)
        ...
        let result7 = m_t_to_mm_d(2500000)
    ...
    func testmetres_t_to_millimetres_d1() {
        ...
        let result2 = m_t_to_mm_d(Int64.min)
        let expected2: millimetres_d = millimetres_d(Int64.min) * 1000.0
        let tolerance2: millimetres_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = m_t_to_mm_d(Int64.max)
        let expected3: millimetres_d = millimetres_d(Int64.max) * 1000.0
        let tolerance3: millimetres_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmetres_t_to_millimetres_f() {
        ...
        let result6 = m_t_to_mm_f(250000)
        ...
        let result7 = m_t_to_mm_f(2500000)
    ...
    func testmetres_t_to_millimetres_f1() {
        ...
        let result2 = m_t_to_mm_f(Int64.min)
        let expected2: millimetres_f = millimetres_f(Int64.min) * 1000.0
        let tolerance2: millimetres_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = m_t_to_mm_f(Int64.max)
        let expected3: millimetres_f = millimetres_f(Int64.max) * 1000.0
        let tolerance3: millimetres_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmetres_t_to_millimetres_t() {
    ...
    func testmetres_t_to_millimetres_t1() {
    ...
    func testmetres_t_to_millimetres_u() {
