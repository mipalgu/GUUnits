...
final class Time_Microseconds_uTests0: XCTestCase {
    ...
    func testmicroseconds_u_to_nanoseconds_d() {
        let result = us_u_to_ns_d(15)
        ...
        let result5 = us_u_to_ns_d(25000)
        ...
        let result6 = us_u_to_ns_d(250000)
        ...
        let result7 = us_u_to_ns_d(2500000)
        ...
        let result8 = us_u_to_ns_d(UInt64.min)
        ...
        let result9 = us_u_to_ns_d(UInt64.max)
    ...
    func testmicroseconds_u_to_nanoseconds_f() {
        let result = us_u_to_ns_f(15)
        ...
        let result5 = us_u_to_ns_f(25000)
        ...
        let result6 = us_u_to_ns_f(250000)
        ...
        let result7 = us_u_to_ns_f(2500000)
        ...
        let result8 = us_u_to_ns_f(UInt64.min)
        ...
        let result9 = us_u_to_ns_f(UInt64.max)
    ...
    func testmicroseconds_u_to_nanoseconds_t() {
        XCTAssertEqual(us_u_to_ns_t(15), nanoseconds_t(15) * 1000)
        XCTAssertEqual(us_u_to_ns_t(25), nanoseconds_t(25) * 1000)
        XCTAssertEqual(us_u_to_ns_t(250), nanoseconds_t(250) * 1000)
        XCTAssertEqual(us_u_to_ns_t(0), nanoseconds_t(0) * 1000)
        XCTAssertEqual(us_u_to_ns_t(2500), nanoseconds_t(2500) * 1000)
        XCTAssertEqual(us_u_to_ns_t(25000), nanoseconds_t(25000) * 1000)
        XCTAssertEqual(us_u_to_ns_t(250000), nanoseconds_t(250000) * 1000)
        XCTAssertEqual(us_u_to_ns_t(2500000), nanoseconds_t(2500000) * 1000)
        XCTAssertEqual(us_u_to_ns_t(UInt64.min), nanoseconds_t(UInt64.min) * 1000)
        XCTAssertEqual(us_u_to_ns_t(UInt64.max), nanoseconds_t(Int64.max))
    }

    func testmicroseconds_u_to_nanoseconds_u() {
        XCTAssertEqual(us_u_to_ns_u(15), nanoseconds_u(15) * 1000)
        XCTAssertEqual(us_u_to_ns_u(25), nanoseconds_u(25) * 1000)
        XCTAssertEqual(us_u_to_ns_u(250), nanoseconds_u(250) * 1000)
        XCTAssertEqual(us_u_to_ns_u(0), nanoseconds_u(0) * 1000)
        XCTAssertEqual(us_u_to_ns_u(2500), nanoseconds_u(2500) * 1000)
        XCTAssertEqual(us_u_to_ns_u(25000), nanoseconds_u(25000) * 1000)
        XCTAssertEqual(us_u_to_ns_u(250000), nanoseconds_u(250000) * 1000)
        XCTAssertEqual(us_u_to_ns_u(2500000), nanoseconds_u(2500000) * 1000)
        XCTAssertEqual(us_u_to_ns_u(UInt64.min), nanoseconds_u(UInt64.min))
        XCTAssertEqual(us_u_to_ns_u(UInt64.max), nanoseconds_u(UInt64.max))
    }

    func testmicroseconds_u_to_picoseconds_d() {
        let result = us_u_to_ps_d(15)
        ...
        let result5 = us_u_to_ps_d(25000)
        ...
        let result6 = us_u_to_ps_d(250000)
        ...
        let result7 = us_u_to_ps_d(2500000)
        ...
        let result8 = us_u_to_ps_d(UInt64.min)
        let expected8: picoseconds_d = picoseconds_d(UInt64.min) * 1000000.0
        ...
        let result9 = us_u_to_ps_d(UInt64.max)
        let expected9: picoseconds_d = picoseconds_d(UInt64.max) * 1000000.0
    ...
    func testmicroseconds_u_to_picoseconds_f() {
        let result = us_u_to_ps_f(15)
        ...
        let result5 = us_u_to_ps_f(25000)
        ...
        let result6 = us_u_to_ps_f(250000)
        ...
        let result7 = us_u_to_ps_f(2500000)
        ...
        let result8 = us_u_to_ps_f(UInt64.min)
        let expected8: picoseconds_f = picoseconds_f(UInt64.min) * 1000000.0
        ...
        let result9 = us_u_to_ps_f(UInt64.max)
        let expected9: picoseconds_f = picoseconds_f(UInt64.max) * 1000000.0
    ...
    func testmicroseconds_u_to_picoseconds_t() {
        XCTAssertEqual(us_u_to_ps_t(15), picoseconds_t(15) * 1000000)
        XCTAssertEqual(us_u_to_ps_t(25), picoseconds_t(25) * 1000000)
        XCTAssertEqual(us_u_to_ps_t(250), picoseconds_t(250) * 1000000)
        XCTAssertEqual(us_u_to_ps_t(0), picoseconds_t(0) * 1000000)
        XCTAssertEqual(us_u_to_ps_t(2500), picoseconds_t(2500) * 1000000)
        XCTAssertEqual(us_u_to_ps_t(25000), picoseconds_t(25000) * 1000000)
        XCTAssertEqual(us_u_to_ps_t(250000), picoseconds_t(250000) * 1000000)
        XCTAssertEqual(us_u_to_ps_t(2500000), picoseconds_t(2500000) * 1000000)
        XCTAssertEqual(us_u_to_ps_t(UInt64.min), picoseconds_t(UInt64.min) * 1000000)
        XCTAssertEqual(us_u_to_ps_t(UInt64.max), picoseconds_t(Int64.max))
    }

    func testmicroseconds_u_to_picoseconds_u() {
        XCTAssertEqual(us_u_to_ps_u(15), picoseconds_u(15) * 1000000)
        XCTAssertEqual(us_u_to_ps_u(25), picoseconds_u(25) * 1000000)
        XCTAssertEqual(us_u_to_ps_u(250), picoseconds_u(250) * 1000000)
        XCTAssertEqual(us_u_to_ps_u(0), picoseconds_u(0) * 1000000)
        XCTAssertEqual(us_u_to_ps_u(2500), picoseconds_u(2500) * 1000000)
        XCTAssertEqual(us_u_to_ps_u(25000), picoseconds_u(25000) * 1000000)
        XCTAssertEqual(us_u_to_ps_u(250000), picoseconds_u(250000) * 1000000)
        XCTAssertEqual(us_u_to_ps_u(2500000), picoseconds_u(2500000) * 1000000)
        XCTAssertEqual(us_u_to_ps_u(UInt64.min), picoseconds_u(UInt64.min))
        XCTAssertEqual(us_u_to_ps_u(UInt64.max), picoseconds_u(UInt64.max))
    }
