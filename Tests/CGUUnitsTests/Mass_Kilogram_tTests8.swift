...
final class Mass_Kilogram_tTests8: XCTestCase {
    ...
    func testkilogram_tTomilligram_fUsingInt64_maxExpectingmilligram_fInt64_max1000000_0() {
        ...
        let expected: milligram_f = milligram_f(Int64.max) * 1000000.0
        let tolerance: milligram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testkilogram_tTomilligram_fUsingInt64_minExpectingmilligram_fInt64_min1000000_0() {
        ...
        let expected: milligram_f = milligram_f(Int64.min) * 1000000.0
        let tolerance: milligram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
