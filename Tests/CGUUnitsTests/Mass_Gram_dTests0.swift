...
final class Mass_Gram_dTests0: XCTestCase {
    ...
    func testdouble_to_gram_d() {
        ...
        let result2 = d_to_g_d(Double(-Double.greatestFiniteMagnitude))
        let expected2: gram_d = gram_d(-Double.greatestFiniteMagnitude)
        ...
        let result3 = d_to_g_d(Double(Double.greatestFiniteMagnitude))
        let expected3: gram_d = gram_d(Double.greatestFiniteMagnitude)
    ...
    func testfloat_to_gram_d() {
        ...
        let result2 = f_to_g_d(Float(-Float.greatestFiniteMagnitude))
        ...
        let result3 = f_to_g_d(Float(Float.greatestFiniteMagnitude))
        let expected3: gram_d = gram_d(Float.greatestFiniteMagnitude)
        let tolerance3: gram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testgram_d_to_double() {
        ...
        let result2 = g_d_to_d(gram_d(-Double.greatestFiniteMagnitude))
        ...
        let result3 = g_d_to_d(gram_d(Double.greatestFiniteMagnitude))
    ...
    func testgram_d_to_float() {
        ...
        let result2 = g_d_to_f(gram_d(-Double.greatestFiniteMagnitude))
        ...
        let result3 = g_d_to_f(gram_d(Double.greatestFiniteMagnitude))
    ...
    func testgram_d_to_gram_f() {
        ...
        let result1 = g_d_to_g_f(gram_d(-Double.greatestFiniteMagnitude))
        let expected1: gram_f = gram_f(-Float.greatestFiniteMagnitude)
        ...
        let result2 = g_d_to_g_f(gram_d(Double.greatestFiniteMagnitude))
    ...
    func testgram_d_to_int16_t() {
        XCTAssertEqual(g_d_to_i16(0.0), 0)
        XCTAssertEqual(g_d_to_i16(5.0), 5)
        XCTAssertEqual(g_d_to_i16(gram_d(-Double.greatestFiniteMagnitude)), Int16(Int16.min))
        XCTAssertEqual(g_d_to_i16(gram_d(Double.greatestFiniteMagnitude)), Int16(Int16.max))
    }

    func testgram_d_to_int32_t() {
        XCTAssertEqual(g_d_to_i32(0.0), 0)
        XCTAssertEqual(g_d_to_i32(5.0), 5)
        XCTAssertEqual(g_d_to_i32(gram_d(-Double.greatestFiniteMagnitude)), Int32(Int32.min))
        XCTAssertEqual(g_d_to_i32(gram_d(Double.greatestFiniteMagnitude)), Int32(Int32.max))
    }

    func testgram_d_to_int64_t() {
        XCTAssertEqual(g_d_to_i64(0.0), 0)
        XCTAssertEqual(g_d_to_i64(5.0), 5)
        XCTAssertEqual(g_d_to_i64(gram_d(-Double.greatestFiniteMagnitude)), Int64(Int64.min))
        XCTAssertEqual(g_d_to_i64(gram_d(Double.greatestFiniteMagnitude)), Int64(Int64.max))
    }

    func testgram_d_to_int8_t() {
        XCTAssertEqual(g_d_to_i8(0.0), 0)
        XCTAssertEqual(g_d_to_i8(5.0), 5)
        XCTAssertEqual(g_d_to_i8(gram_d(-Double.greatestFiniteMagnitude)), Int8(Int8.min))
        XCTAssertEqual(g_d_to_i8(gram_d(Double.greatestFiniteMagnitude)), Int8(Int8.max))
    }

    func testgram_d_to_kilogram_d() {
        let result = g_d_to_kg_d(15.0)
        ...
        let result4 = g_d_to_kg_d(2500.0)
        ...
        let result5 = g_d_to_kg_d(25000.0)
        ...
        let result6 = g_d_to_kg_d(250000.0)
        ...
        let result7 = g_d_to_kg_d(2500000.0)
    ...
    func testgram_d_to_kilogram_d1() {
        let result = g_d_to_kg_d(-1000.0)
        ...
        let result2 = g_d_to_kg_d(-Double.greatestFiniteMagnitude)
        let expected2: kilogram_d = kilogram_d(-Double.greatestFiniteMagnitude) / 1000.0
        let tolerance2: kilogram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = g_d_to_kg_d(Double.greatestFiniteMagnitude)
        let expected3: kilogram_d = kilogram_d(Double.greatestFiniteMagnitude) / 1000.0
        let tolerance3: kilogram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testgram_d_to_kilogram_f() {
        let result = g_d_to_kg_f(15.0)
        ...
        let result4 = g_d_to_kg_f(2500.0)
        ...
        let result5 = g_d_to_kg_f(25000.0)
        ...
        let result6 = g_d_to_kg_f(250000.0)
        ...
        let result7 = g_d_to_kg_f(2500000.0)
    ...
    func testgram_d_to_kilogram_f1() {
        let result = g_d_to_kg_f(-1000.0)
        ...
        let result2 = g_d_to_kg_f(-Double.greatestFiniteMagnitude)
        ...
        let result3 = g_d_to_kg_f(Double.greatestFiniteMagnitude)
    ...
    func testgram_d_to_kilogram_t() {
        XCTAssertEqual(g_d_to_kg_t(15.0), kilogram_t((Double(15.0) / 1000.0).rounded()))
        XCTAssertEqual(g_d_to_kg_t(25.0), kilogram_t((Double(25.0) / 1000.0).rounded()))
        XCTAssertEqual(g_d_to_kg_t(250.0), kilogram_t((Double(250.0) / 1000.0).rounded()))
        XCTAssertEqual(g_d_to_kg_t(0.0), kilogram_t((Double(0.0) / 1000.0).rounded()))
        XCTAssertEqual(g_d_to_kg_t(2500.0), kilogram_t((Double(2500.0) / 1000.0).rounded()))
        XCTAssertEqual(g_d_to_kg_t(25000.0), kilogram_t((Double(25000.0) / 1000.0).rounded()))
        XCTAssertEqual(g_d_to_kg_t(250000.0), kilogram_t((Double(250000.0) / 1000.0).rounded()))
        XCTAssertEqual(g_d_to_kg_t(2500000.0), kilogram_t((Double(2500000.0) / 1000.0).rounded()))
        XCTAssertEqual(g_d_to_kg_t(-323.0), kilogram_t((Double(-323.0) / 1000.0).rounded()))
        XCTAssertEqual(g_d_to_kg_t(-10.0), kilogram_t((Double(-10.0) / 1000.0).rounded()))
    }

    func testgram_d_to_kilogram_t1() {
        XCTAssertEqual(g_d_to_kg_t(-1000.0), kilogram_t((Double(-1000.0) / 1000.0).rounded()))
        XCTAssertEqual(g_d_to_kg_t(-5.0), kilogram_t((Double(-5.0) / 1000.0).rounded()))
        XCTAssertEqual(g_d_to_kg_t(-Double.greatestFiniteMagnitude), kilogram_t(Int64.min))
        XCTAssertEqual(g_d_to_kg_t(Double.greatestFiniteMagnitude), kilogram_t(Int64.max))
    }

    func testgram_d_to_kilogram_u() {
        XCTAssertEqual(g_d_to_kg_u(15.0), kilogram_u((Double(15.0) / 1000.0).rounded()))
        ...
        XCTAssertEqual(g_d_to_kg_u(0.0), kilogram_u((Double(0.0) / 1000.0).rounded()))
        ...
        XCTAssertEqual(g_d_to_kg_u(250000.0), kilogram_u((Double(250000.0) / 1000.0).rounded()))
        XCTAssertEqual(g_d_to_kg_u(2500000.0), kilogram_u((Double(2500000.0) / 1000.0).rounded()))
        XCTAssertEqual(g_d_to_kg_u(-323.0), 0)
        XCTAssertEqual(g_d_to_kg_u(-10.0), 0)
    }

    func testgram_d_to_kilogram_u1() {
    ...
    func testgram_d_to_megagram_d1() {
        ...
        let expected2: megagram_d = megagram_d(-Double.greatestFiniteMagnitude) / 1000000.0
        let tolerance2: megagram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: megagram_d = megagram_d(Double.greatestFiniteMagnitude) / 1000000.0
        let tolerance3: megagram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testgram_d_to_megagram_f1() {
    ...
    func testgram_d_to_megagram_t() {
        XCTAssertEqual(g_d_to_Mg_t(15.0), megagram_t((Double(15.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_t(25.0), megagram_t((Double(25.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_t(250.0), megagram_t((Double(250.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_t(0.0), megagram_t((Double(0.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_t(2500.0), megagram_t((Double(2500.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_t(25000.0), megagram_t((Double(25000.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_t(250000.0), megagram_t((Double(250000.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_t(2500000.0), megagram_t((Double(2500000.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_t(-323.0), megagram_t((Double(-323.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_t(-10.0), megagram_t((Double(-10.0) / 1000000.0).rounded()))
    }

    func testgram_d_to_megagram_t1() {
        XCTAssertEqual(g_d_to_Mg_t(-1000.0), megagram_t((Double(-1000.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_t(-5.0), megagram_t((Double(-5.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_t(-Double.greatestFiniteMagnitude), megagram_t(Int64.min))
        XCTAssertEqual(g_d_to_Mg_t(Double.greatestFiniteMagnitude), megagram_t(Int64.max))
    }

    func testgram_d_to_megagram_u() {
        XCTAssertEqual(g_d_to_Mg_u(15.0), megagram_u((Double(15.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_u(25.0), megagram_u((Double(25.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_u(250.0), megagram_u((Double(250.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_u(0.0), megagram_u((Double(0.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_u(2500.0), megagram_u((Double(2500.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_u(25000.0), megagram_u((Double(25000.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_u(250000.0), megagram_u((Double(250000.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_u(2500000.0), megagram_u((Double(2500000.0) / 1000000.0).rounded()))
        XCTAssertEqual(g_d_to_Mg_u(-323.0), 0)
        XCTAssertEqual(g_d_to_Mg_u(-10.0), 0)
    }

    func testgram_d_to_megagram_u1() {
        XCTAssertEqual(g_d_to_Mg_u(-1000.0), 0)
        XCTAssertEqual(g_d_to_Mg_u(-6.0), 0)
        XCTAssertEqual(g_d_to_Mg_u(-Double.greatestFiniteMagnitude), megagram_u(UInt64.min))
        XCTAssertEqual(g_d_to_Mg_u(Double.greatestFiniteMagnitude), megagram_u(UInt64.max))
    }

    func testgram_d_to_microgram_d() {
        let result = g_d_to_ug_d(15.0)
        ...
        let result4 = g_d_to_ug_d(2500.0)
        ...
        let result5 = g_d_to_ug_d(25000.0)
        ...
        let result6 = g_d_to_ug_d(250000.0)
        ...
        let result7 = g_d_to_ug_d(2500000.0)
    ...
    func testgram_d_to_microgram_d1() {
        let result = g_d_to_ug_d(-1000.0)
        ...
        let result2 = g_d_to_ug_d(-Double.greatestFiniteMagnitude)
        ...
        let result3 = g_d_to_ug_d(Double.greatestFiniteMagnitude)
    ...
    func testgram_d_to_microgram_f() {
        let result = g_d_to_ug_f(15.0)
        ...
        let result4 = g_d_to_ug_f(2500.0)
        ...
        let result5 = g_d_to_ug_f(25000.0)
        ...
        let result6 = g_d_to_ug_f(250000.0)
        ...
        let result7 = g_d_to_ug_f(2500000.0)
