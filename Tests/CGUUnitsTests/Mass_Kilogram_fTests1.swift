...
final class Mass_Kilogram_fTests1: XCTestCase {
    ...
    func testkilogram_fTofloatUsingkilogram_fFloat_greatestFiniteMagnitudeExpectingFloatFloat_greatestFiniteMagnitude() {
        let result = kg_f_to_f(kilogram_f(Float.greatestFiniteMagnitude))
    ...
    func testkilogram_fTogram_dUsing2500000_0Expectinggram_d2500000_01000_0() {
        let result = kg_f_to_g_d(2500000.0)
    ...
    func testkilogram_fTogram_dUsing250000_0Expectinggram_d250000_01000_0() {
        let result = kg_f_to_g_d(250000.0)
    ...
    func testkilogram_fTogram_dUsing25000_0Expectinggram_d25000_01000_0() {
        let result = kg_f_to_g_d(25000.0)
    ...
    func testkilogram_fTogram_dUsingFloat_greatestFiniteMagnitudeExpectinggram_dFloat_greatestFiniteMagnitude1000_0() {
        let result = kg_f_to_g_d(Float.greatestFiniteMagnitude)
    ...
    func testkilogram_fTogram_fUsing15_0Expectinggram_f15_01000_0() {
    ...
    func testkilogram_fTogram_fUsing2500000_0Expectinggram_f2500000_01000_0() {
        let result = kg_f_to_g_f(2500000.0)
    ...
    func testkilogram_fTogram_fUsing250000_0Expectinggram_f250000_01000_0() {
        let result = kg_f_to_g_f(250000.0)
    ...
    func testkilogram_fTogram_fUsing25000_0Expectinggram_f25000_01000_0() {
        let result = kg_f_to_g_f(25000.0)
    ...
    func testkilogram_fTogram_fUsing25_0Expectinggram_f25_01000_0() {
        let result = kg_f_to_g_f(25.0)
    ...
    func testkilogram_fTogram_fUsingFloat_greatestFiniteMagnitudeExpectinggram_fFloat_greatestFiniteMagnitude() {
        let result = kg_f_to_g_f(Float.greatestFiniteMagnitude)
