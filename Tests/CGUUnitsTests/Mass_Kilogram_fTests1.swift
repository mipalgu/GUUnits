...
final class Mass_Kilogram_fTests1: XCTestCase {

    func testkilogram_f_to_megagram_u1() {
    ...
    func testkilogram_f_to_microgram_d() {
        ...
        let result2 = kg_f_to_ug_d(250.0)
        ...
        let result4 = kg_f_to_ug_d(2500.0)
        ...
        let result5 = kg_f_to_ug_d(25000.0)
        ...
        let result6 = kg_f_to_ug_d(250000.0)
        ...
        let result7 = kg_f_to_ug_d(2500000.0)
        ...
        let result8 = kg_f_to_ug_d(-323.0)
    ...
    func testkilogram_f_to_microgram_d1() {
        ...
        let result2 = kg_f_to_ug_d(-Float.greatestFiniteMagnitude)
        let expected2: microgram_d = microgram_d(-Float.greatestFiniteMagnitude) * 1000000000.0
        let tolerance2: microgram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = kg_f_to_ug_d(Float.greatestFiniteMagnitude)
        let expected3: microgram_d = microgram_d(Float.greatestFiniteMagnitude) * 1000000000.0
        let tolerance3: microgram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testkilogram_f_to_microgram_f() {
        ...
        let result2 = kg_f_to_ug_f(250.0)
        ...
        let result4 = kg_f_to_ug_f(2500.0)
        ...
        let result5 = kg_f_to_ug_f(25000.0)
        ...
        let result6 = kg_f_to_ug_f(250000.0)
        ...
        let result7 = kg_f_to_ug_f(2500000.0)
        ...
        let result8 = kg_f_to_ug_f(-323.0)
    ...
    func testkilogram_f_to_microgram_f1() {
        ...
        let result2 = kg_f_to_ug_f(-Float.greatestFiniteMagnitude)
        ...
        let result3 = kg_f_to_ug_f(Float.greatestFiniteMagnitude)
    ...
    func testkilogram_f_to_microgram_t() {
        ...
        XCTAssertEqual(kg_f_to_ug_t(-323.0), microgram_t((Float(-323.0) * 1000000000.0).rounded()))
        XCTAssertEqual(kg_f_to_ug_t(-10.0), microgram_t((Float(-10.0) * 1000000000.0).rounded()))
    }

    func testkilogram_f_to_microgram_t1() {
        XCTAssertEqual(kg_f_to_ug_t(-1000.0), microgram_t((Float(-1000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(kg_f_to_ug_t(-5.0), microgram_t((Float(-5.0) * 1000000000.0).rounded()))
        XCTAssertEqual(kg_f_to_ug_t(-Float.greatestFiniteMagnitude), microgram_t(Int64.min))
        XCTAssertEqual(kg_f_to_ug_t(Float.greatestFiniteMagnitude), microgram_t(Int64.max))
    }

    func testkilogram_f_to_microgram_u() {
        XCTAssertEqual(kg_f_to_ug_u(15.0), microgram_u((Float(15.0) * 1000000000.0).rounded()))
        XCTAssertEqual(kg_f_to_ug_u(25.0), microgram_u((Float(25.0) * 1000000000.0).rounded()))
        XCTAssertEqual(kg_f_to_ug_u(250.0), microgram_u((Float(250.0) * 1000000000.0).rounded()))
        XCTAssertEqual(kg_f_to_ug_u(0.0), microgram_u((Float(0.0) * 1000000000.0).rounded()))
        XCTAssertEqual(kg_f_to_ug_u(2500.0), microgram_u((Float(2500.0) * 1000000000.0).rounded()))
        XCTAssertEqual(kg_f_to_ug_u(25000.0), microgram_u((Float(25000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(kg_f_to_ug_u(250000.0), microgram_u((Float(250000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(kg_f_to_ug_u(2500000.0), microgram_u((Float(2500000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(kg_f_to_ug_u(-323.0), 0)
        XCTAssertEqual(kg_f_to_ug_u(-10.0), 0)
    }

    func testkilogram_f_to_microgram_u1() {
        XCTAssertEqual(kg_f_to_ug_u(-1000.0), 0)
        XCTAssertEqual(kg_f_to_ug_u(-6.0), 0)
        XCTAssertEqual(kg_f_to_ug_u(-Float.greatestFiniteMagnitude), microgram_u(UInt64.min))
        XCTAssertEqual(kg_f_to_ug_u(Float.greatestFiniteMagnitude), microgram_u(UInt64.max))
    }

    func testkilogram_f_to_milligram_d() {
    ...
    func testkilogram_f_to_milligram_d1() {
        ...
        let expected2: milligram_d = milligram_d(-Float.greatestFiniteMagnitude) * 1000000.0
        let tolerance2: milligram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: milligram_d = milligram_d(Float.greatestFiniteMagnitude) * 1000000.0
        let tolerance3: milligram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testkilogram_f_to_milligram_f() {
    ...
    func testkilogram_f_to_milligram_f1() {
    ...
    func testkilogram_f_to_milligram_t() {
    ...
    func testkilogram_f_to_milligram_t1() {
    ...
    func testkilogram_f_to_milligram_u() {
        XCTAssertEqual(kg_f_to_mg_u(15.0), milligram_u((Float(15.0) * 1000000.0).rounded()))
        XCTAssertEqual(kg_f_to_mg_u(25.0), milligram_u((Float(25.0) * 1000000.0).rounded()))
        XCTAssertEqual(kg_f_to_mg_u(250.0), milligram_u((Float(250.0) * 1000000.0).rounded()))
        XCTAssertEqual(kg_f_to_mg_u(0.0), milligram_u((Float(0.0) * 1000000.0).rounded()))
        XCTAssertEqual(kg_f_to_mg_u(2500.0), milligram_u((Float(2500.0) * 1000000.0).rounded()))
        XCTAssertEqual(kg_f_to_mg_u(25000.0), milligram_u((Float(25000.0) * 1000000.0).rounded()))
        XCTAssertEqual(kg_f_to_mg_u(250000.0), milligram_u((Float(250000.0) * 1000000.0).rounded()))
        XCTAssertEqual(kg_f_to_mg_u(2500000.0), milligram_u((Float(2500000.0) * 1000000.0).rounded()))
        XCTAssertEqual(kg_f_to_mg_u(-323.0), 0)
        XCTAssertEqual(kg_f_to_mg_u(-10.0), 0)
    }

    func testkilogram_f_to_milligram_u1() {
        XCTAssertEqual(kg_f_to_mg_u(-1000.0), 0)
        XCTAssertEqual(kg_f_to_mg_u(-6.0), 0)
        XCTAssertEqual(kg_f_to_mg_u(-Float.greatestFiniteMagnitude), milligram_u(UInt64.min))
        XCTAssertEqual(kg_f_to_mg_u(Float.greatestFiniteMagnitude), milligram_u(UInt64.max))
    }

    func testkilogram_f_to_uint16_t() {
        XCTAssertEqual(kg_f_to_u16(0.0), 0)
        XCTAssertEqual(kg_f_to_u16(5.0), 5)
        XCTAssertEqual(kg_f_to_u16(kilogram_f(-Float.greatestFiniteMagnitude)), UInt16(UInt16.min))
        XCTAssertEqual(kg_f_to_u16(kilogram_f(Float.greatestFiniteMagnitude)), UInt16(UInt16.max))
    }

    func testkilogram_f_to_uint32_t() {
        XCTAssertEqual(kg_f_to_u32(0.0), 0)
        XCTAssertEqual(kg_f_to_u32(5.0), 5)
        XCTAssertEqual(kg_f_to_u32(kilogram_f(-Float.greatestFiniteMagnitude)), UInt32(UInt32.min))
        XCTAssertEqual(kg_f_to_u32(kilogram_f(Float.greatestFiniteMagnitude)), UInt32(UInt32.max))
    }

    func testkilogram_f_to_uint64_t() {
        XCTAssertEqual(kg_f_to_u64(0.0), 0)
        XCTAssertEqual(kg_f_to_u64(5.0), 5)
        XCTAssertEqual(kg_f_to_u64(kilogram_f(-Float.greatestFiniteMagnitude)), UInt64(UInt64.min))
        XCTAssertEqual(kg_f_to_u64(kilogram_f(Float.greatestFiniteMagnitude)), UInt64(UInt64.max))
    }

    func testkilogram_f_to_uint8_t() {
        XCTAssertEqual(kg_f_to_u8(0.0), 0)
        XCTAssertEqual(kg_f_to_u8(5.0), 5)
        XCTAssertEqual(kg_f_to_u8(kilogram_f(-Float.greatestFiniteMagnitude)), UInt8(UInt8.min))
        XCTAssertEqual(kg_f_to_u8(kilogram_f(Float.greatestFiniteMagnitude)), UInt8(UInt8.max))
    }

    func testuint16_t_to_kilogram_f() {
        ...
        let result2 = u16_to_kg_f(UInt16(UInt16.min))
        let expected2: kilogram_f = kilogram_f(UInt16.min)
        ...
        let result3 = u16_to_kg_f(UInt16(UInt16.max))
        let expected3: kilogram_f = kilogram_f(UInt16.max)
    ...
    func testuint32_t_to_kilogram_f() {
        ...
        let result2 = u32_to_kg_f(UInt32(UInt32.min))
        let expected2: kilogram_f = kilogram_f(UInt32.min)
        let tolerance2: kilogram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u32_to_kg_f(UInt32(UInt32.max))
        let expected3: kilogram_f = kilogram_f(UInt32.max)
        let tolerance3: kilogram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint64_t_to_kilogram_f() {
        ...
        let result2 = u64_to_kg_f(UInt64(UInt64.min))
        let expected2: kilogram_f = kilogram_f(UInt64.min)
        let tolerance2: kilogram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u64_to_kg_f(UInt64(UInt64.max))
        let expected3: kilogram_f = kilogram_f(UInt64.max)
        let tolerance3: kilogram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint8_t_to_kilogram_f() {
        ...
        let result2 = u8_to_kg_f(UInt8(UInt8.min))
        let expected2: kilogram_f = kilogram_f(UInt8.min)
        let tolerance2: kilogram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u8_to_kg_f(UInt8(UInt8.max))
        let expected3: kilogram_f = kilogram_f(UInt8.max)
        let tolerance3: kilogram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
