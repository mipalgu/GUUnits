...
final class Time_Microseconds_fTests0: XCTestCase {
    ...
    func testdouble_to_microseconds_f() {
        ...
        let result2 = d_to_us_f(Double(-Double.greatestFiniteMagnitude))
        ...
        let result3 = d_to_us_f(Double(Double.greatestFiniteMagnitude))
    ...
    func testfloat_to_microseconds_f() {
        ...
        let result2 = f_to_us_f(Float(-Float.greatestFiniteMagnitude))
        let expected2: microseconds_f = microseconds_f(-Float.greatestFiniteMagnitude)
        let tolerance2: microseconds_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        ...
        let result3 = f_to_us_f(Float(Float.greatestFiniteMagnitude))
        let expected3: microseconds_f = microseconds_f(Float.greatestFiniteMagnitude)
        let tolerance3: microseconds_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
    ...
    func testint16_t_to_microseconds_f() {
        ...
        let result2 = i16_to_us_f(Int16(Int16.min))
        let expected2: microseconds_f = microseconds_f(Int16.min)
        let tolerance2: microseconds_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i16_to_us_f(Int16(Int16.max))
        let expected3: microseconds_f = microseconds_f(Int16.max)
        let tolerance3: microseconds_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint32_t_to_microseconds_f() {
        ...
        let result2 = i32_to_us_f(Int32(Int32.min))
        let expected2: microseconds_f = microseconds_f(Int32.min)
        let tolerance2: microseconds_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i32_to_us_f(Int32(Int32.max))
        let expected3: microseconds_f = microseconds_f(Int32.max)
        let tolerance3: microseconds_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint64_t_to_microseconds_f() {
        ...
        let result2 = i64_to_us_f(Int64(Int64.min))
        let expected2: microseconds_f = microseconds_f(Int64.min)
        let tolerance2: microseconds_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i64_to_us_f(Int64(Int64.max))
        let expected3: microseconds_f = microseconds_f(Int64.max)
        let tolerance3: microseconds_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint8_t_to_microseconds_f() {
        ...
        let result2 = i8_to_us_f(Int8(Int8.min))
        let expected2: microseconds_f = microseconds_f(Int8.min)
        let tolerance2: microseconds_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i8_to_us_f(Int8(Int8.max))
        let expected3: microseconds_f = microseconds_f(Int8.max)
        let tolerance3: microseconds_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmicroseconds_f_to_double() {
        ...
        let result2 = us_f_to_d(microseconds_f(-Float.greatestFiniteMagnitude))
        ...
        let result3 = us_f_to_d(microseconds_f(Float.greatestFiniteMagnitude))
    ...
    func testmicroseconds_f_to_float() {
        ...
        let result2 = us_f_to_f(microseconds_f(-Float.greatestFiniteMagnitude))
        ...
        let result3 = us_f_to_f(microseconds_f(Float.greatestFiniteMagnitude))
    ...
    func testmicroseconds_f_to_int16_t() {
    ...
    func testmicroseconds_f_to_int32_t() {
    ...
    func testmicroseconds_f_to_int64_t() {
    ...
    func testmicroseconds_f_to_int8_t() {
    ...
    func testmicroseconds_f_to_microseconds_d() {
        ...
        let result1 = us_f_to_us_d(microseconds_f(-Float.greatestFiniteMagnitude))
        let expected1: microseconds_d = microseconds_d(-Float.greatestFiniteMagnitude)
        ...
        let result2 = us_f_to_us_d(microseconds_f(Float.greatestFiniteMagnitude))
    ...
    func testmicroseconds_f_to_microseconds_t() {
    ...
    func testmicroseconds_f_to_microseconds_u() {
    ...
    func testmicroseconds_f_to_milliseconds_d() {
        ...
        let result2 = us_f_to_ms_d(250.0)
        ...
        let result4 = us_f_to_ms_d(2500.0)
        ...
        let result5 = us_f_to_ms_d(25000.0)
        ...
        let result6 = us_f_to_ms_d(250000.0)
        ...
        let result7 = us_f_to_ms_d(2500000.0)
        ...
        let result8 = us_f_to_ms_d(-323.0)
    ...
    func testmicroseconds_f_to_milliseconds_d1() {
        ...
        let result2 = us_f_to_ms_d(-Float.greatestFiniteMagnitude)
        let expected2: milliseconds_d = milliseconds_d(-Float.greatestFiniteMagnitude) / 1000.0
        let tolerance2: milliseconds_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = us_f_to_ms_d(Float.greatestFiniteMagnitude)
        let expected3: milliseconds_d = milliseconds_d(Float.greatestFiniteMagnitude) / 1000.0
        let tolerance3: milliseconds_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmicroseconds_f_to_milliseconds_f() {
        ...
        let result2 = us_f_to_ms_f(250.0)
        ...
        let result4 = us_f_to_ms_f(2500.0)
        ...
        let result5 = us_f_to_ms_f(25000.0)
        ...
        let result6 = us_f_to_ms_f(250000.0)
        ...
        let result7 = us_f_to_ms_f(2500000.0)
        ...
        let result8 = us_f_to_ms_f(-323.0)
    ...
    func testmicroseconds_f_to_milliseconds_f1() {
        ...
        let result2 = us_f_to_ms_f(-Float.greatestFiniteMagnitude)
        let expected2: milliseconds_f = milliseconds_f(-Float.greatestFiniteMagnitude) / 1000.0
        let tolerance2: milliseconds_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = us_f_to_ms_f(Float.greatestFiniteMagnitude)
        let expected3: milliseconds_f = milliseconds_f(Float.greatestFiniteMagnitude) / 1000.0
        let tolerance3: milliseconds_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmicroseconds_f_to_milliseconds_t() {
    ...
    func testmicroseconds_f_to_milliseconds_t1() {
    ...
    func testmicroseconds_f_to_milliseconds_u() {
    ...
    func testmicroseconds_f_to_milliseconds_u1() {
    ...
    func testmicroseconds_f_to_nanoseconds_d() {
        let result = us_f_to_ns_d(15.0)
        ...
        let result2 = us_f_to_ns_d(250.0)
        ...
        let result4 = us_f_to_ns_d(2500.0)
        ...
        let result5 = us_f_to_ns_d(25000.0)
        ...
        let result6 = us_f_to_ns_d(250000.0)
        ...
        let result7 = us_f_to_ns_d(2500000.0)
        ...
        let result8 = us_f_to_ns_d(-323.0)
    ...
    func testmicroseconds_f_to_nanoseconds_d1() {
        let result = us_f_to_ns_d(-1000.0)
        ...
        let result2 = us_f_to_ns_d(-Float.greatestFiniteMagnitude)
        ...
        let result3 = us_f_to_ns_d(Float.greatestFiniteMagnitude)
    ...
    func testmicroseconds_f_to_nanoseconds_f() {
        let result = us_f_to_ns_f(15.0)
        ...
        let result2 = us_f_to_ns_f(250.0)
        ...
        let result4 = us_f_to_ns_f(2500.0)
        ...
        let result5 = us_f_to_ns_f(25000.0)
        ...
        let result6 = us_f_to_ns_f(250000.0)
        ...
        let result7 = us_f_to_ns_f(2500000.0)
        ...
        let result8 = us_f_to_ns_f(-323.0)
    ...
    func testmicroseconds_f_to_nanoseconds_f1() {
        let result = us_f_to_ns_f(-1000.0)
        ...
        let result2 = us_f_to_ns_f(-Float.greatestFiniteMagnitude)
        ...
        let result3 = us_f_to_ns_f(Float.greatestFiniteMagnitude)
    ...
    func testmicroseconds_f_to_nanoseconds_t() {
        XCTAssertEqual(us_f_to_ns_t(15.0), nanoseconds_t((Float(15.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_t(25.0), nanoseconds_t((Float(25.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_t(250.0), nanoseconds_t((Float(250.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_t(0.0), nanoseconds_t((Float(0.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_t(2500.0), nanoseconds_t((Float(2500.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_t(25000.0), nanoseconds_t((Float(25000.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_t(250000.0), nanoseconds_t((Float(250000.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_t(2500000.0), nanoseconds_t((Float(2500000.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_t(-323.0), nanoseconds_t((Float(-323.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_t(-10.0), nanoseconds_t((Float(-10.0) * 1000.0).rounded()))
    }

    func testmicroseconds_f_to_nanoseconds_t1() {
        XCTAssertEqual(us_f_to_ns_t(-1000.0), nanoseconds_t((Float(-1000.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_t(-5.0), nanoseconds_t((Float(-5.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_t(-Float.greatestFiniteMagnitude), nanoseconds_t(Int64.min))
        XCTAssertEqual(us_f_to_ns_t(Float.greatestFiniteMagnitude), nanoseconds_t(Int64.max))
    }

    func testmicroseconds_f_to_nanoseconds_u() {
        XCTAssertEqual(us_f_to_ns_u(15.0), nanoseconds_u((Float(15.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_u(25.0), nanoseconds_u((Float(25.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_u(250.0), nanoseconds_u((Float(250.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_u(0.0), nanoseconds_u((Float(0.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_u(2500.0), nanoseconds_u((Float(2500.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_u(25000.0), nanoseconds_u((Float(25000.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_u(250000.0), nanoseconds_u((Float(250000.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_u(2500000.0), nanoseconds_u((Float(2500000.0) * 1000.0).rounded()))
        XCTAssertEqual(us_f_to_ns_u(-323.0), 0)
        XCTAssertEqual(us_f_to_ns_u(-10.0), 0)
    }
