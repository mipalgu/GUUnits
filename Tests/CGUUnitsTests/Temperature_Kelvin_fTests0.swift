...
final class Temperature_Kelvin_fTests0: XCTestCase {
    ...
    func testdouble_to_kelvin_f() {
        ...
        let result2 = d_to_K_f(Double(-Double.greatestFiniteMagnitude))
        ...
        let result3 = d_to_K_f(Double(Double.greatestFiniteMagnitude))
        let expected3: kelvin_f = kelvin_f(Float.greatestFiniteMagnitude)
    ...
    func testfloat_to_kelvin_f() {
        ...
        let result2 = f_to_K_f(Float(-Float.greatestFiniteMagnitude))
        let expected2: kelvin_f = kelvin_f(-Float.greatestFiniteMagnitude)
        let tolerance2: kelvin_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        ...
        let result3 = f_to_K_f(Float(Float.greatestFiniteMagnitude))
        let expected3: kelvin_f = kelvin_f(Float.greatestFiniteMagnitude)
        let tolerance3: kelvin_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
    ...
    func testint16_t_to_kelvin_f() {
        ...
        let result2 = i16_to_K_f(Int16(Int16.min))
        let expected2: kelvin_f = kelvin_f(Int16.min)
        let tolerance2: kelvin_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i16_to_K_f(Int16(Int16.max))
        let expected3: kelvin_f = kelvin_f(Int16.max)
        let tolerance3: kelvin_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint32_t_to_kelvin_f() {
        ...
        let result2 = i32_to_K_f(Int32(Int32.min))
        let expected2: kelvin_f = kelvin_f(Int32.min)
        let tolerance2: kelvin_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i32_to_K_f(Int32(Int32.max))
        let expected3: kelvin_f = kelvin_f(Int32.max)
        let tolerance3: kelvin_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint64_t_to_kelvin_f() {
        ...
        let result2 = i64_to_K_f(Int64(Int64.min))
        let expected2: kelvin_f = kelvin_f(Int64.min)
        let tolerance2: kelvin_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i64_to_K_f(Int64(Int64.max))
        let expected3: kelvin_f = kelvin_f(Int64.max)
        let tolerance3: kelvin_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint8_t_to_kelvin_f() {
        ...
        let result2 = i8_to_K_f(Int8(Int8.min))
        let expected2: kelvin_f = kelvin_f(Int8.min)
        let tolerance2: kelvin_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i8_to_K_f(Int8(Int8.max))
        let expected3: kelvin_f = kelvin_f(Int8.max)
        let tolerance3: kelvin_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testkelvin_f_to_celsius_d() {
        ...
        let result1 = K_f_to_degC_d(274.0)
        ...
        let result5 = K_f_to_degC_d(-300.0)
        ...
        let result6 = K_f_to_degC_d(-Float.greatestFiniteMagnitude)
        let expected6: celsius_d = celsius_d(-Float.greatestFiniteMagnitude) - 273.15
        ...
        let result7 = K_f_to_degC_d(Float.greatestFiniteMagnitude)
        let expected7: celsius_d = celsius_d(Float.greatestFiniteMagnitude) - 273.15
    ...
    func testkelvin_f_to_celsius_f() {
        ...
        let result1 = K_f_to_degC_f(274.0)
        ...
        let result5 = K_f_to_degC_f(-300.0)
        ...
        let result6 = K_f_to_degC_f(-Float.greatestFiniteMagnitude)
        ...
        let result7 = K_f_to_degC_f(Float.greatestFiniteMagnitude)
        let expected7: celsius_f = celsius_f(Float.greatestFiniteMagnitude) - 273.15
    ...
    func testkelvin_f_to_celsius_t() {
    ...
    func testkelvin_f_to_celsius_u() {
    ...
    func testkelvin_f_to_double() {
        ...
        let result2 = K_f_to_d(kelvin_f(-Float.greatestFiniteMagnitude))
        ...
        let result3 = K_f_to_d(kelvin_f(Float.greatestFiniteMagnitude))
    ...
    func testkelvin_f_to_fahrenheit_d() {
        ...
        let result1 = K_f_to_degF_d(2500.0)
        ...
        let result2 = K_f_to_degF_d(25000.0)
        ...
        let result3 = K_f_to_degF_d(250000.0)
        ...
        let result4 = K_f_to_degF_d(2500000.0)
        ...
        let result5 = K_f_to_degF_d(273.15)
        ...
        let result6 = K_f_to_degF_d(300.0)
        ...
        let result8 = K_f_to_degF_d(20.0)
        ...
        let result9 = K_f_to_degF_d(10.0)
    ...
    func testkelvin_f_to_fahrenheit_d1() {
        ...
        let result1 = K_f_to_degF_d(12.0)
        ...
        let result2 = K_f_to_degF_d(25.0)
        ...
        let result3 = K_f_to_degF_d(-250.0)
        ...
        let result4 = K_f_to_degF_d(-2500.0)
        ...
        let result5 = K_f_to_degF_d(-25000.0)
        ...
        let result6 = K_f_to_degF_d(-250000.0)
        ...
        let result7 = K_f_to_degF_d(-2500000.0)
        ...
        let result8 = K_f_to_degF_d(-40.0)
        ...
        let result9 = K_f_to_degF_d(-Float.greatestFiniteMagnitude)
        let expected9: fahrenheit_d = fahrenheit_d((Double(-Float.greatestFiniteMagnitude) - 273.15) * 1.8 + 32.0)
        let tolerance9: fahrenheit_d = 0.99
        if result9 > expected9 {
            XCTAssertLessThanOrEqual(result9 - expected9, tolerance9)
        } else {
    ...
    func testkelvin_f_to_fahrenheit_d2() {
    ...
    func testkelvin_f_to_fahrenheit_f() {
        ...
        let result1 = K_f_to_degF_f(2500.0)
        ...
        let result2 = K_f_to_degF_f(25000.0)
        ...
        let result3 = K_f_to_degF_f(250000.0)
        ...
        let result4 = K_f_to_degF_f(2500000.0)
        ...
        let result5 = K_f_to_degF_f(273.15)
        ...
        let result6 = K_f_to_degF_f(300.0)
        ...
        let result8 = K_f_to_degF_f(20.0)
        ...
        let result9 = K_f_to_degF_f(10.0)
    ...
    func testkelvin_f_to_fahrenheit_f1() {
        ...
        let result1 = K_f_to_degF_f(12.0)
        ...
        let result2 = K_f_to_degF_f(25.0)
        ...
        let result3 = K_f_to_degF_f(-250.0)
        ...
        let result4 = K_f_to_degF_f(-2500.0)
        ...
        let result5 = K_f_to_degF_f(-25000.0)
        ...
        let result6 = K_f_to_degF_f(-250000.0)
        ...
        let result7 = K_f_to_degF_f(-2500000.0)
        ...
        let result8 = K_f_to_degF_f(-40.0)
        ...
        let result9 = K_f_to_degF_f(-Float.greatestFiniteMagnitude)
    ...
    func testkelvin_f_to_fahrenheit_f2() {
    ...
    func testkelvin_f_to_fahrenheit_t() {
    ...
    func testkelvin_f_to_fahrenheit_t1() {
    ...
    func testkelvin_f_to_fahrenheit_u1() {
    ...
    func testkelvin_f_to_float() {
        ...
        let result2 = K_f_to_f(kelvin_f(-Float.greatestFiniteMagnitude))
        ...
        let result3 = K_f_to_f(kelvin_f(Float.greatestFiniteMagnitude))
    ...
    func testkelvin_f_to_kelvin_d() {
        ...
        let result1 = K_f_to_K_d(kelvin_f(-Float.greatestFiniteMagnitude))
        let expected1: kelvin_d = kelvin_d(-Float.greatestFiniteMagnitude)
        ...
        let result2 = K_f_to_K_d(kelvin_f(Float.greatestFiniteMagnitude))
