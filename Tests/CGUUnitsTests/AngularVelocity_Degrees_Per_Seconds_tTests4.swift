...
final class AngularVelocity_Degrees_Per_Seconds_tTests4: XCTestCase {
    ...
    func testdegrees_per_seconds_tToradians_per_seconds_dUsingInt64_maxExpectingradians_per_seconds_dDouble_greatestFiniteMagnitude() {
        let result = deg_per_s_t_to_rad_per_s_d(Int64.max)
    ...
    func testdegrees_per_seconds_tToradians_per_seconds_dUsingInt64_minExpectingradians_per_seconds_dNegDouble_greatestFiniteMagnitude() {
        let result = deg_per_s_t_to_rad_per_s_d(Int64.min)
        let expected: radians_per_seconds_d = radians_per_seconds_d(-Double.greatestFiniteMagnitude)
        let tolerance: radians_per_seconds_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
    ...
    func testdegrees_per_seconds_tToradians_per_seconds_fUsing0Expectingradians_per_seconds_fDouble0Double3_141592653589793Double180() {
        let result = deg_per_s_t_to_rad_per_s_f(0)
    ...
    func testdegrees_per_seconds_tToradians_per_seconds_fUsingInt64_maxExpectingradians_per_seconds_fFloat_greatestFiniteMagnitude() {
        let result = deg_per_s_t_to_rad_per_s_f(Int64.max)
    ...
    func testdegrees_per_seconds_tToradians_per_seconds_fUsingInt64_minExpectingradians_per_seconds_fNegFloat_greatestFiniteMagnitude() {
        let result = deg_per_s_t_to_rad_per_s_f(Int64.min)
        let expected: radians_per_seconds_f = radians_per_seconds_f(-Float.greatestFiniteMagnitude)
        let tolerance: radians_per_seconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
