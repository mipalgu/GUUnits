...
final class Mass_Milligram_tTests5: XCTestCase {

    func testmilligram_tTokilogram_uUsing25000Expectingkilogram_u250001000000() {
        XCTAssertEqual(mg_t_to_kg_u(25000), kilogram_u(25000) / 1000000)
    }

    func testmilligram_tTokilogram_uUsing2500Expectingkilogram_u25001000000() {
        XCTAssertEqual(mg_t_to_kg_u(2500), kilogram_u(2500) / 1000000)
    }

    func testmilligram_tTokilogram_uUsing250Expectingkilogram_u2501000000() {
    ...
    func testmilligram_tTokilogram_uUsingInt64_maxExpectingkilogram_uInt64_max1000000() {
        XCTAssertEqual(mg_t_to_kg_u(Int64.max), kilogram_u(Int64.max) / 1000000)
    }

    func testmilligram_tTokilogram_uUsingInt64_minExpecting0() {
        XCTAssertEqual(mg_t_to_kg_u(Int64.min), 0)
    }

    func testmilligram_tTokilogram_uUsingNeg1000Expecting0() {
        XCTAssertEqual(mg_t_to_kg_u(-1000), 0)
    }

    func testmilligram_tTokilogram_uUsingNeg10Expecting0() {
        XCTAssertEqual(mg_t_to_kg_u(-10), 0)
    }

    func testmilligram_tTokilogram_uUsingNeg323Expecting0() {
        XCTAssertEqual(mg_t_to_kg_u(-323), 0)
    }

    func testmilligram_tTokilogram_uUsingNeg6Expecting0() {
        XCTAssertEqual(mg_t_to_kg_u(-6), 0)
    }

    func testmilligram_tTomegagram_dUsing0Expectingmegagram_d0_01000000000_0() {
    ...
    func testmilligram_tTomegagram_dUsing15Expectingmegagram_d15_01000000000_0() {
    ...
    func testmilligram_tTomegagram_dUsing2500000Expectingmegagram_d2500000_01000000000_0() {
    ...
    func testmilligram_tTomegagram_dUsing250000Expectingmegagram_d250000_01000000000_0() {
    ...
    func testmilligram_tTomegagram_dUsing25000Expectingmegagram_d25000_01000000000_0() {
    ...
    func testmilligram_tTomegagram_dUsing2500Expectingmegagram_d2500_01000000000_0() {
    ...
    func testmilligram_tTomegagram_dUsing250Expectingmegagram_d250_01000000000_0() {
    ...
    func testmilligram_tTomegagram_dUsing25Expectingmegagram_d25_01000000000_0() {
    ...
    func testmilligram_tTomegagram_dUsingInt64_maxExpectingmegagram_dInt64_max1000000000_0() {
        let result = mg_t_to_Mg_d(Int64.max)
        let expected: megagram_d = megagram_d(Int64.max) / 1000000000.0
        let tolerance: megagram_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmilligram_tTomegagram_dUsingInt64_minExpectingmegagram_dInt64_min1000000000_0() {
        let result = mg_t_to_Mg_d(Int64.min)
        let expected: megagram_d = megagram_d(Int64.min) / 1000000000.0
        let tolerance: megagram_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmilligram_tTomegagram_dUsingNeg1000Expectingmegagram_dNeg1000_01000000000_0() {
    ...
    func testmilligram_tTomegagram_dUsingNeg10Expectingmegagram_dNeg10_01000000000_0() {
    ...
    func testmilligram_tTomegagram_dUsingNeg323Expectingmegagram_dNeg323_01000000000_0() {
    ...
    func testmilligram_tTomegagram_dUsingNeg5Expectingmegagram_dNeg5_01000000000_0() {
