...
final class Time_Seconds_dTests0: XCTestCase {
    ...
    func testseconds_d_to_nanoseconds_d() {
        let result = s_d_to_ns_d(15.0)
        ...
        let result4 = s_d_to_ns_d(2500.0)
        ...
        let result5 = s_d_to_ns_d(25000.0)
        ...
        let result6 = s_d_to_ns_d(250000.0)
        ...
        let result7 = s_d_to_ns_d(2500000.0)
    ...
    func testseconds_d_to_nanoseconds_d1() {
        let result = s_d_to_ns_d(-1000.0)
        ...
        let result2 = s_d_to_ns_d(-Double.greatestFiniteMagnitude)
        ...
        let result3 = s_d_to_ns_d(Double.greatestFiniteMagnitude)
