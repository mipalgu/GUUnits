...
final class Mass_Megagram_fTests1: XCTestCase {

    func testmegagram_f_to_megagram_u() {
    ...
    func testmegagram_f_to_microgram_d() {
        ...
        let result2 = Mg_f_to_ug_d(250.0)
        ...
        let result4 = Mg_f_to_ug_d(2500.0)
        ...
        let result5 = Mg_f_to_ug_d(25000.0)
        ...
        let result6 = Mg_f_to_ug_d(250000.0)
        ...
        let result7 = Mg_f_to_ug_d(2500000.0)
        ...
        let result8 = Mg_f_to_ug_d(-323.0)
    ...
    func testmegagram_f_to_microgram_d1() {
        let result = Mg_f_to_ug_d(-1000.0)
        ...
        let result2 = Mg_f_to_ug_d(-Float.greatestFiniteMagnitude)
        let expected2: microgram_d = microgram_d(-Float.greatestFiniteMagnitude) * 1000000000000.0
        let tolerance2: microgram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = Mg_f_to_ug_d(Float.greatestFiniteMagnitude)
        let expected3: microgram_d = microgram_d(Float.greatestFiniteMagnitude) * 1000000000000.0
        let tolerance3: microgram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmegagram_f_to_microgram_f() {
        let result = Mg_f_to_ug_f(15.0)
        ...
        let result2 = Mg_f_to_ug_f(250.0)
        ...
        let result4 = Mg_f_to_ug_f(2500.0)
        ...
        let result5 = Mg_f_to_ug_f(25000.0)
        ...
        let result6 = Mg_f_to_ug_f(250000.0)
        ...
        let result7 = Mg_f_to_ug_f(2500000.0)
        ...
        let result8 = Mg_f_to_ug_f(-323.0)
    ...
    func testmegagram_f_to_microgram_f1() {
        let result = Mg_f_to_ug_f(-1000.0)
        ...
        let result2 = Mg_f_to_ug_f(-Float.greatestFiniteMagnitude)
        ...
        let result3 = Mg_f_to_ug_f(Float.greatestFiniteMagnitude)
    ...
    func testmegagram_f_to_microgram_t() {
        XCTAssertEqual(Mg_f_to_ug_t(15.0), microgram_t((Float(15.0) * 1000000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_ug_t(25.0), microgram_t((Float(25.0) * 1000000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_ug_t(250.0), microgram_t((Float(250.0) * 1000000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_ug_t(0.0), microgram_t((Float(0.0) * 1000000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_ug_t(2500.0), microgram_t((Float(2500.0) * 1000000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_ug_t(25000.0), microgram_t((Float(25000.0) * 1000000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_ug_t(250000.0), microgram_t((Float(250000.0) * 1000000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_ug_t(2500000.0), microgram_t((Float(2500000.0) * 1000000000000.0).rounded()))
    ...
    func testmegagram_f_to_microgram_t1() {
        XCTAssertEqual(Mg_f_to_ug_t(-1000.0), microgram_t((Float(-1000.0) * 1000000000000.0).rounded()))
    ...
    func testmegagram_f_to_microgram_u() {
    ...
    func testmegagram_f_to_microgram_u1() {
    ...
    func testmegagram_f_to_milligram_d() {
    ...
    func testmegagram_f_to_milligram_d1() {
        ...
        let expected2: milligram_d = milligram_d(-Float.greatestFiniteMagnitude) * 1000000000.0
        let tolerance2: milligram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: milligram_d = milligram_d(Float.greatestFiniteMagnitude) * 1000000000.0
        let tolerance3: milligram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmegagram_f_to_milligram_f() {
        let result = Mg_f_to_mg_f(15.0)
        ...
        let result2 = Mg_f_to_mg_f(250.0)
        ...
        let result4 = Mg_f_to_mg_f(2500.0)
        ...
        let result5 = Mg_f_to_mg_f(25000.0)
        ...
        let result6 = Mg_f_to_mg_f(250000.0)
        ...
        let result7 = Mg_f_to_mg_f(2500000.0)
        ...
        let result8 = Mg_f_to_mg_f(-323.0)
    ...
    func testmegagram_f_to_milligram_f1() {
        let result = Mg_f_to_mg_f(-1000.0)
        ...
        let result2 = Mg_f_to_mg_f(-Float.greatestFiniteMagnitude)
        ...
        let result3 = Mg_f_to_mg_f(Float.greatestFiniteMagnitude)
    ...
    func testmegagram_f_to_milligram_t() {
        XCTAssertEqual(Mg_f_to_mg_t(15.0), milligram_t((Float(15.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_mg_t(25.0), milligram_t((Float(25.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_mg_t(250.0), milligram_t((Float(250.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_mg_t(0.0), milligram_t((Float(0.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_mg_t(2500.0), milligram_t((Float(2500.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_mg_t(25000.0), milligram_t((Float(25000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_mg_t(250000.0), milligram_t((Float(250000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_mg_t(2500000.0), milligram_t((Float(2500000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_mg_t(-323.0), milligram_t((Float(-323.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_mg_t(-10.0), milligram_t((Float(-10.0) * 1000000000.0).rounded()))
    }

    func testmegagram_f_to_milligram_t1() {
        XCTAssertEqual(Mg_f_to_mg_t(-1000.0), milligram_t((Float(-1000.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_mg_t(-5.0), milligram_t((Float(-5.0) * 1000000000.0).rounded()))
        XCTAssertEqual(Mg_f_to_mg_t(-Float.greatestFiniteMagnitude), milligram_t(Int64.min))
        XCTAssertEqual(Mg_f_to_mg_t(Float.greatestFiniteMagnitude), milligram_t(Int64.max))
    }

    func testmegagram_f_to_milligram_u() {
    ...
    func testmegagram_f_to_milligram_u1() {
    ...
    func testmegagram_f_to_uint16_t() {
    ...
    func testmegagram_f_to_uint32_t() {
    ...
    func testmegagram_f_to_uint64_t() {
    ...
    func testmegagram_f_to_uint8_t() {
    ...
    func testuint16_t_to_megagram_f() {
        ...
        let result2 = u16_to_Mg_f(UInt16(UInt16.min))
        let expected2: megagram_f = megagram_f(UInt16.min)
        ...
        let result3 = u16_to_Mg_f(UInt16(UInt16.max))
        let expected3: megagram_f = megagram_f(UInt16.max)
    ...
    func testuint32_t_to_megagram_f() {
        ...
        let result2 = u32_to_Mg_f(UInt32(UInt32.min))
        let expected2: megagram_f = megagram_f(UInt32.min)
        let tolerance2: megagram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u32_to_Mg_f(UInt32(UInt32.max))
        let expected3: megagram_f = megagram_f(UInt32.max)
        let tolerance3: megagram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint64_t_to_megagram_f() {
        ...
        let result2 = u64_to_Mg_f(UInt64(UInt64.min))
        let expected2: megagram_f = megagram_f(UInt64.min)
        let tolerance2: megagram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u64_to_Mg_f(UInt64(UInt64.max))
        let expected3: megagram_f = megagram_f(UInt64.max)
        let tolerance3: megagram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint8_t_to_megagram_f() {
        ...
        let result2 = u8_to_Mg_f(UInt8(UInt8.min))
        let expected2: megagram_f = megagram_f(UInt8.min)
        let tolerance2: megagram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u8_to_Mg_f(UInt8(UInt8.max))
        let expected3: megagram_f = megagram_f(UInt8.max)
        let tolerance3: megagram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
