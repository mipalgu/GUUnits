...
final class Mass_Megagram_fTests1: XCTestCase {
    ...
    func testmegagram_fTofloatUsingmegagram_fFloat_greatestFiniteMagnitudeExpectingFloatFloat_greatestFiniteMagnitude() {
        let result = Mg_f_to_f(megagram_f(Float.greatestFiniteMagnitude))
    ...
    func testmegagram_fTofloatUsingmegagram_fNegFloat_greatestFiniteMagnitudeExpectingFloatNegFloat_greatestFiniteMagnitude() {
        let result = Mg_f_to_f(megagram_f(-Float.greatestFiniteMagnitude))
        let expected: Float = Float(-Float.greatestFiniteMagnitude)
        let tolerance: Float = 0.99
        if result > expected {
    ...
    func testmegagram_fTogram_dUsing0_0Expectinggram_d0_01000000_0() {
    ...
    func testmegagram_fTogram_dUsing15_0Expectinggram_d15_01000000_0() {
    ...
    func testmegagram_fTogram_dUsing2500000_0Expectinggram_d2500000_01000000_0() {
    ...
    func testmegagram_fTogram_dUsing250000_0Expectinggram_d250000_01000000_0() {
    ...
    func testmegagram_fTogram_dUsing25000_0Expectinggram_d25000_01000000_0() {
    ...
    func testmegagram_fTogram_dUsing2500_0Expectinggram_d2500_01000000_0() {
    ...
    func testmegagram_fTogram_dUsing250_0Expectinggram_d250_01000000_0() {
    ...
    func testmegagram_fTogram_dUsing25_0Expectinggram_d25_01000000_0() {
    ...
    func testmegagram_fTogram_dUsingFloat_greatestFiniteMagnitudeExpectinggram_dFloat_greatestFiniteMagnitude1000000_0() {
    ...
    func testmegagram_fTogram_dUsingNeg1000_0Expectinggram_dNeg1000_01000000_0() {
    ...
    func testmegagram_fTogram_dUsingNeg10_0Expectinggram_dNeg10_01000000_0() {
    ...
    func testmegagram_fTogram_dUsingNeg323_0Expectinggram_dNeg323_01000000_0() {
    ...
    func testmegagram_fTogram_dUsingNeg5_0Expectinggram_dNeg5_01000000_0() {
    ...
    func testmegagram_fTogram_dUsingNegFloat_greatestFiniteMagnitudeExpectinggram_dNegFloat_greatestFiniteMagnitude1000000_0() {
        let result = Mg_f_to_g_d(-Float.greatestFiniteMagnitude)
        let expected: gram_d = gram_d(-Float.greatestFiniteMagnitude) * 1000000.0
        let tolerance: gram_d = 0.99
        if result > expected {
