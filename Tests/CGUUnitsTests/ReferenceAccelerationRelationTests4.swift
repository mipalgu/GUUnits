...
final class ReferenceAccelerationRelationTests4: XCTestCase {
    ...
    func testearthG_dTocentimetres_per_seconds_sq_tUsingNeg5000000Expectingcentimetres_per_seconds_sq_tDouble9_80665DoubleNeg5000000Double100_roundedDoubleInt64_max_nextDownInt64_maxDouble9_80665DoubleNeg5000000Double100_roundedDoubleInt64_min_nextUpInt64_minInt64Double9_80665DoubleNeg5000000Double100_rounded() {
    ...
    func testearthG_dTocentimetres_per_seconds_sq_tUsing0Expectingcentimetres_per_seconds_sq_tDouble9_80665Double0Double100_roundedDoubleInt64_max_nextDownInt64_maxDouble9_80665Double0Double100_roundedDoubleInt64_min_nextUpInt64_minInt64Double9_80665Double0Double100_rounded() {
    ...
    func testearthG_dTocentimetres_per_seconds_sq_tUsing5000000Expectingcentimetres_per_seconds_sq_tDouble9_80665Double5000000Double100_roundedDoubleInt64_max_nextDownInt64_maxDouble9_80665Double5000000Double100_roundedDoubleInt64_min_nextUpInt64_minInt64Double9_80665Double5000000Double100_rounded() {
        XCTAssertEqual(gs_d_to_cm_per_s_sq_t(5000000), centimetres_per_seconds_sq_t(((((Double(9.80665)) * (Double(5000000))) * (Double(100))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : ((((((Double(9.80665)) * (Double(5000000))) * (Double(100))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64((((Double(9.80665)) * (Double(5000000))) * (Double(100))).rounded()))))
    }
