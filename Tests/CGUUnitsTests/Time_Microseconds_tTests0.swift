...
final class Time_Microseconds_tTests0: XCTestCase {
    ...
    func testmicroseconds_t_to_nanoseconds_d() {
        let result = us_t_to_ns_d(15)
        ...
        let result5 = us_t_to_ns_d(25000)
        ...
        let result6 = us_t_to_ns_d(250000)
        ...
        let result7 = us_t_to_ns_d(2500000)
    ...
    func testmicroseconds_t_to_nanoseconds_d1() {
        let result = us_t_to_ns_d(-1000)
        ...
        let result2 = us_t_to_ns_d(Int64.min)
        ...
        let result3 = us_t_to_ns_d(Int64.max)
    ...
    func testmicroseconds_t_to_nanoseconds_f() {
        let result = us_t_to_ns_f(15)
        ...
        let result5 = us_t_to_ns_f(25000)
        ...
        let result6 = us_t_to_ns_f(250000)
        ...
        let result7 = us_t_to_ns_f(2500000)
    ...
    func testmicroseconds_t_to_nanoseconds_f1() {
        let result = us_t_to_ns_f(-1000)
        ...
        let result2 = us_t_to_ns_f(Int64.min)
        ...
        let result3 = us_t_to_ns_f(Int64.max)
    ...
    func testmicroseconds_t_to_nanoseconds_t() {
        XCTAssertEqual(us_t_to_ns_t(15), nanoseconds_t(15) * 1000)
        XCTAssertEqual(us_t_to_ns_t(25), nanoseconds_t(25) * 1000)
        XCTAssertEqual(us_t_to_ns_t(250), nanoseconds_t(250) * 1000)
        XCTAssertEqual(us_t_to_ns_t(0), nanoseconds_t(0) * 1000)
        XCTAssertEqual(us_t_to_ns_t(2500), nanoseconds_t(2500) * 1000)
        XCTAssertEqual(us_t_to_ns_t(25000), nanoseconds_t(25000) * 1000)
        XCTAssertEqual(us_t_to_ns_t(250000), nanoseconds_t(250000) * 1000)
        XCTAssertEqual(us_t_to_ns_t(2500000), nanoseconds_t(2500000) * 1000)
        XCTAssertEqual(us_t_to_ns_t(-323), nanoseconds_t(-323) * 1000)
        XCTAssertEqual(us_t_to_ns_t(-10), nanoseconds_t(-10) * 1000)
    }

    func testmicroseconds_t_to_nanoseconds_t1() {
        XCTAssertEqual(us_t_to_ns_t(-1000), nanoseconds_t(-1000) * 1000)
        XCTAssertEqual(us_t_to_ns_t(-5), nanoseconds_t(-5) * 1000)
        XCTAssertEqual(us_t_to_ns_t(Int64.min), nanoseconds_t(Int64.min))
        XCTAssertEqual(us_t_to_ns_t(Int64.max), nanoseconds_t(Int64.max))
    }

    func testmicroseconds_t_to_nanoseconds_u() {
        XCTAssertEqual(us_t_to_ns_u(15), nanoseconds_u(15) * 1000)
        XCTAssertEqual(us_t_to_ns_u(25), nanoseconds_u(25) * 1000)
        XCTAssertEqual(us_t_to_ns_u(250), nanoseconds_u(250) * 1000)
        XCTAssertEqual(us_t_to_ns_u(0), nanoseconds_u(0) * 1000)
        XCTAssertEqual(us_t_to_ns_u(2500), nanoseconds_u(2500) * 1000)
        XCTAssertEqual(us_t_to_ns_u(25000), nanoseconds_u(25000) * 1000)
        XCTAssertEqual(us_t_to_ns_u(250000), nanoseconds_u(250000) * 1000)
        XCTAssertEqual(us_t_to_ns_u(2500000), nanoseconds_u(2500000) * 1000)
        XCTAssertEqual(us_t_to_ns_u(-323), 0)
        XCTAssertEqual(us_t_to_ns_u(-10), 0)
    }
