...
final class Acceleration_Millimetres_Per_Microseconds_Sq_tTests0: XCTestCase {

    func testdouble_to_millimetres_per_microseconds_sq_t() {
        XCTAssertEqual(d_to_mm_per_us_sq_t(0.0), 0)
        XCTAssertEqual(d_to_mm_per_us_sq_t(5.0), 5)
        XCTAssertEqual(d_to_mm_per_us_sq_t(Double(-Double.greatestFiniteMagnitude)), millimetres_per_microseconds_sq_t(Int64.min))
        XCTAssertEqual(d_to_mm_per_us_sq_t(Double(Double.greatestFiniteMagnitude)), millimetres_per_microseconds_sq_t(Int64.max))
    }

    func testfloat_to_millimetres_per_microseconds_sq_t() {
        XCTAssertEqual(f_to_mm_per_us_sq_t(0.0), 0)
        XCTAssertEqual(f_to_mm_per_us_sq_t(5.0), 5)
        XCTAssertEqual(f_to_mm_per_us_sq_t(Float(-Float.greatestFiniteMagnitude)), millimetres_per_microseconds_sq_t(Int64.min))
        XCTAssertEqual(f_to_mm_per_us_sq_t(Float(Float.greatestFiniteMagnitude)), millimetres_per_microseconds_sq_t(Int64.max))
    }

    func testint16_t_to_millimetres_per_microseconds_sq_t() {
        XCTAssertEqual(i16_to_mm_per_us_sq_t(0), 0)
        XCTAssertEqual(i16_to_mm_per_us_sq_t(5), 5)
        XCTAssertEqual(i16_to_mm_per_us_sq_t(Int16(Int16.min)), millimetres_per_microseconds_sq_t(Int16.min))
        XCTAssertEqual(i16_to_mm_per_us_sq_t(Int16(Int16.max)), millimetres_per_microseconds_sq_t(Int16.max))
    }

    func testint32_t_to_millimetres_per_microseconds_sq_t() {
        XCTAssertEqual(i32_to_mm_per_us_sq_t(0), 0)
        XCTAssertEqual(i32_to_mm_per_us_sq_t(5), 5)
        XCTAssertEqual(i32_to_mm_per_us_sq_t(Int32(Int32.min)), millimetres_per_microseconds_sq_t(Int32.min))
        XCTAssertEqual(i32_to_mm_per_us_sq_t(Int32(Int32.max)), millimetres_per_microseconds_sq_t(Int32.max))
    }

    func testint64_t_to_millimetres_per_microseconds_sq_t() {
        XCTAssertEqual(i64_to_mm_per_us_sq_t(0), 0)
        XCTAssertEqual(i64_to_mm_per_us_sq_t(5), 5)
        XCTAssertEqual(i64_to_mm_per_us_sq_t(Int64(Int64.min)), millimetres_per_microseconds_sq_t(Int64.min))
        XCTAssertEqual(i64_to_mm_per_us_sq_t(Int64(Int64.max)), millimetres_per_microseconds_sq_t(Int64.max))
    }

    func testint8_t_to_millimetres_per_microseconds_sq_t() {
        XCTAssertEqual(i8_to_mm_per_us_sq_t(0), 0)
        XCTAssertEqual(i8_to_mm_per_us_sq_t(5), 5)
        XCTAssertEqual(i8_to_mm_per_us_sq_t(Int8(Int8.min)), millimetres_per_microseconds_sq_t(Int8.min))
        XCTAssertEqual(i8_to_mm_per_us_sq_t(Int8(Int8.max)), millimetres_per_microseconds_sq_t(Int8.max))
    }

    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_microseconds_sq_d() {
        let result = mm_per_us_sq_t_to_cm_per_us_sq_d(-5000000)
        ...
        let result1 = mm_per_us_sq_t_to_cm_per_us_sq_d(0)
        ...
        let result2 = mm_per_us_sq_t_to_cm_per_us_sq_d(5000000)
        ...
        let result3 = mm_per_us_sq_t_to_cm_per_us_sq_d(Int64.min)
        ...
        let result4 = mm_per_us_sq_t_to_cm_per_us_sq_d(Int64.max)
    ...
    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_microseconds_sq_f() {
        let result = mm_per_us_sq_t_to_cm_per_us_sq_f(-5000000)
        ...
        let result1 = mm_per_us_sq_t_to_cm_per_us_sq_f(0)
        ...
        let result2 = mm_per_us_sq_t_to_cm_per_us_sq_f(5000000)
        ...
        let result3 = mm_per_us_sq_t_to_cm_per_us_sq_f(Int64.min)
        ...
        let result4 = mm_per_us_sq_t_to_cm_per_us_sq_f(Int64.max)
    ...
    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_microseconds_sq_t() {
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_us_sq_t(-5000000), centimetres_per_microseconds_sq_t((((Double(-5000000)) / (Double(10))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) / (Double(10))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) / (Double(10))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_us_sq_t(0), centimetres_per_microseconds_sq_t((((Double(0)) / (Double(10))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) / (Double(10))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) / (Double(10))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_us_sq_t(5000000), centimetres_per_microseconds_sq_t((((Double(5000000)) / (Double(10))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) / (Double(10))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) / (Double(10))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_us_sq_t(Int64.min), centimetres_per_microseconds_sq_t(Int64.min))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_us_sq_t(Int64.max), centimetres_per_microseconds_sq_t(Int64.max))
    }

    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_microseconds_sq_u() {
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_us_sq_u(-5000000), centimetres_per_microseconds_sq_u((((Double(-5000000)) / (Double(10))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) / (Double(10))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) / (Double(10))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_us_sq_u(0), centimetres_per_microseconds_sq_u((((Double(0)) / (Double(10))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) / (Double(10))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) / (Double(10))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_us_sq_u(5000000), centimetres_per_microseconds_sq_u((((Double(5000000)) / (Double(10))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) / (Double(10))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) / (Double(10))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_us_sq_u(Int64.min), centimetres_per_microseconds_sq_u(UInt64.min))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_us_sq_u(Int64.max), centimetres_per_microseconds_sq_u(UInt64.max))
    }

    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_milliseconds_sq_d() {
        let result = mm_per_us_sq_t_to_cm_per_ms_sq_d(-5000000)
        ...
        let result1 = mm_per_us_sq_t_to_cm_per_ms_sq_d(0)
        ...
        let result2 = mm_per_us_sq_t_to_cm_per_ms_sq_d(5000000)
        ...
        let result3 = mm_per_us_sq_t_to_cm_per_ms_sq_d(Int64.min)
        ...
        let result4 = mm_per_us_sq_t_to_cm_per_ms_sq_d(Int64.max)
    ...
    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_milliseconds_sq_f() {
        let result = mm_per_us_sq_t_to_cm_per_ms_sq_f(-5000000)
        ...
        let result1 = mm_per_us_sq_t_to_cm_per_ms_sq_f(0)
        ...
        let result2 = mm_per_us_sq_t_to_cm_per_ms_sq_f(5000000)
        ...
        let result3 = mm_per_us_sq_t_to_cm_per_ms_sq_f(Int64.min)
        ...
        let result4 = mm_per_us_sq_t_to_cm_per_ms_sq_f(Int64.max)
    ...
    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_milliseconds_sq_u() {
        ...
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ms_sq_u(5000000), centimetres_per_milliseconds_sq_u((((Double(5000000)) * (((Double(1)) / (Double(10))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(10))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(1)) / (Double(10))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ms_sq_u(Int64.min), centimetres_per_milliseconds_sq_u(UInt64.min))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ms_sq_u(Int64.max), centimetres_per_milliseconds_sq_u(UInt64.max))
    }

    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_nanoseconds_sq_d() {
        let result = mm_per_us_sq_t_to_cm_per_ns_sq_d(-5000000)
        ...
        let result1 = mm_per_us_sq_t_to_cm_per_ns_sq_d(0)
        ...
        let result2 = mm_per_us_sq_t_to_cm_per_ns_sq_d(5000000)
        ...
        let result3 = mm_per_us_sq_t_to_cm_per_ns_sq_d(Int64.min)
        ...
        let result4 = mm_per_us_sq_t_to_cm_per_ns_sq_d(Int64.max)
    ...
    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_nanoseconds_sq_f() {
        let result = mm_per_us_sq_t_to_cm_per_ns_sq_f(-5000000)
        ...
        let result1 = mm_per_us_sq_t_to_cm_per_ns_sq_f(0)
        ...
        let result2 = mm_per_us_sq_t_to_cm_per_ns_sq_f(5000000)
        ...
        let result3 = mm_per_us_sq_t_to_cm_per_ns_sq_f(Int64.min)
        ...
        let result4 = mm_per_us_sq_t_to_cm_per_ns_sq_f(Int64.max)
    ...
    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_nanoseconds_sq_t() {
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ns_sq_t(-5000000), centimetres_per_nanoseconds_sq_t((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ns_sq_t(0), centimetres_per_nanoseconds_sq_t((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ns_sq_t(5000000), centimetres_per_nanoseconds_sq_t((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ns_sq_t(Int64.min), centimetres_per_nanoseconds_sq_t(Int64.min))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ns_sq_t(Int64.max), centimetres_per_nanoseconds_sq_t(Int64.max))
    }

    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_nanoseconds_sq_u() {
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ns_sq_u(-5000000), centimetres_per_nanoseconds_sq_u((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ns_sq_u(0), centimetres_per_nanoseconds_sq_u((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ns_sq_u(5000000), centimetres_per_nanoseconds_sq_u((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000)) * (Double(1000))))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ns_sq_u(Int64.min), centimetres_per_nanoseconds_sq_u(UInt64.min))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ns_sq_u(Int64.max), centimetres_per_nanoseconds_sq_u(UInt64.max))
    }

    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_picoseconds_sq_d() {
        let result = mm_per_us_sq_t_to_cm_per_ps_sq_d(-5000000)
        ...
        let result1 = mm_per_us_sq_t_to_cm_per_ps_sq_d(0)
        ...
        let result2 = mm_per_us_sq_t_to_cm_per_ps_sq_d(5000000)
        ...
        let result3 = mm_per_us_sq_t_to_cm_per_ps_sq_d(Int64.min)
        ...
        let result4 = mm_per_us_sq_t_to_cm_per_ps_sq_d(Int64.max)
    ...
    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_picoseconds_sq_f() {
        let result = mm_per_us_sq_t_to_cm_per_ps_sq_f(-5000000)
        ...
        let result1 = mm_per_us_sq_t_to_cm_per_ps_sq_f(0)
        ...
        let result2 = mm_per_us_sq_t_to_cm_per_ps_sq_f(5000000)
        ...
        let result3 = mm_per_us_sq_t_to_cm_per_ps_sq_f(Int64.min)
        ...
        let result4 = mm_per_us_sq_t_to_cm_per_ps_sq_f(Int64.max)
    ...
    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_picoseconds_sq_t() {
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ps_sq_t(-5000000), centimetres_per_picoseconds_sq_t((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ps_sq_t(0), centimetres_per_picoseconds_sq_t((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ps_sq_t(5000000), centimetres_per_picoseconds_sq_t((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ps_sq_t(Int64.min), centimetres_per_picoseconds_sq_t(Int64.min))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ps_sq_t(Int64.max), centimetres_per_picoseconds_sq_t(Int64.max))
    }

    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_picoseconds_sq_u() {
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ps_sq_u(-5000000), centimetres_per_picoseconds_sq_u((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ps_sq_u(0), centimetres_per_picoseconds_sq_u((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ps_sq_u(5000000), centimetres_per_picoseconds_sq_u((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000)) * (Double(1000000))))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ps_sq_u(Int64.min), centimetres_per_picoseconds_sq_u(UInt64.min))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_ps_sq_u(Int64.max), centimetres_per_picoseconds_sq_u(UInt64.max))
    }

    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_seconds_sq_d() {
        let result = mm_per_us_sq_t_to_cm_per_s_sq_d(-5000000)
        ...
        let result1 = mm_per_us_sq_t_to_cm_per_s_sq_d(0)
        ...
        let result2 = mm_per_us_sq_t_to_cm_per_s_sq_d(5000000)
        ...
        let result3 = mm_per_us_sq_t_to_cm_per_s_sq_d(Int64.min)
        ...
        let result4 = mm_per_us_sq_t_to_cm_per_s_sq_d(Int64.max)
    ...
    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_seconds_sq_f() {
        let result = mm_per_us_sq_t_to_cm_per_s_sq_f(-5000000)
        ...
        let result1 = mm_per_us_sq_t_to_cm_per_s_sq_f(0)
        ...
        let result2 = mm_per_us_sq_t_to_cm_per_s_sq_f(5000000)
        ...
        let result3 = mm_per_us_sq_t_to_cm_per_s_sq_f(Int64.min)
        ...
        let result4 = mm_per_us_sq_t_to_cm_per_s_sq_f(Int64.max)
    ...
    func testmillimetres_per_microseconds_sq_t_to_centimetres_per_seconds_sq_u() {
        ...
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_s_sq_u(5000000), centimetres_per_seconds_sq_u((((Double(5000000)) * (((Double(1)) / (Double(10))) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(10))) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(1)) / (Double(10))) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()))))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_s_sq_u(Int64.min), centimetres_per_seconds_sq_u(UInt64.min))
        XCTAssertEqual(mm_per_us_sq_t_to_cm_per_s_sq_u(Int64.max), centimetres_per_seconds_sq_u(UInt64.max))
    }

    func testmillimetres_per_microseconds_sq_t_to_double() {
        let result = mm_per_us_sq_t_to_d(0)
        ...
        let result1 = mm_per_us_sq_t_to_d(5)
        ...
        let result2 = mm_per_us_sq_t_to_d(millimetres_per_microseconds_sq_t(Int64.min))
        ...
        let result3 = mm_per_us_sq_t_to_d(millimetres_per_microseconds_sq_t(Int64.max))
    ...
    func testmillimetres_per_microseconds_sq_t_to_float() {
        let result = mm_per_us_sq_t_to_f(0)
        ...
        let result1 = mm_per_us_sq_t_to_f(5)
        ...
        let result2 = mm_per_us_sq_t_to_f(millimetres_per_microseconds_sq_t(Int64.min))
        ...
        let result3 = mm_per_us_sq_t_to_f(millimetres_per_microseconds_sq_t(Int64.max))
    ...
    func testmillimetres_per_microseconds_sq_t_to_int16_t() {
    ...
    func testmillimetres_per_microseconds_sq_t_to_int32_t() {
