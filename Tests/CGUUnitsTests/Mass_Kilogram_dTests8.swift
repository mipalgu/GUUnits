...
final class Mass_Kilogram_dTests8: XCTestCase {
    ...
    func testkilogram_dTomilligram_fUsing0_0Expectingmilligram_f0_01000000_0() {
    ...
    func testkilogram_dTomilligram_fUsing15_0Expectingmilligram_f15_01000000_0() {
    ...
    func testkilogram_dTomilligram_fUsing2500000_0Expectingmilligram_f2500000_01000000_0() {
    ...
    func testkilogram_dTomilligram_fUsing250000_0Expectingmilligram_f250000_01000000_0() {
    ...
    func testkilogram_dTomilligram_fUsing25000_0Expectingmilligram_f25000_01000000_0() {
    ...
    func testkilogram_dTomilligram_fUsing2500_0Expectingmilligram_f2500_01000000_0() {
    ...
    func testkilogram_dTomilligram_fUsing250_0Expectingmilligram_f250_01000000_0() {
    ...
    func testkilogram_dTomilligram_fUsing25_0Expectingmilligram_f25_01000000_0() {
    ...
    func testkilogram_dTomilligram_fUsingDouble_greatestFiniteMagnitudeExpectingmilligram_fFloat_greatestFiniteMagnitude() {
    ...
    func testkilogram_dTomilligram_fUsingNeg1000_0Expectingmilligram_fNeg1000_01000000_0() {
    ...
    func testkilogram_dTomilligram_fUsingNeg10_0Expectingmilligram_fNeg10_01000000_0() {
    ...
    func testkilogram_dTomilligram_fUsingNeg323_0Expectingmilligram_fNeg323_01000000_0() {
    ...
    func testkilogram_dTomilligram_fUsingNeg5_0Expectingmilligram_fNeg5_01000000_0() {
    ...
    func testkilogram_dTomilligram_fUsingNegDouble_greatestFiniteMagnitudeExpectingmilligram_fNegFloat_greatestFiniteMagnitude() {
        let result = kg_d_to_mg_f(-Double.greatestFiniteMagnitude)
        let expected: milligram_f = milligram_f(-Float.greatestFiniteMagnitude)
        let tolerance: milligram_f = 0.99
        if result > expected {
    ...
    func testkilogram_dTomilligram_tUsing0_0Expectingmilligram_tDouble0_01000000_0_rounded() {
        XCTAssertEqual(kg_d_to_mg_t(0.0), milligram_t((Double(0.0) * 1000000.0).rounded()))
    }

    func testkilogram_dTomilligram_tUsing15_0Expectingmilligram_tDouble15_01000000_0_rounded() {
        XCTAssertEqual(kg_d_to_mg_t(15.0), milligram_t((Double(15.0) * 1000000.0).rounded()))
    }

    func testkilogram_dTomilligram_tUsing2500000_0Expectingmilligram_tDouble2500000_01000000_0_rounded() {
        XCTAssertEqual(kg_d_to_mg_t(2500000.0), milligram_t((Double(2500000.0) * 1000000.0).rounded()))
    }

    func testkilogram_dTomilligram_tUsing250000_0Expectingmilligram_tDouble250000_01000000_0_rounded() {
        XCTAssertEqual(kg_d_to_mg_t(250000.0), milligram_t((Double(250000.0) * 1000000.0).rounded()))
    }

    func testkilogram_dTomilligram_tUsing25000_0Expectingmilligram_tDouble25000_01000000_0_rounded() {
        XCTAssertEqual(kg_d_to_mg_t(25000.0), milligram_t((Double(25000.0) * 1000000.0).rounded()))
    }

    func testkilogram_dTomilligram_tUsing2500_0Expectingmilligram_tDouble2500_01000000_0_rounded() {
        XCTAssertEqual(kg_d_to_mg_t(2500.0), milligram_t((Double(2500.0) * 1000000.0).rounded()))
    }

    func testkilogram_dTomilligram_tUsing250_0Expectingmilligram_tDouble250_01000000_0_rounded() {
        XCTAssertEqual(kg_d_to_mg_t(250.0), milligram_t((Double(250.0) * 1000000.0).rounded()))
    }

    func testkilogram_dTomilligram_tUsing25_0Expectingmilligram_tDouble25_01000000_0_rounded() {
        XCTAssertEqual(kg_d_to_mg_t(25.0), milligram_t((Double(25.0) * 1000000.0).rounded()))
    }

    func testkilogram_dTomilligram_tUsingDouble_greatestFiniteMagnitudeExpectingmilligram_tInt64_max() {
        XCTAssertEqual(kg_d_to_mg_t(Double.greatestFiniteMagnitude), milligram_t(Int64.max))
    }

    func testkilogram_dTomilligram_tUsingNeg1000_0Expectingmilligram_tDoubleNeg1000_01000000_0_rounded() {
        XCTAssertEqual(kg_d_to_mg_t(-1000.0), milligram_t((Double(-1000.0) * 1000000.0).rounded()))
    }

    func testkilogram_dTomilligram_tUsingNeg10_0Expectingmilligram_tDoubleNeg10_01000000_0_rounded() {
        XCTAssertEqual(kg_d_to_mg_t(-10.0), milligram_t((Double(-10.0) * 1000000.0).rounded()))
    }

    func testkilogram_dTomilligram_tUsingNeg323_0Expectingmilligram_tDoubleNeg323_01000000_0_rounded() {
        XCTAssertEqual(kg_d_to_mg_t(-323.0), milligram_t((Double(-323.0) * 1000000.0).rounded()))
    }

    func testkilogram_dTomilligram_tUsingNeg5_0Expectingmilligram_tDoubleNeg5_01000000_0_rounded() {
        XCTAssertEqual(kg_d_to_mg_t(-5.0), milligram_t((Double(-5.0) * 1000000.0).rounded()))
    }

    func testkilogram_dTomilligram_tUsingNegDouble_greatestFiniteMagnitudeExpectingmilligram_tInt64_min() {
