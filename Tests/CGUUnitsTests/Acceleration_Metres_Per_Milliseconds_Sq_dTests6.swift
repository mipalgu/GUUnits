...
final class Acceleration_Metres_Per_Milliseconds_Sq_dTests6: XCTestCase {
    ...
    func testmetres_per_milliseconds_sq_dTomillimetres_per_milliseconds_sq_dUsing0Expectingmillimetres_per_milliseconds_sq_dDouble0Double1000() {
        let result = m_per_ms_sq_d_to_mm_per_ms_sq_d(0)
    ...
    func testmetres_per_milliseconds_sq_dTomillimetres_per_milliseconds_sq_dUsingDouble_greatestFiniteMagnitudeExpectingmillimetres_per_milliseconds_sq_dDouble_greatestFiniteMagnitude() {
        let result = m_per_ms_sq_d_to_mm_per_ms_sq_d(Double.greatestFiniteMagnitude)
    ...
    func testmetres_per_milliseconds_sq_dTomillimetres_per_milliseconds_sq_fUsing0Expectingmillimetres_per_milliseconds_sq_fDouble0Double1000() {
        let result = m_per_ms_sq_d_to_mm_per_ms_sq_f(0)
    ...
    func testmetres_per_milliseconds_sq_dTomillimetres_per_milliseconds_sq_fUsingDouble_greatestFiniteMagnitudeExpectingmillimetres_per_milliseconds_sq_fFloat_greatestFiniteMagnitude() {
        let result = m_per_ms_sq_d_to_mm_per_ms_sq_f(Double.greatestFiniteMagnitude)
    ...
    func testmetres_per_milliseconds_sq_dTomillimetres_per_seconds_sq_dUsing0Expectingmillimetres_per_seconds_sq_dDouble0Double1000Double1Double1000Double1Double1000() {
        let result = m_per_ms_sq_d_to_mm_per_s_sq_d(0)
    ...
    func testmetres_per_milliseconds_sq_dTomillimetres_per_seconds_sq_dUsingDouble_greatestFiniteMagnitudeExpectingmillimetres_per_seconds_sq_dDouble_greatestFiniteMagnitude() {
        let result = m_per_ms_sq_d_to_mm_per_s_sq_d(Double.greatestFiniteMagnitude)
    ...
    func testmetres_per_milliseconds_sq_dTomillimetres_per_seconds_sq_fUsing0Expectingmillimetres_per_seconds_sq_fDouble0Double1000Double1Double1000Double1Double1000() {
        let result = m_per_ms_sq_d_to_mm_per_s_sq_f(0)
