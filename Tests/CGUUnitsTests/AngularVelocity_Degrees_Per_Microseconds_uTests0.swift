...
final class AngularVelocity_Degrees_Per_Microseconds_uTests0: XCTestCase {
    ...
    func testdegrees_per_microseconds_u_to_degrees_per_nanoseconds_d() {
        let result = deg_per_us_u_to_deg_per_ns_d(0)
        ...
        let result1 = deg_per_us_u_to_deg_per_ns_d(5000000)
        ...
        let result2 = deg_per_us_u_to_deg_per_ns_d(UInt64.min)
        ...
        let result3 = deg_per_us_u_to_deg_per_ns_d(UInt64.max)
    ...
    func testdegrees_per_microseconds_u_to_degrees_per_nanoseconds_f() {
        let result = deg_per_us_u_to_deg_per_ns_f(0)
        ...
        let result1 = deg_per_us_u_to_deg_per_ns_f(5000000)
        ...
        let result2 = deg_per_us_u_to_deg_per_ns_f(UInt64.min)
        ...
        let result3 = deg_per_us_u_to_deg_per_ns_f(UInt64.max)
    ...
    func testdegrees_per_microseconds_u_to_degrees_per_nanoseconds_t() {
        XCTAssertEqual(deg_per_us_u_to_deg_per_ns_t(0), degrees_per_nanoseconds_t(Int64(clamping: (UInt64(0)) / (UInt64(1000)))))
        XCTAssertEqual(deg_per_us_u_to_deg_per_ns_t(5000000), degrees_per_nanoseconds_t(Int64(clamping: (UInt64(5000000)) / (UInt64(1000)))))
        XCTAssertEqual(deg_per_us_u_to_deg_per_ns_t(UInt64.min), degrees_per_nanoseconds_t((UInt64(UInt64.min)) / (UInt64(1000))))
        XCTAssertEqual(deg_per_us_u_to_deg_per_ns_t(UInt64.max), degrees_per_nanoseconds_t(Int64.max))
    }

    func testdegrees_per_microseconds_u_to_degrees_per_nanoseconds_u() {
        XCTAssertEqual(deg_per_us_u_to_deg_per_ns_u(0), degrees_per_nanoseconds_u(UInt64(clamping: (UInt64(0)) / (UInt64(1000)))))
        XCTAssertEqual(deg_per_us_u_to_deg_per_ns_u(5000000), degrees_per_nanoseconds_u(UInt64(clamping: (UInt64(5000000)) / (UInt64(1000)))))
        XCTAssertEqual(deg_per_us_u_to_deg_per_ns_u(UInt64.min), degrees_per_nanoseconds_u((UInt64(UInt64.min)) / (UInt64(1000))))
        XCTAssertEqual(deg_per_us_u_to_deg_per_ns_u(UInt64.max), degrees_per_nanoseconds_u(UInt64.max))
    }

    func testdegrees_per_microseconds_u_to_degrees_per_picoseconds_d() {
        let result = deg_per_us_u_to_deg_per_ps_d(0)
        let expected: degrees_per_picoseconds_d = degrees_per_picoseconds_d((Double(0)) / (Double(1000000)))
        ...
        let result1 = deg_per_us_u_to_deg_per_ps_d(5000000)
        let expected1: degrees_per_picoseconds_d = degrees_per_picoseconds_d((Double(5000000)) / (Double(1000000)))
        ...
        let result2 = deg_per_us_u_to_deg_per_ps_d(UInt64.min)
        let expected2: degrees_per_picoseconds_d = degrees_per_picoseconds_d(((Double(UInt64.min)) / (Double(1000000))).rounded())
        ...
        let result3 = deg_per_us_u_to_deg_per_ps_d(UInt64.max)
    ...
    func testdegrees_per_microseconds_u_to_degrees_per_picoseconds_f() {
        let result = deg_per_us_u_to_deg_per_ps_f(0)
        let expected: degrees_per_picoseconds_f = degrees_per_picoseconds_f((Double(0)) / (Double(1000000)))
        ...
        let result1 = deg_per_us_u_to_deg_per_ps_f(5000000)
        let expected1: degrees_per_picoseconds_f = degrees_per_picoseconds_f((Double(5000000)) / (Double(1000000)))
        ...
        let result2 = deg_per_us_u_to_deg_per_ps_f(UInt64.min)
        let expected2: degrees_per_picoseconds_f = degrees_per_picoseconds_f(((Double(UInt64.min)) / (Double(1000000))).rounded())
        ...
        let result3 = deg_per_us_u_to_deg_per_ps_f(UInt64.max)
    ...
    func testdegrees_per_microseconds_u_to_degrees_per_picoseconds_t() {
        XCTAssertEqual(deg_per_us_u_to_deg_per_ps_t(0), degrees_per_picoseconds_t(Int64(clamping: (UInt64(0)) / (UInt64(1000000)))))
        XCTAssertEqual(deg_per_us_u_to_deg_per_ps_t(5000000), degrees_per_picoseconds_t(Int64(clamping: (UInt64(5000000)) / (UInt64(1000000)))))
        XCTAssertEqual(deg_per_us_u_to_deg_per_ps_t(UInt64.min), degrees_per_picoseconds_t((UInt64(UInt64.min)) / (UInt64(1000000))))
        XCTAssertEqual(deg_per_us_u_to_deg_per_ps_t(UInt64.max), degrees_per_picoseconds_t(Int64.max))
    }

    func testdegrees_per_microseconds_u_to_degrees_per_picoseconds_u() {
        XCTAssertEqual(deg_per_us_u_to_deg_per_ps_u(0), degrees_per_picoseconds_u(UInt64(clamping: (UInt64(0)) / (UInt64(1000000)))))
        XCTAssertEqual(deg_per_us_u_to_deg_per_ps_u(5000000), degrees_per_picoseconds_u(UInt64(clamping: (UInt64(5000000)) / (UInt64(1000000)))))
        XCTAssertEqual(deg_per_us_u_to_deg_per_ps_u(UInt64.min), degrees_per_picoseconds_u((UInt64(UInt64.min)) / (UInt64(1000000))))
        XCTAssertEqual(deg_per_us_u_to_deg_per_ps_u(UInt64.max), degrees_per_picoseconds_u(UInt64.max))
    }
