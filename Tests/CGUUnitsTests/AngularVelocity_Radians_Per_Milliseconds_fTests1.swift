...
final class AngularVelocity_Radians_Per_Milliseconds_fTests1: XCTestCase {
    ...
    func testradians_per_milliseconds_f_to_int64_t() {
        XCTAssertEqual(rad_per_ms_f_to_i64(0.0), 0)
        XCTAssertEqual(rad_per_ms_f_to_i64(5.0), 5)
        XCTAssertEqual(rad_per_ms_f_to_i64(radians_per_milliseconds_f(-Float.greatestFiniteMagnitude)), Int64(Int64.min))
        XCTAssertEqual(rad_per_ms_f_to_i64(radians_per_milliseconds_f(Float.greatestFiniteMagnitude)), Int64(Int64.max))
    }

    func testradians_per_milliseconds_f_to_int8_t() {
        XCTAssertEqual(rad_per_ms_f_to_i8(0.0), 0)
        XCTAssertEqual(rad_per_ms_f_to_i8(5.0), 5)
        XCTAssertEqual(rad_per_ms_f_to_i8(radians_per_milliseconds_f(-Float.greatestFiniteMagnitude)), Int8(Int8.min))
        XCTAssertEqual(rad_per_ms_f_to_i8(radians_per_milliseconds_f(Float.greatestFiniteMagnitude)), Int8(Int8.max))
    }

    func testradians_per_milliseconds_f_to_radians_per_microseconds_d() {
        let result = rad_per_ms_f_to_rad_per_us_d(-5000000)
        ...
        let result1 = rad_per_ms_f_to_rad_per_us_d(0)
        ...
        let result2 = rad_per_ms_f_to_rad_per_us_d(5000000)
        ...
        let result3 = rad_per_ms_f_to_rad_per_us_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = rad_per_ms_f_to_rad_per_us_d(Float.greatestFiniteMagnitude)
    ...
    func testradians_per_milliseconds_f_to_radians_per_microseconds_f() {
        let result = rad_per_ms_f_to_rad_per_us_f(-5000000)
        ...
        let result1 = rad_per_ms_f_to_rad_per_us_f(0)
        ...
        let result2 = rad_per_ms_f_to_rad_per_us_f(5000000)
        ...
        let result3 = rad_per_ms_f_to_rad_per_us_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = rad_per_ms_f_to_rad_per_us_f(Float.greatestFiniteMagnitude)
    ...
    func testradians_per_milliseconds_f_to_radians_per_microseconds_t() {
        XCTAssertEqual(rad_per_ms_f_to_rad_per_us_t(-5000000), radians_per_microseconds_t((((Double(-5000000)) / (Double(1000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) / (Double(1000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) / (Double(1000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_us_t(0), radians_per_microseconds_t((((Double(0)) / (Double(1000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) / (Double(1000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) / (Double(1000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_us_t(5000000), radians_per_microseconds_t((((Double(5000000)) / (Double(1000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) / (Double(1000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) / (Double(1000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_us_t(-Float.greatestFiniteMagnitude), radians_per_microseconds_t(Int64.min))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_us_t(Float.greatestFiniteMagnitude), radians_per_microseconds_t(Int64.max))
    }

    func testradians_per_milliseconds_f_to_radians_per_microseconds_u() {
        XCTAssertEqual(rad_per_ms_f_to_rad_per_us_u(-5000000), radians_per_microseconds_u((((Double(-5000000)) / (Double(1000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) / (Double(1000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) / (Double(1000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_us_u(0), radians_per_microseconds_u((((Double(0)) / (Double(1000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) / (Double(1000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) / (Double(1000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_us_u(5000000), radians_per_microseconds_u((((Double(5000000)) / (Double(1000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) / (Double(1000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) / (Double(1000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_us_u(-Float.greatestFiniteMagnitude), radians_per_microseconds_u(UInt64.min))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_us_u(Float.greatestFiniteMagnitude), radians_per_microseconds_u(UInt64.max))
    }

    func testradians_per_milliseconds_f_to_radians_per_milliseconds_d() {
        let result = rad_per_ms_f_to_rad_per_ms_d(-5000000)
        ...
        let result1 = rad_per_ms_f_to_rad_per_ms_d(0)
        ...
        let result2 = rad_per_ms_f_to_rad_per_ms_d(5000000)
        ...
        let result3 = rad_per_ms_f_to_rad_per_ms_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = rad_per_ms_f_to_rad_per_ms_d(Float.greatestFiniteMagnitude)
    ...
    func testradians_per_milliseconds_f_to_radians_per_milliseconds_t() {
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ms_t(-5000000), radians_per_milliseconds_t(((Double(-5000000)).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : ((((Double(-5000000)).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64((Double(-5000000)).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ms_t(0), radians_per_milliseconds_t(((Double(0)).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : ((((Double(0)).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64((Double(0)).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ms_t(5000000), radians_per_milliseconds_t(((Double(5000000)).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : ((((Double(5000000)).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64((Double(5000000)).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ms_t(-Float.greatestFiniteMagnitude), radians_per_milliseconds_t(Int64.min))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ms_t(Float.greatestFiniteMagnitude), radians_per_milliseconds_t(Int64.max))
    }
    ...
    func testradians_per_milliseconds_f_to_radians_per_nanoseconds_d() {
        let result = rad_per_ms_f_to_rad_per_ns_d(-5000000)
        ...
        let result1 = rad_per_ms_f_to_rad_per_ns_d(0)
        ...
        let result2 = rad_per_ms_f_to_rad_per_ns_d(5000000)
        ...
        let result3 = rad_per_ms_f_to_rad_per_ns_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = rad_per_ms_f_to_rad_per_ns_d(Float.greatestFiniteMagnitude)
    ...
    func testradians_per_milliseconds_f_to_radians_per_nanoseconds_f() {
        let result = rad_per_ms_f_to_rad_per_ns_f(-5000000)
        ...
        let result1 = rad_per_ms_f_to_rad_per_ns_f(0)
        ...
        let result2 = rad_per_ms_f_to_rad_per_ns_f(5000000)
        ...
        let result3 = rad_per_ms_f_to_rad_per_ns_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = rad_per_ms_f_to_rad_per_ns_f(Float.greatestFiniteMagnitude)
    ...
    func testradians_per_milliseconds_f_to_radians_per_nanoseconds_t() {
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ns_t(-5000000), radians_per_nanoseconds_t((((Double(-5000000)) / (Double(1000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) / (Double(1000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) / (Double(1000000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ns_t(0), radians_per_nanoseconds_t((((Double(0)) / (Double(1000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) / (Double(1000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) / (Double(1000000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ns_t(5000000), radians_per_nanoseconds_t((((Double(5000000)) / (Double(1000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) / (Double(1000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) / (Double(1000000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ns_t(-Float.greatestFiniteMagnitude), radians_per_nanoseconds_t(Int64.min))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ns_t(Float.greatestFiniteMagnitude), radians_per_nanoseconds_t(Int64.max))
    }

    func testradians_per_milliseconds_f_to_radians_per_nanoseconds_u() {
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ns_u(-5000000), radians_per_nanoseconds_u((((Double(-5000000)) / (Double(1000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) / (Double(1000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) / (Double(1000000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ns_u(0), radians_per_nanoseconds_u((((Double(0)) / (Double(1000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) / (Double(1000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) / (Double(1000000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ns_u(5000000), radians_per_nanoseconds_u((((Double(5000000)) / (Double(1000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) / (Double(1000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) / (Double(1000000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ns_u(-Float.greatestFiniteMagnitude), radians_per_nanoseconds_u(UInt64.min))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ns_u(Float.greatestFiniteMagnitude), radians_per_nanoseconds_u(UInt64.max))
    }

    func testradians_per_milliseconds_f_to_radians_per_picoseconds_d() {
        let result = rad_per_ms_f_to_rad_per_ps_d(-5000000)
        ...
        let result1 = rad_per_ms_f_to_rad_per_ps_d(0)
        ...
        let result2 = rad_per_ms_f_to_rad_per_ps_d(5000000)
        ...
        let result3 = rad_per_ms_f_to_rad_per_ps_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = rad_per_ms_f_to_rad_per_ps_d(Float.greatestFiniteMagnitude)
    ...
    func testradians_per_milliseconds_f_to_radians_per_picoseconds_f() {
        let result = rad_per_ms_f_to_rad_per_ps_f(-5000000)
        ...
        let result1 = rad_per_ms_f_to_rad_per_ps_f(0)
        ...
        let result2 = rad_per_ms_f_to_rad_per_ps_f(5000000)
        ...
        let result3 = rad_per_ms_f_to_rad_per_ps_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = rad_per_ms_f_to_rad_per_ps_f(Float.greatestFiniteMagnitude)
    ...
    func testradians_per_milliseconds_f_to_radians_per_picoseconds_t() {
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ps_t(-5000000), radians_per_picoseconds_t((((Double(-5000000)) / (Double(1000000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) / (Double(1000000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ps_t(0), radians_per_picoseconds_t((((Double(0)) / (Double(1000000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) / (Double(1000000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ps_t(5000000), radians_per_picoseconds_t((((Double(5000000)) / (Double(1000000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) / (Double(1000000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ps_t(-Float.greatestFiniteMagnitude), radians_per_picoseconds_t(Int64.min))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ps_t(Float.greatestFiniteMagnitude), radians_per_picoseconds_t(Int64.max))
    }

    func testradians_per_milliseconds_f_to_radians_per_picoseconds_u() {
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ps_u(-5000000), radians_per_picoseconds_u((((Double(-5000000)) / (Double(1000000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) / (Double(1000000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ps_u(0), radians_per_picoseconds_u((((Double(0)) / (Double(1000000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) / (Double(1000000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ps_u(5000000), radians_per_picoseconds_u((((Double(5000000)) / (Double(1000000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) / (Double(1000000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ps_u(-Float.greatestFiniteMagnitude), radians_per_picoseconds_u(UInt64.min))
        XCTAssertEqual(rad_per_ms_f_to_rad_per_ps_u(Float.greatestFiniteMagnitude), radians_per_picoseconds_u(UInt64.max))
    }
