...
final class Time_Microseconds_tTests4: XCTestCase {
    ...
    func testmicroseconds_tToseconds_dUsingInt64_maxExpectingseconds_dInt64_max1000000_0() {
        let result = us_t_to_s_d(Int64.max)
        let expected: seconds_d = seconds_d(Int64.max) / 1000000.0
        let tolerance: seconds_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmicroseconds_tToseconds_dUsingInt64_minExpectingseconds_dInt64_min1000000_0() {
        let result = us_t_to_s_d(Int64.min)
        let expected: seconds_d = seconds_d(Int64.min) / 1000000.0
        let tolerance: seconds_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmicroseconds_tToseconds_fUsingInt64_maxExpectingseconds_fInt64_max1000000_0() {
        let result = us_t_to_s_f(Int64.max)
        let expected: seconds_f = seconds_f(Int64.max) / 1000000.0
        let tolerance: seconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmicroseconds_tToseconds_fUsingInt64_minExpectingseconds_fInt64_min1000000_0() {
        let result = us_t_to_s_f(Int64.min)
        let expected: seconds_f = seconds_f(Int64.min) / 1000000.0
        let tolerance: seconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
