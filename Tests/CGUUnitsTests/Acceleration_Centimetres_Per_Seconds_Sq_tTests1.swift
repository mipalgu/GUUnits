...
final class Acceleration_Centimetres_Per_Seconds_Sq_tTests1: XCTestCase {
    ...
    func testcentimetres_per_seconds_sq_t_to_millimetres_per_seconds_sq_d() {
        ...
        let result1 = cm_per_s_sq_t_to_mm_per_s_sq_d(0)
        ...
        let result2 = cm_per_s_sq_t_to_mm_per_s_sq_d(5000000)
        ...
        let result3 = cm_per_s_sq_t_to_mm_per_s_sq_d(Int64.min)
        ...
        let result4 = cm_per_s_sq_t_to_mm_per_s_sq_d(Int64.max)
    ...
    func testcentimetres_per_seconds_sq_t_to_millimetres_per_seconds_sq_f() {
        ...
        let result1 = cm_per_s_sq_t_to_mm_per_s_sq_f(0)
        ...
        let result2 = cm_per_s_sq_t_to_mm_per_s_sq_f(5000000)
        ...
        let result3 = cm_per_s_sq_t_to_mm_per_s_sq_f(Int64.min)
        ...
        let result4 = cm_per_s_sq_t_to_mm_per_s_sq_f(Int64.max)
    ...
    func testcentimetres_per_seconds_sq_t_to_millimetres_per_seconds_sq_t() {
    ...
    func testcentimetres_per_seconds_sq_t_to_millimetres_per_seconds_sq_u() {
    ...
    func testcentimetres_per_seconds_sq_t_to_uint16_t() {
    ...
    func testcentimetres_per_seconds_sq_t_to_uint32_t() {
    ...
    func testcentimetres_per_seconds_sq_t_to_uint64_t() {
    ...
    func testcentimetres_per_seconds_sq_t_to_uint8_t() {
    ...
    func testdouble_to_centimetres_per_seconds_sq_t() {
    ...
    func testfloat_to_centimetres_per_seconds_sq_t() {
    ...
    func testint16_t_to_centimetres_per_seconds_sq_t() {
    ...
    func testint32_t_to_centimetres_per_seconds_sq_t() {
    ...
    func testint64_t_to_centimetres_per_seconds_sq_t() {
    ...
    func testint8_t_to_centimetres_per_seconds_sq_t() {
    ...
    func testuint16_t_to_centimetres_per_seconds_sq_t() {
        XCTAssertEqual(u16_to_cm_per_s_sq_t(0), 0)
        XCTAssertEqual(u16_to_cm_per_s_sq_t(5), 5)
        XCTAssertEqual(u16_to_cm_per_s_sq_t(UInt16(UInt16.min)), centimetres_per_seconds_sq_t(UInt16.min))
        XCTAssertEqual(u16_to_cm_per_s_sq_t(UInt16(UInt16.max)), centimetres_per_seconds_sq_t(UInt16.max))
    }

    func testuint32_t_to_centimetres_per_seconds_sq_t() {
        XCTAssertEqual(u32_to_cm_per_s_sq_t(0), 0)
        XCTAssertEqual(u32_to_cm_per_s_sq_t(5), 5)
        XCTAssertEqual(u32_to_cm_per_s_sq_t(UInt32(UInt32.min)), centimetres_per_seconds_sq_t(UInt32.min))
        XCTAssertEqual(u32_to_cm_per_s_sq_t(UInt32(UInt32.max)), centimetres_per_seconds_sq_t(UInt32.max))
    }

    func testuint64_t_to_centimetres_per_seconds_sq_t() {
        XCTAssertEqual(u64_to_cm_per_s_sq_t(0), 0)
        XCTAssertEqual(u64_to_cm_per_s_sq_t(5), 5)
        XCTAssertEqual(u64_to_cm_per_s_sq_t(UInt64(UInt64.min)), centimetres_per_seconds_sq_t(UInt64.min))
        XCTAssertEqual(u64_to_cm_per_s_sq_t(UInt64(UInt64.max)), centimetres_per_seconds_sq_t(Int64.max))
    }

    func testuint8_t_to_centimetres_per_seconds_sq_t() {
        XCTAssertEqual(u8_to_cm_per_s_sq_t(0), 0)
        XCTAssertEqual(u8_to_cm_per_s_sq_t(5), 5)
        XCTAssertEqual(u8_to_cm_per_s_sq_t(UInt8(UInt8.min)), centimetres_per_seconds_sq_t(UInt8.min))
        XCTAssertEqual(u8_to_cm_per_s_sq_t(UInt8(UInt8.max)), centimetres_per_seconds_sq_t(UInt8.max))
    }
