...
final class AngularVelocity_Degrees_Per_Seconds_uTests1: XCTestCase {
    ...
    func testdegrees_per_seconds_u_to_radians_per_milliseconds_f() {
        ...
        let result1 = deg_per_s_u_to_rad_per_ms_f(5000000)
        let expected1: radians_per_milliseconds_f = radians_per_milliseconds_f((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000))))
        ...
        let result2 = deg_per_s_u_to_rad_per_ms_f(UInt64.min)
        let expected2: radians_per_milliseconds_f = radians_per_milliseconds_f(((Double(UInt64.min)) * ((((Double(1)) / (Double(180))) * (Double(3.141592653589793))) / (Double(1000)))).rounded())
        ...
        let result3 = deg_per_s_u_to_rad_per_ms_f(UInt64.max)
    ...
    func testdegrees_per_seconds_u_to_radians_per_milliseconds_t() {
    ...
    func testdegrees_per_seconds_u_to_radians_per_milliseconds_u() {
    ...
    func testdegrees_per_seconds_u_to_radians_per_nanoseconds_d() {
        let result = deg_per_s_u_to_rad_per_ns_d(0)
        let expected: radians_per_nanoseconds_d = radians_per_nanoseconds_d((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000))))
        ...
        let result1 = deg_per_s_u_to_rad_per_ns_d(5000000)
        let expected1: radians_per_nanoseconds_d = radians_per_nanoseconds_d((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000))))
        ...
        let result2 = deg_per_s_u_to_rad_per_ns_d(UInt64.min)
        let expected2: radians_per_nanoseconds_d = radians_per_nanoseconds_d(((Double(UInt64.min)) * ((((Double(1)) / (Double(180))) * (Double(3.141592653589793))) / (Double(1000000000)))).rounded())
        ...
        let result3 = deg_per_s_u_to_rad_per_ns_d(UInt64.max)
    ...
    func testdegrees_per_seconds_u_to_radians_per_nanoseconds_f() {
        let result = deg_per_s_u_to_rad_per_ns_f(0)
        let expected: radians_per_nanoseconds_f = radians_per_nanoseconds_f((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000))))
        ...
        let result1 = deg_per_s_u_to_rad_per_ns_f(5000000)
        let expected1: radians_per_nanoseconds_f = radians_per_nanoseconds_f((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000))))
        ...
        let result2 = deg_per_s_u_to_rad_per_ns_f(UInt64.min)
        let expected2: radians_per_nanoseconds_f = radians_per_nanoseconds_f(((Double(UInt64.min)) * ((((Double(1)) / (Double(180))) * (Double(3.141592653589793))) / (Double(1000000000)))).rounded())
        ...
        let result3 = deg_per_s_u_to_rad_per_ns_f(UInt64.max)
    ...
    func testdegrees_per_seconds_u_to_radians_per_nanoseconds_t() {
        XCTAssertEqual(deg_per_s_u_to_rad_per_ns_t(0), radians_per_nanoseconds_t((((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000)))).rounded()))))
        XCTAssertEqual(deg_per_s_u_to_rad_per_ns_t(5000000), radians_per_nanoseconds_t((((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000)))).rounded()))))
        XCTAssertEqual(deg_per_s_u_to_rad_per_ns_t(UInt64.min), radians_per_nanoseconds_t(((Double(UInt64.min)) * ((((Double(1)) / (Double(180))) * (Double(3.141592653589793))) / (Double(1000000000)))).rounded()))
        XCTAssertEqual(deg_per_s_u_to_rad_per_ns_t(UInt64.max), radians_per_nanoseconds_t(Int64.max))
    }

    func testdegrees_per_seconds_u_to_radians_per_nanoseconds_u() {
        XCTAssertEqual(deg_per_s_u_to_rad_per_ns_u(0), radians_per_nanoseconds_u((((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000)))).rounded()))))
        XCTAssertEqual(deg_per_s_u_to_rad_per_ns_u(5000000), radians_per_nanoseconds_u((((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000)))).rounded()))))
        XCTAssertEqual(deg_per_s_u_to_rad_per_ns_u(UInt64.min), radians_per_nanoseconds_u(((Double(UInt64.min)) * ((((Double(1)) / (Double(180))) * (Double(3.141592653589793))) / (Double(1000000000)))).rounded()))
        XCTAssertEqual(deg_per_s_u_to_rad_per_ns_u(UInt64.max), radians_per_nanoseconds_u(UInt64.max))
    }

    func testdegrees_per_seconds_u_to_radians_per_picoseconds_d() {
        let result = deg_per_s_u_to_rad_per_ps_d(0)
        let expected: radians_per_picoseconds_d = radians_per_picoseconds_d((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000))))
        ...
        let result1 = deg_per_s_u_to_rad_per_ps_d(5000000)
        let expected1: radians_per_picoseconds_d = radians_per_picoseconds_d((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000))))
        ...
        let result2 = deg_per_s_u_to_rad_per_ps_d(UInt64.min)
        let expected2: radians_per_picoseconds_d = radians_per_picoseconds_d(((Double(UInt64.min)) * ((((Double(1)) / (Double(180))) * (Double(3.141592653589793))) / (Double(1000000000000)))).rounded())
        ...
        let result3 = deg_per_s_u_to_rad_per_ps_d(UInt64.max)
    ...
    func testdegrees_per_seconds_u_to_radians_per_picoseconds_f() {
        let result = deg_per_s_u_to_rad_per_ps_f(0)
        let expected: radians_per_picoseconds_f = radians_per_picoseconds_f((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000))))
        ...
        let result1 = deg_per_s_u_to_rad_per_ps_f(5000000)
        let expected1: radians_per_picoseconds_f = radians_per_picoseconds_f((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000))))
        ...
        let result2 = deg_per_s_u_to_rad_per_ps_f(UInt64.min)
        let expected2: radians_per_picoseconds_f = radians_per_picoseconds_f(((Double(UInt64.min)) * ((((Double(1)) / (Double(180))) * (Double(3.141592653589793))) / (Double(1000000000000)))).rounded())
        ...
        let result3 = deg_per_s_u_to_rad_per_ps_f(UInt64.max)
    ...
    func testdegrees_per_seconds_u_to_radians_per_picoseconds_t() {
        XCTAssertEqual(deg_per_s_u_to_rad_per_ps_t(0), radians_per_picoseconds_t((((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000)))).rounded()))))
        XCTAssertEqual(deg_per_s_u_to_rad_per_ps_t(5000000), radians_per_picoseconds_t((((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000)))).rounded()))))
        XCTAssertEqual(deg_per_s_u_to_rad_per_ps_t(UInt64.min), radians_per_picoseconds_t(((Double(UInt64.min)) * ((((Double(1)) / (Double(180))) * (Double(3.141592653589793))) / (Double(1000000000000)))).rounded()))
        XCTAssertEqual(deg_per_s_u_to_rad_per_ps_t(UInt64.max), radians_per_picoseconds_t(Int64.max))
    }

    func testdegrees_per_seconds_u_to_radians_per_picoseconds_u() {
        XCTAssertEqual(deg_per_s_u_to_rad_per_ps_u(0), radians_per_picoseconds_u((((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000)))).rounded()))))
        XCTAssertEqual(deg_per_s_u_to_rad_per_ps_u(5000000), radians_per_picoseconds_u((((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(3.141592653589793)) / (Double(180))) / (Double(1000000000000)))).rounded()))))
        XCTAssertEqual(deg_per_s_u_to_rad_per_ps_u(UInt64.min), radians_per_picoseconds_u(((Double(UInt64.min)) * ((((Double(1)) / (Double(180))) * (Double(3.141592653589793))) / (Double(1000000000000)))).rounded()))
        XCTAssertEqual(deg_per_s_u_to_rad_per_ps_u(UInt64.max), radians_per_picoseconds_u(UInt64.max))
    }

    func testdegrees_per_seconds_u_to_radians_per_seconds_d() {
        ...
        let result1 = deg_per_s_u_to_rad_per_s_d(5000000)
        let expected1: radians_per_seconds_d = radians_per_seconds_d((Double(5000000)) * ((Double(3.141592653589793)) / (Double(180))))
        ...
        let result2 = deg_per_s_u_to_rad_per_s_d(UInt64.min)
        let expected2: radians_per_seconds_d = radians_per_seconds_d(((Double(UInt64.min)) * (((Double(1)) / (Double(180))) * (Double(3.141592653589793)))).rounded())
        ...
        let result3 = deg_per_s_u_to_rad_per_s_d(UInt64.max)
    ...
    func testdegrees_per_seconds_u_to_radians_per_seconds_f() {
        ...
        let result1 = deg_per_s_u_to_rad_per_s_f(5000000)
        let expected1: radians_per_seconds_f = radians_per_seconds_f((Double(5000000)) * ((Double(3.141592653589793)) / (Double(180))))
        ...
        let result2 = deg_per_s_u_to_rad_per_s_f(UInt64.min)
        let expected2: radians_per_seconds_f = radians_per_seconds_f(((Double(UInt64.min)) * (((Double(1)) / (Double(180))) * (Double(3.141592653589793)))).rounded())
        ...
        let result3 = deg_per_s_u_to_rad_per_s_f(UInt64.max)
    ...
    func testdegrees_per_seconds_u_to_radians_per_seconds_t() {
    ...
    func testdegrees_per_seconds_u_to_radians_per_seconds_u() {
    ...
    func testdegrees_per_seconds_u_to_uint16_t() {
