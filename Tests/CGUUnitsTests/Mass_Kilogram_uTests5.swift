...
final class Mass_Kilogram_uTests5: XCTestCase {
    ...
    func testkilogram_uTomicrogram_fUsing2500000Expectingmicrogram_f2500000_01000000000_0() {
        let result = kg_u_to_ug_f(2500000)
    ...
    func testkilogram_uTomicrogram_fUsing250000Expectingmicrogram_f250000_01000000000_0() {
        let result = kg_u_to_ug_f(250000)
    ...
    func testkilogram_uTomicrogram_fUsingUInt64_maxExpectingmicrogram_fUInt64_max1000000000_0() {
        let result = kg_u_to_ug_f(UInt64.max)
        let expected: microgram_f = microgram_f(UInt64.max) * 1000000000.0
        let tolerance: microgram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testkilogram_uTomicrogram_fUsingUInt64_minExpectingmicrogram_fUInt64_min1000000000_0() {
        let result = kg_u_to_ug_f(UInt64.min)
        let expected: microgram_f = microgram_f(UInt64.min) * 1000000000.0
        let tolerance: microgram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
