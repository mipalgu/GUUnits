...
final class Velocity_Millimetres_Per_Seconds_uTests0: XCTestCase {
    ...
    func testdouble_to_millimetres_per_seconds_u() {
    ...
    func testfloat_to_millimetres_per_seconds_u() {
    ...
    func testint16_t_to_millimetres_per_seconds_u() {
    ...
    func testint32_t_to_millimetres_per_seconds_u() {
    ...
    func testint64_t_to_millimetres_per_seconds_u() {
    ...
    func testint8_t_to_millimetres_per_seconds_u() {
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_microseconds_d() {
        ...
        let result1 = mm_per_s_u_to_cm_per_us_d(5000000)
        let expected1: centimetres_per_microseconds_d = centimetres_per_microseconds_d((Double(5000000)) * (((Double(1)) / (Double(10))) / (Double(1000000))))
        ...
        let result2 = mm_per_s_u_to_cm_per_us_d(UInt64.min)
        let expected2: centimetres_per_microseconds_d = centimetres_per_microseconds_d(((Double(UInt64.min)) * (((Double(1)) / (Double(10))) / (Double(1000000)))).rounded())
        ...
        let result3 = mm_per_s_u_to_cm_per_us_d(UInt64.max)
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_microseconds_f() {
        ...
        let result1 = mm_per_s_u_to_cm_per_us_f(5000000)
        let expected1: centimetres_per_microseconds_f = centimetres_per_microseconds_f((Double(5000000)) * (((Double(1)) / (Double(10))) / (Double(1000000))))
        ...
        let result2 = mm_per_s_u_to_cm_per_us_f(UInt64.min)
        let expected2: centimetres_per_microseconds_f = centimetres_per_microseconds_f(((Double(UInt64.min)) * (((Double(1)) / (Double(10))) / (Double(1000000)))).rounded())
        ...
        let result3 = mm_per_s_u_to_cm_per_us_f(UInt64.max)
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_microseconds_t() {
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_microseconds_u() {
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_milliseconds_d() {
        ...
        let result1 = mm_per_s_u_to_cm_per_ms_d(5000000)
        let expected1: centimetres_per_milliseconds_d = centimetres_per_milliseconds_d((Double(5000000)) * (((Double(1)) / (Double(10))) / (Double(1000))))
        ...
        let result2 = mm_per_s_u_to_cm_per_ms_d(UInt64.min)
        let expected2: centimetres_per_milliseconds_d = centimetres_per_milliseconds_d(((Double(UInt64.min)) * (((Double(1)) / (Double(10))) / (Double(1000)))).rounded())
        ...
        let result3 = mm_per_s_u_to_cm_per_ms_d(UInt64.max)
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_milliseconds_f() {
        ...
        let result1 = mm_per_s_u_to_cm_per_ms_f(5000000)
        let expected1: centimetres_per_milliseconds_f = centimetres_per_milliseconds_f((Double(5000000)) * (((Double(1)) / (Double(10))) / (Double(1000))))
        ...
        let result2 = mm_per_s_u_to_cm_per_ms_f(UInt64.min)
        let expected2: centimetres_per_milliseconds_f = centimetres_per_milliseconds_f(((Double(UInt64.min)) * (((Double(1)) / (Double(10))) / (Double(1000)))).rounded())
        ...
        let result3 = mm_per_s_u_to_cm_per_ms_f(UInt64.max)
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_milliseconds_t() {
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_milliseconds_u() {
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_nanoseconds_d() {
        let result = mm_per_s_u_to_cm_per_ns_d(0)
        let expected: centimetres_per_nanoseconds_d = centimetres_per_nanoseconds_d((Double(0)) * (((Double(1)) / (Double(10))) / (Double(1000000000))))
        ...
        let result1 = mm_per_s_u_to_cm_per_ns_d(5000000)
        let expected1: centimetres_per_nanoseconds_d = centimetres_per_nanoseconds_d((Double(5000000)) * (((Double(1)) / (Double(10))) / (Double(1000000000))))
        ...
        let result2 = mm_per_s_u_to_cm_per_ns_d(UInt64.min)
        let expected2: centimetres_per_nanoseconds_d = centimetres_per_nanoseconds_d(((Double(UInt64.min)) * (((Double(1)) / (Double(10))) / (Double(1000000000)))).rounded())
        ...
        let result3 = mm_per_s_u_to_cm_per_ns_d(UInt64.max)
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_nanoseconds_f() {
        let result = mm_per_s_u_to_cm_per_ns_f(0)
        let expected: centimetres_per_nanoseconds_f = centimetres_per_nanoseconds_f((Double(0)) * (((Double(1)) / (Double(10))) / (Double(1000000000))))
        ...
        let result1 = mm_per_s_u_to_cm_per_ns_f(5000000)
        let expected1: centimetres_per_nanoseconds_f = centimetres_per_nanoseconds_f((Double(5000000)) * (((Double(1)) / (Double(10))) / (Double(1000000000))))
        ...
        let result2 = mm_per_s_u_to_cm_per_ns_f(UInt64.min)
        let expected2: centimetres_per_nanoseconds_f = centimetres_per_nanoseconds_f(((Double(UInt64.min)) * (((Double(1)) / (Double(10))) / (Double(1000000000)))).rounded())
        ...
        let result3 = mm_per_s_u_to_cm_per_ns_f(UInt64.max)
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_nanoseconds_t() {
        ...
        XCTAssertEqual(mm_per_s_u_to_cm_per_ns_t(UInt64.min), centimetres_per_nanoseconds_t(((Double(UInt64.min)) * (((Double(1)) / (Double(10))) / (Double(1000000000)))).rounded()))
        XCTAssertEqual(mm_per_s_u_to_cm_per_ns_t(UInt64.max), centimetres_per_nanoseconds_t(Int64.max))
    }

    func testmillimetres_per_seconds_u_to_centimetres_per_nanoseconds_u() {
        XCTAssertEqual(mm_per_s_u_to_cm_per_ns_u(0), centimetres_per_nanoseconds_u((((Double(0)) * (((Double(1)) / (Double(10))) / (Double(1000000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(1)) / (Double(10))) / (Double(1000000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(1)) / (Double(10))) / (Double(1000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_u_to_cm_per_ns_u(5000000), centimetres_per_nanoseconds_u((((Double(5000000)) * (((Double(1)) / (Double(10))) / (Double(1000000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(10))) / (Double(1000000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(1)) / (Double(10))) / (Double(1000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_u_to_cm_per_ns_u(UInt64.min), centimetres_per_nanoseconds_u(((Double(UInt64.min)) * (((Double(1)) / (Double(10))) / (Double(1000000000)))).rounded()))
        XCTAssertEqual(mm_per_s_u_to_cm_per_ns_u(UInt64.max), centimetres_per_nanoseconds_u(UInt64.max))
    }

    func testmillimetres_per_seconds_u_to_centimetres_per_picoseconds_d() {
        let result = mm_per_s_u_to_cm_per_ps_d(0)
        let expected: centimetres_per_picoseconds_d = centimetres_per_picoseconds_d((Double(0)) * (((Double(1)) / (Double(10))) / (Double(1000000000000))))
        ...
        let result1 = mm_per_s_u_to_cm_per_ps_d(5000000)
        let expected1: centimetres_per_picoseconds_d = centimetres_per_picoseconds_d((Double(5000000)) * (((Double(1)) / (Double(10))) / (Double(1000000000000))))
        ...
        let result2 = mm_per_s_u_to_cm_per_ps_d(UInt64.min)
        let expected2: centimetres_per_picoseconds_d = centimetres_per_picoseconds_d(((Double(UInt64.min)) * (((Double(1)) / (Double(10))) / (Double(1000000000000)))).rounded())
        ...
        let result3 = mm_per_s_u_to_cm_per_ps_d(UInt64.max)
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_picoseconds_f() {
        let result = mm_per_s_u_to_cm_per_ps_f(0)
        let expected: centimetres_per_picoseconds_f = centimetres_per_picoseconds_f((Double(0)) * (((Double(1)) / (Double(10))) / (Double(1000000000000))))
        ...
        let result1 = mm_per_s_u_to_cm_per_ps_f(5000000)
        let expected1: centimetres_per_picoseconds_f = centimetres_per_picoseconds_f((Double(5000000)) * (((Double(1)) / (Double(10))) / (Double(1000000000000))))
        ...
        let result2 = mm_per_s_u_to_cm_per_ps_f(UInt64.min)
        let expected2: centimetres_per_picoseconds_f = centimetres_per_picoseconds_f(((Double(UInt64.min)) * (((Double(1)) / (Double(10))) / (Double(1000000000000)))).rounded())
        ...
        let result3 = mm_per_s_u_to_cm_per_ps_f(UInt64.max)
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_picoseconds_t() {
        ...
        XCTAssertEqual(mm_per_s_u_to_cm_per_ps_t(UInt64.min), centimetres_per_picoseconds_t(((Double(UInt64.min)) * (((Double(1)) / (Double(10))) / (Double(1000000000000)))).rounded()))
        XCTAssertEqual(mm_per_s_u_to_cm_per_ps_t(UInt64.max), centimetres_per_picoseconds_t(Int64.max))
    }

    func testmillimetres_per_seconds_u_to_centimetres_per_picoseconds_u() {
        XCTAssertEqual(mm_per_s_u_to_cm_per_ps_u(0), centimetres_per_picoseconds_u((((Double(0)) * (((Double(1)) / (Double(10))) / (Double(1000000000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(1)) / (Double(10))) / (Double(1000000000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(1)) / (Double(10))) / (Double(1000000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_u_to_cm_per_ps_u(5000000), centimetres_per_picoseconds_u((((Double(5000000)) * (((Double(1)) / (Double(10))) / (Double(1000000000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(10))) / (Double(1000000000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(1)) / (Double(10))) / (Double(1000000000000)))).rounded()))))
        XCTAssertEqual(mm_per_s_u_to_cm_per_ps_u(UInt64.min), centimetres_per_picoseconds_u(((Double(UInt64.min)) * (((Double(1)) / (Double(10))) / (Double(1000000000000)))).rounded()))
        XCTAssertEqual(mm_per_s_u_to_cm_per_ps_u(UInt64.max), centimetres_per_picoseconds_u(UInt64.max))
    }

    func testmillimetres_per_seconds_u_to_centimetres_per_seconds_d() {
        ...
        let result1 = mm_per_s_u_to_cm_per_s_d(5000000)
        let expected1: centimetres_per_seconds_d = centimetres_per_seconds_d((Double(5000000)) / (Double(10)))
        ...
        let result2 = mm_per_s_u_to_cm_per_s_d(UInt64.min)
        let expected2: centimetres_per_seconds_d = centimetres_per_seconds_d(((Double(UInt64.min)) / (Double(10))).rounded())
        ...
        let result3 = mm_per_s_u_to_cm_per_s_d(UInt64.max)
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_seconds_f() {
        ...
        let result1 = mm_per_s_u_to_cm_per_s_f(5000000)
        let expected1: centimetres_per_seconds_f = centimetres_per_seconds_f((Double(5000000)) / (Double(10)))
        ...
        let result2 = mm_per_s_u_to_cm_per_s_f(UInt64.min)
        let expected2: centimetres_per_seconds_f = centimetres_per_seconds_f(((Double(UInt64.min)) / (Double(10))).rounded())
        ...
        let result3 = mm_per_s_u_to_cm_per_s_f(UInt64.max)
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_seconds_t() {
    ...
    func testmillimetres_per_seconds_u_to_centimetres_per_seconds_u() {
    ...
    func testmillimetres_per_seconds_u_to_double() {
        ...
        let result2 = mm_per_s_u_to_d(millimetres_per_seconds_u(UInt64.min))
        ...
        let result3 = mm_per_s_u_to_d(millimetres_per_seconds_u(UInt64.max))
    ...
    func testmillimetres_per_seconds_u_to_float() {
        ...
        let result2 = mm_per_s_u_to_f(millimetres_per_seconds_u(UInt64.min))
        ...
        let result3 = mm_per_s_u_to_f(millimetres_per_seconds_u(UInt64.max))
    ...
    func testmillimetres_per_seconds_u_to_int16_t() {
    ...
    func testmillimetres_per_seconds_u_to_int32_t() {
