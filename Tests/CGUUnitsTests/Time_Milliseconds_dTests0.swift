...
final class Time_Milliseconds_dTests0: XCTestCase {
    ...
    func testmilliseconds_d_to_nanoseconds_d() {
        let result = ms_d_to_ns_d(15.0)
        ...
        let result2 = ms_d_to_ns_d(250.0)
        ...
        let result4 = ms_d_to_ns_d(2500.0)
        ...
        let result5 = ms_d_to_ns_d(25000.0)
        ...
        let result6 = ms_d_to_ns_d(250000.0)
        ...
        let result7 = ms_d_to_ns_d(2500000.0)
        ...
        let result8 = ms_d_to_ns_d(-323.0)
    ...
    func testmilliseconds_d_to_nanoseconds_d1() {
        let result = ms_d_to_ns_d(-1000.0)
        ...
        let result2 = ms_d_to_ns_d(-Double.greatestFiniteMagnitude)
        ...
        let result3 = ms_d_to_ns_d(Double.greatestFiniteMagnitude)
    ...
    func testmilliseconds_d_to_nanoseconds_f() {
        let result = ms_d_to_ns_f(15.0)
        ...
        let result2 = ms_d_to_ns_f(250.0)
        ...
        let result4 = ms_d_to_ns_f(2500.0)
        ...
        let result5 = ms_d_to_ns_f(25000.0)
        ...
        let result6 = ms_d_to_ns_f(250000.0)
        ...
        let result7 = ms_d_to_ns_f(2500000.0)
        ...
        let result8 = ms_d_to_ns_f(-323.0)
    ...
    func testmilliseconds_d_to_nanoseconds_f1() {
        let result = ms_d_to_ns_f(-1000.0)
        ...
        let result2 = ms_d_to_ns_f(-Double.greatestFiniteMagnitude)
        ...
        let result3 = ms_d_to_ns_f(Double.greatestFiniteMagnitude)
    ...
    func testmilliseconds_d_to_nanoseconds_t() {
        XCTAssertEqual(ms_d_to_ns_t(15.0), nanoseconds_t((Double(15.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_t(25.0), nanoseconds_t((Double(25.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_t(250.0), nanoseconds_t((Double(250.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_t(0.0), nanoseconds_t((Double(0.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_t(2500.0), nanoseconds_t((Double(2500.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_t(25000.0), nanoseconds_t((Double(25000.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_t(250000.0), nanoseconds_t((Double(250000.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_t(2500000.0), nanoseconds_t((Double(2500000.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_t(-323.0), nanoseconds_t((Double(-323.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_t(-10.0), nanoseconds_t((Double(-10.0) * 1000000.0).rounded()))
    }

    func testmilliseconds_d_to_nanoseconds_t1() {
        XCTAssertEqual(ms_d_to_ns_t(-1000.0), nanoseconds_t((Double(-1000.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_t(-5.0), nanoseconds_t((Double(-5.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_t(-Double.greatestFiniteMagnitude), nanoseconds_t(Int64.min))
        XCTAssertEqual(ms_d_to_ns_t(Double.greatestFiniteMagnitude), nanoseconds_t(Int64.max))
    }

    func testmilliseconds_d_to_nanoseconds_u() {
        XCTAssertEqual(ms_d_to_ns_u(15.0), nanoseconds_u((Double(15.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_u(25.0), nanoseconds_u((Double(25.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_u(250.0), nanoseconds_u((Double(250.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_u(0.0), nanoseconds_u((Double(0.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_u(2500.0), nanoseconds_u((Double(2500.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_u(25000.0), nanoseconds_u((Double(25000.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_u(250000.0), nanoseconds_u((Double(250000.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_u(2500000.0), nanoseconds_u((Double(2500000.0) * 1000000.0).rounded()))
        XCTAssertEqual(ms_d_to_ns_u(-323.0), 0)
        XCTAssertEqual(ms_d_to_ns_u(-10.0), 0)
    }
