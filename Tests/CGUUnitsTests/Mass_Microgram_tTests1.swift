...
final class Mass_Microgram_tTests1: XCTestCase {
    ...
    func testmicrogram_tTofloatUsingmicrogram_tInt64_maxExpectingFloatInt64_max() {
        let result = ug_t_to_f(microgram_t(Int64.max))
    ...
    func testmicrogram_tTofloatUsingmicrogram_tInt64_minExpectingFloatInt64_min() {
        let result = ug_t_to_f(microgram_t(Int64.min))
    ...
    func testmicrogram_tTogram_dUsing2500000Expectinggram_d2500000_01000000_0() {
        let result = ug_t_to_g_d(2500000)
    ...
    func testmicrogram_tTogram_dUsingInt64_maxExpectinggram_dInt64_max1000000_0() {
        let result = ug_t_to_g_d(Int64.max)
        let expected: gram_d = gram_d(Int64.max) / 1000000.0
        let tolerance: gram_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmicrogram_tTogram_dUsingInt64_minExpectinggram_dInt64_min1000000_0() {
        let result = ug_t_to_g_d(Int64.min)
        let expected: gram_d = gram_d(Int64.min) / 1000000.0
        let tolerance: gram_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmicrogram_tTogram_fUsing2500000Expectinggram_f2500000_01000000_0() {
        let result = ug_t_to_g_f(2500000)
    ...
    func testmicrogram_tTogram_fUsingInt64_maxExpectinggram_fInt64_max1000000_0() {
        let result = ug_t_to_g_f(Int64.max)
        let expected: gram_f = gram_f(Int64.max) / 1000000.0
        let tolerance: gram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmicrogram_tTogram_fUsingInt64_minExpectinggram_fInt64_min1000000_0() {
        let result = ug_t_to_g_f(Int64.min)
        let expected: gram_f = gram_f(Int64.min) / 1000000.0
        let tolerance: gram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
