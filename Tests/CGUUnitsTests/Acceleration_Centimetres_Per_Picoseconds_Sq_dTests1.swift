...
final class Acceleration_Centimetres_Per_Picoseconds_Sq_dTests1: XCTestCase {

    func testcentimetres_per_picoseconds_sq_d_to_metres_per_milliseconds_sq_f() {
        let result = cm_per_ps_sq_d_to_m_per_ms_sq_f(-5000000)
        ...
        let result1 = cm_per_ps_sq_d_to_m_per_ms_sq_f(0)
        ...
        let result2 = cm_per_ps_sq_d_to_m_per_ms_sq_f(5000000)
        ...
        let result3 = cm_per_ps_sq_d_to_m_per_ms_sq_f(-Double.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_ps_sq_d_to_m_per_ms_sq_f(Double.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_picoseconds_sq_d_to_metres_per_milliseconds_sq_t() {
        ...
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ms_sq_t(5000000), metres_per_milliseconds_sq_t((((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ms_sq_t(-Double.greatestFiniteMagnitude), metres_per_milliseconds_sq_t(Int64.min))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ms_sq_t(Double.greatestFiniteMagnitude), metres_per_milliseconds_sq_t(Int64.max))
    }

    func testcentimetres_per_picoseconds_sq_d_to_metres_per_milliseconds_sq_u() {
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ms_sq_u(-5000000), metres_per_milliseconds_sq_u((((Double(-5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ms_sq_u(0), metres_per_milliseconds_sq_u((((Double(0)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ms_sq_u(5000000), metres_per_milliseconds_sq_u((((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ms_sq_u(-Double.greatestFiniteMagnitude), metres_per_milliseconds_sq_u(UInt64.min))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ms_sq_u(Double.greatestFiniteMagnitude), metres_per_milliseconds_sq_u(UInt64.max))
    }

    func testcentimetres_per_picoseconds_sq_d_to_metres_per_nanoseconds_sq_d() {
        let result = cm_per_ps_sq_d_to_m_per_ns_sq_d(-5000000)
        ...
        let result1 = cm_per_ps_sq_d_to_m_per_ns_sq_d(0)
        ...
        let result2 = cm_per_ps_sq_d_to_m_per_ns_sq_d(5000000)
        ...
        let result3 = cm_per_ps_sq_d_to_m_per_ns_sq_d(-Double.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_ps_sq_d_to_m_per_ns_sq_d(Double.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_picoseconds_sq_d_to_metres_per_nanoseconds_sq_f() {
        let result = cm_per_ps_sq_d_to_m_per_ns_sq_f(-5000000)
        ...
        let result1 = cm_per_ps_sq_d_to_m_per_ns_sq_f(0)
        ...
        let result2 = cm_per_ps_sq_d_to_m_per_ns_sq_f(5000000)
        ...
        let result3 = cm_per_ps_sq_d_to_m_per_ns_sq_f(-Double.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_ps_sq_d_to_m_per_ns_sq_f(Double.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_picoseconds_sq_d_to_metres_per_nanoseconds_sq_t() {
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ns_sq_t(-5000000), metres_per_nanoseconds_sq_t((((Double(-5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ns_sq_t(0), metres_per_nanoseconds_sq_t((((Double(0)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ns_sq_t(5000000), metres_per_nanoseconds_sq_t((((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ns_sq_t(-Double.greatestFiniteMagnitude), metres_per_nanoseconds_sq_t(Int64.min))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ns_sq_t(Double.greatestFiniteMagnitude), metres_per_nanoseconds_sq_t(Int64.max))
    }

    func testcentimetres_per_picoseconds_sq_d_to_metres_per_nanoseconds_sq_u() {
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ns_sq_u(-5000000), metres_per_nanoseconds_sq_u((((Double(-5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()))))
        ...
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ns_sq_u(5000000), metres_per_nanoseconds_sq_u((((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ns_sq_u(-Double.greatestFiniteMagnitude), metres_per_nanoseconds_sq_u(UInt64.min))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ns_sq_u(Double.greatestFiniteMagnitude), metres_per_nanoseconds_sq_u(UInt64.max))
    }

    func testcentimetres_per_picoseconds_sq_d_to_metres_per_picoseconds_sq_d() {
        let result = cm_per_ps_sq_d_to_m_per_ps_sq_d(-5000000)
        ...
        let result1 = cm_per_ps_sq_d_to_m_per_ps_sq_d(0)
        ...
        let result2 = cm_per_ps_sq_d_to_m_per_ps_sq_d(5000000)
        ...
        let result3 = cm_per_ps_sq_d_to_m_per_ps_sq_d(-Double.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_ps_sq_d_to_m_per_ps_sq_d(Double.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_picoseconds_sq_d_to_metres_per_picoseconds_sq_f() {
        let result = cm_per_ps_sq_d_to_m_per_ps_sq_f(-5000000)
        ...
        let result1 = cm_per_ps_sq_d_to_m_per_ps_sq_f(0)
        ...
        let result2 = cm_per_ps_sq_d_to_m_per_ps_sq_f(5000000)
        ...
        let result3 = cm_per_ps_sq_d_to_m_per_ps_sq_f(-Double.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_ps_sq_d_to_m_per_ps_sq_f(Double.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_picoseconds_sq_d_to_metres_per_picoseconds_sq_t() {
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ps_sq_t(-5000000), metres_per_picoseconds_sq_t((((Double(-5000000)) / (Double(100))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) / (Double(100))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) / (Double(100))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ps_sq_t(0), metres_per_picoseconds_sq_t((((Double(0)) / (Double(100))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) / (Double(100))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) / (Double(100))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ps_sq_t(5000000), metres_per_picoseconds_sq_t((((Double(5000000)) / (Double(100))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) / (Double(100))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) / (Double(100))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ps_sq_t(-Double.greatestFiniteMagnitude), metres_per_picoseconds_sq_t(Int64.min))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ps_sq_t(Double.greatestFiniteMagnitude), metres_per_picoseconds_sq_t(Int64.max))
    }

    func testcentimetres_per_picoseconds_sq_d_to_metres_per_picoseconds_sq_u() {
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ps_sq_u(-5000000), metres_per_picoseconds_sq_u((((Double(-5000000)) / (Double(100))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) / (Double(100))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) / (Double(100))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ps_sq_u(0), metres_per_picoseconds_sq_u((((Double(0)) / (Double(100))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) / (Double(100))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) / (Double(100))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ps_sq_u(5000000), metres_per_picoseconds_sq_u((((Double(5000000)) / (Double(100))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) / (Double(100))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) / (Double(100))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ps_sq_u(-Double.greatestFiniteMagnitude), metres_per_picoseconds_sq_u(UInt64.min))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_ps_sq_u(Double.greatestFiniteMagnitude), metres_per_picoseconds_sq_u(UInt64.max))
    }

    func testcentimetres_per_picoseconds_sq_d_to_metres_per_seconds_sq_d() {
        let result = cm_per_ps_sq_d_to_m_per_s_sq_d(-5000000)
        ...
        let result1 = cm_per_ps_sq_d_to_m_per_s_sq_d(0)
        ...
        let result2 = cm_per_ps_sq_d_to_m_per_s_sq_d(5000000)
        ...
        let result3 = cm_per_ps_sq_d_to_m_per_s_sq_d(-Double.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_ps_sq_d_to_m_per_s_sq_d(Double.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_picoseconds_sq_d_to_metres_per_seconds_sq_f() {
        let result = cm_per_ps_sq_d_to_m_per_s_sq_f(-5000000)
        ...
        let result1 = cm_per_ps_sq_d_to_m_per_s_sq_f(0)
        ...
        let result2 = cm_per_ps_sq_d_to_m_per_s_sq_f(5000000)
        ...
        let result3 = cm_per_ps_sq_d_to_m_per_s_sq_f(-Double.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_ps_sq_d_to_m_per_s_sq_f(Double.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_picoseconds_sq_d_to_metres_per_seconds_sq_t() {
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_s_sq_t(-5000000), metres_per_seconds_sq_t((((Double(-5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_s_sq_t(0), metres_per_seconds_sq_t((((Double(0)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_s_sq_t(5000000), metres_per_seconds_sq_t((((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_s_sq_t(-Double.greatestFiniteMagnitude), metres_per_seconds_sq_t(Int64.min))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_s_sq_t(Double.greatestFiniteMagnitude), metres_per_seconds_sq_t(Int64.max))
    }

    func testcentimetres_per_picoseconds_sq_d_to_metres_per_seconds_sq_u() {
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_s_sq_u(-5000000), metres_per_seconds_sq_u((((Double(-5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_s_sq_u(0), metres_per_seconds_sq_u((((Double(0)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_s_sq_u(5000000), metres_per_seconds_sq_u((((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(1)) / (Double(100))) / (((Double(1)) / (Double(1000000000000))) * ((Double(1)) / (Double(1000000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_s_sq_u(-Double.greatestFiniteMagnitude), metres_per_seconds_sq_u(UInt64.min))
        XCTAssertEqual(cm_per_ps_sq_d_to_m_per_s_sq_u(Double.greatestFiniteMagnitude), metres_per_seconds_sq_u(UInt64.max))
    }

    func testcentimetres_per_picoseconds_sq_d_to_millimetres_per_microseconds_sq_d() {
        let result = cm_per_ps_sq_d_to_mm_per_us_sq_d(-5000000)
        ...
        let result1 = cm_per_ps_sq_d_to_mm_per_us_sq_d(0)
        ...
        let result2 = cm_per_ps_sq_d_to_mm_per_us_sq_d(5000000)
        ...
        let result3 = cm_per_ps_sq_d_to_mm_per_us_sq_d(-Double.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_ps_sq_d_to_mm_per_us_sq_d(Double.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_picoseconds_sq_d_to_millimetres_per_microseconds_sq_f() {
        let result = cm_per_ps_sq_d_to_mm_per_us_sq_f(-5000000)
        ...
        let result1 = cm_per_ps_sq_d_to_mm_per_us_sq_f(0)
        ...
        let result2 = cm_per_ps_sq_d_to_mm_per_us_sq_f(5000000)
        ...
        let result3 = cm_per_ps_sq_d_to_mm_per_us_sq_f(-Double.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_ps_sq_d_to_mm_per_us_sq_f(Double.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_picoseconds_sq_d_to_millimetres_per_microseconds_sq_t() {
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_us_sq_t(-5000000), millimetres_per_microseconds_sq_t((((Double(-5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_us_sq_t(0), millimetres_per_microseconds_sq_t((((Double(0)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_us_sq_t(5000000), millimetres_per_microseconds_sq_t((((Double(5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_us_sq_t(-Double.greatestFiniteMagnitude), millimetres_per_microseconds_sq_t(Int64.min))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_us_sq_t(Double.greatestFiniteMagnitude), millimetres_per_microseconds_sq_t(Int64.max))
    }

    func testcentimetres_per_picoseconds_sq_d_to_millimetres_per_microseconds_sq_u() {
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_us_sq_u(-5000000), millimetres_per_microseconds_sq_u((((Double(-5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_us_sq_u(0), millimetres_per_microseconds_sq_u((((Double(0)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_us_sq_u(5000000), millimetres_per_microseconds_sq_u((((Double(5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000))) * ((Double(1)) / (Double(1000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_us_sq_u(-Double.greatestFiniteMagnitude), millimetres_per_microseconds_sq_u(UInt64.min))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_us_sq_u(Double.greatestFiniteMagnitude), millimetres_per_microseconds_sq_u(UInt64.max))
    }

    func testcentimetres_per_picoseconds_sq_d_to_millimetres_per_milliseconds_sq_d() {
        let result = cm_per_ps_sq_d_to_mm_per_ms_sq_d(-5000000)
        ...
        let result1 = cm_per_ps_sq_d_to_mm_per_ms_sq_d(0)
        ...
        let result2 = cm_per_ps_sq_d_to_mm_per_ms_sq_d(5000000)
        ...
        let result3 = cm_per_ps_sq_d_to_mm_per_ms_sq_d(-Double.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_ps_sq_d_to_mm_per_ms_sq_d(Double.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_picoseconds_sq_d_to_millimetres_per_milliseconds_sq_f() {
        let result = cm_per_ps_sq_d_to_mm_per_ms_sq_f(-5000000)
        ...
        let result1 = cm_per_ps_sq_d_to_mm_per_ms_sq_f(0)
        ...
        let result2 = cm_per_ps_sq_d_to_mm_per_ms_sq_f(5000000)
        ...
        let result3 = cm_per_ps_sq_d_to_mm_per_ms_sq_f(-Double.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_ps_sq_d_to_mm_per_ms_sq_f(Double.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_picoseconds_sq_d_to_millimetres_per_milliseconds_sq_t() {
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ms_sq_t(-5000000), millimetres_per_milliseconds_sq_t((((Double(-5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ms_sq_t(0), millimetres_per_milliseconds_sq_t((((Double(0)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ms_sq_t(5000000), millimetres_per_milliseconds_sq_t((((Double(5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ms_sq_t(-Double.greatestFiniteMagnitude), millimetres_per_milliseconds_sq_t(Int64.min))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ms_sq_t(Double.greatestFiniteMagnitude), millimetres_per_milliseconds_sq_t(Int64.max))
    }

    func testcentimetres_per_picoseconds_sq_d_to_millimetres_per_milliseconds_sq_u() {
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ms_sq_u(-5000000), millimetres_per_milliseconds_sq_u((((Double(-5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ms_sq_u(0), millimetres_per_milliseconds_sq_u((((Double(0)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ms_sq_u(5000000), millimetres_per_milliseconds_sq_u((((Double(5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000000000))) * ((Double(1)) / (Double(1000000000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ms_sq_u(-Double.greatestFiniteMagnitude), millimetres_per_milliseconds_sq_u(UInt64.min))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ms_sq_u(Double.greatestFiniteMagnitude), millimetres_per_milliseconds_sq_u(UInt64.max))
    }

    func testcentimetres_per_picoseconds_sq_d_to_millimetres_per_nanoseconds_sq_d() {
        let result = cm_per_ps_sq_d_to_mm_per_ns_sq_d(-5000000)
        ...
        let result1 = cm_per_ps_sq_d_to_mm_per_ns_sq_d(0)
        ...
        let result2 = cm_per_ps_sq_d_to_mm_per_ns_sq_d(5000000)
        ...
        let result3 = cm_per_ps_sq_d_to_mm_per_ns_sq_d(-Double.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_ps_sq_d_to_mm_per_ns_sq_d(Double.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_picoseconds_sq_d_to_millimetres_per_nanoseconds_sq_f() {
        let result = cm_per_ps_sq_d_to_mm_per_ns_sq_f(-5000000)
        ...
        let result1 = cm_per_ps_sq_d_to_mm_per_ns_sq_f(0)
        ...
        let result2 = cm_per_ps_sq_d_to_mm_per_ns_sq_f(5000000)
        ...
        let result3 = cm_per_ps_sq_d_to_mm_per_ns_sq_f(-Double.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_ps_sq_d_to_mm_per_ns_sq_f(Double.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_picoseconds_sq_d_to_millimetres_per_nanoseconds_sq_u() {
        ...
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ns_sq_u(5000000), millimetres_per_nanoseconds_sq_u((((Double(5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * ((Double(10)) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ns_sq_u(-Double.greatestFiniteMagnitude), millimetres_per_nanoseconds_sq_u(UInt64.min))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ns_sq_u(Double.greatestFiniteMagnitude), millimetres_per_nanoseconds_sq_u(UInt64.max))
    }

    func testcentimetres_per_picoseconds_sq_d_to_millimetres_per_picoseconds_sq_d() {
        let result = cm_per_ps_sq_d_to_mm_per_ps_sq_d(-5000000)
        ...
        let result1 = cm_per_ps_sq_d_to_mm_per_ps_sq_d(0)
        ...
        let result2 = cm_per_ps_sq_d_to_mm_per_ps_sq_d(5000000)
        ...
        let result3 = cm_per_ps_sq_d_to_mm_per_ps_sq_d(-Double.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_ps_sq_d_to_mm_per_ps_sq_d(Double.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_picoseconds_sq_d_to_millimetres_per_picoseconds_sq_f() {
        let result = cm_per_ps_sq_d_to_mm_per_ps_sq_f(-5000000)
        ...
        let result1 = cm_per_ps_sq_d_to_mm_per_ps_sq_f(0)
        ...
        let result2 = cm_per_ps_sq_d_to_mm_per_ps_sq_f(5000000)
        ...
        let result3 = cm_per_ps_sq_d_to_mm_per_ps_sq_f(-Double.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_ps_sq_d_to_mm_per_ps_sq_f(Double.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_picoseconds_sq_d_to_millimetres_per_picoseconds_sq_t() {
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ps_sq_t(-5000000), millimetres_per_picoseconds_sq_t((((Double(-5000000)) * (Double(10))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * (Double(10))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * (Double(10))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ps_sq_t(0), millimetres_per_picoseconds_sq_t((((Double(0)) * (Double(10))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * (Double(10))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * (Double(10))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ps_sq_t(5000000), millimetres_per_picoseconds_sq_t((((Double(5000000)) * (Double(10))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (Double(10))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (Double(10))).rounded()))))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ps_sq_t(-Double.greatestFiniteMagnitude), millimetres_per_picoseconds_sq_t(Int64.min))
        XCTAssertEqual(cm_per_ps_sq_d_to_mm_per_ps_sq_t(Double.greatestFiniteMagnitude), millimetres_per_picoseconds_sq_t(Int64.max))
    }
