...
final class Mass_Megagram_tTests0: XCTestCase {
    ...
    func testint16_t_to_megagram_t() {
    ...
    func testint32_t_to_megagram_t() {
    ...
    func testint64_t_to_megagram_t() {
    ...
    func testmegagram_t_to_double() {
        ...
        let result2 = Mg_t_to_d(megagram_t(Int64.min))
        ...
        let result3 = Mg_t_to_d(megagram_t(Int64.max))
    ...
    func testmegagram_t_to_float() {
        ...
        let result2 = Mg_t_to_f(megagram_t(Int64.min))
        ...
        let result3 = Mg_t_to_f(megagram_t(Int64.max))
    ...
    func testmegagram_t_to_gram_d1() {
    ...
    func testmegagram_t_to_gram_f1() {
    ...
    func testmegagram_t_to_gram_t1() {
    ...
    func testmegagram_t_to_gram_u1() {
    ...
    func testmegagram_t_to_int16_t() {
    ...
    func testmegagram_t_to_int32_t() {
    ...
    func testmegagram_t_to_int64_t() {
    ...
    func testmegagram_t_to_kilogram_d() {
    ...
    func testmegagram_t_to_kilogram_d1() {
    ...
    func testmegagram_t_to_kilogram_f() {
    ...
    func testmegagram_t_to_kilogram_f1() {
    ...
    func testmegagram_t_to_kilogram_t() {
    ...
    func testmegagram_t_to_kilogram_t1() {
    ...
    func testmegagram_t_to_kilogram_u() {
    ...
    func testmegagram_t_to_kilogram_u1() {
    ...
    func testmegagram_t_to_megagram_d() {
        ...
        let result1 = Mg_t_to_Mg_d(megagram_t(Int64.min))
        let expected1: megagram_d = megagram_d(Int64.min)
        ...
        let result2 = Mg_t_to_Mg_d(megagram_t(Int64.max))
        let expected2: megagram_d = megagram_d(Int64.max)
    ...
    func testmegagram_t_to_megagram_f() {
        ...
        let result1 = Mg_t_to_Mg_f(megagram_t(Int64.min))
        let expected1: megagram_f = megagram_f(Int64.min)
        ...
        let result2 = Mg_t_to_Mg_f(megagram_t(Int64.max))
        let expected2: megagram_f = megagram_f(Int64.max)
