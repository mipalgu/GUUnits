...
final class Current_Microamperes_uTests0: XCTestCase {
    ...
    func testdouble_to_microamperes_u() {
    ...
    func testfloat_to_microamperes_u() {
    ...
    func testint16_t_to_microamperes_u() {
    ...
    func testint32_t_to_microamperes_u() {
    ...
    func testint64_t_to_microamperes_u() {
    ...
    func testint8_t_to_microamperes_u() {
    ...
    func testmicroamperes_u_to_amperes_d() {
        ...
        let result6 = uA_u_to_A_d(250000)
        ...
        let result7 = uA_u_to_A_d(2500000)
        ...
        let result8 = uA_u_to_A_d(UInt64.min)
        let expected8: amperes_d = amperes_d(UInt64.min) / 1000000.0
        ...
        let result9 = uA_u_to_A_d(UInt64.max)
        let expected9: amperes_d = amperes_d(UInt64.max) / 1000000.0
    ...
    func testmicroamperes_u_to_amperes_f() {
        ...
        let result6 = uA_u_to_A_f(250000)
        ...
        let result7 = uA_u_to_A_f(2500000)
        ...
        let result8 = uA_u_to_A_f(UInt64.min)
        let expected8: amperes_f = amperes_f(UInt64.min) / 1000000.0
        ...
        let result9 = uA_u_to_A_f(UInt64.max)
        let expected9: amperes_f = amperes_f(UInt64.max) / 1000000.0
    ...
    func testmicroamperes_u_to_amperes_t() {
    ...
    func testmicroamperes_u_to_amperes_u() {
    ...
    func testmicroamperes_u_to_double() {
        ...
        let result2 = uA_u_to_d(microamperes_u(UInt64.min))
        ...
        let result3 = uA_u_to_d(microamperes_u(UInt64.max))
    ...
    func testmicroamperes_u_to_float() {
        ...
        let result2 = uA_u_to_f(microamperes_u(UInt64.min))
        ...
        let result3 = uA_u_to_f(microamperes_u(UInt64.max))
    ...
    func testmicroamperes_u_to_int16_t() {
    ...
    func testmicroamperes_u_to_int32_t() {
    ...
    func testmicroamperes_u_to_int64_t() {
    ...
    func testmicroamperes_u_to_int8_t() {
    ...
    func testmicroamperes_u_to_microamperes_d() {
        ...
        let result1 = uA_u_to_uA_d(microamperes_u(UInt64.min))
        let expected1: microamperes_d = microamperes_d(UInt64.min)
        ...
        let result2 = uA_u_to_uA_d(microamperes_u(UInt64.max))
        let expected2: microamperes_d = microamperes_d(UInt64.max)
    ...
    func testmicroamperes_u_to_microamperes_f() {
        ...
        let result1 = uA_u_to_uA_f(microamperes_u(UInt64.min))
        let expected1: microamperes_f = microamperes_f(UInt64.min)
        ...
        let result2 = uA_u_to_uA_f(microamperes_u(UInt64.max))
        let expected2: microamperes_f = microamperes_f(UInt64.max)
    ...
    func testmicroamperes_u_to_microamperes_t() {
    ...
    func testmicroamperes_u_to_milliamperes_d() {
        ...
        let result5 = uA_u_to_mA_d(25000)
        ...
        let result6 = uA_u_to_mA_d(250000)
        ...
        let result7 = uA_u_to_mA_d(2500000)
        ...
        let result8 = uA_u_to_mA_d(UInt64.min)
        ...
        let result9 = uA_u_to_mA_d(UInt64.max)
    ...
    func testmicroamperes_u_to_milliamperes_f() {
        ...
        let result5 = uA_u_to_mA_f(25000)
        ...
        let result6 = uA_u_to_mA_f(250000)
        ...
        let result7 = uA_u_to_mA_f(2500000)
        ...
        let result8 = uA_u_to_mA_f(UInt64.min)
        ...
        let result9 = uA_u_to_mA_f(UInt64.max)
    ...
    func testmicroamperes_u_to_milliamperes_t() {
    ...
    func testmicroamperes_u_to_milliamperes_u() {
    ...
    func testmicroamperes_u_to_uint16_t() {
    ...
    func testmicroamperes_u_to_uint32_t() {
    ...
    func testmicroamperes_u_to_uint64_t() {
    ...
    func testmicroamperes_u_to_uint8_t() {
    ...
    func testuint16_t_to_microamperes_u() {
    ...
    func testuint32_t_to_microamperes_u() {
    ...
    func testuint64_t_to_microamperes_u() {
