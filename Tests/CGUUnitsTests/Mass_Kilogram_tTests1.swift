...
final class Mass_Kilogram_tTests1: XCTestCase {
    ...
    func testkilogram_tTofloatUsingkilogram_tInt64_maxExpectingFloatInt64_max() {
        let result = kg_t_to_f(kilogram_t(Int64.max))
    ...
    func testkilogram_tTofloatUsingkilogram_tInt64_minExpectingFloatInt64_min() {
        let result = kg_t_to_f(kilogram_t(Int64.min))
    ...
    func testkilogram_tTogram_dUsing2500000Expectinggram_d2500000_01000_0() {
        let result = kg_t_to_g_d(2500000)
    ...
    func testkilogram_tTogram_dUsingInt64_maxExpectinggram_dInt64_max1000_0() {
        let result = kg_t_to_g_d(Int64.max)
    ...
    func testkilogram_tTogram_dUsingInt64_minExpectinggram_dInt64_min1000_0() {
        let result = kg_t_to_g_d(Int64.min)
    ...
    func testkilogram_tTogram_fUsing2500000Expectinggram_f2500000_01000_0() {
        let result = kg_t_to_g_f(2500000)
    ...
    func testkilogram_tTogram_fUsing250000Expectinggram_f250000_01000_0() {
        let result = kg_t_to_g_f(250000)
    ...
    func testkilogram_tTogram_fUsingInt64_maxExpectinggram_fInt64_max1000_0() {
        let result = kg_t_to_g_f(Int64.max)
    ...
    func testkilogram_tTogram_fUsingInt64_minExpectinggram_fInt64_min1000_0() {
        let result = kg_t_to_g_f(Int64.min)
    ...
    func testkilogram_tTogram_fUsingNeg1000Expectinggram_fNeg1000_01000_0() {
    ...
    func testkilogram_tTogram_fUsingNeg10Expectinggram_fNeg10_01000_0() {
        let result = kg_t_to_g_f(-10)
    ...
    func testkilogram_tTogram_fUsingNeg323Expectinggram_fNeg323_01000_0() {
        let result = kg_t_to_g_f(-323)
    ...
    func testkilogram_tTogram_fUsingNeg5Expectinggram_fNeg5_01000_0() {
        let result = kg_t_to_g_f(-5)
