...
final class Acceleration_Centimetres_Per_Seconds_Sq_tTests2: XCTestCase {
    ...
    func testcentimetres_per_seconds_sq_t_to_millimetres_per_picoseconds_sq_u() {
        XCTAssertEqual(cm_per_s_sq_t_to_mm_per_ps_sq_u(-5000000), millimetres_per_picoseconds_sq_u((((Double(-5000000)) * ((Double(10)) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * ((Double(10)) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * ((Double(10)) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()))))
        XCTAssertEqual(cm_per_s_sq_t_to_mm_per_ps_sq_u(0), millimetres_per_picoseconds_sq_u((((Double(0)) * ((Double(10)) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * ((Double(10)) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * ((Double(10)) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()))))
        XCTAssertEqual(cm_per_s_sq_t_to_mm_per_ps_sq_u(5000000), millimetres_per_picoseconds_sq_u((((Double(5000000)) * ((Double(10)) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * ((Double(10)) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * ((Double(10)) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()))))
        XCTAssertEqual(cm_per_s_sq_t_to_mm_per_ps_sq_u(Int64.min), millimetres_per_picoseconds_sq_u(UInt64.min))
        XCTAssertEqual(cm_per_s_sq_t_to_mm_per_ps_sq_u(Int64.max), millimetres_per_picoseconds_sq_u(UInt64.max))
    }
