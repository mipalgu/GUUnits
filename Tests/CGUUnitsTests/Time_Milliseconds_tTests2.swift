...
final class Time_Milliseconds_tTests2: XCTestCase {
    ...
    func testmilliseconds_tTomicroseconds_fUsingInt64_maxExpectingmicroseconds_fInt64_max1000_0() {
        let result = ms_t_to_us_f(Int64.max)
        let expected: microseconds_f = microseconds_f(Int64.max) * 1000.0
        let tolerance: microseconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmilliseconds_tTomicroseconds_fUsingInt64_minExpectingmicroseconds_fInt64_min1000_0() {
        let result = ms_t_to_us_f(Int64.min)
        let expected: microseconds_f = microseconds_f(Int64.min) * 1000.0
        let tolerance: microseconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
