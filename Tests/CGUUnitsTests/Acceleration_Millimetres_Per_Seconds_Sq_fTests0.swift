...
final class Acceleration_Millimetres_Per_Seconds_Sq_fTests0: XCTestCase {
    ...
    func testmillimetres_per_seconds_sq_f_to_centimetres_per_nanoseconds_sq_d() {
        let result = mm_per_s_sq_f_to_cm_per_ns_sq_d(-5000000)
        ...
        let result1 = mm_per_s_sq_f_to_cm_per_ns_sq_d(0)
        ...
        let result2 = mm_per_s_sq_f_to_cm_per_ns_sq_d(5000000)
        ...
        let result3 = mm_per_s_sq_f_to_cm_per_ns_sq_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_sq_f_to_cm_per_ns_sq_d(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_sq_f_to_centimetres_per_nanoseconds_sq_f() {
        let result = mm_per_s_sq_f_to_cm_per_ns_sq_f(-5000000)
        ...
        let result1 = mm_per_s_sq_f_to_cm_per_ns_sq_f(0)
        ...
        let result2 = mm_per_s_sq_f_to_cm_per_ns_sq_f(5000000)
        ...
        let result3 = mm_per_s_sq_f_to_cm_per_ns_sq_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_sq_f_to_cm_per_ns_sq_f(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_sq_f_to_centimetres_per_nanoseconds_sq_t() {
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ns_sq_t(-5000000), centimetres_per_nanoseconds_sq_t((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()))))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ns_sq_t(0), centimetres_per_nanoseconds_sq_t((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()))))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ns_sq_t(5000000), centimetres_per_nanoseconds_sq_t((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()))))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ns_sq_t(-Float.greatestFiniteMagnitude), centimetres_per_nanoseconds_sq_t(Int64.min))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ns_sq_t(Float.greatestFiniteMagnitude), centimetres_per_nanoseconds_sq_t(Int64.max))
    }

    func testmillimetres_per_seconds_sq_f_to_centimetres_per_nanoseconds_sq_u() {
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ns_sq_u(-5000000), centimetres_per_nanoseconds_sq_u((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()))))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ns_sq_u(0), centimetres_per_nanoseconds_sq_u((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()))))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ns_sq_u(5000000), centimetres_per_nanoseconds_sq_u((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000)) * (Double(1000000000))))).rounded()))))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ns_sq_u(-Float.greatestFiniteMagnitude), centimetres_per_nanoseconds_sq_u(UInt64.min))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ns_sq_u(Float.greatestFiniteMagnitude), centimetres_per_nanoseconds_sq_u(UInt64.max))
    }

    func testmillimetres_per_seconds_sq_f_to_centimetres_per_picoseconds_sq_d() {
        let result = mm_per_s_sq_f_to_cm_per_ps_sq_d(-5000000)
        ...
        let result1 = mm_per_s_sq_f_to_cm_per_ps_sq_d(0)
        ...
        let result2 = mm_per_s_sq_f_to_cm_per_ps_sq_d(5000000)
        ...
        let result3 = mm_per_s_sq_f_to_cm_per_ps_sq_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_sq_f_to_cm_per_ps_sq_d(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_sq_f_to_centimetres_per_picoseconds_sq_f() {
        let result = mm_per_s_sq_f_to_cm_per_ps_sq_f(-5000000)
        ...
        let result1 = mm_per_s_sq_f_to_cm_per_ps_sq_f(0)
        ...
        let result2 = mm_per_s_sq_f_to_cm_per_ps_sq_f(5000000)
        ...
        let result3 = mm_per_s_sq_f_to_cm_per_ps_sq_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = mm_per_s_sq_f_to_cm_per_ps_sq_f(Float.greatestFiniteMagnitude)
    ...
    func testmillimetres_per_seconds_sq_f_to_centimetres_per_picoseconds_sq_t() {
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ps_sq_t(-5000000), centimetres_per_picoseconds_sq_t((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()))))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ps_sq_t(0), centimetres_per_picoseconds_sq_t((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()))))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ps_sq_t(5000000), centimetres_per_picoseconds_sq_t((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()))))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ps_sq_t(-Float.greatestFiniteMagnitude), centimetres_per_picoseconds_sq_t(Int64.min))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ps_sq_t(Float.greatestFiniteMagnitude), centimetres_per_picoseconds_sq_t(Int64.max))
    }

    func testmillimetres_per_seconds_sq_f_to_centimetres_per_picoseconds_sq_u() {
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ps_sq_u(-5000000), centimetres_per_picoseconds_sq_u((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()))))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ps_sq_u(0), centimetres_per_picoseconds_sq_u((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()))))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ps_sq_u(5000000), centimetres_per_picoseconds_sq_u((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(1)) / (Double(10))) / ((Double(1000000000000)) * (Double(1000000000000))))).rounded()))))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ps_sq_u(-Float.greatestFiniteMagnitude), centimetres_per_picoseconds_sq_u(UInt64.min))
        XCTAssertEqual(mm_per_s_sq_f_to_cm_per_ps_sq_u(Float.greatestFiniteMagnitude), centimetres_per_picoseconds_sq_u(UInt64.max))
    }
