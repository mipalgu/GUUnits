...
final class Velocity_Millimetres_Per_Milliseconds_uTests2: XCTestCase {
    ...
    func testmillimetres_per_milliseconds_u_to_millimetres_per_nanoseconds_f() {
        let result = mm_per_ms_u_to_mm_per_ns_f(0)
        let expected: millimetres_per_nanoseconds_f = millimetres_per_nanoseconds_f((Double(0)) / (Double(1000000)))
        ...
        let result1 = mm_per_ms_u_to_mm_per_ns_f(5000000)
        let expected1: millimetres_per_nanoseconds_f = millimetres_per_nanoseconds_f((Double(5000000)) / (Double(1000000)))
        ...
        let result2 = mm_per_ms_u_to_mm_per_ns_f(UInt64.min)
        let expected2: millimetres_per_nanoseconds_f = millimetres_per_nanoseconds_f(((Double(UInt64.min)) / (Double(1000000))).rounded())
        ...
        let result3 = mm_per_ms_u_to_mm_per_ns_f(UInt64.max)
    ...
    func testmillimetres_per_milliseconds_u_to_millimetres_per_nanoseconds_t() {
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ns_t(0), millimetres_per_nanoseconds_t(Int64(clamping: (UInt64(0)) / (UInt64(1000000)))))
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ns_t(5000000), millimetres_per_nanoseconds_t(Int64(clamping: (UInt64(5000000)) / (UInt64(1000000)))))
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ns_t(UInt64.min), millimetres_per_nanoseconds_t((UInt64(UInt64.min)) / (UInt64(1000000))))
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ns_t(UInt64.max), millimetres_per_nanoseconds_t(Int64.max))
    }

    func testmillimetres_per_milliseconds_u_to_millimetres_per_nanoseconds_u() {
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ns_u(0), millimetres_per_nanoseconds_u(UInt64(clamping: (UInt64(0)) / (UInt64(1000000)))))
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ns_u(5000000), millimetres_per_nanoseconds_u(UInt64(clamping: (UInt64(5000000)) / (UInt64(1000000)))))
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ns_u(UInt64.min), millimetres_per_nanoseconds_u((UInt64(UInt64.min)) / (UInt64(1000000))))
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ns_u(UInt64.max), millimetres_per_nanoseconds_u(UInt64.max))
    }

    func testmillimetres_per_milliseconds_u_to_millimetres_per_picoseconds_d() {
        let result = mm_per_ms_u_to_mm_per_ps_d(0)
        let expected: millimetres_per_picoseconds_d = millimetres_per_picoseconds_d((Double(0)) / (Double(1000000000)))
        ...
        let result1 = mm_per_ms_u_to_mm_per_ps_d(5000000)
        let expected1: millimetres_per_picoseconds_d = millimetres_per_picoseconds_d((Double(5000000)) / (Double(1000000000)))
        ...
        let result2 = mm_per_ms_u_to_mm_per_ps_d(UInt64.min)
        let expected2: millimetres_per_picoseconds_d = millimetres_per_picoseconds_d(((Double(UInt64.min)) / (Double(1000000000))).rounded())
        ...
        let result3 = mm_per_ms_u_to_mm_per_ps_d(UInt64.max)
    ...
    func testmillimetres_per_milliseconds_u_to_millimetres_per_picoseconds_f() {
        let result = mm_per_ms_u_to_mm_per_ps_f(0)
        let expected: millimetres_per_picoseconds_f = millimetres_per_picoseconds_f((Double(0)) / (Double(1000000000)))
        ...
        let result1 = mm_per_ms_u_to_mm_per_ps_f(5000000)
        let expected1: millimetres_per_picoseconds_f = millimetres_per_picoseconds_f((Double(5000000)) / (Double(1000000000)))
        ...
        let result2 = mm_per_ms_u_to_mm_per_ps_f(UInt64.min)
        let expected2: millimetres_per_picoseconds_f = millimetres_per_picoseconds_f(((Double(UInt64.min)) / (Double(1000000000))).rounded())
        ...
        let result3 = mm_per_ms_u_to_mm_per_ps_f(UInt64.max)
    ...
    func testmillimetres_per_milliseconds_u_to_millimetres_per_picoseconds_t() {
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ps_t(0), millimetres_per_picoseconds_t(Int64(clamping: (UInt64(0)) / (UInt64(1000000000)))))
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ps_t(5000000), millimetres_per_picoseconds_t(Int64(clamping: (UInt64(5000000)) / (UInt64(1000000000)))))
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ps_t(UInt64.min), millimetres_per_picoseconds_t((UInt64(UInt64.min)) / (UInt64(1000000000))))
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ps_t(UInt64.max), millimetres_per_picoseconds_t(Int64.max))
    }

    func testmillimetres_per_milliseconds_u_to_millimetres_per_picoseconds_u() {
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ps_u(0), millimetres_per_picoseconds_u(UInt64(clamping: (UInt64(0)) / (UInt64(1000000000)))))
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ps_u(5000000), millimetres_per_picoseconds_u(UInt64(clamping: (UInt64(5000000)) / (UInt64(1000000000)))))
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ps_u(UInt64.min), millimetres_per_picoseconds_u((UInt64(UInt64.min)) / (UInt64(1000000000))))
        XCTAssertEqual(mm_per_ms_u_to_mm_per_ps_u(UInt64.max), millimetres_per_picoseconds_u(UInt64.max))
    }
