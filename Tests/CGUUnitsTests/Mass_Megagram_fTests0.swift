...
final class Mass_Megagram_fTests0: XCTestCase {
    ...
    func testint16_t_to_megagram_f() {
        ...
        let expected2: megagram_f = megagram_f(Int16.min)
        let tolerance2: megagram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: megagram_f = megagram_f(Int16.max)
        let tolerance3: megagram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint32_t_to_megagram_f() {
        ...
        let expected2: megagram_f = megagram_f(Int32.min)
        let tolerance2: megagram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: megagram_f = megagram_f(Int32.max)
        let tolerance3: megagram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint64_t_to_megagram_f() {
        ...
        let expected2: megagram_f = megagram_f(Int64.min)
        let tolerance2: megagram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: megagram_f = megagram_f(Int64.max)
        let tolerance3: megagram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint8_t_to_megagram_f() {
        ...
        let expected2: megagram_f = megagram_f(Int8.min)
        let tolerance2: megagram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: megagram_f = megagram_f(Int8.max)
        let tolerance3: megagram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmegagram_f_to_double() {
        ...
        let result2 = Mg_f_to_d(megagram_f(-Float.greatestFiniteMagnitude))
        ...
        let result3 = Mg_f_to_d(megagram_f(Float.greatestFiniteMagnitude))
    ...
    func testmegagram_f_to_float() {
        ...
        let result2 = Mg_f_to_f(megagram_f(-Float.greatestFiniteMagnitude))
        ...
        let result3 = Mg_f_to_f(megagram_f(Float.greatestFiniteMagnitude))
    ...
    func testmegagram_f_to_gram_d1() {
    ...
    func testmegagram_f_to_gram_f1() {
    ...
    func testmegagram_f_to_gram_t1() {
    ...
    func testmegagram_f_to_gram_u1() {
    ...
    func testmegagram_f_to_int16_t() {
    ...
    func testmegagram_f_to_int32_t() {
    ...
    func testmegagram_f_to_int64_t() {
    ...
    func testmegagram_f_to_kilogram_d() {
    ...
    func testmegagram_f_to_kilogram_d1() {
    ...
    func testmegagram_f_to_kilogram_f() {
    ...
    func testmegagram_f_to_kilogram_f1() {
    ...
    func testmegagram_f_to_kilogram_t() {
        XCTAssertEqual(Mg_f_to_kg_t(15.0), kilogram_t((Float(15.0) * 1000.0).rounded()))
        XCTAssertEqual(Mg_f_to_kg_t(25.0), kilogram_t((Float(25.0) * 1000.0).rounded()))
        XCTAssertEqual(Mg_f_to_kg_t(250.0), kilogram_t((Float(250.0) * 1000.0).rounded()))
        XCTAssertEqual(Mg_f_to_kg_t(0.0), kilogram_t((Float(0.0) * 1000.0).rounded()))
        XCTAssertEqual(Mg_f_to_kg_t(2500.0), kilogram_t((Float(2500.0) * 1000.0).rounded()))
        XCTAssertEqual(Mg_f_to_kg_t(25000.0), kilogram_t((Float(25000.0) * 1000.0).rounded()))
        XCTAssertEqual(Mg_f_to_kg_t(250000.0), kilogram_t((Float(250000.0) * 1000.0).rounded()))
        XCTAssertEqual(Mg_f_to_kg_t(2500000.0), kilogram_t((Float(2500000.0) * 1000.0).rounded()))
        XCTAssertEqual(Mg_f_to_kg_t(-323.0), kilogram_t((Float(-323.0) * 1000.0).rounded()))
        XCTAssertEqual(Mg_f_to_kg_t(-10.0), kilogram_t((Float(-10.0) * 1000.0).rounded()))
    }

    func testmegagram_f_to_kilogram_t1() {
        XCTAssertEqual(Mg_f_to_kg_t(-1000.0), kilogram_t((Float(-1000.0) * 1000.0).rounded()))
        XCTAssertEqual(Mg_f_to_kg_t(-5.0), kilogram_t((Float(-5.0) * 1000.0).rounded()))
    ...
    func testmegagram_f_to_kilogram_u() {
        XCTAssertEqual(Mg_f_to_kg_u(15.0), kilogram_u((Float(15.0) * 1000.0).rounded()))
        ...
        XCTAssertEqual(Mg_f_to_kg_u(0.0), kilogram_u((Float(0.0) * 1000.0).rounded()))
        ...
        XCTAssertEqual(Mg_f_to_kg_u(250000.0), kilogram_u((Float(250000.0) * 1000.0).rounded()))
        XCTAssertEqual(Mg_f_to_kg_u(2500000.0), kilogram_u((Float(2500000.0) * 1000.0).rounded()))
        XCTAssertEqual(Mg_f_to_kg_u(-323.0), 0)
        XCTAssertEqual(Mg_f_to_kg_u(-10.0), 0)
    }

    func testmegagram_f_to_kilogram_u1() {
    ...
    func testmegagram_f_to_megagram_d() {
        ...
        let result1 = Mg_f_to_Mg_d(megagram_f(-Float.greatestFiniteMagnitude))
        let expected1: megagram_d = megagram_d(-Float.greatestFiniteMagnitude)
        ...
        let result2 = Mg_f_to_Mg_d(megagram_f(Float.greatestFiniteMagnitude))
        ...
        let result3 = Mg_f_to_Mg_d(5.0)
        let expected3: megagram_d = 5.0
    ...
    func testmegagram_f_to_megagram_t() {
