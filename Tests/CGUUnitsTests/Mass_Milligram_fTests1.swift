...
final class Mass_Milligram_fTests1: XCTestCase {
    ...
    func testmilligram_f_to_megagram_f() {
    ...
    func testmilligram_f_to_megagram_f1() {
        ...
        let expected2: megagram_f = megagram_f(-Float.greatestFiniteMagnitude) / 1000000000.0
        let tolerance2: megagram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: megagram_f = megagram_f(Float.greatestFiniteMagnitude) / 1000000000.0
        let tolerance3: megagram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmilligram_f_to_megagram_t() {
        XCTAssertEqual(mg_f_to_Mg_t(15.0), megagram_t((Float(15.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_t(25.0), megagram_t((Float(25.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_t(250.0), megagram_t((Float(250.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_t(0.0), megagram_t((Float(0.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_t(2500.0), megagram_t((Float(2500.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_t(25000.0), megagram_t((Float(25000.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_t(250000.0), megagram_t((Float(250000.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_t(2500000.0), megagram_t((Float(2500000.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_t(-323.0), megagram_t((Float(-323.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_t(-10.0), megagram_t((Float(-10.0) / 1000000000.0).rounded()))
    }

    func testmilligram_f_to_megagram_t1() {
        XCTAssertEqual(mg_f_to_Mg_t(-1000.0), megagram_t((Float(-1000.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_t(-5.0), megagram_t((Float(-5.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_t(-Float.greatestFiniteMagnitude), megagram_t(Int64.min))
        XCTAssertEqual(mg_f_to_Mg_t(Float.greatestFiniteMagnitude), megagram_t(Int64.max))
    }

    func testmilligram_f_to_megagram_u() {
        XCTAssertEqual(mg_f_to_Mg_u(15.0), megagram_u((Float(15.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_u(25.0), megagram_u((Float(25.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_u(250.0), megagram_u((Float(250.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_u(0.0), megagram_u((Float(0.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_u(2500.0), megagram_u((Float(2500.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_u(25000.0), megagram_u((Float(25000.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_u(250000.0), megagram_u((Float(250000.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_u(2500000.0), megagram_u((Float(2500000.0) / 1000000000.0).rounded()))
        XCTAssertEqual(mg_f_to_Mg_u(-323.0), 0)
        XCTAssertEqual(mg_f_to_Mg_u(-10.0), 0)
    }

    func testmilligram_f_to_megagram_u1() {
        XCTAssertEqual(mg_f_to_Mg_u(-1000.0), 0)
        XCTAssertEqual(mg_f_to_Mg_u(-6.0), 0)
        XCTAssertEqual(mg_f_to_Mg_u(-Float.greatestFiniteMagnitude), megagram_u(UInt64.min))
        XCTAssertEqual(mg_f_to_Mg_u(Float.greatestFiniteMagnitude), megagram_u(UInt64.max))
    }

    func testmilligram_f_to_microgram_d() {
    ...
    func testmilligram_f_to_microgram_d1() {
        ...
        let expected2: microgram_d = microgram_d(-Float.greatestFiniteMagnitude) * 1000.0
        let tolerance2: microgram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: microgram_d = microgram_d(Float.greatestFiniteMagnitude) * 1000.0
        let tolerance3: microgram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmilligram_f_to_microgram_f() {
    ...
    func testmilligram_f_to_microgram_f1() {
    ...
    func testmilligram_f_to_microgram_t() {
    ...
    func testmilligram_f_to_microgram_t1() {
    ...
    func testmilligram_f_to_microgram_u() {
    ...
    func testmilligram_f_to_microgram_u1() {
    ...
    func testmilligram_f_to_milligram_d() {
        ...
        let result1 = mg_f_to_mg_d(milligram_f(-Float.greatestFiniteMagnitude))
        let expected1: milligram_d = milligram_d(-Float.greatestFiniteMagnitude)
        ...
        let result2 = mg_f_to_mg_d(milligram_f(Float.greatestFiniteMagnitude))
    ...
    func testmilligram_f_to_milligram_t() {
    ...
    func testmilligram_f_to_milligram_u() {
    ...
    func testmilligram_f_to_uint16_t() {
    ...
    func testmilligram_f_to_uint32_t() {
    ...
    func testmilligram_f_to_uint64_t() {
    ...
    func testmilligram_f_to_uint8_t() {
    ...
    func testuint16_t_to_milligram_f() {
        ...
        let expected2: milligram_f = milligram_f(UInt16.min)
        ...
        let expected3: milligram_f = milligram_f(UInt16.max)
    ...
    func testuint32_t_to_milligram_f() {
        ...
        let expected2: milligram_f = milligram_f(UInt32.min)
        let tolerance2: milligram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: milligram_f = milligram_f(UInt32.max)
        let tolerance3: milligram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint64_t_to_milligram_f() {
        ...
        let expected2: milligram_f = milligram_f(UInt64.min)
        let tolerance2: milligram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: milligram_f = milligram_f(UInt64.max)
        let tolerance3: milligram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint8_t_to_milligram_f() {
        ...
        let expected2: milligram_f = milligram_f(UInt8.min)
        let tolerance2: milligram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: milligram_f = milligram_f(UInt8.max)
        let tolerance3: milligram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
