...
final class Mass_Microgram_tTests0: XCTestCase {
    ...
    func testdouble_to_microgram_t() {
    ...
    func testint16_t_to_microgram_t() {
    ...
    func testint32_t_to_microgram_t() {
    ...
    func testint64_t_to_microgram_t() {
    ...
    func testint8_t_to_microgram_t() {
    ...
    func testmicrogram_t_to_double() {
        ...
        let result2 = ug_t_to_d(microgram_t(Int64.min))
        ...
        let result3 = ug_t_to_d(microgram_t(Int64.max))
    ...
    func testmicrogram_t_to_float() {
        ...
        let result2 = ug_t_to_f(microgram_t(Int64.min))
        ...
        let result3 = ug_t_to_f(microgram_t(Int64.max))
    ...
    func testmicrogram_t_to_gram_d() {
        let result = ug_t_to_g_d(15)
        ...
        let result6 = ug_t_to_g_d(250000)
        ...
        let result7 = ug_t_to_g_d(2500000)
    ...
    func testmicrogram_t_to_gram_d1() {
        let result = ug_t_to_g_d(-1000)
        ...
        let result2 = ug_t_to_g_d(Int64.min)
        let expected2: gram_d = gram_d(Int64.min) / 1000000.0
        let tolerance2: gram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = ug_t_to_g_d(Int64.max)
        let expected3: gram_d = gram_d(Int64.max) / 1000000.0
        let tolerance3: gram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmicrogram_t_to_gram_f() {
        let result = ug_t_to_g_f(15)
        ...
        let result6 = ug_t_to_g_f(250000)
        ...
        let result7 = ug_t_to_g_f(2500000)
    ...
    func testmicrogram_t_to_gram_f1() {
        let result = ug_t_to_g_f(-1000)
        ...
        let result2 = ug_t_to_g_f(Int64.min)
        let expected2: gram_f = gram_f(Int64.min) / 1000000.0
        let tolerance2: gram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = ug_t_to_g_f(Int64.max)
        let expected3: gram_f = gram_f(Int64.max) / 1000000.0
        let tolerance3: gram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmicrogram_t_to_gram_t() {
        XCTAssertEqual(ug_t_to_g_t(15), gram_t(15) / 1000000)
        XCTAssertEqual(ug_t_to_g_t(25), gram_t(25) / 1000000)
        XCTAssertEqual(ug_t_to_g_t(250), gram_t(250) / 1000000)
        XCTAssertEqual(ug_t_to_g_t(0), gram_t(0) / 1000000)
        XCTAssertEqual(ug_t_to_g_t(2500), gram_t(2500) / 1000000)
        XCTAssertEqual(ug_t_to_g_t(25000), gram_t(25000) / 1000000)
        XCTAssertEqual(ug_t_to_g_t(250000), gram_t(250000) / 1000000)
        XCTAssertEqual(ug_t_to_g_t(2500000), gram_t(2500000) / 1000000)
        XCTAssertEqual(ug_t_to_g_t(-323), gram_t(-323) / 1000000)
        XCTAssertEqual(ug_t_to_g_t(-10), gram_t(-10) / 1000000)
    }

    func testmicrogram_t_to_gram_t1() {
        XCTAssertEqual(ug_t_to_g_t(-1000), gram_t(-1000) / 1000000)
        XCTAssertEqual(ug_t_to_g_t(-5), gram_t(-5) / 1000000)
        XCTAssertEqual(ug_t_to_g_t(Int64.min), gram_t(Int64.min) / 1000000)
        XCTAssertEqual(ug_t_to_g_t(Int64.max), gram_t(Int64.max) / 1000000)
    }

    func testmicrogram_t_to_gram_u() {
        XCTAssertEqual(ug_t_to_g_u(15), gram_u(15) / 1000000)
        XCTAssertEqual(ug_t_to_g_u(25), gram_u(25) / 1000000)
        XCTAssertEqual(ug_t_to_g_u(250), gram_u(250) / 1000000)
        XCTAssertEqual(ug_t_to_g_u(0), gram_u(0) / 1000000)
        XCTAssertEqual(ug_t_to_g_u(2500), gram_u(2500) / 1000000)
        XCTAssertEqual(ug_t_to_g_u(25000), gram_u(25000) / 1000000)
        XCTAssertEqual(ug_t_to_g_u(250000), gram_u(250000) / 1000000)
        XCTAssertEqual(ug_t_to_g_u(2500000), gram_u(2500000) / 1000000)
        XCTAssertEqual(ug_t_to_g_u(-323), 0)
        XCTAssertEqual(ug_t_to_g_u(-10), 0)
    }

    func testmicrogram_t_to_gram_u1() {
        XCTAssertEqual(ug_t_to_g_u(-1000), 0)
        XCTAssertEqual(ug_t_to_g_u(-6), 0)
        XCTAssertEqual(ug_t_to_g_u(Int64.min), 0)
        XCTAssertEqual(ug_t_to_g_u(Int64.max), gram_u(Int64.max) / 1000000)
    }

    func testmicrogram_t_to_int16_t() {
        XCTAssertEqual(ug_t_to_i16(0), 0)
        XCTAssertEqual(ug_t_to_i16(5), 5)
    ...
    func testmicrogram_t_to_int32_t() {
    ...
    func testmicrogram_t_to_int64_t() {
    ...
    func testmicrogram_t_to_int8_t() {
    ...
    func testmicrogram_t_to_kilogram_d() {
        ...
        let result5 = ug_t_to_kg_d(25000)
        ...
        let result6 = ug_t_to_kg_d(250000)
        ...
        let result7 = ug_t_to_kg_d(2500000)
    ...
    func testmicrogram_t_to_kilogram_d1() {
        ...
        let result2 = ug_t_to_kg_d(Int64.min)
        let expected2: kilogram_d = kilogram_d(Int64.min) / 1000000000.0
        let tolerance2: kilogram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = ug_t_to_kg_d(Int64.max)
        let expected3: kilogram_d = kilogram_d(Int64.max) / 1000000000.0
        let tolerance3: kilogram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmicrogram_t_to_kilogram_f() {
        ...
        let result5 = ug_t_to_kg_f(25000)
        ...
        let result6 = ug_t_to_kg_f(250000)
        ...
        let result7 = ug_t_to_kg_f(2500000)
    ...
    func testmicrogram_t_to_kilogram_f1() {
        ...
        let result2 = ug_t_to_kg_f(Int64.min)
        let expected2: kilogram_f = kilogram_f(Int64.min) / 1000000000.0
        let tolerance2: kilogram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = ug_t_to_kg_f(Int64.max)
        let expected3: kilogram_f = kilogram_f(Int64.max) / 1000000000.0
        let tolerance3: kilogram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmicrogram_t_to_kilogram_t() {
    ...
    func testmicrogram_t_to_kilogram_t1() {
    ...
    func testmicrogram_t_to_kilogram_u() {
        XCTAssertEqual(ug_t_to_kg_u(15), kilogram_u(15) / 1000000000)
        XCTAssertEqual(ug_t_to_kg_u(25), kilogram_u(25) / 1000000000)
        XCTAssertEqual(ug_t_to_kg_u(250), kilogram_u(250) / 1000000000)
        XCTAssertEqual(ug_t_to_kg_u(0), kilogram_u(0) / 1000000000)
        XCTAssertEqual(ug_t_to_kg_u(2500), kilogram_u(2500) / 1000000000)
        XCTAssertEqual(ug_t_to_kg_u(25000), kilogram_u(25000) / 1000000000)
        ...
        XCTAssertEqual(ug_t_to_kg_u(-323), 0)
        XCTAssertEqual(ug_t_to_kg_u(-10), 0)
    }

    func testmicrogram_t_to_kilogram_u1() {
        XCTAssertEqual(ug_t_to_kg_u(-1000), 0)
        XCTAssertEqual(ug_t_to_kg_u(-6), 0)
        XCTAssertEqual(ug_t_to_kg_u(Int64.min), 0)
        XCTAssertEqual(ug_t_to_kg_u(Int64.max), kilogram_u(Int64.max) / 1000000000)
    }

    func testmicrogram_t_to_megagram_d() {
    ...
    func testmicrogram_t_to_megagram_d1() {
        ...
        let expected2: megagram_d = megagram_d(Int64.min) / 1000000000000.0
        let tolerance2: megagram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: megagram_d = megagram_d(Int64.max) / 1000000000000.0
        let tolerance3: megagram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
