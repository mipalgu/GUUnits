...
final class Velocity_Centimetres_Per_Seconds_fTests3: XCTestCase {
    ...
    func testcentimetres_per_seconds_fTometres_per_milliseconds_dUsing0Expectingmetres_per_milliseconds_dDouble0Double1Double100Double1000() {
        let result = cm_per_s_f_to_m_per_ms_d(0)
    ...
    func testcentimetres_per_seconds_fTometres_per_milliseconds_dUsing5000000Expectingmetres_per_milliseconds_dDouble5000000Double1Double100Double1000() {
    ...
    func testcentimetres_per_seconds_fTometres_per_milliseconds_dUsingFloat_greatestFiniteMagnitudeExpectingmetres_per_milliseconds_dDouble_greatestFiniteMagnitude() {
        let result = cm_per_s_f_to_m_per_ms_d(Float.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_seconds_fTometres_per_milliseconds_dUsingNeg5000000Expectingmetres_per_milliseconds_dDoubleNeg5000000Double1Double100Double1000() {
        let result = cm_per_s_f_to_m_per_ms_d(-5000000)
        let expected: metres_per_milliseconds_d = metres_per_milliseconds_d((Double(-5000000)) * (((Double(1)) / (Double(100))) / (Double(1000))))
        let tolerance: metres_per_milliseconds_d = 0.99
        if result > expected {
    ...
    func testcentimetres_per_seconds_fTometres_per_milliseconds_dUsingNegFloat_greatestFiniteMagnitudeExpectingmetres_per_milliseconds_dNegDouble_greatestFiniteMagnitude() {
        let result = cm_per_s_f_to_m_per_ms_d(-Float.greatestFiniteMagnitude)
        let expected: metres_per_milliseconds_d = metres_per_milliseconds_d(-Double.greatestFiniteMagnitude)
        let tolerance: metres_per_milliseconds_d = 0.99
        if result > expected {
    ...
    func testcentimetres_per_seconds_fTometres_per_milliseconds_fUsing0Expectingmetres_per_milliseconds_fDouble0Double1Double100Double1000() {
        let result = cm_per_s_f_to_m_per_ms_f(0)
    ...
    func testcentimetres_per_seconds_fTometres_per_milliseconds_fUsingFloat_greatestFiniteMagnitudeExpectingmetres_per_milliseconds_fFloat_greatestFiniteMagnitude() {
        let result = cm_per_s_f_to_m_per_ms_f(Float.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_seconds_fTometres_per_seconds_dUsing0Expectingmetres_per_seconds_dDouble0Double100() {
        let result = cm_per_s_f_to_m_per_s_d(0)
