...
final class Mass_Microgram_dTests1: XCTestCase {
    ...
    func testmicrogram_d_to_megagram_f() {
        ...
        let result2 = ug_d_to_Mg_f(250.0)
        ...
        let result4 = ug_d_to_Mg_f(2500.0)
        ...
        let result5 = ug_d_to_Mg_f(25000.0)
        ...
        let result6 = ug_d_to_Mg_f(250000.0)
        ...
        let result7 = ug_d_to_Mg_f(2500000.0)
        ...
        let result8 = ug_d_to_Mg_f(-323.0)
    ...
    func testmicrogram_d_to_megagram_f1() {
        ...
        let result2 = ug_d_to_Mg_f(-Double.greatestFiniteMagnitude)
        ...
        let result3 = ug_d_to_Mg_f(Double.greatestFiniteMagnitude)
    ...
    func testmicrogram_d_to_megagram_t() {
    ...
    func testmicrogram_d_to_megagram_t1() {
    ...
    func testmicrogram_d_to_megagram_u() {
    ...
    func testmicrogram_d_to_megagram_u1() {
    ...
    func testmicrogram_d_to_microgram_f() {
        ...
        let result1 = ug_d_to_ug_f(microgram_d(-Double.greatestFiniteMagnitude))
        let expected1: microgram_f = microgram_f(-Float.greatestFiniteMagnitude)
        ...
        let result2 = ug_d_to_ug_f(microgram_d(Double.greatestFiniteMagnitude))
    ...
    func testmicrogram_d_to_microgram_t() {
    ...
    func testmicrogram_d_to_microgram_u() {
    ...
    func testmicrogram_d_to_milligram_d() {
    ...
    func testmicrogram_d_to_milligram_d1() {
        ...
        let expected2: milligram_d = milligram_d(-Double.greatestFiniteMagnitude) / 1000.0
        let tolerance2: milligram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: milligram_d = milligram_d(Double.greatestFiniteMagnitude) / 1000.0
        let tolerance3: milligram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmicrogram_d_to_milligram_f() {
        let result = ug_d_to_mg_f(15.0)
    ...
    func testmicrogram_d_to_milligram_f1() {
        let result = ug_d_to_mg_f(-1000.0)
    ...
    func testmicrogram_d_to_milligram_t() {
    ...
    func testmicrogram_d_to_milligram_t1() {
    ...
    func testmicrogram_d_to_milligram_u() {
    ...
    func testmicrogram_d_to_milligram_u1() {
        XCTAssertEqual(ug_d_to_mg_u(-1000.0), 0)
        XCTAssertEqual(ug_d_to_mg_u(-6.0), 0)
    ...
    func testmicrogram_d_to_uint16_t() {
    ...
    func testmicrogram_d_to_uint32_t() {
    ...
    func testmicrogram_d_to_uint64_t() {
    ...
    func testmicrogram_d_to_uint8_t() {
    ...
    func testuint16_t_to_microgram_d() {
        ...
        let result2 = u16_to_ug_d(UInt16(UInt16.min))
        let expected2: microgram_d = microgram_d(UInt16.min)
        ...
        let result3 = u16_to_ug_d(UInt16(UInt16.max))
        let expected3: microgram_d = microgram_d(UInt16.max)
    ...
    func testuint32_t_to_microgram_d() {
        ...
        let result2 = u32_to_ug_d(UInt32(UInt32.min))
        let expected2: microgram_d = microgram_d(UInt32.min)
        let tolerance2: microgram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u32_to_ug_d(UInt32(UInt32.max))
        let expected3: microgram_d = microgram_d(UInt32.max)
        let tolerance3: microgram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint64_t_to_microgram_d() {
        ...
        let result2 = u64_to_ug_d(UInt64(UInt64.min))
        let expected2: microgram_d = microgram_d(UInt64.min)
        let tolerance2: microgram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u64_to_ug_d(UInt64(UInt64.max))
        let expected3: microgram_d = microgram_d(UInt64.max)
        let tolerance3: microgram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testuint8_t_to_microgram_d() {
        ...
        let result2 = u8_to_ug_d(UInt8(UInt8.min))
        let expected2: microgram_d = microgram_d(UInt8.min)
        let tolerance2: microgram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = u8_to_ug_d(UInt8(UInt8.max))
        let expected3: microgram_d = microgram_d(UInt8.max)
        let tolerance3: microgram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
