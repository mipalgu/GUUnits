...
final class Mass_Kilogram_dTests0: XCTestCase {
    ...
    func testdouble_to_kilogram_d() {
        ...
        let result2 = d_to_kg_d(Double(-Double.greatestFiniteMagnitude))
        ...
        let result3 = d_to_kg_d(Double(Double.greatestFiniteMagnitude))
    ...
    func testfloat_to_kilogram_d() {
        ...
        let result2 = f_to_kg_d(Float(-Float.greatestFiniteMagnitude))
        ...
        let result3 = f_to_kg_d(Float(Float.greatestFiniteMagnitude))
        let expected3: kilogram_d = kilogram_d(Float.greatestFiniteMagnitude)
        let tolerance3: kilogram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint16_t_to_kilogram_d() {
        ...
        let result2 = i16_to_kg_d(Int16(Int16.min))
        let expected2: kilogram_d = kilogram_d(Int16.min)
        let tolerance2: kilogram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i16_to_kg_d(Int16(Int16.max))
        let expected3: kilogram_d = kilogram_d(Int16.max)
        let tolerance3: kilogram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint32_t_to_kilogram_d() {
        ...
        let result2 = i32_to_kg_d(Int32(Int32.min))
        let expected2: kilogram_d = kilogram_d(Int32.min)
        let tolerance2: kilogram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i32_to_kg_d(Int32(Int32.max))
        let expected3: kilogram_d = kilogram_d(Int32.max)
        let tolerance3: kilogram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint64_t_to_kilogram_d() {
        ...
        let result2 = i64_to_kg_d(Int64(Int64.min))
        let expected2: kilogram_d = kilogram_d(Int64.min)
        let tolerance2: kilogram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i64_to_kg_d(Int64(Int64.max))
        let expected3: kilogram_d = kilogram_d(Int64.max)
        let tolerance3: kilogram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint8_t_to_kilogram_d() {
        ...
        let result2 = i8_to_kg_d(Int8(Int8.min))
        let expected2: kilogram_d = kilogram_d(Int8.min)
        let tolerance2: kilogram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i8_to_kg_d(Int8(Int8.max))
        let expected3: kilogram_d = kilogram_d(Int8.max)
        let tolerance3: kilogram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testkilogram_d_to_double() {
        ...
        let result2 = kg_d_to_d(kilogram_d(-Double.greatestFiniteMagnitude))
        ...
        let result3 = kg_d_to_d(kilogram_d(Double.greatestFiniteMagnitude))
    ...
    func testkilogram_d_to_float() {
        ...
        let result2 = kg_d_to_f(kilogram_d(-Double.greatestFiniteMagnitude))
        ...
        let result3 = kg_d_to_f(kilogram_d(Double.greatestFiniteMagnitude))
    ...
    func testkilogram_d_to_gram_d() {
        let result = kg_d_to_g_d(15.0)
        ...
        let result4 = kg_d_to_g_d(2500.0)
        ...
        let result5 = kg_d_to_g_d(25000.0)
        ...
        let result6 = kg_d_to_g_d(250000.0)
        ...
        let result7 = kg_d_to_g_d(2500000.0)
    ...
    func testkilogram_d_to_gram_d1() {
        let result = kg_d_to_g_d(-1000.0)
        ...
        let result2 = kg_d_to_g_d(-Double.greatestFiniteMagnitude)
        ...
        let result3 = kg_d_to_g_d(Double.greatestFiniteMagnitude)
    ...
    func testkilogram_d_to_gram_f() {
        let result = kg_d_to_g_f(15.0)
        ...
        let result4 = kg_d_to_g_f(2500.0)
        ...
        let result5 = kg_d_to_g_f(25000.0)
        ...
        let result6 = kg_d_to_g_f(250000.0)
        ...
        let result7 = kg_d_to_g_f(2500000.0)
    ...
    func testkilogram_d_to_gram_f1() {
        let result = kg_d_to_g_f(-1000.0)
        ...
        let result2 = kg_d_to_g_f(-Double.greatestFiniteMagnitude)
        ...
        let result3 = kg_d_to_g_f(Double.greatestFiniteMagnitude)
    ...
    func testkilogram_d_to_gram_t1() {
    ...
    func testkilogram_d_to_gram_u1() {
    ...
    func testkilogram_d_to_int16_t() {
    ...
    func testkilogram_d_to_int32_t() {
    ...
    func testkilogram_d_to_int64_t() {
    ...
    func testkilogram_d_to_kilogram_f() {
        ...
        let result1 = kg_d_to_kg_f(kilogram_d(-Double.greatestFiniteMagnitude))
        let expected1: kilogram_f = kilogram_f(-Float.greatestFiniteMagnitude)
        ...
        let result2 = kg_d_to_kg_f(kilogram_d(Double.greatestFiniteMagnitude))
    ...
    func testkilogram_d_to_kilogram_t() {
    ...
    func testkilogram_d_to_kilogram_u() {
    ...
    func testkilogram_d_to_megagram_d() {
    ...
    func testkilogram_d_to_megagram_d1() {
        ...
        let expected2: megagram_d = megagram_d(-Double.greatestFiniteMagnitude) / 1000.0
        let tolerance2: megagram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let expected3: megagram_d = megagram_d(Double.greatestFiniteMagnitude) / 1000.0
        let tolerance3: megagram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testkilogram_d_to_megagram_f() {
    ...
    func testkilogram_d_to_megagram_f1() {
    ...
    func testkilogram_d_to_megagram_t() {
    ...
    func testkilogram_d_to_megagram_t1() {
    ...
    func testkilogram_d_to_megagram_u() {
