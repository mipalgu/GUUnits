...
final class Acceleration_Metres_Per_Microseconds_Sq_tTests0: XCTestCase {

    func testdouble_to_metres_per_microseconds_sq_t() {
        XCTAssertEqual(d_to_m_per_us_sq_t(0.0), 0)
        XCTAssertEqual(d_to_m_per_us_sq_t(5.0), 5)
        XCTAssertEqual(d_to_m_per_us_sq_t(Double(-Double.greatestFiniteMagnitude)), metres_per_microseconds_sq_t(Int64.min))
        XCTAssertEqual(d_to_m_per_us_sq_t(Double(Double.greatestFiniteMagnitude)), metres_per_microseconds_sq_t(Int64.max))
    }

    func testfloat_to_metres_per_microseconds_sq_t() {
        XCTAssertEqual(f_to_m_per_us_sq_t(0.0), 0)
        XCTAssertEqual(f_to_m_per_us_sq_t(5.0), 5)
        XCTAssertEqual(f_to_m_per_us_sq_t(Float(-Float.greatestFiniteMagnitude)), metres_per_microseconds_sq_t(Int64.min))
        XCTAssertEqual(f_to_m_per_us_sq_t(Float(Float.greatestFiniteMagnitude)), metres_per_microseconds_sq_t(Int64.max))
    }

    func testint16_t_to_metres_per_microseconds_sq_t() {
        XCTAssertEqual(i16_to_m_per_us_sq_t(0), 0)
        XCTAssertEqual(i16_to_m_per_us_sq_t(5), 5)
        XCTAssertEqual(i16_to_m_per_us_sq_t(Int16(Int16.min)), metres_per_microseconds_sq_t(Int16.min))
        XCTAssertEqual(i16_to_m_per_us_sq_t(Int16(Int16.max)), metres_per_microseconds_sq_t(Int16.max))
    }

    func testint32_t_to_metres_per_microseconds_sq_t() {
        XCTAssertEqual(i32_to_m_per_us_sq_t(0), 0)
        XCTAssertEqual(i32_to_m_per_us_sq_t(5), 5)
        XCTAssertEqual(i32_to_m_per_us_sq_t(Int32(Int32.min)), metres_per_microseconds_sq_t(Int32.min))
        XCTAssertEqual(i32_to_m_per_us_sq_t(Int32(Int32.max)), metres_per_microseconds_sq_t(Int32.max))
    }

    func testint64_t_to_metres_per_microseconds_sq_t() {
        XCTAssertEqual(i64_to_m_per_us_sq_t(0), 0)
        XCTAssertEqual(i64_to_m_per_us_sq_t(5), 5)
        XCTAssertEqual(i64_to_m_per_us_sq_t(Int64(Int64.min)), metres_per_microseconds_sq_t(Int64.min))
        XCTAssertEqual(i64_to_m_per_us_sq_t(Int64(Int64.max)), metres_per_microseconds_sq_t(Int64.max))
    }

    func testint8_t_to_metres_per_microseconds_sq_t() {
        XCTAssertEqual(i8_to_m_per_us_sq_t(0), 0)
        XCTAssertEqual(i8_to_m_per_us_sq_t(5), 5)
        XCTAssertEqual(i8_to_m_per_us_sq_t(Int8(Int8.min)), metres_per_microseconds_sq_t(Int8.min))
        XCTAssertEqual(i8_to_m_per_us_sq_t(Int8(Int8.max)), metres_per_microseconds_sq_t(Int8.max))
    }

    func testmetres_per_microseconds_sq_t_to_centimetres_per_microseconds_sq_d() {
        let result = m_per_us_sq_t_to_cm_per_us_sq_d(-5000000)
        ...
        let result1 = m_per_us_sq_t_to_cm_per_us_sq_d(0)
        ...
        let result2 = m_per_us_sq_t_to_cm_per_us_sq_d(5000000)
        ...
        let result3 = m_per_us_sq_t_to_cm_per_us_sq_d(Int64.min)
        ...
        let result4 = m_per_us_sq_t_to_cm_per_us_sq_d(Int64.max)
    ...
    func testmetres_per_microseconds_sq_t_to_centimetres_per_microseconds_sq_f() {
        let result = m_per_us_sq_t_to_cm_per_us_sq_f(-5000000)
        ...
        let result1 = m_per_us_sq_t_to_cm_per_us_sq_f(0)
        ...
        let result2 = m_per_us_sq_t_to_cm_per_us_sq_f(5000000)
        ...
        let result3 = m_per_us_sq_t_to_cm_per_us_sq_f(Int64.min)
        ...
        let result4 = m_per_us_sq_t_to_cm_per_us_sq_f(Int64.max)
    ...
    func testmetres_per_microseconds_sq_t_to_centimetres_per_microseconds_sq_t() {
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_us_sq_t(-5000000), centimetres_per_microseconds_sq_t((((Double(-5000000)) * (Double(100))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * (Double(100))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * (Double(100))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_us_sq_t(0), centimetres_per_microseconds_sq_t((((Double(0)) * (Double(100))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * (Double(100))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * (Double(100))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_us_sq_t(5000000), centimetres_per_microseconds_sq_t((((Double(5000000)) * (Double(100))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (Double(100))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (Double(100))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_us_sq_t(Int64.min), centimetres_per_microseconds_sq_t(Int64.min))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_us_sq_t(Int64.max), centimetres_per_microseconds_sq_t(Int64.max))
    }

    func testmetres_per_microseconds_sq_t_to_centimetres_per_microseconds_sq_u() {
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_us_sq_u(-5000000), centimetres_per_microseconds_sq_u((((Double(-5000000)) * (Double(100))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * (Double(100))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * (Double(100))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_us_sq_u(0), centimetres_per_microseconds_sq_u((((Double(0)) * (Double(100))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (Double(100))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (Double(100))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_us_sq_u(5000000), centimetres_per_microseconds_sq_u((((Double(5000000)) * (Double(100))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (Double(100))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (Double(100))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_us_sq_u(Int64.min), centimetres_per_microseconds_sq_u(UInt64.min))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_us_sq_u(Int64.max), centimetres_per_microseconds_sq_u(UInt64.max))
    }

    func testmetres_per_microseconds_sq_t_to_centimetres_per_milliseconds_sq_d() {
        let result = m_per_us_sq_t_to_cm_per_ms_sq_d(-5000000)
        ...
        let result1 = m_per_us_sq_t_to_cm_per_ms_sq_d(0)
        ...
        let result2 = m_per_us_sq_t_to_cm_per_ms_sq_d(5000000)
        ...
        let result3 = m_per_us_sq_t_to_cm_per_ms_sq_d(Int64.min)
        ...
        let result4 = m_per_us_sq_t_to_cm_per_ms_sq_d(Int64.max)
    ...
    func testmetres_per_microseconds_sq_t_to_centimetres_per_milliseconds_sq_f() {
        let result = m_per_us_sq_t_to_cm_per_ms_sq_f(-5000000)
        ...
        let result1 = m_per_us_sq_t_to_cm_per_ms_sq_f(0)
        ...
        let result2 = m_per_us_sq_t_to_cm_per_ms_sq_f(5000000)
        ...
        let result3 = m_per_us_sq_t_to_cm_per_ms_sq_f(Int64.min)
        ...
        let result4 = m_per_us_sq_t_to_cm_per_ms_sq_f(Int64.max)
    ...
    func testmetres_per_microseconds_sq_t_to_centimetres_per_milliseconds_sq_t() {
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ms_sq_t(-5000000), centimetres_per_milliseconds_sq_t((((Double(-5000000)) * ((Double(100)) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * ((Double(100)) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * ((Double(100)) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ms_sq_t(0), centimetres_per_milliseconds_sq_t((((Double(0)) * ((Double(100)) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * ((Double(100)) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * ((Double(100)) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ms_sq_t(5000000), centimetres_per_milliseconds_sq_t((((Double(5000000)) * ((Double(100)) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * ((Double(100)) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * ((Double(100)) / (((Double(1)) / (Double(1000))) * ((Double(1)) / (Double(1000)))))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ms_sq_t(Int64.min), centimetres_per_milliseconds_sq_t(Int64.min))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ms_sq_t(Int64.max), centimetres_per_milliseconds_sq_t(Int64.max))
    }

    func testmetres_per_microseconds_sq_t_to_centimetres_per_milliseconds_sq_u() {
    ...
    func testmetres_per_microseconds_sq_t_to_centimetres_per_nanoseconds_sq_d() {
        let result = m_per_us_sq_t_to_cm_per_ns_sq_d(-5000000)
        ...
        let result1 = m_per_us_sq_t_to_cm_per_ns_sq_d(0)
        ...
        let result2 = m_per_us_sq_t_to_cm_per_ns_sq_d(5000000)
        ...
        let result3 = m_per_us_sq_t_to_cm_per_ns_sq_d(Int64.min)
        ...
        let result4 = m_per_us_sq_t_to_cm_per_ns_sq_d(Int64.max)
    ...
    func testmetres_per_microseconds_sq_t_to_centimetres_per_nanoseconds_sq_f() {
        let result = m_per_us_sq_t_to_cm_per_ns_sq_f(-5000000)
        ...
        let result1 = m_per_us_sq_t_to_cm_per_ns_sq_f(0)
        ...
        let result2 = m_per_us_sq_t_to_cm_per_ns_sq_f(5000000)
        ...
        let result3 = m_per_us_sq_t_to_cm_per_ns_sq_f(Int64.min)
        ...
        let result4 = m_per_us_sq_t_to_cm_per_ns_sq_f(Int64.max)
    ...
    func testmetres_per_microseconds_sq_t_to_centimetres_per_nanoseconds_sq_t() {
        ...
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ns_sq_t(5000000), centimetres_per_nanoseconds_sq_t((((Double(5000000)) * ((Double(100)) / ((Double(1000)) * (Double(1000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * ((Double(100)) / ((Double(1000)) * (Double(1000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * ((Double(100)) / ((Double(1000)) * (Double(1000))))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ns_sq_t(Int64.min), centimetres_per_nanoseconds_sq_t(Int64.min))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ns_sq_t(Int64.max), centimetres_per_nanoseconds_sq_t(Int64.max))
    }

    func testmetres_per_microseconds_sq_t_to_centimetres_per_nanoseconds_sq_u() {
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ns_sq_u(-5000000), centimetres_per_nanoseconds_sq_u((((Double(-5000000)) * ((Double(100)) / ((Double(1000)) * (Double(1000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * ((Double(100)) / ((Double(1000)) * (Double(1000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * ((Double(100)) / ((Double(1000)) * (Double(1000))))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ns_sq_u(0), centimetres_per_nanoseconds_sq_u((((Double(0)) * ((Double(100)) / ((Double(1000)) * (Double(1000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * ((Double(100)) / ((Double(1000)) * (Double(1000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * ((Double(100)) / ((Double(1000)) * (Double(1000))))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ns_sq_u(5000000), centimetres_per_nanoseconds_sq_u((((Double(5000000)) * ((Double(100)) / ((Double(1000)) * (Double(1000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * ((Double(100)) / ((Double(1000)) * (Double(1000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * ((Double(100)) / ((Double(1000)) * (Double(1000))))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ns_sq_u(Int64.min), centimetres_per_nanoseconds_sq_u(UInt64.min))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ns_sq_u(Int64.max), centimetres_per_nanoseconds_sq_u(UInt64.max))
    }

    func testmetres_per_microseconds_sq_t_to_centimetres_per_picoseconds_sq_d() {
        let result = m_per_us_sq_t_to_cm_per_ps_sq_d(-5000000)
        ...
        let result1 = m_per_us_sq_t_to_cm_per_ps_sq_d(0)
        ...
        let result2 = m_per_us_sq_t_to_cm_per_ps_sq_d(5000000)
        ...
        let result3 = m_per_us_sq_t_to_cm_per_ps_sq_d(Int64.min)
        ...
        let result4 = m_per_us_sq_t_to_cm_per_ps_sq_d(Int64.max)
    ...
    func testmetres_per_microseconds_sq_t_to_centimetres_per_picoseconds_sq_f() {
        let result = m_per_us_sq_t_to_cm_per_ps_sq_f(-5000000)
        ...
        let result1 = m_per_us_sq_t_to_cm_per_ps_sq_f(0)
        ...
        let result2 = m_per_us_sq_t_to_cm_per_ps_sq_f(5000000)
        ...
        let result3 = m_per_us_sq_t_to_cm_per_ps_sq_f(Int64.min)
        ...
        let result4 = m_per_us_sq_t_to_cm_per_ps_sq_f(Int64.max)
    ...
    func testmetres_per_microseconds_sq_t_to_centimetres_per_picoseconds_sq_t() {
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ps_sq_t(-5000000), centimetres_per_picoseconds_sq_t((((Double(-5000000)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ps_sq_t(0), centimetres_per_picoseconds_sq_t((((Double(0)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ps_sq_t(5000000), centimetres_per_picoseconds_sq_t((((Double(5000000)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ps_sq_t(Int64.min), centimetres_per_picoseconds_sq_t(Int64.min))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ps_sq_t(Int64.max), centimetres_per_picoseconds_sq_t(Int64.max))
    }

    func testmetres_per_microseconds_sq_t_to_centimetres_per_picoseconds_sq_u() {
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ps_sq_u(-5000000), centimetres_per_picoseconds_sq_u((((Double(-5000000)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ps_sq_u(0), centimetres_per_picoseconds_sq_u((((Double(0)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ps_sq_u(5000000), centimetres_per_picoseconds_sq_u((((Double(5000000)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * ((Double(100)) / ((Double(1000000)) * (Double(1000000))))).rounded()))))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ps_sq_u(Int64.min), centimetres_per_picoseconds_sq_u(UInt64.min))
        XCTAssertEqual(m_per_us_sq_t_to_cm_per_ps_sq_u(Int64.max), centimetres_per_picoseconds_sq_u(UInt64.max))
    }

    func testmetres_per_microseconds_sq_t_to_centimetres_per_seconds_sq_d() {
        ...
        let result1 = m_per_us_sq_t_to_cm_per_s_sq_d(0)
        ...
        let result2 = m_per_us_sq_t_to_cm_per_s_sq_d(5000000)
        ...
        let result3 = m_per_us_sq_t_to_cm_per_s_sq_d(Int64.min)
        ...
        let result4 = m_per_us_sq_t_to_cm_per_s_sq_d(Int64.max)
    ...
    func testmetres_per_microseconds_sq_t_to_centimetres_per_seconds_sq_f() {
        ...
        let result1 = m_per_us_sq_t_to_cm_per_s_sq_f(0)
        ...
        let result2 = m_per_us_sq_t_to_cm_per_s_sq_f(5000000)
        ...
        let result3 = m_per_us_sq_t_to_cm_per_s_sq_f(Int64.min)
        ...
        let result4 = m_per_us_sq_t_to_cm_per_s_sq_f(Int64.max)
    ...
    func testmetres_per_microseconds_sq_t_to_centimetres_per_seconds_sq_t() {
    ...
    func testmetres_per_microseconds_sq_t_to_centimetres_per_seconds_sq_u() {
    ...
    func testmetres_per_microseconds_sq_t_to_double() {
        ...
        let result1 = m_per_us_sq_t_to_d(5)
        ...
        let result2 = m_per_us_sq_t_to_d(metres_per_microseconds_sq_t(Int64.min))
        ...
        let result3 = m_per_us_sq_t_to_d(metres_per_microseconds_sq_t(Int64.max))
    ...
    func testmetres_per_microseconds_sq_t_to_float() {
        ...
        let result1 = m_per_us_sq_t_to_f(5)
        ...
        let result2 = m_per_us_sq_t_to_f(metres_per_microseconds_sq_t(Int64.min))
        ...
        let result3 = m_per_us_sq_t_to_f(metres_per_microseconds_sq_t(Int64.max))
    ...
    func testmetres_per_microseconds_sq_t_to_int16_t() {
    ...
    func testmetres_per_microseconds_sq_t_to_int32_t() {
