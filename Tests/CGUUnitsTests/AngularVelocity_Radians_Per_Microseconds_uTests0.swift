...
final class AngularVelocity_Radians_Per_Microseconds_uTests0: XCTestCase {
    ...
    func testradians_per_microseconds_u_to_degrees_per_nanoseconds_d() {
        let result = rad_per_us_u_to_deg_per_ns_d(0)
        let expected: degrees_per_nanoseconds_d = degrees_per_nanoseconds_d((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000))))
        ...
        let result1 = rad_per_us_u_to_deg_per_ns_d(5000000)
        let expected1: degrees_per_nanoseconds_d = degrees_per_nanoseconds_d((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000))))
        ...
        let result2 = rad_per_us_u_to_deg_per_ns_d(UInt64.min)
        let expected2: degrees_per_nanoseconds_d = degrees_per_nanoseconds_d(((Double(UInt64.min)) * ((((Double(1)) / (Double(3.141592653589793))) * (Double(180))) / (Double(1000)))).rounded())
        ...
        let result3 = rad_per_us_u_to_deg_per_ns_d(UInt64.max)
    ...
    func testradians_per_microseconds_u_to_degrees_per_nanoseconds_f() {
        let result = rad_per_us_u_to_deg_per_ns_f(0)
        let expected: degrees_per_nanoseconds_f = degrees_per_nanoseconds_f((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000))))
        ...
        let result1 = rad_per_us_u_to_deg_per_ns_f(5000000)
        let expected1: degrees_per_nanoseconds_f = degrees_per_nanoseconds_f((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000))))
        ...
        let result2 = rad_per_us_u_to_deg_per_ns_f(UInt64.min)
        let expected2: degrees_per_nanoseconds_f = degrees_per_nanoseconds_f(((Double(UInt64.min)) * ((((Double(1)) / (Double(3.141592653589793))) * (Double(180))) / (Double(1000)))).rounded())
        ...
        let result3 = rad_per_us_u_to_deg_per_ns_f(UInt64.max)
    ...
    func testradians_per_microseconds_u_to_degrees_per_nanoseconds_t() {
        XCTAssertEqual(rad_per_us_u_to_deg_per_ns_t(0), degrees_per_nanoseconds_t((((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000)))).rounded()))))
        XCTAssertEqual(rad_per_us_u_to_deg_per_ns_t(5000000), degrees_per_nanoseconds_t((((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000)))).rounded()))))
        XCTAssertEqual(rad_per_us_u_to_deg_per_ns_t(UInt64.min), degrees_per_nanoseconds_t(((Double(UInt64.min)) * ((((Double(1)) / (Double(3.141592653589793))) * (Double(180))) / (Double(1000)))).rounded()))
        XCTAssertEqual(rad_per_us_u_to_deg_per_ns_t(UInt64.max), degrees_per_nanoseconds_t(Int64.max))
    }

    func testradians_per_microseconds_u_to_degrees_per_nanoseconds_u() {
        XCTAssertEqual(rad_per_us_u_to_deg_per_ns_u(0), degrees_per_nanoseconds_u((((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000)))).rounded()))))
        XCTAssertEqual(rad_per_us_u_to_deg_per_ns_u(5000000), degrees_per_nanoseconds_u((((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000)))).rounded()))))
        XCTAssertEqual(rad_per_us_u_to_deg_per_ns_u(UInt64.min), degrees_per_nanoseconds_u(((Double(UInt64.min)) * ((((Double(1)) / (Double(3.141592653589793))) * (Double(180))) / (Double(1000)))).rounded()))
        XCTAssertEqual(rad_per_us_u_to_deg_per_ns_u(UInt64.max), degrees_per_nanoseconds_u(UInt64.max))
    }

    func testradians_per_microseconds_u_to_degrees_per_picoseconds_d() {
        let result = rad_per_us_u_to_deg_per_ps_d(0)
        let expected: degrees_per_picoseconds_d = degrees_per_picoseconds_d((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000))))
        ...
        let result1 = rad_per_us_u_to_deg_per_ps_d(5000000)
        let expected1: degrees_per_picoseconds_d = degrees_per_picoseconds_d((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000))))
        ...
        let result2 = rad_per_us_u_to_deg_per_ps_d(UInt64.min)
        let expected2: degrees_per_picoseconds_d = degrees_per_picoseconds_d(((Double(UInt64.min)) * ((((Double(1)) / (Double(3.141592653589793))) * (Double(180))) / (Double(1000000)))).rounded())
        ...
        let result3 = rad_per_us_u_to_deg_per_ps_d(UInt64.max)
    ...
    func testradians_per_microseconds_u_to_degrees_per_picoseconds_f() {
        let result = rad_per_us_u_to_deg_per_ps_f(0)
        let expected: degrees_per_picoseconds_f = degrees_per_picoseconds_f((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000))))
        ...
        let result1 = rad_per_us_u_to_deg_per_ps_f(5000000)
        let expected1: degrees_per_picoseconds_f = degrees_per_picoseconds_f((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000))))
        ...
        let result2 = rad_per_us_u_to_deg_per_ps_f(UInt64.min)
        let expected2: degrees_per_picoseconds_f = degrees_per_picoseconds_f(((Double(UInt64.min)) * ((((Double(1)) / (Double(3.141592653589793))) * (Double(180))) / (Double(1000000)))).rounded())
        ...
        let result3 = rad_per_us_u_to_deg_per_ps_f(UInt64.max)
    ...
    func testradians_per_microseconds_u_to_degrees_per_picoseconds_t() {
        XCTAssertEqual(rad_per_us_u_to_deg_per_ps_t(0), degrees_per_picoseconds_t((((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(rad_per_us_u_to_deg_per_ps_t(5000000), degrees_per_picoseconds_t((((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(rad_per_us_u_to_deg_per_ps_t(UInt64.min), degrees_per_picoseconds_t(((Double(UInt64.min)) * ((((Double(1)) / (Double(3.141592653589793))) * (Double(180))) / (Double(1000000)))).rounded()))
        XCTAssertEqual(rad_per_us_u_to_deg_per_ps_t(UInt64.max), degrees_per_picoseconds_t(Int64.max))
    }

    func testradians_per_microseconds_u_to_degrees_per_picoseconds_u() {
        XCTAssertEqual(rad_per_us_u_to_deg_per_ps_u(0), degrees_per_picoseconds_u((((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(rad_per_us_u_to_deg_per_ps_u(5000000), degrees_per_picoseconds_u((((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * (((Double(180)) / (Double(3.141592653589793))) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(rad_per_us_u_to_deg_per_ps_u(UInt64.min), degrees_per_picoseconds_u(((Double(UInt64.min)) * ((((Double(1)) / (Double(3.141592653589793))) * (Double(180))) / (Double(1000000)))).rounded()))
        XCTAssertEqual(rad_per_us_u_to_deg_per_ps_u(UInt64.max), degrees_per_picoseconds_u(UInt64.max))
    }
