...
final class AngularVelocity_Radians_Per_Microseconds_uTests0: XCTestCase {
    ...
    func testradians_per_microseconds_uTodegrees_per_microseconds_dUsing5000000Expectingdegrees_per_microseconds_dDouble5000000Double180Double3_141592653589793() {
        let result = rad_per_us_u_to_deg_per_us_d(5000000)
    ...
    func testradians_per_microseconds_uTodegrees_per_microseconds_dUsingUInt64_maxExpectingdegrees_per_microseconds_dDouble_greatestFiniteMagnitude() {
        let result = rad_per_us_u_to_deg_per_us_d(UInt64.max)
    ...
    func testradians_per_microseconds_uTodegrees_per_microseconds_dUsingUInt64_minExpectingdegrees_per_microseconds_dDoubleUInt64_minDouble1Double3_141592653589793Double180_rounded() {
        let result = rad_per_us_u_to_deg_per_us_d(UInt64.min)
        let expected: degrees_per_microseconds_d = degrees_per_microseconds_d(((Double(UInt64.min)) * (((Double(1)) / (Double(3.141592653589793))) * (Double(180)))).rounded())
        let tolerance: degrees_per_microseconds_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testradians_per_microseconds_uTodegrees_per_microseconds_fUsing0Expectingdegrees_per_microseconds_fDouble0Double180Double3_141592653589793() {
    ...
    func testradians_per_microseconds_uTodegrees_per_microseconds_fUsing5000000Expectingdegrees_per_microseconds_fDouble5000000Double180Double3_141592653589793() {
        let result = rad_per_us_u_to_deg_per_us_f(5000000)
