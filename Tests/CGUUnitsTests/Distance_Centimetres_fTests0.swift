...
final class Distance_Centimetres_fTests0: XCTestCase {
    ...
    func testcentimetres_f_to_centimetres_d() {
        ...
        let result1 = cm_f_to_cm_d(centimetres_f(-Float.greatestFiniteMagnitude))
        let expected1: centimetres_d = centimetres_d(-Float.greatestFiniteMagnitude)
        ...
        let result2 = cm_f_to_cm_d(centimetres_f(Float.greatestFiniteMagnitude))
    ...
    func testcentimetres_f_to_centimetres_t() {
    ...
    func testcentimetres_f_to_centimetres_u() {
    ...
    func testcentimetres_f_to_double() {
        ...
        let result2 = cm_f_to_d(centimetres_f(-Float.greatestFiniteMagnitude))
        ...
        let result3 = cm_f_to_d(centimetres_f(Float.greatestFiniteMagnitude))
    ...
    func testcentimetres_f_to_float() {
        ...
        let result2 = cm_f_to_f(centimetres_f(-Float.greatestFiniteMagnitude))
        ...
        let result3 = cm_f_to_f(centimetres_f(Float.greatestFiniteMagnitude))
    ...
    func testcentimetres_f_to_int16_t() {
    ...
    func testcentimetres_f_to_int32_t() {
    ...
    func testcentimetres_f_to_int64_t() {
    ...
    func testcentimetres_f_to_int8_t() {
    ...
    func testcentimetres_f_to_metres_d() {
        ...
        let result4 = cm_f_to_m_d(2500.0)
        ...
        let result5 = cm_f_to_m_d(25000.0)
        ...
        let result6 = cm_f_to_m_d(250000.0)
        ...
        let result7 = cm_f_to_m_d(2500000.0)
    ...
    func testcentimetres_f_to_metres_d1() {
        ...
        let result2 = cm_f_to_m_d(-Float.greatestFiniteMagnitude)
        let expected2: metres_d = metres_d(-Float.greatestFiniteMagnitude) / 100.0
        let tolerance2: metres_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = cm_f_to_m_d(Float.greatestFiniteMagnitude)
        let expected3: metres_d = metres_d(Float.greatestFiniteMagnitude) / 100.0
        let tolerance3: metres_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testcentimetres_f_to_metres_f() {
        ...
        let result4 = cm_f_to_m_f(2500.0)
        ...
        let result5 = cm_f_to_m_f(25000.0)
        ...
        let result6 = cm_f_to_m_f(250000.0)
        ...
        let result7 = cm_f_to_m_f(2500000.0)
    ...
    func testcentimetres_f_to_metres_f1() {
        ...
        let result2 = cm_f_to_m_f(-Float.greatestFiniteMagnitude)
        let expected2: metres_f = metres_f(-Float.greatestFiniteMagnitude) / 100.0
        let tolerance2: metres_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = cm_f_to_m_f(Float.greatestFiniteMagnitude)
        let expected3: metres_f = metres_f(Float.greatestFiniteMagnitude) / 100.0
        let tolerance3: metres_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testcentimetres_f_to_metres_t() {
    ...
    func testcentimetres_f_to_metres_t1() {
    ...
    func testcentimetres_f_to_metres_u() {
    ...
    func testcentimetres_f_to_metres_u1() {
    ...
    func testcentimetres_f_to_millimetres_d() {
        ...
        let result2 = cm_f_to_mm_d(250.0)
        ...
        let result4 = cm_f_to_mm_d(2500.0)
        ...
        let result5 = cm_f_to_mm_d(25000.0)
        ...
        let result6 = cm_f_to_mm_d(250000.0)
        ...
        let result7 = cm_f_to_mm_d(2500000.0)
        ...
        let result8 = cm_f_to_mm_d(-323.0)
    ...
    func testcentimetres_f_to_millimetres_d1() {
        ...
        let result2 = cm_f_to_mm_d(-Float.greatestFiniteMagnitude)
        let expected2: millimetres_d = millimetres_d(-Float.greatestFiniteMagnitude) * 10.0
        let tolerance2: millimetres_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = cm_f_to_mm_d(Float.greatestFiniteMagnitude)
        let expected3: millimetres_d = millimetres_d(Float.greatestFiniteMagnitude) * 10.0
        let tolerance3: millimetres_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testcentimetres_f_to_millimetres_f() {
        ...
        let result2 = cm_f_to_mm_f(250.0)
        ...
        let result4 = cm_f_to_mm_f(2500.0)
        ...
        let result5 = cm_f_to_mm_f(25000.0)
        ...
        let result6 = cm_f_to_mm_f(250000.0)
        ...
        let result7 = cm_f_to_mm_f(2500000.0)
        ...
        let result8 = cm_f_to_mm_f(-323.0)
    ...
    func testcentimetres_f_to_millimetres_f1() {
        ...
        let result2 = cm_f_to_mm_f(-Float.greatestFiniteMagnitude)
        ...
        let result3 = cm_f_to_mm_f(Float.greatestFiniteMagnitude)
    ...
    func testcentimetres_f_to_millimetres_t() {
    ...
    func testcentimetres_f_to_millimetres_t1() {
    ...
    func testcentimetres_f_to_millimetres_u() {
    ...
    func testcentimetres_f_to_millimetres_u1() {
    ...
    func testcentimetres_f_to_uint16_t() {
    ...
    func testcentimetres_f_to_uint32_t() {
    ...
    func testcentimetres_f_to_uint64_t() {
    ...
    func testcentimetres_f_to_uint8_t() {
    ...
    func testdouble_to_centimetres_f() {
        ...
        let result2 = d_to_cm_f(Double(-Double.greatestFiniteMagnitude))
        ...
        let result3 = d_to_cm_f(Double(Double.greatestFiniteMagnitude))
