...
final class Velocity_Metres_Per_Seconds_tTests1: XCTestCase {
    ...
    func testmetres_per_seconds_t_to_millimetres_per_seconds_d() {
        let result = m_per_s_t_to_mm_per_s_d(-5000000)
        ...
        let result1 = m_per_s_t_to_mm_per_s_d(0)
        ...
        let result2 = m_per_s_t_to_mm_per_s_d(5000000)
        ...
        let result3 = m_per_s_t_to_mm_per_s_d(Int64.min)
        ...
        let result4 = m_per_s_t_to_mm_per_s_d(Int64.max)
    ...
    func testmetres_per_seconds_t_to_millimetres_per_seconds_f() {
        ...
        let result1 = m_per_s_t_to_mm_per_s_f(0)
        ...
        let result2 = m_per_s_t_to_mm_per_s_f(5000000)
        ...
        let result3 = m_per_s_t_to_mm_per_s_f(Int64.min)
        ...
        let result4 = m_per_s_t_to_mm_per_s_f(Int64.max)
    ...
    func testmetres_per_seconds_t_to_millimetres_per_seconds_t() {
    ...
    func testmetres_per_seconds_t_to_millimetres_per_seconds_u() {
    ...
    func testmetres_per_seconds_t_to_uint16_t() {
    ...
    func testmetres_per_seconds_t_to_uint32_t() {
    ...
    func testmetres_per_seconds_t_to_uint64_t() {
    ...
    func testmetres_per_seconds_t_to_uint8_t() {
    ...
    func testuint16_t_to_metres_per_seconds_t() {
        XCTAssertEqual(u16_to_m_per_s_t(0), 0)
        XCTAssertEqual(u16_to_m_per_s_t(5), 5)
        XCTAssertEqual(u16_to_m_per_s_t(UInt16(UInt16.min)), metres_per_seconds_t(UInt16.min))
        XCTAssertEqual(u16_to_m_per_s_t(UInt16(UInt16.max)), metres_per_seconds_t(UInt16.max))
    }

    func testuint32_t_to_metres_per_seconds_t() {
        XCTAssertEqual(u32_to_m_per_s_t(0), 0)
        XCTAssertEqual(u32_to_m_per_s_t(5), 5)
        XCTAssertEqual(u32_to_m_per_s_t(UInt32(UInt32.min)), metres_per_seconds_t(UInt32.min))
        XCTAssertEqual(u32_to_m_per_s_t(UInt32(UInt32.max)), metres_per_seconds_t(UInt32.max))
    }

    func testuint64_t_to_metres_per_seconds_t() {
        XCTAssertEqual(u64_to_m_per_s_t(0), 0)
        XCTAssertEqual(u64_to_m_per_s_t(5), 5)
        XCTAssertEqual(u64_to_m_per_s_t(UInt64(UInt64.min)), metres_per_seconds_t(UInt64.min))
        XCTAssertEqual(u64_to_m_per_s_t(UInt64(UInt64.max)), metres_per_seconds_t(Int64.max))
    }

    func testuint8_t_to_metres_per_seconds_t() {
        XCTAssertEqual(u8_to_m_per_s_t(0), 0)
        XCTAssertEqual(u8_to_m_per_s_t(5), 5)
        XCTAssertEqual(u8_to_m_per_s_t(UInt8(UInt8.min)), metres_per_seconds_t(UInt8.min))
        XCTAssertEqual(u8_to_m_per_s_t(UInt8(UInt8.max)), metres_per_seconds_t(UInt8.max))
    }
