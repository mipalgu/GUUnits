...
final class Velocity_Centimetres_Per_Seconds_fTests0: XCTestCase {
    ...
    func testcentimetres_per_seconds_f_to_centimetres_per_nanoseconds_d() {
        let result = cm_per_s_f_to_cm_per_ns_d(-5000000)
        ...
        let result1 = cm_per_s_f_to_cm_per_ns_d(0)
        ...
        let result2 = cm_per_s_f_to_cm_per_ns_d(5000000)
        ...
        let result3 = cm_per_s_f_to_cm_per_ns_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_s_f_to_cm_per_ns_d(Float.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_seconds_f_to_centimetres_per_nanoseconds_f() {
        let result = cm_per_s_f_to_cm_per_ns_f(-5000000)
        ...
        let result1 = cm_per_s_f_to_cm_per_ns_f(0)
        ...
        let result2 = cm_per_s_f_to_cm_per_ns_f(5000000)
        ...
        let result3 = cm_per_s_f_to_cm_per_ns_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_s_f_to_cm_per_ns_f(Float.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_seconds_f_to_centimetres_per_nanoseconds_t() {
        XCTAssertEqual(cm_per_s_f_to_cm_per_ns_t(-5000000), centimetres_per_nanoseconds_t((((Double(-5000000)) / (Double(1000000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) / (Double(1000000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ns_t(0), centimetres_per_nanoseconds_t((((Double(0)) / (Double(1000000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) / (Double(1000000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ns_t(5000000), centimetres_per_nanoseconds_t((((Double(5000000)) / (Double(1000000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) / (Double(1000000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ns_t(-Float.greatestFiniteMagnitude), centimetres_per_nanoseconds_t(Int64.min))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ns_t(Float.greatestFiniteMagnitude), centimetres_per_nanoseconds_t(Int64.max))
    }

    func testcentimetres_per_seconds_f_to_centimetres_per_nanoseconds_u() {
        XCTAssertEqual(cm_per_s_f_to_cm_per_ns_u(-5000000), centimetres_per_nanoseconds_u((((Double(-5000000)) / (Double(1000000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) / (Double(1000000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ns_u(0), centimetres_per_nanoseconds_u((((Double(0)) / (Double(1000000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) / (Double(1000000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ns_u(5000000), centimetres_per_nanoseconds_u((((Double(5000000)) / (Double(1000000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) / (Double(1000000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) / (Double(1000000000))).rounded()))))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ns_u(-Float.greatestFiniteMagnitude), centimetres_per_nanoseconds_u(UInt64.min))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ns_u(Float.greatestFiniteMagnitude), centimetres_per_nanoseconds_u(UInt64.max))
    }

    func testcentimetres_per_seconds_f_to_centimetres_per_picoseconds_d() {
        let result = cm_per_s_f_to_cm_per_ps_d(-5000000)
        ...
        let result1 = cm_per_s_f_to_cm_per_ps_d(0)
        ...
        let result2 = cm_per_s_f_to_cm_per_ps_d(5000000)
        ...
        let result3 = cm_per_s_f_to_cm_per_ps_d(-Float.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_s_f_to_cm_per_ps_d(Float.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_seconds_f_to_centimetres_per_picoseconds_f() {
        let result = cm_per_s_f_to_cm_per_ps_f(-5000000)
        ...
        let result1 = cm_per_s_f_to_cm_per_ps_f(0)
        ...
        let result2 = cm_per_s_f_to_cm_per_ps_f(5000000)
        ...
        let result3 = cm_per_s_f_to_cm_per_ps_f(-Float.greatestFiniteMagnitude)
        ...
        let result4 = cm_per_s_f_to_cm_per_ps_f(Float.greatestFiniteMagnitude)
    ...
    func testcentimetres_per_seconds_f_to_centimetres_per_picoseconds_t() {
        XCTAssertEqual(cm_per_s_f_to_cm_per_ps_t(-5000000), centimetres_per_picoseconds_t((((Double(-5000000)) / (Double(1000000000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) / (Double(1000000000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) / (Double(1000000000000))).rounded()))))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ps_t(0), centimetres_per_picoseconds_t((((Double(0)) / (Double(1000000000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) / (Double(1000000000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) / (Double(1000000000000))).rounded()))))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ps_t(5000000), centimetres_per_picoseconds_t((((Double(5000000)) / (Double(1000000000000))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) / (Double(1000000000000))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) / (Double(1000000000000))).rounded()))))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ps_t(-Float.greatestFiniteMagnitude), centimetres_per_picoseconds_t(Int64.min))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ps_t(Float.greatestFiniteMagnitude), centimetres_per_picoseconds_t(Int64.max))
    }

    func testcentimetres_per_seconds_f_to_centimetres_per_picoseconds_u() {
        XCTAssertEqual(cm_per_s_f_to_cm_per_ps_u(-5000000), centimetres_per_picoseconds_u((((Double(-5000000)) / (Double(1000000000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) / (Double(1000000000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) / (Double(1000000000000))).rounded()))))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ps_u(0), centimetres_per_picoseconds_u((((Double(0)) / (Double(1000000000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) / (Double(1000000000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) / (Double(1000000000000))).rounded()))))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ps_u(5000000), centimetres_per_picoseconds_u((((Double(5000000)) / (Double(1000000000000))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) / (Double(1000000000000))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) / (Double(1000000000000))).rounded()))))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ps_u(-Float.greatestFiniteMagnitude), centimetres_per_picoseconds_u(UInt64.min))
        XCTAssertEqual(cm_per_s_f_to_cm_per_ps_u(Float.greatestFiniteMagnitude), centimetres_per_picoseconds_u(UInt64.max))
    }
