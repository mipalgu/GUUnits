...
final class Mass_Kilogram_uTests1: XCTestCase {
    ...
    func testkilogram_u_to_milligram_u() {
    ...
    func testkilogram_u_to_uint16_t() {
    ...
    func testkilogram_u_to_uint32_t() {
    ...
    func testkilogram_u_to_uint64_t() {
    ...
    func testkilogram_u_to_uint8_t() {
    ...
    func testuint16_t_to_kilogram_u() {
    ...
    func testuint32_t_to_kilogram_u() {
    ...
    func testuint64_t_to_kilogram_u() {
    ...
    func testuint8_t_to_kilogram_u() {
