...
final class Velocity_Metres_Per_Microseconds_dTests0: XCTestCase {
    ...
    func testmetres_per_microseconds_d_to_centimetres_per_nanoseconds_d() {
        let result = m_per_us_d_to_cm_per_ns_d(-5000000)
        ...
        let result1 = m_per_us_d_to_cm_per_ns_d(0)
        ...
        let result2 = m_per_us_d_to_cm_per_ns_d(5000000)
        ...
        let result3 = m_per_us_d_to_cm_per_ns_d(-Double.greatestFiniteMagnitude)
        ...
        let result4 = m_per_us_d_to_cm_per_ns_d(Double.greatestFiniteMagnitude)
    ...
    func testmetres_per_microseconds_d_to_centimetres_per_nanoseconds_f() {
        let result = m_per_us_d_to_cm_per_ns_f(-5000000)
        ...
        let result1 = m_per_us_d_to_cm_per_ns_f(0)
        ...
        let result2 = m_per_us_d_to_cm_per_ns_f(5000000)
        ...
        let result3 = m_per_us_d_to_cm_per_ns_f(-Double.greatestFiniteMagnitude)
        ...
        let result4 = m_per_us_d_to_cm_per_ns_f(Double.greatestFiniteMagnitude)
    ...
    func testmetres_per_microseconds_d_to_centimetres_per_nanoseconds_t() {
        XCTAssertEqual(m_per_us_d_to_cm_per_ns_t(-5000000), centimetres_per_nanoseconds_t((((Double(-5000000)) * ((Double(100)) / (Double(1000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * ((Double(100)) / (Double(1000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * ((Double(100)) / (Double(1000)))).rounded()))))
        XCTAssertEqual(m_per_us_d_to_cm_per_ns_t(0), centimetres_per_nanoseconds_t((((Double(0)) * ((Double(100)) / (Double(1000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * ((Double(100)) / (Double(1000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * ((Double(100)) / (Double(1000)))).rounded()))))
        XCTAssertEqual(m_per_us_d_to_cm_per_ns_t(5000000), centimetres_per_nanoseconds_t((((Double(5000000)) * ((Double(100)) / (Double(1000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * ((Double(100)) / (Double(1000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * ((Double(100)) / (Double(1000)))).rounded()))))
        XCTAssertEqual(m_per_us_d_to_cm_per_ns_t(-Double.greatestFiniteMagnitude), centimetres_per_nanoseconds_t(Int64.min))
        XCTAssertEqual(m_per_us_d_to_cm_per_ns_t(Double.greatestFiniteMagnitude), centimetres_per_nanoseconds_t(Int64.max))
    }

    func testmetres_per_microseconds_d_to_centimetres_per_nanoseconds_u() {
        XCTAssertEqual(m_per_us_d_to_cm_per_ns_u(-5000000), centimetres_per_nanoseconds_u((((Double(-5000000)) * ((Double(100)) / (Double(1000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * ((Double(100)) / (Double(1000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * ((Double(100)) / (Double(1000)))).rounded()))))
        XCTAssertEqual(m_per_us_d_to_cm_per_ns_u(0), centimetres_per_nanoseconds_u((((Double(0)) * ((Double(100)) / (Double(1000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * ((Double(100)) / (Double(1000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * ((Double(100)) / (Double(1000)))).rounded()))))
        XCTAssertEqual(m_per_us_d_to_cm_per_ns_u(5000000), centimetres_per_nanoseconds_u((((Double(5000000)) * ((Double(100)) / (Double(1000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * ((Double(100)) / (Double(1000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * ((Double(100)) / (Double(1000)))).rounded()))))
        XCTAssertEqual(m_per_us_d_to_cm_per_ns_u(-Double.greatestFiniteMagnitude), centimetres_per_nanoseconds_u(UInt64.min))
        XCTAssertEqual(m_per_us_d_to_cm_per_ns_u(Double.greatestFiniteMagnitude), centimetres_per_nanoseconds_u(UInt64.max))
    }

    func testmetres_per_microseconds_d_to_centimetres_per_picoseconds_d() {
        let result = m_per_us_d_to_cm_per_ps_d(-5000000)
        ...
        let result1 = m_per_us_d_to_cm_per_ps_d(0)
        ...
        let result2 = m_per_us_d_to_cm_per_ps_d(5000000)
        ...
        let result3 = m_per_us_d_to_cm_per_ps_d(-Double.greatestFiniteMagnitude)
        ...
        let result4 = m_per_us_d_to_cm_per_ps_d(Double.greatestFiniteMagnitude)
    ...
    func testmetres_per_microseconds_d_to_centimetres_per_picoseconds_f() {
        let result = m_per_us_d_to_cm_per_ps_f(-5000000)
        ...
        let result1 = m_per_us_d_to_cm_per_ps_f(0)
        ...
        let result2 = m_per_us_d_to_cm_per_ps_f(5000000)
        ...
        let result3 = m_per_us_d_to_cm_per_ps_f(-Double.greatestFiniteMagnitude)
        ...
        let result4 = m_per_us_d_to_cm_per_ps_f(Double.greatestFiniteMagnitude)
    ...
    func testmetres_per_microseconds_d_to_centimetres_per_picoseconds_t() {
        XCTAssertEqual(m_per_us_d_to_cm_per_ps_t(-5000000), centimetres_per_picoseconds_t((((Double(-5000000)) * ((Double(100)) / (Double(1000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(-5000000)) * ((Double(100)) / (Double(1000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(-5000000)) * ((Double(100)) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(m_per_us_d_to_cm_per_ps_t(0), centimetres_per_picoseconds_t((((Double(0)) * ((Double(100)) / (Double(1000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(0)) * ((Double(100)) / (Double(1000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(0)) * ((Double(100)) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(m_per_us_d_to_cm_per_ps_t(5000000), centimetres_per_picoseconds_t((((Double(5000000)) * ((Double(100)) / (Double(1000000)))).rounded()) > (Double(Int64.max)).nextDown ? (Int64.max) : (((((Double(5000000)) * ((Double(100)) / (Double(1000000)))).rounded()) < (Double(Int64.min)).nextUp) ? (Int64.min) : Int64(((Double(5000000)) * ((Double(100)) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(m_per_us_d_to_cm_per_ps_t(-Double.greatestFiniteMagnitude), centimetres_per_picoseconds_t(Int64.min))
        XCTAssertEqual(m_per_us_d_to_cm_per_ps_t(Double.greatestFiniteMagnitude), centimetres_per_picoseconds_t(Int64.max))
    }

    func testmetres_per_microseconds_d_to_centimetres_per_picoseconds_u() {
        XCTAssertEqual(m_per_us_d_to_cm_per_ps_u(-5000000), centimetres_per_picoseconds_u((((Double(-5000000)) * ((Double(100)) / (Double(1000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * ((Double(100)) / (Double(1000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * ((Double(100)) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(m_per_us_d_to_cm_per_ps_u(0), centimetres_per_picoseconds_u((((Double(0)) * ((Double(100)) / (Double(1000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * ((Double(100)) / (Double(1000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * ((Double(100)) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(m_per_us_d_to_cm_per_ps_u(5000000), centimetres_per_picoseconds_u((((Double(5000000)) * ((Double(100)) / (Double(1000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * ((Double(100)) / (Double(1000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * ((Double(100)) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(m_per_us_d_to_cm_per_ps_u(-Double.greatestFiniteMagnitude), centimetres_per_picoseconds_u(UInt64.min))
        XCTAssertEqual(m_per_us_d_to_cm_per_ps_u(Double.greatestFiniteMagnitude), centimetres_per_picoseconds_u(UInt64.max))
    }
