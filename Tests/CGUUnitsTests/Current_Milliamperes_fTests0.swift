...
final class Current_Milliamperes_fTests0: XCTestCase {
    ...
    func testdouble_to_milliamperes_f() {
        ...
        let result2 = d_to_mA_f(Double(-Double.greatestFiniteMagnitude))
        ...
        let result3 = d_to_mA_f(Double(Double.greatestFiniteMagnitude))
    ...
    func testfloat_to_milliamperes_f() {
        ...
        let result2 = f_to_mA_f(Float(-Float.greatestFiniteMagnitude))
        let expected2: milliamperes_f = milliamperes_f(-Float.greatestFiniteMagnitude)
        let tolerance2: milliamperes_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        ...
        let result3 = f_to_mA_f(Float(Float.greatestFiniteMagnitude))
        let expected3: milliamperes_f = milliamperes_f(Float.greatestFiniteMagnitude)
        let tolerance3: milliamperes_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
    ...
    func testint16_t_to_milliamperes_f() {
        ...
        let result2 = i16_to_mA_f(Int16(Int16.min))
        let expected2: milliamperes_f = milliamperes_f(Int16.min)
        let tolerance2: milliamperes_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i16_to_mA_f(Int16(Int16.max))
        let expected3: milliamperes_f = milliamperes_f(Int16.max)
        let tolerance3: milliamperes_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint32_t_to_milliamperes_f() {
        ...
        let result2 = i32_to_mA_f(Int32(Int32.min))
        let expected2: milliamperes_f = milliamperes_f(Int32.min)
        let tolerance2: milliamperes_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i32_to_mA_f(Int32(Int32.max))
        let expected3: milliamperes_f = milliamperes_f(Int32.max)
        let tolerance3: milliamperes_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint64_t_to_milliamperes_f() {
        ...
        let result2 = i64_to_mA_f(Int64(Int64.min))
        let expected2: milliamperes_f = milliamperes_f(Int64.min)
        let tolerance2: milliamperes_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i64_to_mA_f(Int64(Int64.max))
        let expected3: milliamperes_f = milliamperes_f(Int64.max)
        let tolerance3: milliamperes_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint8_t_to_milliamperes_f() {
        ...
        let result2 = i8_to_mA_f(Int8(Int8.min))
        let expected2: milliamperes_f = milliamperes_f(Int8.min)
        let tolerance2: milliamperes_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i8_to_mA_f(Int8(Int8.max))
        let expected3: milliamperes_f = milliamperes_f(Int8.max)
        let tolerance3: milliamperes_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmilliamperes_f_to_amperes_d() {
        ...
        let result4 = mA_f_to_A_d(2500.0)
        ...
        let result5 = mA_f_to_A_d(25000.0)
        ...
        let result6 = mA_f_to_A_d(250000.0)
        ...
        let result7 = mA_f_to_A_d(2500000.0)
    ...
    func testmilliamperes_f_to_amperes_d1() {
        ...
        let result2 = mA_f_to_A_d(-Float.greatestFiniteMagnitude)
        let expected2: amperes_d = amperes_d(-Float.greatestFiniteMagnitude) / 1000.0
        let tolerance2: amperes_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = mA_f_to_A_d(Float.greatestFiniteMagnitude)
        let expected3: amperes_d = amperes_d(Float.greatestFiniteMagnitude) / 1000.0
        let tolerance3: amperes_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmilliamperes_f_to_amperes_f() {
        ...
        let result4 = mA_f_to_A_f(2500.0)
        ...
        let result5 = mA_f_to_A_f(25000.0)
        ...
        let result6 = mA_f_to_A_f(250000.0)
        ...
        let result7 = mA_f_to_A_f(2500000.0)
    ...
    func testmilliamperes_f_to_amperes_f1() {
        ...
        let result2 = mA_f_to_A_f(-Float.greatestFiniteMagnitude)
        let expected2: amperes_f = amperes_f(-Float.greatestFiniteMagnitude) / 1000.0
        let tolerance2: amperes_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = mA_f_to_A_f(Float.greatestFiniteMagnitude)
        let expected3: amperes_f = amperes_f(Float.greatestFiniteMagnitude) / 1000.0
        let tolerance3: amperes_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmilliamperes_f_to_amperes_t() {
        XCTAssertEqual(mA_f_to_A_t(15.0), amperes_t((Float(15.0) / 1000.0).rounded()))
        XCTAssertEqual(mA_f_to_A_t(25.0), amperes_t((Float(25.0) / 1000.0).rounded()))
        XCTAssertEqual(mA_f_to_A_t(250.0), amperes_t((Float(250.0) / 1000.0).rounded()))
        XCTAssertEqual(mA_f_to_A_t(0.0), amperes_t((Float(0.0) / 1000.0).rounded()))
        XCTAssertEqual(mA_f_to_A_t(2500.0), amperes_t((Float(2500.0) / 1000.0).rounded()))
        XCTAssertEqual(mA_f_to_A_t(25000.0), amperes_t((Float(25000.0) / 1000.0).rounded()))
        XCTAssertEqual(mA_f_to_A_t(250000.0), amperes_t((Float(250000.0) / 1000.0).rounded()))
        XCTAssertEqual(mA_f_to_A_t(2500000.0), amperes_t((Float(2500000.0) / 1000.0).rounded()))
    ...
    func testmilliamperes_f_to_amperes_t1() {
    ...
    func testmilliamperes_f_to_amperes_u() {
    ...
    func testmilliamperes_f_to_amperes_u1() {
    ...
    func testmilliamperes_f_to_double() {
        ...
        let result2 = mA_f_to_d(milliamperes_f(-Float.greatestFiniteMagnitude))
        ...
        let result3 = mA_f_to_d(milliamperes_f(Float.greatestFiniteMagnitude))
    ...
    func testmilliamperes_f_to_float() {
        ...
        let result2 = mA_f_to_f(milliamperes_f(-Float.greatestFiniteMagnitude))
        ...
        let result3 = mA_f_to_f(milliamperes_f(Float.greatestFiniteMagnitude))
    ...
    func testmilliamperes_f_to_int16_t() {
    ...
    func testmilliamperes_f_to_int32_t() {
    ...
    func testmilliamperes_f_to_int64_t() {
    ...
    func testmilliamperes_f_to_int8_t() {
    ...
    func testmilliamperes_f_to_microamperes_d() {
        ...
        let result2 = mA_f_to_uA_d(250.0)
        ...
        let result4 = mA_f_to_uA_d(2500.0)
        ...
        let result5 = mA_f_to_uA_d(25000.0)
        ...
        let result6 = mA_f_to_uA_d(250000.0)
        ...
        let result7 = mA_f_to_uA_d(2500000.0)
        ...
        let result8 = mA_f_to_uA_d(-323.0)
    ...
    func testmilliamperes_f_to_microamperes_d1() {
        ...
        let result2 = mA_f_to_uA_d(-Float.greatestFiniteMagnitude)
        let expected2: microamperes_d = microamperes_d(-Float.greatestFiniteMagnitude) * 1000.0
        let tolerance2: microamperes_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = mA_f_to_uA_d(Float.greatestFiniteMagnitude)
        let expected3: microamperes_d = microamperes_d(Float.greatestFiniteMagnitude) * 1000.0
        let tolerance3: microamperes_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmilliamperes_f_to_microamperes_f() {
        ...
        let result2 = mA_f_to_uA_f(250.0)
        ...
        let result4 = mA_f_to_uA_f(2500.0)
        ...
        let result5 = mA_f_to_uA_f(25000.0)
        ...
        let result6 = mA_f_to_uA_f(250000.0)
        ...
        let result7 = mA_f_to_uA_f(2500000.0)
        ...
        let result8 = mA_f_to_uA_f(-323.0)
    ...
    func testmilliamperes_f_to_microamperes_f1() {
        ...
        let result2 = mA_f_to_uA_f(-Float.greatestFiniteMagnitude)
        ...
        let result3 = mA_f_to_uA_f(Float.greatestFiniteMagnitude)
    ...
    func testmilliamperes_f_to_microamperes_t() {
    ...
    func testmilliamperes_f_to_microamperes_t1() {
    ...
    func testmilliamperes_f_to_microamperes_u() {
    ...
    func testmilliamperes_f_to_microamperes_u1() {
    ...
    func testmilliamperes_f_to_milliamperes_d() {
        ...
        let result1 = mA_f_to_mA_d(milliamperes_f(-Float.greatestFiniteMagnitude))
        let expected1: milliamperes_d = milliamperes_d(-Float.greatestFiniteMagnitude)
        ...
        let result2 = mA_f_to_mA_d(milliamperes_f(Float.greatestFiniteMagnitude))
    ...
    func testmilliamperes_f_to_milliamperes_t() {
