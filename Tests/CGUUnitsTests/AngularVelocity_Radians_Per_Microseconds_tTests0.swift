...
final class AngularVelocity_Radians_Per_Microseconds_tTests0: XCTestCase {
    ...
    func testradians_per_microseconds_t_to_int64_t() {
        XCTAssertEqual(rad_per_us_t_to_i64(0), 0)
        XCTAssertEqual(rad_per_us_t_to_i64(5), 5)
        XCTAssertEqual(rad_per_us_t_to_i64(radians_per_microseconds_t(Int64.min)), Int64(Int64.min))
        XCTAssertEqual(rad_per_us_t_to_i64(radians_per_microseconds_t(Int64.max)), Int64(Int64.max))
    }

    func testradians_per_microseconds_t_to_int8_t() {
        XCTAssertEqual(rad_per_us_t_to_i8(0), 0)
        XCTAssertEqual(rad_per_us_t_to_i8(5), 5)
        XCTAssertEqual(rad_per_us_t_to_i8(radians_per_microseconds_t(Int64.min)), Int8(Int8.min))
        XCTAssertEqual(rad_per_us_t_to_i8(radians_per_microseconds_t(Int64.max)), Int8(Int8.max))
    }

    func testradians_per_microseconds_t_to_radians_per_microseconds_d() {
        let result = rad_per_us_t_to_rad_per_us_d(-5000000)
        ...
        let result1 = rad_per_us_t_to_rad_per_us_d(0)
        ...
        let result2 = rad_per_us_t_to_rad_per_us_d(5000000)
        ...
        let result3 = rad_per_us_t_to_rad_per_us_d(Int64.min)
        ...
        let result4 = rad_per_us_t_to_rad_per_us_d(Int64.max)
    ...
    func testradians_per_microseconds_t_to_radians_per_microseconds_f() {
        let result = rad_per_us_t_to_rad_per_us_f(-5000000)
        ...
        let result1 = rad_per_us_t_to_rad_per_us_f(0)
        ...
        let result2 = rad_per_us_t_to_rad_per_us_f(5000000)
        ...
        let result3 = rad_per_us_t_to_rad_per_us_f(Int64.min)
        ...
        let result4 = rad_per_us_t_to_rad_per_us_f(Int64.max)
    ...
    func testradians_per_microseconds_t_to_radians_per_microseconds_u() {
        XCTAssertEqual(rad_per_us_t_to_rad_per_us_u(-5000000), radians_per_microseconds_u(UInt64(clamping: Int64(-5000000))))
        XCTAssertEqual(rad_per_us_t_to_rad_per_us_u(0), radians_per_microseconds_u(UInt64(clamping: Int64(0))))
        XCTAssertEqual(rad_per_us_t_to_rad_per_us_u(5000000), radians_per_microseconds_u(UInt64(clamping: Int64(5000000))))
        XCTAssertEqual(rad_per_us_t_to_rad_per_us_u(Int64.min), radians_per_microseconds_u(UInt64.min))
        XCTAssertEqual(rad_per_us_t_to_rad_per_us_u(Int64.max), radians_per_microseconds_u(UInt64.max))
    }

    func testradians_per_microseconds_t_to_radians_per_milliseconds_d() {
        let result = rad_per_us_t_to_rad_per_ms_d(-5000000)
        ...
        let result1 = rad_per_us_t_to_rad_per_ms_d(0)
        ...
        let result2 = rad_per_us_t_to_rad_per_ms_d(5000000)
        ...
        let result3 = rad_per_us_t_to_rad_per_ms_d(Int64.min)
        ...
        let result4 = rad_per_us_t_to_rad_per_ms_d(Int64.max)
    ...
    func testradians_per_microseconds_t_to_radians_per_milliseconds_f() {
        let result = rad_per_us_t_to_rad_per_ms_f(-5000000)
        ...
        let result1 = rad_per_us_t_to_rad_per_ms_f(0)
        ...
        let result2 = rad_per_us_t_to_rad_per_ms_f(5000000)
        ...
        let result3 = rad_per_us_t_to_rad_per_ms_f(Int64.min)
        ...
        let result4 = rad_per_us_t_to_rad_per_ms_f(Int64.max)
    ...
    func testradians_per_microseconds_t_to_radians_per_milliseconds_t() {
        XCTAssertEqual(rad_per_us_t_to_rad_per_ms_t(-5000000), radians_per_milliseconds_t(Int64(clamping: (Int64(-5000000)) * (Int64(1000)))))
        XCTAssertEqual(rad_per_us_t_to_rad_per_ms_t(0), radians_per_milliseconds_t(Int64(clamping: (Int64(0)) * (Int64(1000)))))
        XCTAssertEqual(rad_per_us_t_to_rad_per_ms_t(5000000), radians_per_milliseconds_t(Int64(clamping: (Int64(5000000)) * (Int64(1000)))))
        XCTAssertEqual(rad_per_us_t_to_rad_per_ms_t(Int64.min), radians_per_milliseconds_t(Int64.min))
        XCTAssertEqual(rad_per_us_t_to_rad_per_ms_t(Int64.max), radians_per_milliseconds_t(Int64.max))
    }
