...
final class Velocity_Centimetres_Per_Microseconds_fTests2: XCTestCase {
    ...
    func testcentimetres_per_microseconds_f_to_millimetres_per_picoseconds_u() {
        XCTAssertEqual(cm_per_us_f_to_mm_per_ps_u(-5000000), millimetres_per_picoseconds_u((((Double(-5000000)) * ((Double(10)) / (Double(1000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(-5000000)) * ((Double(10)) / (Double(1000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(-5000000)) * ((Double(10)) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(cm_per_us_f_to_mm_per_ps_u(0), millimetres_per_picoseconds_u((((Double(0)) * ((Double(10)) / (Double(1000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(0)) * ((Double(10)) / (Double(1000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(0)) * ((Double(10)) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(cm_per_us_f_to_mm_per_ps_u(5000000), millimetres_per_picoseconds_u((((Double(5000000)) * ((Double(10)) / (Double(1000000)))).rounded()) > (Double(UInt64.max)).nextDown ? (UInt64.max) : (((((Double(5000000)) * ((Double(10)) / (Double(1000000)))).rounded()) < (Double(UInt64.min)).nextUp) ? (UInt64.min) : UInt64(((Double(5000000)) * ((Double(10)) / (Double(1000000)))).rounded()))))
        XCTAssertEqual(cm_per_us_f_to_mm_per_ps_u(-Float.greatestFiniteMagnitude), millimetres_per_picoseconds_u(UInt64.min))
        XCTAssertEqual(cm_per_us_f_to_mm_per_ps_u(Float.greatestFiniteMagnitude), millimetres_per_picoseconds_u(UInt64.max))
    }
