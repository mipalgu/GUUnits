...
final class Mass_Gram_tTests0: XCTestCase {
    ...
    func testgram_t_to_double() {
        ...
        let result2 = g_t_to_d(gram_t(Int64.min))
        ...
        let result3 = g_t_to_d(gram_t(Int64.max))
    ...
    func testgram_t_to_float() {
        ...
        let result2 = g_t_to_f(gram_t(Int64.min))
        ...
        let result3 = g_t_to_f(gram_t(Int64.max))
    ...
    func testgram_t_to_gram_d() {
        ...
        let result1 = g_t_to_g_d(gram_t(Int64.min))
        let expected1: gram_d = gram_d(Int64.min)
        ...
        let result2 = g_t_to_g_d(gram_t(Int64.max))
        let expected2: gram_d = gram_d(Int64.max)
    ...
    func testgram_t_to_gram_f() {
        ...
        let result1 = g_t_to_g_f(gram_t(Int64.min))
        let expected1: gram_f = gram_f(Int64.min)
        ...
        let result2 = g_t_to_g_f(gram_t(Int64.max))
        let expected2: gram_f = gram_f(Int64.max)
    ...
    func testgram_t_to_kilogram_d() {
        ...
        let result6 = g_t_to_kg_d(250000)
        ...
        let result7 = g_t_to_kg_d(2500000)
    ...
    func testgram_t_to_kilogram_d1() {
        ...
        let result2 = g_t_to_kg_d(Int64.min)
        let expected2: kilogram_d = kilogram_d(Int64.min) / 1000.0
        let tolerance2: kilogram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = g_t_to_kg_d(Int64.max)
        let expected3: kilogram_d = kilogram_d(Int64.max) / 1000.0
        let tolerance3: kilogram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testgram_t_to_kilogram_f() {
        ...
        let result6 = g_t_to_kg_f(250000)
        ...
        let result7 = g_t_to_kg_f(2500000)
    ...
    func testgram_t_to_kilogram_f1() {
        let result = g_t_to_kg_f(-1000)
        ...
        let result2 = g_t_to_kg_f(Int64.min)
        let expected2: kilogram_f = kilogram_f(Int64.min) / 1000.0
        let tolerance2: kilogram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = g_t_to_kg_f(Int64.max)
        let expected3: kilogram_f = kilogram_f(Int64.max) / 1000.0
        let tolerance3: kilogram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testgram_t_to_kilogram_t() {
        XCTAssertEqual(g_t_to_kg_t(15), kilogram_t(15) / 1000)
        XCTAssertEqual(g_t_to_kg_t(25), kilogram_t(25) / 1000)
        XCTAssertEqual(g_t_to_kg_t(250), kilogram_t(250) / 1000)
        XCTAssertEqual(g_t_to_kg_t(0), kilogram_t(0) / 1000)
        XCTAssertEqual(g_t_to_kg_t(2500), kilogram_t(2500) / 1000)
        XCTAssertEqual(g_t_to_kg_t(25000), kilogram_t(25000) / 1000)
        XCTAssertEqual(g_t_to_kg_t(250000), kilogram_t(250000) / 1000)
        XCTAssertEqual(g_t_to_kg_t(2500000), kilogram_t(2500000) / 1000)
        XCTAssertEqual(g_t_to_kg_t(-323), kilogram_t(-323) / 1000)
        XCTAssertEqual(g_t_to_kg_t(-10), kilogram_t(-10) / 1000)
    }

    func testgram_t_to_kilogram_t1() {
        XCTAssertEqual(g_t_to_kg_t(-1000), kilogram_t(-1000) / 1000)
        XCTAssertEqual(g_t_to_kg_t(-5), kilogram_t(-5) / 1000)
        XCTAssertEqual(g_t_to_kg_t(Int64.min), kilogram_t(Int64.min) / 1000)
        XCTAssertEqual(g_t_to_kg_t(Int64.max), kilogram_t(Int64.max) / 1000)
    }

    func testgram_t_to_kilogram_u() {
        XCTAssertEqual(g_t_to_kg_u(15), kilogram_u(15) / 1000)
        XCTAssertEqual(g_t_to_kg_u(25), kilogram_u(25) / 1000)
        XCTAssertEqual(g_t_to_kg_u(250), kilogram_u(250) / 1000)
        XCTAssertEqual(g_t_to_kg_u(0), kilogram_u(0) / 1000)
        XCTAssertEqual(g_t_to_kg_u(2500), kilogram_u(2500) / 1000)
        XCTAssertEqual(g_t_to_kg_u(25000), kilogram_u(25000) / 1000)
        XCTAssertEqual(g_t_to_kg_u(250000), kilogram_u(250000) / 1000)
        XCTAssertEqual(g_t_to_kg_u(2500000), kilogram_u(2500000) / 1000)
        XCTAssertEqual(g_t_to_kg_u(-323), 0)
        XCTAssertEqual(g_t_to_kg_u(-10), 0)
    }

    func testgram_t_to_kilogram_u1() {
    ...
    func testgram_t_to_megagram_d() {
        ...
        let result6 = g_t_to_Mg_d(250000)
        ...
        let result7 = g_t_to_Mg_d(2500000)
    ...
    func testgram_t_to_megagram_d1() {
        ...
        let result2 = g_t_to_Mg_d(Int64.min)
        let expected2: megagram_d = megagram_d(Int64.min) / 1000000.0
        let tolerance2: megagram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = g_t_to_Mg_d(Int64.max)
        let expected3: megagram_d = megagram_d(Int64.max) / 1000000.0
        let tolerance3: megagram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testgram_t_to_megagram_f() {
        ...
        let result6 = g_t_to_Mg_f(250000)
        ...
        let result7 = g_t_to_Mg_f(2500000)
    ...
    func testgram_t_to_megagram_f1() {
        ...
        let result2 = g_t_to_Mg_f(Int64.min)
        let expected2: megagram_f = megagram_f(Int64.min) / 1000000.0
        let tolerance2: megagram_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = g_t_to_Mg_f(Int64.max)
        let expected3: megagram_f = megagram_f(Int64.max) / 1000000.0
        let tolerance3: megagram_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testgram_t_to_megagram_t() {
        XCTAssertEqual(g_t_to_Mg_t(15), megagram_t(15) / 1000000)
        XCTAssertEqual(g_t_to_Mg_t(25), megagram_t(25) / 1000000)
        XCTAssertEqual(g_t_to_Mg_t(250), megagram_t(250) / 1000000)
        XCTAssertEqual(g_t_to_Mg_t(0), megagram_t(0) / 1000000)
        XCTAssertEqual(g_t_to_Mg_t(2500), megagram_t(2500) / 1000000)
        XCTAssertEqual(g_t_to_Mg_t(25000), megagram_t(25000) / 1000000)
        XCTAssertEqual(g_t_to_Mg_t(250000), megagram_t(250000) / 1000000)
        XCTAssertEqual(g_t_to_Mg_t(2500000), megagram_t(2500000) / 1000000)
        XCTAssertEqual(g_t_to_Mg_t(-323), megagram_t(-323) / 1000000)
        XCTAssertEqual(g_t_to_Mg_t(-10), megagram_t(-10) / 1000000)
    }

    func testgram_t_to_megagram_t1() {
        XCTAssertEqual(g_t_to_Mg_t(-1000), megagram_t(-1000) / 1000000)
        XCTAssertEqual(g_t_to_Mg_t(-5), megagram_t(-5) / 1000000)
        XCTAssertEqual(g_t_to_Mg_t(Int64.min), megagram_t(Int64.min) / 1000000)
        XCTAssertEqual(g_t_to_Mg_t(Int64.max), megagram_t(Int64.max) / 1000000)
    }

    func testgram_t_to_megagram_u() {
        XCTAssertEqual(g_t_to_Mg_u(15), megagram_u(15) / 1000000)
        XCTAssertEqual(g_t_to_Mg_u(25), megagram_u(25) / 1000000)
        XCTAssertEqual(g_t_to_Mg_u(250), megagram_u(250) / 1000000)
        XCTAssertEqual(g_t_to_Mg_u(0), megagram_u(0) / 1000000)
        XCTAssertEqual(g_t_to_Mg_u(2500), megagram_u(2500) / 1000000)
        XCTAssertEqual(g_t_to_Mg_u(25000), megagram_u(25000) / 1000000)
        XCTAssertEqual(g_t_to_Mg_u(250000), megagram_u(250000) / 1000000)
        XCTAssertEqual(g_t_to_Mg_u(2500000), megagram_u(2500000) / 1000000)
        XCTAssertEqual(g_t_to_Mg_u(-323), 0)
        XCTAssertEqual(g_t_to_Mg_u(-10), 0)
    }

    func testgram_t_to_megagram_u1() {
        XCTAssertEqual(g_t_to_Mg_u(-1000), 0)
        XCTAssertEqual(g_t_to_Mg_u(-6), 0)
        XCTAssertEqual(g_t_to_Mg_u(Int64.min), 0)
        XCTAssertEqual(g_t_to_Mg_u(Int64.max), megagram_u(Int64.max) / 1000000)
    }

    func testgram_t_to_microgram_d() {
        let result = g_t_to_ug_d(15)
        ...
        let result6 = g_t_to_ug_d(250000)
        ...
        let result7 = g_t_to_ug_d(2500000)
    ...
    func testgram_t_to_microgram_d1() {
        let result = g_t_to_ug_d(-1000)
        ...
        let result2 = g_t_to_ug_d(Int64.min)
        let expected2: microgram_d = microgram_d(Int64.min) * 1000000.0
        let tolerance2: microgram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = g_t_to_ug_d(Int64.max)
        let expected3: microgram_d = microgram_d(Int64.max) * 1000000.0
        let tolerance3: microgram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testgram_t_to_microgram_f() {
        let result = g_t_to_ug_f(15)
        ...
        let result6 = g_t_to_ug_f(250000)
        ...
        let result7 = g_t_to_ug_f(2500000)
