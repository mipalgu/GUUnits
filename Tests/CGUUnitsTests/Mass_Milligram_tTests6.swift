...
final class Mass_Milligram_tTests6: XCTestCase {
    ...
    func testmilligram_tTomegagram_fUsingInt64_maxExpectingmegagram_fInt64_max1000000000_0() {
        ...
        let expected: megagram_f = megagram_f(Int64.max) / 1000000000.0
        let tolerance: megagram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmilligram_tTomegagram_fUsingInt64_minExpectingmegagram_fInt64_min1000000000_0() {
        ...
        let expected: megagram_f = megagram_f(Int64.min) / 1000000000.0
        let tolerance: megagram_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
