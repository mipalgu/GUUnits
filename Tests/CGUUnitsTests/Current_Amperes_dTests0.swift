...
final class Current_Amperes_dTests0: XCTestCase {
    ...
    func testamperes_d_to_amperes_f() {
        ...
        let result1 = A_d_to_A_f(amperes_d(-Double.greatestFiniteMagnitude))
        let expected1: amperes_f = amperes_f(-Float.greatestFiniteMagnitude)
        ...
        let result2 = A_d_to_A_f(amperes_d(Double.greatestFiniteMagnitude))
    ...
    func testamperes_d_to_amperes_t() {
    ...
    func testamperes_d_to_amperes_u() {
    ...
    func testamperes_d_to_double() {
        ...
        let result2 = A_d_to_d(amperes_d(-Double.greatestFiniteMagnitude))
        ...
        let result3 = A_d_to_d(amperes_d(Double.greatestFiniteMagnitude))
    ...
    func testamperes_d_to_float() {
        ...
        let result2 = A_d_to_f(amperes_d(-Double.greatestFiniteMagnitude))
        ...
        let result3 = A_d_to_f(amperes_d(Double.greatestFiniteMagnitude))
    ...
    func testamperes_d_to_microamperes_d() {
        ...
        let result4 = A_d_to_uA_d(2500.0)
        ...
        let result5 = A_d_to_uA_d(25000.0)
        ...
        let result6 = A_d_to_uA_d(250000.0)
        ...
        let result7 = A_d_to_uA_d(2500000.0)
    ...
    func testamperes_d_to_microamperes_d1() {
        ...
        let result2 = A_d_to_uA_d(-Double.greatestFiniteMagnitude)
        ...
        let result3 = A_d_to_uA_d(Double.greatestFiniteMagnitude)
    ...
    func testamperes_d_to_microamperes_f() {
        ...
        let result4 = A_d_to_uA_f(2500.0)
        ...
        let result5 = A_d_to_uA_f(25000.0)
        ...
        let result6 = A_d_to_uA_f(250000.0)
        ...
        let result7 = A_d_to_uA_f(2500000.0)
    ...
    func testamperes_d_to_microamperes_f1() {
        ...
        let result2 = A_d_to_uA_f(-Double.greatestFiniteMagnitude)
        ...
        let result3 = A_d_to_uA_f(Double.greatestFiniteMagnitude)
    ...
    func testamperes_d_to_microamperes_t() {
    ...
    func testamperes_d_to_microamperes_t1() {
    ...
    func testamperes_d_to_microamperes_u() {
    ...
    func testamperes_d_to_microamperes_u1() {
    ...
    func testamperes_d_to_milliamperes_d() {
        ...
        let result4 = A_d_to_mA_d(2500.0)
        ...
        let result5 = A_d_to_mA_d(25000.0)
        ...
        let result6 = A_d_to_mA_d(250000.0)
        ...
        let result7 = A_d_to_mA_d(2500000.0)
    ...
    func testamperes_d_to_milliamperes_d1() {
        ...
        let result2 = A_d_to_mA_d(-Double.greatestFiniteMagnitude)
        ...
        let result3 = A_d_to_mA_d(Double.greatestFiniteMagnitude)
    ...
    func testamperes_d_to_milliamperes_f() {
        ...
        let result4 = A_d_to_mA_f(2500.0)
        ...
        let result5 = A_d_to_mA_f(25000.0)
        ...
        let result6 = A_d_to_mA_f(250000.0)
        ...
        let result7 = A_d_to_mA_f(2500000.0)
    ...
    func testamperes_d_to_milliamperes_f1() {
        ...
        let result2 = A_d_to_mA_f(-Double.greatestFiniteMagnitude)
        ...
        let result3 = A_d_to_mA_f(Double.greatestFiniteMagnitude)
    ...
    func testamperes_d_to_milliamperes_t() {
    ...
    func testamperes_d_to_milliamperes_t1() {
    ...
    func testamperes_d_to_milliamperes_u() {
    ...
    func testamperes_d_to_milliamperes_u1() {
    ...
    func testamperes_d_to_uint16_t() {
    ...
    func testamperes_d_to_uint32_t() {
    ...
    func testamperes_d_to_uint64_t() {
    ...
    func testdouble_to_amperes_d() {
        ...
        let result2 = d_to_A_d(Double(-Double.greatestFiniteMagnitude))
        let expected2: amperes_d = amperes_d(-Double.greatestFiniteMagnitude)
        ...
        let result3 = d_to_A_d(Double(Double.greatestFiniteMagnitude))
        let expected3: amperes_d = amperes_d(Double.greatestFiniteMagnitude)
