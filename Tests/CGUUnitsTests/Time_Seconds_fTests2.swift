...
final class Time_Seconds_fTests2: XCTestCase {
    ...
    func testseconds_fTomicroseconds_tUsing0_0Expectingmicroseconds_tFloat0_01000000_0_rounded() {
        XCTAssertEqual(s_f_to_us_t(0.0), microseconds_t((Float(0.0) * 1000000.0).rounded()))
    }

    func testseconds_fTomicroseconds_tUsing15_0Expectingmicroseconds_tFloat15_01000000_0_rounded() {
        XCTAssertEqual(s_f_to_us_t(15.0), microseconds_t((Float(15.0) * 1000000.0).rounded()))
    }

    func testseconds_fTomicroseconds_tUsing2500000_0Expectingmicroseconds_tFloat2500000_01000000_0_rounded() {
        XCTAssertEqual(s_f_to_us_t(2500000.0), microseconds_t((Float(2500000.0) * 1000000.0).rounded()))
    }

    func testseconds_fTomicroseconds_tUsing250000_0Expectingmicroseconds_tFloat250000_01000000_0_rounded() {
        XCTAssertEqual(s_f_to_us_t(250000.0), microseconds_t((Float(250000.0) * 1000000.0).rounded()))
    }

    func testseconds_fTomicroseconds_tUsing25000_0Expectingmicroseconds_tFloat25000_01000000_0_rounded() {
        XCTAssertEqual(s_f_to_us_t(25000.0), microseconds_t((Float(25000.0) * 1000000.0).rounded()))
    }

    func testseconds_fTomicroseconds_tUsing2500_0Expectingmicroseconds_tFloat2500_01000000_0_rounded() {
        XCTAssertEqual(s_f_to_us_t(2500.0), microseconds_t((Float(2500.0) * 1000000.0).rounded()))
    }

    func testseconds_fTomicroseconds_tUsing250_0Expectingmicroseconds_tFloat250_01000000_0_rounded() {
        XCTAssertEqual(s_f_to_us_t(250.0), microseconds_t((Float(250.0) * 1000000.0).rounded()))
    }

    func testseconds_fTomicroseconds_tUsing25_0Expectingmicroseconds_tFloat25_01000000_0_rounded() {
        XCTAssertEqual(s_f_to_us_t(25.0), microseconds_t((Float(25.0) * 1000000.0).rounded()))
    }

    func testseconds_fTomicroseconds_tUsingFloat_greatestFiniteMagnitudeExpectingmicroseconds_tInt64_max() {
        XCTAssertEqual(s_f_to_us_t(Float.greatestFiniteMagnitude), microseconds_t(Int64.max))
    }

    func testseconds_fTomicroseconds_tUsingNeg1000_0Expectingmicroseconds_tFloatNeg1000_01000000_0_rounded() {
        XCTAssertEqual(s_f_to_us_t(-1000.0), microseconds_t((Float(-1000.0) * 1000000.0).rounded()))
    }

    func testseconds_fTomicroseconds_tUsingNeg10_0Expectingmicroseconds_tFloatNeg10_01000000_0_rounded() {
        XCTAssertEqual(s_f_to_us_t(-10.0), microseconds_t((Float(-10.0) * 1000000.0).rounded()))
    }

    func testseconds_fTomicroseconds_tUsingNeg323_0Expectingmicroseconds_tFloatNeg323_01000000_0_rounded() {
        XCTAssertEqual(s_f_to_us_t(-323.0), microseconds_t((Float(-323.0) * 1000000.0).rounded()))
    }

    func testseconds_fTomicroseconds_tUsingNeg5_0Expectingmicroseconds_tFloatNeg5_01000000_0_rounded() {
        XCTAssertEqual(s_f_to_us_t(-5.0), microseconds_t((Float(-5.0) * 1000000.0).rounded()))
    }

    func testseconds_fTomicroseconds_tUsingNegFloat_greatestFiniteMagnitudeExpectingmicroseconds_tInt64_min() {
