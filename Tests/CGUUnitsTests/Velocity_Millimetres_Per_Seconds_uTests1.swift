...
final class Velocity_Millimetres_Per_Seconds_uTests1: XCTestCase {
    ...
    func testmillimetres_per_seconds_u_to_millimetres_per_seconds_d() {
        ...
        let result1 = mm_per_s_u_to_mm_per_s_d(5000000)
        let expected1: millimetres_per_seconds_d = millimetres_per_seconds_d(Double(5000000))
        ...
        let result2 = mm_per_s_u_to_mm_per_s_d(UInt64.min)
        let expected2: millimetres_per_seconds_d = millimetres_per_seconds_d((Double(UInt64.min)).rounded())
        ...
        let result3 = mm_per_s_u_to_mm_per_s_d(UInt64.max)
    ...
    func testmillimetres_per_seconds_u_to_millimetres_per_seconds_f() {
        ...
        let result1 = mm_per_s_u_to_mm_per_s_f(5000000)
        let expected1: millimetres_per_seconds_f = millimetres_per_seconds_f(Double(5000000))
        ...
        let result2 = mm_per_s_u_to_mm_per_s_f(UInt64.min)
        let expected2: millimetres_per_seconds_f = millimetres_per_seconds_f((Double(UInt64.min)).rounded())
        ...
        let result3 = mm_per_s_u_to_mm_per_s_f(UInt64.max)
    ...
    func testmillimetres_per_seconds_u_to_millimetres_per_seconds_t() {
    ...
    func testmillimetres_per_seconds_u_to_uint16_t() {
    ...
    func testmillimetres_per_seconds_u_to_uint32_t() {
    ...
    func testmillimetres_per_seconds_u_to_uint64_t() {
    ...
    func testmillimetres_per_seconds_u_to_uint8_t() {
    ...
    func testuint16_t_to_millimetres_per_seconds_u() {
    ...
    func testuint32_t_to_millimetres_per_seconds_u() {
        XCTAssertEqual(u32_to_mm_per_s_u(0), 0)
        XCTAssertEqual(u32_to_mm_per_s_u(5), 5)
        XCTAssertEqual(u32_to_mm_per_s_u(UInt32(UInt32.min)), millimetres_per_seconds_u(UInt64.min))
        XCTAssertEqual(u32_to_mm_per_s_u(UInt32(UInt32.max)), millimetres_per_seconds_u(UInt32.max))
    }

    func testuint64_t_to_millimetres_per_seconds_u() {
        XCTAssertEqual(u64_to_mm_per_s_u(0), 0)
        XCTAssertEqual(u64_to_mm_per_s_u(5), 5)
        XCTAssertEqual(u64_to_mm_per_s_u(UInt64(UInt64.min)), millimetres_per_seconds_u(UInt64.min))
        XCTAssertEqual(u64_to_mm_per_s_u(UInt64(UInt64.max)), millimetres_per_seconds_u(UInt64.max))
    }

    func testuint8_t_to_millimetres_per_seconds_u() {
        XCTAssertEqual(u8_to_mm_per_s_u(0), 0)
        XCTAssertEqual(u8_to_mm_per_s_u(5), 5)
        XCTAssertEqual(u8_to_mm_per_s_u(UInt8(UInt8.min)), millimetres_per_seconds_u(UInt64.min))
        XCTAssertEqual(u8_to_mm_per_s_u(UInt8(UInt8.max)), millimetres_per_seconds_u(UInt8.max))
    }
