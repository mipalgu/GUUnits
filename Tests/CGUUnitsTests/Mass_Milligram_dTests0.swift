...
final class Mass_Milligram_dTests0: XCTestCase {
    ...
    func testdouble_to_milligram_d() {
        ...
        let result2 = d_to_mg_d(Double(-Double.greatestFiniteMagnitude))
        ...
        let result3 = d_to_mg_d(Double(Double.greatestFiniteMagnitude))
    ...
    func testfloat_to_milligram_d() {
        ...
        let result2 = f_to_mg_d(Float(-Float.greatestFiniteMagnitude))
        let expected2: milligram_d = milligram_d(-Float.greatestFiniteMagnitude)
        let tolerance2: milligram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = f_to_mg_d(Float(Float.greatestFiniteMagnitude))
        let expected3: milligram_d = milligram_d(Float.greatestFiniteMagnitude)
        let tolerance3: milligram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint16_t_to_milligram_d() {
        ...
        let result2 = i16_to_mg_d(Int16(Int16.min))
        let expected2: milligram_d = milligram_d(Int16.min)
        let tolerance2: milligram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i16_to_mg_d(Int16(Int16.max))
        let expected3: milligram_d = milligram_d(Int16.max)
        let tolerance3: milligram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint32_t_to_milligram_d() {
        ...
        let result2 = i32_to_mg_d(Int32(Int32.min))
        let expected2: milligram_d = milligram_d(Int32.min)
        let tolerance2: milligram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i32_to_mg_d(Int32(Int32.max))
        let expected3: milligram_d = milligram_d(Int32.max)
        let tolerance3: milligram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint64_t_to_milligram_d() {
        ...
        let result2 = i64_to_mg_d(Int64(Int64.min))
        let expected2: milligram_d = milligram_d(Int64.min)
        let tolerance2: milligram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i64_to_mg_d(Int64(Int64.max))
        let expected3: milligram_d = milligram_d(Int64.max)
        let tolerance3: milligram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testint8_t_to_milligram_d() {
        ...
        let result2 = i8_to_mg_d(Int8(Int8.min))
        let expected2: milligram_d = milligram_d(Int8.min)
        let tolerance2: milligram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = i8_to_mg_d(Int8(Int8.max))
        let expected3: milligram_d = milligram_d(Int8.max)
        let tolerance3: milligram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmilligram_d_to_double() {
        ...
        let result2 = mg_d_to_d(milligram_d(-Double.greatestFiniteMagnitude))
        ...
        let result3 = mg_d_to_d(milligram_d(Double.greatestFiniteMagnitude))
    ...
    func testmilligram_d_to_float() {
        ...
        let result2 = mg_d_to_f(milligram_d(-Double.greatestFiniteMagnitude))
        ...
        let result3 = mg_d_to_f(milligram_d(Double.greatestFiniteMagnitude))
    ...
    func testmilligram_d_to_gram_d() {
        let result = mg_d_to_g_d(15.0)
        ...
        let result4 = mg_d_to_g_d(2500.0)
        ...
        let result5 = mg_d_to_g_d(25000.0)
        ...
        let result6 = mg_d_to_g_d(250000.0)
        ...
        let result7 = mg_d_to_g_d(2500000.0)
    ...
    func testmilligram_d_to_gram_d1() {
        let result = mg_d_to_g_d(-1000.0)
        ...
        let result2 = mg_d_to_g_d(-Double.greatestFiniteMagnitude)
        let expected2: gram_d = gram_d(-Double.greatestFiniteMagnitude) / 1000.0
        let tolerance2: gram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = mg_d_to_g_d(Double.greatestFiniteMagnitude)
        let expected3: gram_d = gram_d(Double.greatestFiniteMagnitude) / 1000.0
        let tolerance3: gram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmilligram_d_to_gram_f() {
        let result = mg_d_to_g_f(15.0)
        ...
        let result4 = mg_d_to_g_f(2500.0)
        ...
        let result5 = mg_d_to_g_f(25000.0)
        ...
        let result6 = mg_d_to_g_f(250000.0)
        ...
        let result7 = mg_d_to_g_f(2500000.0)
    ...
    func testmilligram_d_to_gram_f1() {
        let result = mg_d_to_g_f(-1000.0)
        ...
        let result2 = mg_d_to_g_f(-Double.greatestFiniteMagnitude)
        ...
        let result3 = mg_d_to_g_f(Double.greatestFiniteMagnitude)
    ...
    func testmilligram_d_to_gram_t() {
        XCTAssertEqual(mg_d_to_g_t(15.0), gram_t((Double(15.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_t(25.0), gram_t((Double(25.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_t(250.0), gram_t((Double(250.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_t(0.0), gram_t((Double(0.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_t(2500.0), gram_t((Double(2500.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_t(25000.0), gram_t((Double(25000.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_t(250000.0), gram_t((Double(250000.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_t(2500000.0), gram_t((Double(2500000.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_t(-323.0), gram_t((Double(-323.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_t(-10.0), gram_t((Double(-10.0) / 1000.0).rounded()))
    }

    func testmilligram_d_to_gram_t1() {
        XCTAssertEqual(mg_d_to_g_t(-1000.0), gram_t((Double(-1000.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_t(-5.0), gram_t((Double(-5.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_t(-Double.greatestFiniteMagnitude), gram_t(Int64.min))
        XCTAssertEqual(mg_d_to_g_t(Double.greatestFiniteMagnitude), gram_t(Int64.max))
    }

    func testmilligram_d_to_gram_u() {
        XCTAssertEqual(mg_d_to_g_u(15.0), gram_u((Double(15.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_u(25.0), gram_u((Double(25.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_u(250.0), gram_u((Double(250.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_u(0.0), gram_u((Double(0.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_u(2500.0), gram_u((Double(2500.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_u(25000.0), gram_u((Double(25000.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_u(250000.0), gram_u((Double(250000.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_u(2500000.0), gram_u((Double(2500000.0) / 1000.0).rounded()))
        XCTAssertEqual(mg_d_to_g_u(-323.0), 0)
        XCTAssertEqual(mg_d_to_g_u(-10.0), 0)
    }

    func testmilligram_d_to_gram_u1() {
        XCTAssertEqual(mg_d_to_g_u(-1000.0), 0)
        XCTAssertEqual(mg_d_to_g_u(-6.0), 0)
        XCTAssertEqual(mg_d_to_g_u(-Double.greatestFiniteMagnitude), gram_u(UInt64.min))
        XCTAssertEqual(mg_d_to_g_u(Double.greatestFiniteMagnitude), gram_u(UInt64.max))
    }

    func testmilligram_d_to_int16_t() {
        XCTAssertEqual(mg_d_to_i16(0.0), 0)
        XCTAssertEqual(mg_d_to_i16(5.0), 5)
    ...
    func testmilligram_d_to_int32_t() {
    ...
    func testmilligram_d_to_int64_t() {
    ...
    func testmilligram_d_to_int8_t() {
    ...
    func testmilligram_d_to_kilogram_d() {
        ...
        let result2 = mg_d_to_kg_d(250.0)
        ...
        let result4 = mg_d_to_kg_d(2500.0)
        ...
        let result5 = mg_d_to_kg_d(25000.0)
        ...
        let result6 = mg_d_to_kg_d(250000.0)
        ...
        let result7 = mg_d_to_kg_d(2500000.0)
        ...
        let result8 = mg_d_to_kg_d(-323.0)
    ...
    func testmilligram_d_to_kilogram_d1() {
        ...
        let result2 = mg_d_to_kg_d(-Double.greatestFiniteMagnitude)
        let expected2: kilogram_d = kilogram_d(-Double.greatestFiniteMagnitude) / 1000000.0
        let tolerance2: kilogram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = mg_d_to_kg_d(Double.greatestFiniteMagnitude)
        let expected3: kilogram_d = kilogram_d(Double.greatestFiniteMagnitude) / 1000000.0
        let tolerance3: kilogram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmilligram_d_to_kilogram_f() {
        ...
        let result2 = mg_d_to_kg_f(250.0)
        ...
        let result4 = mg_d_to_kg_f(2500.0)
        ...
        let result5 = mg_d_to_kg_f(25000.0)
        ...
        let result6 = mg_d_to_kg_f(250000.0)
        ...
        let result7 = mg_d_to_kg_f(2500000.0)
        ...
        let result8 = mg_d_to_kg_f(-323.0)
    ...
    func testmilligram_d_to_kilogram_f1() {
        ...
        let result2 = mg_d_to_kg_f(-Double.greatestFiniteMagnitude)
        ...
        let result3 = mg_d_to_kg_f(Double.greatestFiniteMagnitude)
    ...
    func testmilligram_d_to_kilogram_t() {
    ...
    func testmilligram_d_to_kilogram_t1() {
    ...
    func testmilligram_d_to_kilogram_u() {
    ...
    func testmilligram_d_to_kilogram_u1() {
    ...
    func testmilligram_d_to_megagram_d() {
        ...
        let result2 = mg_d_to_Mg_d(250.0)
        ...
        let result4 = mg_d_to_Mg_d(2500.0)
        ...
        let result5 = mg_d_to_Mg_d(25000.0)
        ...
        let result6 = mg_d_to_Mg_d(250000.0)
        ...
        let result7 = mg_d_to_Mg_d(2500000.0)
        ...
        let result8 = mg_d_to_Mg_d(-323.0)
    ...
    func testmilligram_d_to_megagram_d1() {
        ...
        let result2 = mg_d_to_Mg_d(-Double.greatestFiniteMagnitude)
        let expected2: megagram_d = megagram_d(-Double.greatestFiniteMagnitude) / 1000000000.0
        let tolerance2: megagram_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = mg_d_to_Mg_d(Double.greatestFiniteMagnitude)
        let expected3: megagram_d = megagram_d(Double.greatestFiniteMagnitude) / 1000000000.0
        let tolerance3: megagram_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
