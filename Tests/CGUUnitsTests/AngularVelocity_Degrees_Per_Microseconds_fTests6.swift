...
final class AngularVelocity_Degrees_Per_Microseconds_fTests6: XCTestCase {

    func testuint16_tTodegrees_per_microseconds_fUsing5Expecting5_0() {
        let result = u16_to_deg_per_us_f(5)
    ...
    func testuint16_tTodegrees_per_microseconds_fUsingUInt16UInt16_maxExpectingdegrees_per_microseconds_fUInt16_max() {
        let result = u16_to_deg_per_us_f(UInt16(UInt16.max))
        let expected: degrees_per_microseconds_f = degrees_per_microseconds_f(UInt16.max)
        let tolerance: degrees_per_microseconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testuint16_tTodegrees_per_microseconds_fUsingUInt16UInt16_minExpectingdegrees_per_microseconds_fUInt16_min() {
        let result = u16_to_deg_per_us_f(UInt16(UInt16.min))
        let expected: degrees_per_microseconds_f = degrees_per_microseconds_f(UInt16.min)
        let tolerance: degrees_per_microseconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testuint32_tTodegrees_per_microseconds_fUsing5Expecting5_0() {
        let result = u32_to_deg_per_us_f(5)
        let expected: degrees_per_microseconds_f = 5.0
        let tolerance: degrees_per_microseconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
    ...
    func testuint32_tTodegrees_per_microseconds_fUsingUInt32UInt32_maxExpectingdegrees_per_microseconds_fUInt32_max() {
        let result = u32_to_deg_per_us_f(UInt32(UInt32.max))
        let expected: degrees_per_microseconds_f = degrees_per_microseconds_f(UInt32.max)
        let tolerance: degrees_per_microseconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testuint32_tTodegrees_per_microseconds_fUsingUInt32UInt32_minExpectingdegrees_per_microseconds_fUInt32_min() {
        let result = u32_to_deg_per_us_f(UInt32(UInt32.min))
        let expected: degrees_per_microseconds_f = degrees_per_microseconds_f(UInt32.min)
        let tolerance: degrees_per_microseconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testuint64_tTodegrees_per_microseconds_fUsing5Expecting5_0() {
        let result = u64_to_deg_per_us_f(5)
        let expected: degrees_per_microseconds_f = 5.0
        let tolerance: degrees_per_microseconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
    ...
    func testuint64_tTodegrees_per_microseconds_fUsingUInt64UInt64_maxExpectingdegrees_per_microseconds_fUInt64_max() {
        let result = u64_to_deg_per_us_f(UInt64(UInt64.max))
        let expected: degrees_per_microseconds_f = degrees_per_microseconds_f(UInt64.max)
        let tolerance: degrees_per_microseconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testuint64_tTodegrees_per_microseconds_fUsingUInt64UInt64_minExpectingdegrees_per_microseconds_fUInt64_min() {
        let result = u64_to_deg_per_us_f(UInt64(UInt64.min))
        let expected: degrees_per_microseconds_f = degrees_per_microseconds_f(UInt64.min)
        let tolerance: degrees_per_microseconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testuint8_tTodegrees_per_microseconds_fUsing5Expecting5_0() {
        let result = u8_to_deg_per_us_f(5)
        let expected: degrees_per_microseconds_f = 5.0
        let tolerance: degrees_per_microseconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
    ...
    func testuint8_tTodegrees_per_microseconds_fUsingUInt8UInt8_maxExpectingdegrees_per_microseconds_fUInt8_max() {
        let result = u8_to_deg_per_us_f(UInt8(UInt8.max))
        let expected: degrees_per_microseconds_f = degrees_per_microseconds_f(UInt8.max)
        let tolerance: degrees_per_microseconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testuint8_tTodegrees_per_microseconds_fUsingUInt8UInt8_minExpectingdegrees_per_microseconds_fUInt8_min() {
        let result = u8_to_deg_per_us_f(UInt8(UInt8.min))
        let expected: degrees_per_microseconds_f = degrees_per_microseconds_f(UInt8.min)
        let tolerance: degrees_per_microseconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
