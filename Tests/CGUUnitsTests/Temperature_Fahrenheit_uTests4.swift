...
final class Temperature_Fahrenheit_uTests4: XCTestCase {
    ...
    func testfahrenheit_uTokelvin_fUsingUInt64_maxExpectingkelvin_fDoubleUInt64_max5_09_0Neg32_05_09_0273_15() {
        let result = degF_u_to_K_f(UInt64.max)
        let expected: kelvin_f = kelvin_f((Double(UInt64.max) * (5.0 / 9.0)) - (32.0 * (5.0 / 9.0)) + 273.15)
        let tolerance: kelvin_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testfahrenheit_uTokelvin_fUsingUInt64_minExpectingkelvin_fDoubleUInt64_min5_09_0Neg32_05_09_0273_15() {
        let result = degF_u_to_K_f(UInt64.min)
        let expected: kelvin_f = kelvin_f((Double(UInt64.min) * (5.0 / 9.0)) - (32.0 * (5.0 / 9.0)) + 273.15)
        let tolerance: kelvin_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
