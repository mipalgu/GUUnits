...
final class Temperature_Kelvin_tTests0: XCTestCase {
    ...
    func testkelvin_t_to_celsius_d() {
        ...
        let result6 = K_t_to_degC_d(Int64.min)
        let expected6: celsius_d = celsius_d(Int64.min) - 273.15
        ...
        let result7 = K_t_to_degC_d(Int64.max)
        let expected7: celsius_d = celsius_d(Int64.max) - 273.15
    ...
    func testkelvin_t_to_celsius_f() {
        ...
        let result6 = K_t_to_degC_f(Int64.min)
        let expected6: celsius_f = celsius_f(Int64.min) - 273.15
        ...
        let result7 = K_t_to_degC_f(Int64.max)
        let expected7: celsius_f = celsius_f(Int64.max) - 273.15
    ...
    func testkelvin_t_to_celsius_t() {
    ...
    func testkelvin_t_to_celsius_u() {
    ...
    func testkelvin_t_to_double() {
        ...
        let result2 = K_t_to_d(kelvin_t(Int64.min))
        ...
        let result3 = K_t_to_d(kelvin_t(Int64.max))
    ...
    func testkelvin_t_to_fahrenheit_d() {
        ...
        let result1 = K_t_to_degF_d(2500)
        ...
        let result2 = K_t_to_degF_d(25000)
        ...
        let result3 = K_t_to_degF_d(250000)
        ...
        let result4 = K_t_to_degF_d(2500000)
    ...
    func testkelvin_t_to_fahrenheit_d1() {
        ...
        let result3 = K_t_to_degF_d(-250)
        let expected3: fahrenheit_d = fahrenheit_d((Double(-250) - 273.15) * 1.8 + 32.0)
        let tolerance3: fahrenheit_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
        ...
        let result4 = K_t_to_degF_d(-2500)
        let expected4: fahrenheit_d = fahrenheit_d((Double(-2500) - 273.15) * 1.8 + 32.0)
        let tolerance4: fahrenheit_d = 0.99
        if result4 > expected4 {
            XCTAssertLessThanOrEqual(result4 - expected4, tolerance4)
        } else {
        ...
        let result5 = K_t_to_degF_d(-25000)
        let expected5: fahrenheit_d = fahrenheit_d((Double(-25000) - 273.15) * 1.8 + 32.0)
        let tolerance5: fahrenheit_d = 0.99
        if result5 > expected5 {
            XCTAssertLessThanOrEqual(result5 - expected5, tolerance5)
        } else {
        ...
        let result6 = K_t_to_degF_d(-250000)
        let expected6: fahrenheit_d = fahrenheit_d((Double(-250000) - 273.15) * 1.8 + 32.0)
        let tolerance6: fahrenheit_d = 0.99
        if result6 > expected6 {
            XCTAssertLessThanOrEqual(result6 - expected6, tolerance6)
        } else {
        ...
        let result7 = K_t_to_degF_d(-2500000)
        let expected7: fahrenheit_d = fahrenheit_d((Double(-2500000) - 273.15) * 1.8 + 32.0)
        let tolerance7: fahrenheit_d = 0.99
        if result7 > expected7 {
            XCTAssertLessThanOrEqual(result7 - expected7, tolerance7)
        } else {
        ...
        let result8 = K_t_to_degF_d(-40)
        let expected8: fahrenheit_d = fahrenheit_d((Double(-40) - 273.15) * 1.8 + 32.0)
        let tolerance8: fahrenheit_d = 0.99
        if result8 > expected8 {
            XCTAssertLessThanOrEqual(result8 - expected8, tolerance8)
        } else {
        ...
        let result9 = K_t_to_degF_d(Int64.min)
        let expected9: fahrenheit_d = fahrenheit_d((Double(Int64.min) - 273.15) * 1.8 + 32.0)
        let tolerance9: fahrenheit_d = 0.99
        if result9 > expected9 {
            XCTAssertLessThanOrEqual(result9 - expected9, tolerance9)
        } else {
    ...
    func testkelvin_t_to_fahrenheit_d2() {
    ...
    func testkelvin_t_to_fahrenheit_f() {
        ...
        let result1 = K_t_to_degF_f(2500)
        ...
        let result2 = K_t_to_degF_f(25000)
        ...
        let result3 = K_t_to_degF_f(250000)
        ...
        let result4 = K_t_to_degF_f(2500000)
    ...
    func testkelvin_t_to_fahrenheit_f1() {
        ...
        let result3 = K_t_to_degF_f(-250)
        let expected3: fahrenheit_f = fahrenheit_f((Double(-250) - 273.15) * 1.8 + 32.0)
        let tolerance3: fahrenheit_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
        ...
        let result4 = K_t_to_degF_f(-2500)
        let expected4: fahrenheit_f = fahrenheit_f((Double(-2500) - 273.15) * 1.8 + 32.0)
        let tolerance4: fahrenheit_f = 0.99
        if result4 > expected4 {
            XCTAssertLessThanOrEqual(result4 - expected4, tolerance4)
        } else {
        ...
        let result5 = K_t_to_degF_f(-25000)
        let expected5: fahrenheit_f = fahrenheit_f((Double(-25000) - 273.15) * 1.8 + 32.0)
        let tolerance5: fahrenheit_f = 0.99
        if result5 > expected5 {
            XCTAssertLessThanOrEqual(result5 - expected5, tolerance5)
        } else {
        ...
        let result6 = K_t_to_degF_f(-250000)
        let expected6: fahrenheit_f = fahrenheit_f((Double(-250000) - 273.15) * 1.8 + 32.0)
        let tolerance6: fahrenheit_f = 0.99
        if result6 > expected6 {
            XCTAssertLessThanOrEqual(result6 - expected6, tolerance6)
        } else {
        ...
        let result7 = K_t_to_degF_f(-2500000)
        let expected7: fahrenheit_f = fahrenheit_f((Double(-2500000) - 273.15) * 1.8 + 32.0)
        let tolerance7: fahrenheit_f = 0.99
        if result7 > expected7 {
            XCTAssertLessThanOrEqual(result7 - expected7, tolerance7)
        } else {
        ...
        let result8 = K_t_to_degF_f(-40)
        let expected8: fahrenheit_f = fahrenheit_f((Double(-40) - 273.15) * 1.8 + 32.0)
        let tolerance8: fahrenheit_f = 0.99
        if result8 > expected8 {
            XCTAssertLessThanOrEqual(result8 - expected8, tolerance8)
        } else {
        ...
        let result9 = K_t_to_degF_f(Int64.min)
        let expected9: fahrenheit_f = fahrenheit_f((Double(Int64.min) - 273.15) * 1.8 + 32.0)
        let tolerance9: fahrenheit_f = 0.99
        if result9 > expected9 {
            XCTAssertLessThanOrEqual(result9 - expected9, tolerance9)
        } else {
    ...
    func testkelvin_t_to_fahrenheit_f2() {
    ...
    func testkelvin_t_to_fahrenheit_t() {
    ...
    func testkelvin_t_to_fahrenheit_t1() {
    ...
    func testkelvin_t_to_fahrenheit_t2() {
        XCTAssertEqual(K_t_to_degF_t(Int64.max), Int64.max)
    }

    func testkelvin_t_to_fahrenheit_u() {
    ...
    func testkelvin_t_to_fahrenheit_u1() {
    ...
    func testkelvin_t_to_float() {
        ...
        let result2 = K_t_to_f(kelvin_t(Int64.min))
        ...
        let result3 = K_t_to_f(kelvin_t(Int64.max))
    ...
    func testkelvin_t_to_kelvin_d() {
        ...
        let result1 = K_t_to_K_d(kelvin_t(Int64.min))
        let expected1: kelvin_d = kelvin_d(Int64.min)
        ...
        let result2 = K_t_to_K_d(kelvin_t(Int64.max))
        let expected2: kelvin_d = kelvin_d(Int64.max)
    ...
    func testkelvin_t_to_kelvin_f() {
        ...
        let result1 = K_t_to_K_f(kelvin_t(Int64.min))
        let expected1: kelvin_f = kelvin_f(Int64.min)
        ...
        let result2 = K_t_to_K_f(kelvin_t(Int64.max))
        let expected2: kelvin_f = kelvin_f(Int64.max)
