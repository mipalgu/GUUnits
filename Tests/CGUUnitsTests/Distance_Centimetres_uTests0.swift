...
final class Distance_Centimetres_uTests0: XCTestCase {
    ...
    func testcentimetres_u_to_centimetres_d() {
        ...
        let result1 = cm_u_to_cm_d(centimetres_u(UInt64.min))
        let expected1: centimetres_d = centimetres_d(UInt64.min)
        ...
        let result2 = cm_u_to_cm_d(centimetres_u(UInt64.max))
        let expected2: centimetres_d = centimetres_d(UInt64.max)
    ...
    func testcentimetres_u_to_centimetres_f() {
        ...
        let result1 = cm_u_to_cm_f(centimetres_u(UInt64.min))
        let expected1: centimetres_f = centimetres_f(UInt64.min)
        ...
        let result2 = cm_u_to_cm_f(centimetres_u(UInt64.max))
        let expected2: centimetres_f = centimetres_f(UInt64.max)
    ...
    func testcentimetres_u_to_centimetres_t() {
    ...
    func testcentimetres_u_to_double() {
        ...
        let result2 = cm_u_to_d(centimetres_u(UInt64.min))
        ...
        let result3 = cm_u_to_d(centimetres_u(UInt64.max))
    ...
    func testcentimetres_u_to_float() {
        ...
        let result2 = cm_u_to_f(centimetres_u(UInt64.min))
        ...
        let result3 = cm_u_to_f(centimetres_u(UInt64.max))
    ...
    func testcentimetres_u_to_int16_t() {
    ...
    func testcentimetres_u_to_int32_t() {
    ...
    func testcentimetres_u_to_int64_t() {
    ...
    func testcentimetres_u_to_int8_t() {
    ...
    func testcentimetres_u_to_metres_d() {
        ...
        let result6 = cm_u_to_m_d(250000)
        ...
        let result7 = cm_u_to_m_d(2500000)
        ...
        let result8 = cm_u_to_m_d(UInt64.min)
        let expected8: metres_d = metres_d(UInt64.min) / 100.0
        ...
        let result9 = cm_u_to_m_d(UInt64.max)
        let expected9: metres_d = metres_d(UInt64.max) / 100.0
    ...
    func testcentimetres_u_to_metres_f() {
        ...
        let result6 = cm_u_to_m_f(250000)
        ...
        let result7 = cm_u_to_m_f(2500000)
        ...
        let result8 = cm_u_to_m_f(UInt64.min)
        let expected8: metres_f = metres_f(UInt64.min) / 100.0
        ...
        let result9 = cm_u_to_m_f(UInt64.max)
        let expected9: metres_f = metres_f(UInt64.max) / 100.0
    ...
    func testcentimetres_u_to_metres_t() {
    ...
    func testcentimetres_u_to_metres_u() {
    ...
    func testcentimetres_u_to_millimetres_d() {
        ...
        let result5 = cm_u_to_mm_d(25000)
        ...
        let result6 = cm_u_to_mm_d(250000)
        ...
        let result7 = cm_u_to_mm_d(2500000)
        ...
        let result8 = cm_u_to_mm_d(UInt64.min)
        let expected8: millimetres_d = millimetres_d(UInt64.min) * 10.0
        ...
        let result9 = cm_u_to_mm_d(UInt64.max)
        let expected9: millimetres_d = millimetres_d(UInt64.max) * 10.0
    ...
    func testcentimetres_u_to_millimetres_f() {
        ...
        let result5 = cm_u_to_mm_f(25000)
        ...
        let result6 = cm_u_to_mm_f(250000)
        ...
        let result7 = cm_u_to_mm_f(2500000)
        ...
        let result8 = cm_u_to_mm_f(UInt64.min)
        let expected8: millimetres_f = millimetres_f(UInt64.min) * 10.0
        ...
        let result9 = cm_u_to_mm_f(UInt64.max)
        let expected9: millimetres_f = millimetres_f(UInt64.max) * 10.0
    ...
    func testcentimetres_u_to_millimetres_t() {
    ...
    func testcentimetres_u_to_millimetres_u() {
    ...
    func testcentimetres_u_to_uint16_t() {
    ...
    func testcentimetres_u_to_uint32_t() {
    ...
    func testcentimetres_u_to_uint64_t() {
    ...
    func testcentimetres_u_to_uint8_t() {
    ...
    func testdouble_to_centimetres_u() {
    ...
    func testfloat_to_centimetres_u() {
    ...
    func testint16_t_to_centimetres_u() {
    ...
    func testint32_t_to_centimetres_u() {
    ...
    func testint64_t_to_centimetres_u() {
    ...
    func testint8_t_to_centimetres_u() {
    ...
    func testuint16_t_to_centimetres_u() {
    ...
    func testuint32_t_to_centimetres_u() {
    ...
    func testuint64_t_to_centimetres_u() {
