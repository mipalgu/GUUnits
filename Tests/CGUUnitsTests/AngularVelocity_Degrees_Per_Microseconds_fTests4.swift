...
final class AngularVelocity_Degrees_Per_Microseconds_fTests4: XCTestCase {
    ...
    func testdegrees_per_microseconds_fToradians_per_seconds_dUsingFloat_greatestFiniteMagnitudeExpectingradians_per_seconds_dDouble_greatestFiniteMagnitude() {
        let result = deg_per_us_f_to_rad_per_s_d(Float.greatestFiniteMagnitude)
    ...
    func testdegrees_per_microseconds_fToradians_per_seconds_fUsing0Expectingradians_per_seconds_fDouble0Double3_141592653589793Double180Double1Double1000000() {
        let result = deg_per_us_f_to_rad_per_s_f(0)
    ...
    func testdegrees_per_microseconds_fToradians_per_seconds_fUsingFloat_greatestFiniteMagnitudeExpectingradians_per_seconds_fFloat_greatestFiniteMagnitude() {
        let result = deg_per_us_f_to_rad_per_s_f(Float.greatestFiniteMagnitude)
