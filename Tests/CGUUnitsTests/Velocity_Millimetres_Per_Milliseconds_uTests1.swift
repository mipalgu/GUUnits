...
final class Velocity_Millimetres_Per_Milliseconds_uTests1: XCTestCase {
    ...
    func testmillimetres_per_milliseconds_uTocentimetres_per_microseconds_fUsingUInt64_maxExpectingcentimetres_per_microseconds_fFloat_greatestFiniteMagnitude() {
        let result = mm_per_ms_u_to_cm_per_us_f(UInt64.max)
    ...
    func testmillimetres_per_milliseconds_uTocentimetres_per_microseconds_fUsingUInt64_minExpectingcentimetres_per_microseconds_fDoubleUInt64_minDouble1Double10Double1000_rounded() {
        let result = mm_per_ms_u_to_cm_per_us_f(UInt64.min)
        let expected: centimetres_per_microseconds_f = centimetres_per_microseconds_f(((Double(UInt64.min)) * (((Double(1)) / (Double(10))) / (Double(1000)))).rounded())
        let tolerance: centimetres_per_microseconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmillimetres_per_milliseconds_uTocentimetres_per_milliseconds_dUsing5000000Expectingcentimetres_per_milliseconds_dDouble5000000Double10() {
        let result = mm_per_ms_u_to_cm_per_ms_d(5000000)
    ...
    func testmillimetres_per_milliseconds_uTocentimetres_per_milliseconds_dUsingUInt64_maxExpectingcentimetres_per_milliseconds_dDouble_greatestFiniteMagnitude() {
        let result = mm_per_ms_u_to_cm_per_ms_d(UInt64.max)
    ...
    func testmillimetres_per_milliseconds_uTocentimetres_per_milliseconds_dUsingUInt64_minExpectingcentimetres_per_milliseconds_dDoubleUInt64_minDouble10_rounded() {
        let result = mm_per_ms_u_to_cm_per_ms_d(UInt64.min)
        let expected: centimetres_per_milliseconds_d = centimetres_per_milliseconds_d(((Double(UInt64.min)) / (Double(10))).rounded())
        let tolerance: centimetres_per_milliseconds_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmillimetres_per_milliseconds_uTocentimetres_per_milliseconds_fUsing5000000Expectingcentimetres_per_milliseconds_fDouble5000000Double10() {
        let result = mm_per_ms_u_to_cm_per_ms_f(5000000)
    ...
    func testmillimetres_per_milliseconds_uTocentimetres_per_milliseconds_fUsingUInt64_maxExpectingcentimetres_per_milliseconds_fFloat_greatestFiniteMagnitude() {
        let result = mm_per_ms_u_to_cm_per_ms_f(UInt64.max)
    ...
    func testmillimetres_per_milliseconds_uTocentimetres_per_milliseconds_fUsingUInt64_minExpectingcentimetres_per_milliseconds_fDoubleUInt64_minDouble10_rounded() {
        let result = mm_per_ms_u_to_cm_per_ms_f(UInt64.min)
        let expected: centimetres_per_milliseconds_f = centimetres_per_milliseconds_f(((Double(UInt64.min)) / (Double(10))).rounded())
        let tolerance: centimetres_per_milliseconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmillimetres_per_milliseconds_uTocentimetres_per_seconds_dUsing5000000Expectingcentimetres_per_seconds_dDouble5000000Double1Double10Double1Double1000() {
        let result = mm_per_ms_u_to_cm_per_s_d(5000000)
    ...
    func testmillimetres_per_milliseconds_uTocentimetres_per_seconds_dUsingUInt64_maxExpectingcentimetres_per_seconds_dDouble_greatestFiniteMagnitude() {
        let result = mm_per_ms_u_to_cm_per_s_d(UInt64.max)
    ...
    func testmillimetres_per_milliseconds_uTocentimetres_per_seconds_dUsingUInt64_minExpectingcentimetres_per_seconds_dDoubleUInt64_minDouble1Double10Double1Double1000_rounded() {
        let result = mm_per_ms_u_to_cm_per_s_d(UInt64.min)
        let expected: centimetres_per_seconds_d = centimetres_per_seconds_d(((Double(UInt64.min)) * (((Double(1)) / (Double(10))) / ((Double(1)) / (Double(1000))))).rounded())
        let tolerance: centimetres_per_seconds_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
