...
final class Mass_Microgram_fTests2: XCTestCase {
    ...
    func testmicrogram_fTogram_uUsingFloat_greatestFiniteMagnitudeExpectinggram_uUInt64_max() {
    ...
    func testmicrogram_fTogram_uUsingNegFloat_greatestFiniteMagnitudeExpectinggram_uUInt64_min() {
