...
final class Velocity_Centimetres_Per_Seconds_tTests0: XCTestCase {
    ...
    func testcentimetres_per_seconds_t_to_centimetres_per_microseconds_d() {
        ...
        let result1 = cm_per_s_t_to_cm_per_us_d(0)
        ...
        let result2 = cm_per_s_t_to_cm_per_us_d(5000000)
        ...
        let result3 = cm_per_s_t_to_cm_per_us_d(Int64.min)
        ...
        let result4 = cm_per_s_t_to_cm_per_us_d(Int64.max)
    ...
    func testcentimetres_per_seconds_t_to_centimetres_per_microseconds_f() {
        ...
        let result1 = cm_per_s_t_to_cm_per_us_f(0)
        ...
        let result2 = cm_per_s_t_to_cm_per_us_f(5000000)
        ...
        let result3 = cm_per_s_t_to_cm_per_us_f(Int64.min)
        ...
        let result4 = cm_per_s_t_to_cm_per_us_f(Int64.max)
    ...
    func testcentimetres_per_seconds_t_to_centimetres_per_microseconds_t() {
    ...
    func testcentimetres_per_seconds_t_to_centimetres_per_microseconds_u() {
    ...
    func testcentimetres_per_seconds_t_to_centimetres_per_milliseconds_d() {
        ...
        let result1 = cm_per_s_t_to_cm_per_ms_d(0)
        ...
        let result2 = cm_per_s_t_to_cm_per_ms_d(5000000)
        ...
        let result3 = cm_per_s_t_to_cm_per_ms_d(Int64.min)
        ...
        let result4 = cm_per_s_t_to_cm_per_ms_d(Int64.max)
    ...
    func testcentimetres_per_seconds_t_to_centimetres_per_milliseconds_f() {
        ...
        let result1 = cm_per_s_t_to_cm_per_ms_f(0)
        ...
        let result2 = cm_per_s_t_to_cm_per_ms_f(5000000)
        ...
        let result3 = cm_per_s_t_to_cm_per_ms_f(Int64.min)
        ...
        let result4 = cm_per_s_t_to_cm_per_ms_f(Int64.max)
    ...
    func testcentimetres_per_seconds_t_to_centimetres_per_milliseconds_t() {
    ...
    func testcentimetres_per_seconds_t_to_centimetres_per_milliseconds_u() {
    ...
    func testcentimetres_per_seconds_t_to_centimetres_per_nanoseconds_d() {
        let result = cm_per_s_t_to_cm_per_ns_d(-5000000)
        ...
        let result1 = cm_per_s_t_to_cm_per_ns_d(0)
        ...
        let result2 = cm_per_s_t_to_cm_per_ns_d(5000000)
        ...
        let result3 = cm_per_s_t_to_cm_per_ns_d(Int64.min)
        ...
        let result4 = cm_per_s_t_to_cm_per_ns_d(Int64.max)
    ...
    func testcentimetres_per_seconds_t_to_centimetres_per_nanoseconds_f() {
        let result = cm_per_s_t_to_cm_per_ns_f(-5000000)
        ...
        let result1 = cm_per_s_t_to_cm_per_ns_f(0)
        ...
        let result2 = cm_per_s_t_to_cm_per_ns_f(5000000)
        ...
        let result3 = cm_per_s_t_to_cm_per_ns_f(Int64.min)
        ...
        let result4 = cm_per_s_t_to_cm_per_ns_f(Int64.max)
    ...
    func testcentimetres_per_seconds_t_to_centimetres_per_nanoseconds_t() {
        XCTAssertEqual(cm_per_s_t_to_cm_per_ns_t(-5000000), centimetres_per_nanoseconds_t(Int64(clamping: (Int64(-5000000)) / (Int64(1000000000)))))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ns_t(0), centimetres_per_nanoseconds_t(Int64(clamping: (Int64(0)) / (Int64(1000000000)))))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ns_t(5000000), centimetres_per_nanoseconds_t(Int64(clamping: (Int64(5000000)) / (Int64(1000000000)))))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ns_t(Int64.min), centimetres_per_nanoseconds_t(Int64.min))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ns_t(Int64.max), centimetres_per_nanoseconds_t(Int64.max))
    }

    func testcentimetres_per_seconds_t_to_centimetres_per_nanoseconds_u() {
        XCTAssertEqual(cm_per_s_t_to_cm_per_ns_u(-5000000), centimetres_per_nanoseconds_u(UInt64(clamping: (Int64(-5000000)) / (Int64(1000000000)))))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ns_u(0), centimetres_per_nanoseconds_u(UInt64(clamping: (Int64(0)) / (Int64(1000000000)))))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ns_u(5000000), centimetres_per_nanoseconds_u(UInt64(clamping: (Int64(5000000)) / (Int64(1000000000)))))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ns_u(Int64.min), centimetres_per_nanoseconds_u(UInt64.min))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ns_u(Int64.max), centimetres_per_nanoseconds_u(UInt64.max))
    }

    func testcentimetres_per_seconds_t_to_centimetres_per_picoseconds_d() {
        let result = cm_per_s_t_to_cm_per_ps_d(-5000000)
        ...
        let result1 = cm_per_s_t_to_cm_per_ps_d(0)
        ...
        let result2 = cm_per_s_t_to_cm_per_ps_d(5000000)
        ...
        let result3 = cm_per_s_t_to_cm_per_ps_d(Int64.min)
        ...
        let result4 = cm_per_s_t_to_cm_per_ps_d(Int64.max)
    ...
    func testcentimetres_per_seconds_t_to_centimetres_per_picoseconds_f() {
        let result = cm_per_s_t_to_cm_per_ps_f(-5000000)
        ...
        let result1 = cm_per_s_t_to_cm_per_ps_f(0)
        ...
        let result2 = cm_per_s_t_to_cm_per_ps_f(5000000)
        ...
        let result3 = cm_per_s_t_to_cm_per_ps_f(Int64.min)
        ...
        let result4 = cm_per_s_t_to_cm_per_ps_f(Int64.max)
    ...
    func testcentimetres_per_seconds_t_to_centimetres_per_picoseconds_t() {
        XCTAssertEqual(cm_per_s_t_to_cm_per_ps_t(-5000000), centimetres_per_picoseconds_t(Int64(clamping: (Int64(-5000000)) / (Int64(1000000000000)))))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ps_t(0), centimetres_per_picoseconds_t(Int64(clamping: (Int64(0)) / (Int64(1000000000000)))))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ps_t(5000000), centimetres_per_picoseconds_t(Int64(clamping: (Int64(5000000)) / (Int64(1000000000000)))))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ps_t(Int64.min), centimetres_per_picoseconds_t(Int64.min))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ps_t(Int64.max), centimetres_per_picoseconds_t(Int64.max))
    }

    func testcentimetres_per_seconds_t_to_centimetres_per_picoseconds_u() {
        XCTAssertEqual(cm_per_s_t_to_cm_per_ps_u(-5000000), centimetres_per_picoseconds_u(UInt64(clamping: (Int64(-5000000)) / (Int64(1000000000000)))))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ps_u(0), centimetres_per_picoseconds_u(UInt64(clamping: (Int64(0)) / (Int64(1000000000000)))))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ps_u(5000000), centimetres_per_picoseconds_u(UInt64(clamping: (Int64(5000000)) / (Int64(1000000000000)))))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ps_u(Int64.min), centimetres_per_picoseconds_u(UInt64.min))
        XCTAssertEqual(cm_per_s_t_to_cm_per_ps_u(Int64.max), centimetres_per_picoseconds_u(UInt64.max))
    }

    func testcentimetres_per_seconds_t_to_centimetres_per_seconds_d() {
        ...
        let result1 = cm_per_s_t_to_cm_per_s_d(0)
        ...
        let result2 = cm_per_s_t_to_cm_per_s_d(5000000)
        ...
        let result3 = cm_per_s_t_to_cm_per_s_d(Int64.min)
        ...
        let result4 = cm_per_s_t_to_cm_per_s_d(Int64.max)
    ...
    func testcentimetres_per_seconds_t_to_centimetres_per_seconds_f() {
        ...
        let result1 = cm_per_s_t_to_cm_per_s_f(0)
        ...
        let result2 = cm_per_s_t_to_cm_per_s_f(5000000)
        ...
        let result3 = cm_per_s_t_to_cm_per_s_f(Int64.min)
        ...
        let result4 = cm_per_s_t_to_cm_per_s_f(Int64.max)
    ...
    func testcentimetres_per_seconds_t_to_centimetres_per_seconds_u() {
    ...
    func testcentimetres_per_seconds_t_to_double() {
        ...
        let result2 = cm_per_s_t_to_d(centimetres_per_seconds_t(Int64.min))
        ...
        let result3 = cm_per_s_t_to_d(centimetres_per_seconds_t(Int64.max))
    ...
    func testcentimetres_per_seconds_t_to_float() {
        ...
        let result2 = cm_per_s_t_to_f(centimetres_per_seconds_t(Int64.min))
        ...
        let result3 = cm_per_s_t_to_f(centimetres_per_seconds_t(Int64.max))
    ...
    func testcentimetres_per_seconds_t_to_int16_t() {
    ...
    func testcentimetres_per_seconds_t_to_int32_t() {
    ...
    func testcentimetres_per_seconds_t_to_int64_t() {
    ...
    func testcentimetres_per_seconds_t_to_int8_t() {
    ...
    func testcentimetres_per_seconds_t_to_metres_per_microseconds_d() {
        ...
        let result1 = cm_per_s_t_to_m_per_us_d(0)
        ...
        let result2 = cm_per_s_t_to_m_per_us_d(5000000)
        ...
        let result3 = cm_per_s_t_to_m_per_us_d(Int64.min)
        ...
        let result4 = cm_per_s_t_to_m_per_us_d(Int64.max)
    ...
    func testcentimetres_per_seconds_t_to_metres_per_microseconds_f() {
        ...
        let result1 = cm_per_s_t_to_m_per_us_f(0)
        ...
        let result2 = cm_per_s_t_to_m_per_us_f(5000000)
        ...
        let result3 = cm_per_s_t_to_m_per_us_f(Int64.min)
        ...
        let result4 = cm_per_s_t_to_m_per_us_f(Int64.max)
    ...
    func testcentimetres_per_seconds_t_to_metres_per_microseconds_t() {
    ...
    func testcentimetres_per_seconds_t_to_metres_per_microseconds_u() {
    ...
    func testcentimetres_per_seconds_t_to_metres_per_milliseconds_d() {
        ...
        let result1 = cm_per_s_t_to_m_per_ms_d(0)
        ...
        let result2 = cm_per_s_t_to_m_per_ms_d(5000000)
        ...
        let result3 = cm_per_s_t_to_m_per_ms_d(Int64.min)
        ...
        let result4 = cm_per_s_t_to_m_per_ms_d(Int64.max)
