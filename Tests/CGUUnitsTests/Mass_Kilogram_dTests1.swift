...
final class Mass_Kilogram_dTests1: XCTestCase {
    ...
    func testkilogram_dTofloatUsingkilogram_dDouble_greatestFiniteMagnitudeExpectingFloatFloat_greatestFiniteMagnitude() {
        let result = kg_d_to_f(kilogram_d(Double.greatestFiniteMagnitude))
    ...
    func testkilogram_dTogram_dUsing0_0Expectinggram_d0_01000_0() {
        let result = kg_d_to_g_d(0.0)
    ...
    func testkilogram_dTogram_dUsing2500000_0Expectinggram_d2500000_01000_0() {
        let result = kg_d_to_g_d(2500000.0)
    ...
    func testkilogram_dTogram_dUsing250000_0Expectinggram_d250000_01000_0() {
        let result = kg_d_to_g_d(250000.0)
    ...
    func testkilogram_dTogram_dUsing25000_0Expectinggram_d25000_01000_0() {
        let result = kg_d_to_g_d(25000.0)
    ...
    func testkilogram_dTogram_dUsing2500_0Expectinggram_d2500_01000_0() {
        let result = kg_d_to_g_d(2500.0)
    ...
    func testkilogram_dTogram_dUsing250_0Expectinggram_d250_01000_0() {
        let result = kg_d_to_g_d(250.0)
    ...
    func testkilogram_dTogram_dUsingDouble_greatestFiniteMagnitudeExpectinggram_dDouble_greatestFiniteMagnitude() {
        let result = kg_d_to_g_d(Double.greatestFiniteMagnitude)
    ...
    func testkilogram_dTogram_dUsingNeg1000_0Expectinggram_dNeg1000_01000_0() {
    ...
    func testkilogram_dTogram_dUsingNeg10_0Expectinggram_dNeg10_01000_0() {
        let result = kg_d_to_g_d(-10.0)
    ...
    func testkilogram_dTogram_dUsingNeg323_0Expectinggram_dNeg323_01000_0() {
        let result = kg_d_to_g_d(-323.0)
    ...
    func testkilogram_dTogram_dUsingNeg5_0Expectinggram_dNeg5_01000_0() {
        let result = kg_d_to_g_d(-5.0)
    ...
    func testkilogram_dTogram_dUsingNegDouble_greatestFiniteMagnitudeExpectinggram_dNegDouble_greatestFiniteMagnitude() {
        let result = kg_d_to_g_d(-Double.greatestFiniteMagnitude)
        let expected: gram_d = gram_d(-Double.greatestFiniteMagnitude)
        let tolerance: gram_d = 0.99
        if result > expected {
    ...
    func testkilogram_dTogram_fUsing15_0Expectinggram_f15_01000_0() {
    ...
    func testkilogram_dTogram_fUsing2500000_0Expectinggram_f2500000_01000_0() {
        let result = kg_d_to_g_f(2500000.0)
    ...
    func testkilogram_dTogram_fUsing250000_0Expectinggram_f250000_01000_0() {
        let result = kg_d_to_g_f(250000.0)
    ...
    func testkilogram_dTogram_fUsing25000_0Expectinggram_f25000_01000_0() {
        let result = kg_d_to_g_f(25000.0)
    ...
    func testkilogram_dTogram_fUsing25_0Expectinggram_f25_01000_0() {
        let result = kg_d_to_g_f(25.0)
    ...
    func testkilogram_dTogram_fUsingDouble_greatestFiniteMagnitudeExpectinggram_fFloat_greatestFiniteMagnitude() {
        let result = kg_d_to_g_f(Double.greatestFiniteMagnitude)
