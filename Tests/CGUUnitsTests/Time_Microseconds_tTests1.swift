...
final class Time_Microseconds_tTests1: XCTestCase {
    ...
    func testmicroseconds_t_to_nanoseconds_u1() {
        XCTAssertEqual(us_t_to_ns_u(-1000), 0)
        XCTAssertEqual(us_t_to_ns_u(-6), 0)
        XCTAssertEqual(us_t_to_ns_u(Int64.min), 0)
        XCTAssertEqual(us_t_to_ns_u(Int64.max), nanoseconds_u(UInt64.max))
    }

    func testmicroseconds_t_to_picoseconds_d() {
        let result = us_t_to_ps_d(15)
        ...
        let result5 = us_t_to_ps_d(25000)
        ...
        let result6 = us_t_to_ps_d(250000)
        ...
        let result7 = us_t_to_ps_d(2500000)
    ...
    func testmicroseconds_t_to_picoseconds_d1() {
        let result = us_t_to_ps_d(-1000)
        ...
        let result2 = us_t_to_ps_d(Int64.min)
        let expected2: picoseconds_d = picoseconds_d(Int64.min) * 1000000.0
        let tolerance2: picoseconds_d = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = us_t_to_ps_d(Int64.max)
        let expected3: picoseconds_d = picoseconds_d(Int64.max) * 1000000.0
        let tolerance3: picoseconds_d = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmicroseconds_t_to_picoseconds_f() {
        let result = us_t_to_ps_f(15)
        ...
        let result5 = us_t_to_ps_f(25000)
        ...
        let result6 = us_t_to_ps_f(250000)
        ...
        let result7 = us_t_to_ps_f(2500000)
    ...
    func testmicroseconds_t_to_picoseconds_f1() {
        let result = us_t_to_ps_f(-1000)
        ...
        let result2 = us_t_to_ps_f(Int64.min)
        let expected2: picoseconds_f = picoseconds_f(Int64.min) * 1000000.0
        let tolerance2: picoseconds_f = 0.99
        if result2 > expected2 {
            XCTAssertLessThanOrEqual(result2 - expected2, tolerance2)
        } else {
        ...
        let result3 = us_t_to_ps_f(Int64.max)
        let expected3: picoseconds_f = picoseconds_f(Int64.max) * 1000000.0
        let tolerance3: picoseconds_f = 0.99
        if result3 > expected3 {
            XCTAssertLessThanOrEqual(result3 - expected3, tolerance3)
        } else {
    ...
    func testmicroseconds_t_to_picoseconds_t() {
        XCTAssertEqual(us_t_to_ps_t(15), picoseconds_t(15) * 1000000)
        XCTAssertEqual(us_t_to_ps_t(25), picoseconds_t(25) * 1000000)
        XCTAssertEqual(us_t_to_ps_t(250), picoseconds_t(250) * 1000000)
        XCTAssertEqual(us_t_to_ps_t(0), picoseconds_t(0) * 1000000)
        XCTAssertEqual(us_t_to_ps_t(2500), picoseconds_t(2500) * 1000000)
        XCTAssertEqual(us_t_to_ps_t(25000), picoseconds_t(25000) * 1000000)
        XCTAssertEqual(us_t_to_ps_t(250000), picoseconds_t(250000) * 1000000)
        XCTAssertEqual(us_t_to_ps_t(2500000), picoseconds_t(2500000) * 1000000)
        XCTAssertEqual(us_t_to_ps_t(-323), picoseconds_t(-323) * 1000000)
        XCTAssertEqual(us_t_to_ps_t(-10), picoseconds_t(-10) * 1000000)
    }

    func testmicroseconds_t_to_picoseconds_t1() {
        XCTAssertEqual(us_t_to_ps_t(-1000), picoseconds_t(-1000) * 1000000)
        XCTAssertEqual(us_t_to_ps_t(-5), picoseconds_t(-5) * 1000000)
        XCTAssertEqual(us_t_to_ps_t(Int64.min), picoseconds_t(Int64.min))
        XCTAssertEqual(us_t_to_ps_t(Int64.max), picoseconds_t(Int64.max))
    }

    func testmicroseconds_t_to_picoseconds_u() {
        XCTAssertEqual(us_t_to_ps_u(15), picoseconds_u(15) * 1000000)
        XCTAssertEqual(us_t_to_ps_u(25), picoseconds_u(25) * 1000000)
        XCTAssertEqual(us_t_to_ps_u(250), picoseconds_u(250) * 1000000)
        XCTAssertEqual(us_t_to_ps_u(0), picoseconds_u(0) * 1000000)
        XCTAssertEqual(us_t_to_ps_u(2500), picoseconds_u(2500) * 1000000)
        XCTAssertEqual(us_t_to_ps_u(25000), picoseconds_u(25000) * 1000000)
        XCTAssertEqual(us_t_to_ps_u(250000), picoseconds_u(250000) * 1000000)
        XCTAssertEqual(us_t_to_ps_u(2500000), picoseconds_u(2500000) * 1000000)
        XCTAssertEqual(us_t_to_ps_u(-323), 0)
        XCTAssertEqual(us_t_to_ps_u(-10), 0)
    }

    func testmicroseconds_t_to_picoseconds_u1() {
        XCTAssertEqual(us_t_to_ps_u(-1000), 0)
        XCTAssertEqual(us_t_to_ps_u(-6), 0)
        XCTAssertEqual(us_t_to_ps_u(Int64.min), 0)
        XCTAssertEqual(us_t_to_ps_u(Int64.max), picoseconds_u(UInt64.max))
    }
