...
final class AngularVelocity_Radians_Per_Seconds_uTests4: XCTestCase {
    ...
    func testradians_per_seconds_uToradians_per_seconds_dUsing5000000Expectingradians_per_seconds_dDouble5000000() {
        let result = rad_per_s_u_to_rad_per_s_d(5000000)
    ...
    func testradians_per_seconds_uToradians_per_seconds_dUsingUInt64_maxExpectingradians_per_seconds_dDouble_greatestFiniteMagnitude() {
        let result = rad_per_s_u_to_rad_per_s_d(UInt64.max)
    ...
    func testradians_per_seconds_uToradians_per_seconds_dUsingUInt64_minExpectingradians_per_seconds_dDoubleUInt64_min_rounded() {
        let result = rad_per_s_u_to_rad_per_s_d(UInt64.min)
        let expected: radians_per_seconds_d = radians_per_seconds_d((Double(UInt64.min)).rounded())
        let tolerance: radians_per_seconds_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testradians_per_seconds_uToradians_per_seconds_fUsing5000000Expectingradians_per_seconds_fDouble5000000() {
        let result = rad_per_s_u_to_rad_per_s_f(5000000)
    ...
    func testradians_per_seconds_uToradians_per_seconds_fUsingUInt64_maxExpectingradians_per_seconds_fFloat_greatestFiniteMagnitude() {
        let result = rad_per_s_u_to_rad_per_s_f(UInt64.max)
    ...
    func testradians_per_seconds_uToradians_per_seconds_fUsingUInt64_minExpectingradians_per_seconds_fDoubleUInt64_min_rounded() {
        let result = rad_per_s_u_to_rad_per_s_f(UInt64.min)
        let expected: radians_per_seconds_f = radians_per_seconds_f((Double(UInt64.min)).rounded())
        let tolerance: radians_per_seconds_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
