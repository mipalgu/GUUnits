...
final class Current_Microamperes_tTests1: XCTestCase {
    ...
    func testmicroamperes_tToamperes_dUsingInt64_maxExpectingamperes_dInt64_max1000000_0() {
        let result = uA_t_to_A_d(Int64.max)
        let expected: amperes_d = amperes_d(Int64.max) / 1000000.0
        let tolerance: amperes_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmicroamperes_tToamperes_dUsingInt64_minExpectingamperes_dInt64_min1000000_0() {
        let result = uA_t_to_A_d(Int64.min)
        let expected: amperes_d = amperes_d(Int64.min) / 1000000.0
        let tolerance: amperes_d = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmicroamperes_tToamperes_fUsingInt64_maxExpectingamperes_fInt64_max1000000_0() {
        let result = uA_t_to_A_f(Int64.max)
        let expected: amperes_f = amperes_f(Int64.max) / 1000000.0
        let tolerance: amperes_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
    ...
    func testmicroamperes_tToamperes_fUsingInt64_minExpectingamperes_fInt64_min1000000_0() {
        let result = uA_t_to_A_f(Int64.min)
        let expected: amperes_f = amperes_f(Int64.min) / 1000000.0
        let tolerance: amperes_f = 0.99
        if result > expected {
            XCTAssertLessThanOrEqual(result - expected, tolerance)
        } else {
